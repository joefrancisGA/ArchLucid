...
/// Executive, Network, and Data hit this shape (one VNet or storage/SQL resource per RG across many groups).
/// </summary>
internal static class DiagramAstExecutiveLayoutSimplifier
{
    ...
    {
        return mode is DiagramMode.Executive or DiagramMode.Data or DiagramMode.Network;
    }
}
