...
public static partial class GenericArchitectureAdvicePatterns
{
    ...
    [GeneratedRegex(@"\b(conflicts? with|contradicts?|violates? (?:the |a |an )?constraints?)\b", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant | RegexOptions.Compiled)]
