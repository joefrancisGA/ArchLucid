...
/// </summary>
/// <remarks>
///     Implementations are registered in DI and matched by <see cref="ChannelType" /> against
///     <see cref="AlertRoutingSubscription.ChannelType" />
///     (typically <see cref="AlertRoutingChannelType" /> constants). Invoked from
///     <c>ArchLucid.Persistence.Alerts.AlertDeliveryDispatcher</c>.
/// </remarks>
public interface IAlertDeliveryChannel
{
    /// <summary>
    ///     Discriminator matching <see cref="AlertRoutingChannelType" /> / subscription rows (case-insensitive match in
    ///     dispatcher).
    /// </summary>
    string ChannelType
    {
