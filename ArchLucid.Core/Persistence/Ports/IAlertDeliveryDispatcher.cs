...
/// </summary>
/// <remarks>
///     Implemented by <c>ArchLucid.Persistence.Alerts.AlertDeliveryDispatcher</c>. Invoked after persistence from alert
///     services.
/// </remarks>
public interface IAlertDeliveryDispatcher
{
    /// <summary>
    ///     Resolves enabled subscriptions for the alert’s scope, filters by minimum severity, records attempts, invokes
    ///     channels, and audits success/failure per subscription.
    /// </summary>
