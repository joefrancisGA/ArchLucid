...
public sealed class RunExplanationSummary
{
    ...
    /// </summary>
    public double? FaithfulnessSupportRatio { get; init; }
    ...
    public string? FaithfulnessWarning { get; init; }

    /// <summary>Per-finding trace completeness (same order as snapshot findings when populated).</summary>
    public IReadOnlyList<FindingTraceConfidenceDto>? FindingTraceConfidences { get; init; }
}
