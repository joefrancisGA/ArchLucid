...
/// <summary>
///     Grounded natural-language Q&amp;A over a scoped run’s golden manifest, provenance, optional comparison, and
///     retrieval hits.
/// </summary>
...
{
    /// <summary>
    ///     Resolves or creates a conversation thread, loads authority context, calls the LLM with structured JSON
    ///     instructions, persists assistant turn, and optionally indexes the turn for retrieval.
    /// </summary>
    ...
    ///     Thrown when no run can be resolved (missing <see cref="AskRequest.RunId" />
