...
/// <summary>
///     Structured delta between two golden manifests: run ids, per-domain change lists, and short human-readable summary
///     lines.
/// </summary>
/// <remarks>
///     Produced by <c>ArchLucid.Decisioning.Comparison.IComparisonService.Compare</c>. Consumed by HTTP
///     <c>GET api/compare</c>, advisory pipelines, and <c>IImprovementSignalAnalyzer</c> when a comparison is available.
/// </remarks>
public class ComparisonResult
{
    ...
    public List<DecisionDelta> DecisionChanges
    {
        get;
        set;
    } = [];
    ...
    public List<RequirementDelta> RequirementChanges
    {
        get;
        set;
    } = [];
    ...
    public List<SecurityDelta> SecurityChanges
    {
        get;
        set;
    } = [];
    ...
    public List<TopologyDelta> TopologyChanges
    {
        get;
        set;
    } = [];
    ...
    public List<CostDelta> CostChanges
    {
        get;
        set;
    } = [];
    ...
    public List<string> SummaryHighlights
    {
        get;
        set;
    } = [];
    ...
    /// <summary>
    ///     Sum of decision, requirement, security, topology, and cost delta row counts (set by <c>ComparisonService</c> for
    ///     operator UIs).
    /// </summary>
