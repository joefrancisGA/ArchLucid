...
/// <summary>
///     Tier-2 GCP extractor continuous pull worker (leader-elected; per-connection session lock).
/// </summary>
public sealed class GcpExtractorAutoPullOptions
{
    public const string SectionName = "CloudPolling:Gcp";
