...
public sealed class BillingOptions
{
    ...
    public StripeBillingOptions Stripe
    {
        get;
        init;
    } = new();

    public AzureMarketplaceBillingOptions AzureMarketplace
    {
        get;
        init;
    } = new();
...
public sealed class StripeBillingOptions
{
    ...
    public string? PriceIdPro
    {
        get;
        init;
    }

    public string? PriceIdEnterprise
    {
        get;
        init;
    }
...
public sealed class AzureMarketplaceBillingOptions
{
    ...
    public bool FulfillmentApiEnabled
    {
        get;
        init;
    } = true;
    ...
    ///     Required in Production when <see cref="GaEnabled" /> is true so operators cannot enable GA mutations without a
    ///     bound offer.
    /// </summary>
