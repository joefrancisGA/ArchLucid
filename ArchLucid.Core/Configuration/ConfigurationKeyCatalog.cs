    ...
    private static IReadOnlyList<ConfigurationKeyEntry> Build()
    {
        return new List<ConfigurationKeyEntry>(161)
        {
            ...
            E("ArchLucid", "ArchLucid:AgentOutput:QualityGate:StructuralRejectBelow", M("appsettings", "env"), "0.7",
                ...
                ConfigKeyRequirementKind.None),
            E("ArchLucid", "ArchLucid:AgentOutput:QualityGate:SemanticRejectBelow", M("appsettings", "env"), "0.5",
                "—",
            ...
            E("ArchLucid", "ArchLucid:AgentOutput:QualityGate:PilotStrictMinSemanticScore", M("appsettings", "env"), "0.5",
