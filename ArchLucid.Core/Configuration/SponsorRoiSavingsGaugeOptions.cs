...
/// <summary>
///     Background refresh of <c>archlucid_tenant_estimated_savings_usd</c> from sponsor ROI rollups.
/// </summary>
public sealed class SponsorRoiSavingsGaugeOptions
{
    public const string SectionPath = "SponsorRoi:SavingsGauge";
