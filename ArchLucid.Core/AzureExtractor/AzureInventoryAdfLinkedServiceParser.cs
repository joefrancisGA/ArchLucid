...
public static class AzureInventoryAdfLinkedServiceParser
{
    ...
    public static bool TryParse(JsonElement element, out AzureInventoryAdfLinkedServiceRow? row, out string? errorMessage)
    {
        ...
        if (!IsValidCollectionStatus(collectionStatus))
        {
    ...
    private static bool IsValidCollectionStatus(string collectionStatus)
    {
        return collectionStatus.Equals(AzureInventoryAdfLinkedServiceCollectionStatus.Succeeded, StringComparison.OrdinalIgnoreCase)
               || collectionStatus.Equals(AzureInventoryAdfLinkedServiceCollectionStatus.Forbidden, StringComparison.OrdinalIgnoreCase)
               || collectionStatus.Equals(AzureInventoryAdfLinkedServiceCollectionStatus.NotFound, StringComparison.OrdinalIgnoreCase)
               || collectionStatus.Equals(AzureInventoryAdfLinkedServiceCollectionStatus.Throttled, StringComparison.OrdinalIgnoreCase)
               || collectionStatus.Equals(AzureInventoryAdfLinkedServiceCollectionStatus.MalformedPayload, StringComparison.OrdinalIgnoreCase)
               || collectionStatus.Equals(AzureInventoryAdfLinkedServiceCollectionStatus.UnsupportedConnector, StringComparison.OrdinalIgnoreCase)
               || collectionStatus.Equals(AzureInventoryAdfLinkedServiceCollectionStatus.TargetUnresolved, StringComparison.OrdinalIgnoreCase);
    }
