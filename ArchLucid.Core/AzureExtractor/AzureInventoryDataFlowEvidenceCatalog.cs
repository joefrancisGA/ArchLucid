...
public static class AzureInventoryDataFlowEvidenceCatalog
{
    ...
    [
        ...
        Row("inventory-event-hub-may-publish", AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayWrite, "May publish"),
        Row("inventory-event-hub-may-consume", AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayRead, "May consume"),
        Row("inventory-service-bus-may-send", AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayWrite, "May send"),
        Row("inventory-service-bus-may-receive", AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayRead, "May receive"),
