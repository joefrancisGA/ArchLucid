...
public static class AzureInventoryDataFlowEvidenceCatalog
{
    ...
    [
        ...
        Row(AzureInventoryRelationshipAssociationTypes.InventoryEventHubMayPublish, AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayWrite, "May publish"),
        Row(AzureInventoryRelationshipAssociationTypes.InventoryEventHubMayConsume, AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayRead, "May consume"),
        Row(AzureInventoryRelationshipAssociationTypes.InventoryServiceBusMaySend, AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayWrite, "May send"),
        Row(AzureInventoryRelationshipAssociationTypes.InventoryServiceBusMayReceive, AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayRead, "May receive"),
