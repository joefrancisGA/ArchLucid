...
public static class AzureInventoryDataFlowEvidenceCatalog
{
    ...
    [
        ...
        Row(AzureInventoryRelationshipAssociationTypes.AdfLinkedService, AzureInventoryDataFlowEvidenceFamily.DeclaredMovement, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.Undeclared, "uses"),
        ...
        Row(AzureInventoryRelationshipAssociationTypes.SynapseLinkedService, AzureInventoryDataFlowEvidenceFamily.DeclaredMovement, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.Undeclared, "uses"),
        ...
        Row(AzureInventoryRelationshipAssociationTypes.ServiceBusForwardTo, AzureInventoryDataFlowEvidenceFamily.DeclaredMovement, PathConfidenceBand.Confirmed, AzureInventoryDataFlowEdgeDirection.DeclaredWrite, "Forwards to"),
        Row(AzureInventoryRelationshipAssociationTypes.ServiceBusForwardDeadLetterTo, AzureInventoryDataFlowEvidenceFamily.DeclaredMovement, PathConfidenceBand.Confirmed, AzureInventoryDataFlowEdgeDirection.DeclaredWrite, "Forwards dead-letter to"),
        Row(AzureInventoryRelationshipAssociationTypes.EventHubMayPublish, AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayWrite, "May publish"),
        Row(AzureInventoryRelationshipAssociationTypes.EventHubMayConsume, AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayRead, "May consume"),
        Row(AzureInventoryRelationshipAssociationTypes.ServiceBusMaySend, AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayWrite, "May send"),
        Row(AzureInventoryRelationshipAssociationTypes.ServiceBusMayReceive, AzureInventoryDataFlowEvidenceFamily.AuthorizedAccess, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.MayRead, "May receive"),
        ...
        Row(AzureInventoryRelationshipAssociationTypes.LogicAppConnection, AzureInventoryDataFlowEvidenceFamily.DeclaredMovement, PathConfidenceBand.Probable, AzureInventoryDataFlowEdgeDirection.Undeclared, "uses"),
        ...
        Row(AzureInventoryRelationshipAssociationTypes.LbToBackend, AzureInventoryDataFlowEvidenceFamily.DeclaredMovement, PathConfidenceBand.Confirmed, AzureInventoryDataFlowEdgeDirection.DeclaredWrite, "Routes to"),
        ...
        Excluded(AzureInventoryRelationshipAssociationTypes.SubnetToRouteTable),
        Excluded(AzureInventoryRelationshipAssociationTypes.SubnetToNsg),
        Excluded(AzureInventoryRelationshipAssociationTypes.NicToNsg),
        Excluded("inventory-route-table-route"),
        Excluded("inventory-nsg-policy-attachment"),
