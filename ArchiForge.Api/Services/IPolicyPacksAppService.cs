...
/// <remarks>
/// <para>
/// <strong>Why:</strong> Keeps <c>PolicyPacksController</c> thin (HTTP + validation only) and centralizes audit payload shape for create / publish / assign.
/// </para>
/// <para>
/// <strong>Callers:</strong> <see cref="PolicyPacksController"/> exclusively in normal hosting; tests may substitute fakes.
/// </para>
/// </remarks>
