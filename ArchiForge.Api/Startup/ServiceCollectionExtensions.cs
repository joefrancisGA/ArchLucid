...
internal static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<ArchiForge.Application.Summaries.IManifestSummaryService, ArchiForge.Application.Summaries.ManifestSummaryService>();
        ...
        services.AddScoped<ArchiForge.Application.Analysis.IDriftReportFormatter, ArchiForge.Application.Analysis.MarkdownDriftReportFormatter>();
        services.AddScoped<ArchiForge.Application.Analysis.DriftReportDocxExport>();
        services.AddSingleton<ArchiForge.ContextIngestion.Interfaces.IContextConnector, ArchiForge.ContextIngestion.Connectors.StaticRequestContextConnector>();
        services.AddSingleton<ArchiForge.ContextIngestion.Interfaces.IContextSnapshotRepository, ArchiForge.ContextIngestion.Repositories.InMemoryContextSnapshotRepository>();
        services.AddScoped<ArchiForge.ContextIngestion.Interfaces.IContextIngestionService, ArchiForge.ContextIngestion.Services.ContextIngestionService>();
        services.AddSingleton<ArchiForge.KnowledgeGraph.Interfaces.IGraphSnapshotRepository, ArchiForge.KnowledgeGraph.Repositories.InMemoryGraphSnapshotRepository>();
        services.AddScoped<ArchiForge.KnowledgeGraph.Interfaces.IGraphBuilder, ArchiForge.KnowledgeGraph.Builders.DefaultGraphBuilder>();
        services.AddScoped<ArchiForge.KnowledgeGraph.Interfaces.IKnowledgeGraphService, ArchiForge.KnowledgeGraph.Services.KnowledgeGraphService>();
        services.AddSingleton<ArchiForge.Decisioning.Interfaces.IFindingsSnapshotRepository, ArchiForge.Decisioning.Repositories.InMemoryFindingsSnapshotRepository>();
        services.AddSingleton<ArchiForge.Decisioning.Interfaces.IGoldenManifestRepository, ArchiForge.Decisioning.Repositories.InMemoryGoldenManifestRepository>();
        services.AddSingleton<ArchiForge.Decisioning.Interfaces.IDecisionTraceRepository, ArchiForge.Decisioning.Repositories.InMemoryDecisionTraceRepository>();
        services.AddScoped<ArchiForge.Decisioning.Interfaces.IFindingEngine, ArchiForge.Decisioning.Services.RequirementFindingEngine>();
        services.AddScoped<ArchiForge.Decisioning.Interfaces.IFindingEngine, ArchiForge.Decisioning.Services.TopologySanityFindingEngine>();
        services.AddScoped<ArchiForge.Decisioning.Interfaces.IFindingEngine, ArchiForge.Decisioning.Services.SecurityBaselineFindingEngine>();
        services.AddScoped<ArchiForge.Decisioning.Interfaces.IFindingEngine, ArchiForge.Decisioning.Services.CostConstraintFindingEngine>();
        services.AddScoped<ArchiForge.Decisioning.Interfaces.IFindingsOrchestrator, ArchiForge.Decisioning.Services.FindingsOrchestrator>();
        services.AddSingleton<ArchiForge.Decisioning.Interfaces.IFindingPayloadValidator, ArchiForge.Decisioning.Services.FindingPayloadValidator>();
        services.AddSingleton<ArchiForge.Decisioning.Interfaces.IDecisionRuleProvider, ArchiForge.Decisioning.Rules.InMemoryDecisionRuleProvider>();
        services.AddScoped<ArchiForge.Decisioning.Interfaces.IGoldenManifestBuilder, ArchiForge.Decisioning.Manifest.Builders.DefaultGoldenManifestBuilder>();
        services.AddSingleton<ArchiForge.Decisioning.Interfaces.IGoldenManifestValidator, ArchiForge.Decisioning.Services.GoldenManifestValidator>();
        services.AddScoped<ArchiForge.Decisioning.Interfaces.IDecisionEngine, ArchiForge.Decisioning.Services.RuleBasedDecisionEngine>();
        ...
        services.AddScoped<ArchiForge.Application.Decisions.IAgentEvaluationService, ArchiForge.Application.Decisions.DefaultAgentEvaluationService>();
