...
public static class ProblemSupportHints
{
    ...
    private static string? Resolve(string typeUri)
    {
        ...
        if (typeUri == ProblemTypes.ValidationFailed || typeUri == ProblemTypes.BadRequest || typeUri == ProblemTypes.RequestBodyRequired)
        {
        ...
        if (typeUri == ProblemTypes.DatabaseTimeout || typeUri == ProblemTypes.DatabaseUnavailable)
        {
        ...
        if (typeUri == ProblemTypes.ExportFailed || typeUri == ProblemTypes.DeterminismFailed)
        {
