...
/// <summary>Cosmos document for <see cref="ArchLucid.KnowledgeGraph.Models.GraphSnapshot"/> (partition: <c>/graphSnapshotId</c>).</summary>
public sealed class GraphSnapshotDocument
{
    ...
    public string GraphSnapshotId { get; set; } = string.Empty;
