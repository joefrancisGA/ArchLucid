...
public sealed class InMemoryPolicyPackChangeLogRepository : IPolicyPackChangeLogRepository
{
        ...
        IDbTransaction? transaction = null)
    {
        ...
        DateTime changedUtc = entry.ChangedUtc == default ? TimeProvider.System.UtcNowDateTime() : entry.ChangedUtc;
    ...
    /// <inheritdoc />
    public Task<IReadOnlyList<PolicyPackChangeLogEntry>> GetByScopeInRangeAsync(
        Guid tenantId,
        Guid workspaceId,
        Guid projectId,
        DateTime fromUtc,
