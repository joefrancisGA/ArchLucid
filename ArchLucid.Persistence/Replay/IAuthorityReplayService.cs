...
{
    /// <summary>
    /// Loads the run via <see cref="Queries.IAuthorityQueryService.GetRunDetailAsync"/> using the caller’s current scope, then applies <see cref="ReplayRequest.Mode"/>.
    /// </summary>
    ...
    /// <remarks>
    /// <see cref="ReplayMode.RebuildManifest"/> re-runs <see cref="IDecisionEngine.DecideAsync"/> and persists a new trace/manifest; <see cref="ReplayMode.RebuildArtifacts"/> additionally synthesizes and saves an artifact bundle.
    /// </remarks>
