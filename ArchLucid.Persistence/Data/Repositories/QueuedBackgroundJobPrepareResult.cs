...
/// </summary>
/// <param name="ShouldRunExecutor">When true, the worker should execute the job body and delete the queue message after terminal persistence.</param>
...
/// <param name="RowWhenRunnable">Populated when <paramref name="ShouldRunExecutor"/> is true; includes state transitioned to Running.</param>
