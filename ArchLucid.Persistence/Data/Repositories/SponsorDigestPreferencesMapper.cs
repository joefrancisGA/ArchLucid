...
internal static class SponsorDigestPreferencesMapper
{
    internal static SponsorDigestPreferencesResponse ToResponse(TenantSponsorDigestPreferencesRow row)
    {
        if (row is null)
            throw new ArgumentNullException(nameof(row));

        return new SponsorDigestPreferencesResponse
        {
