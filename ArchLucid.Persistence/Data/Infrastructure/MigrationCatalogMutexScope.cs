...
///     <see cref="DatabaseMigrator.Run" /> with the same <c>ARCHLUCID_SQL_TEST</c> connection string — without
///     serialization,
...
internal sealed class MigrationCatalogMutexScope : IDisposable
{
    ...
    /// <summary>
    ///     Blocks until this process holds an exclusive lock for the catalog implied by
