/*
  161: Hard-delete stale non-committed authority runs (DataArchival batch, worker).

  Eligibility: CreatedUtc < @CutoffUtc, LegacyRunStatus IS NULL or not 'Committed',
  excluding demo/showcase runs. Deletes dependent rows then dbo.Runs in one transaction.
*/
