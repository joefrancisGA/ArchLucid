/*
  195: Hard-delete sample-marked authority runs (OS-1b SampleRunPurgeService / TTL worker).

  Eligibility: IsSample = 1, optional tenant filter, optional CreatedUtc cutoff.
  Reuses the same dependent-row cascade as Archival_PurgeStaleUncommittedRunsBatch (161).
*/
...
BEGIN
    GRANT EXECUTE ON OBJECT::dbo.SampleRunPurgeBatch TO [ArchLucidApp];
END;
GO
