/*
  DbUp 129: Authority-path child table scope denormalization (brownfield).
  Adds TenantId/WorkspaceId/ProjectId columns to authority child tables and backfills from parent tables.
...
/* DbUp 129 Part 1 — add columns + backfills */
SET XACT_ABORT ON;
GO
