/*
  R252: Rollback 252_Runs_EngineProvenanceJson.sql — restore TB-310 seal trigger without EngineProvenanceJson; drop column.
*/

IF OBJECT_ID(N'dbo.TR_Runs_SealCommittedHeader', N'TR') IS NOT NULL
BEGIN
    DROP TRIGGER dbo.TR_Runs_SealCommittedHeader;
END;
GO

IF OBJECT_ID(N'dbo.Runs', N'U') IS NOT NULL
   AND COL_LENGTH(N'dbo.Runs', N'EngineProvenanceJson') IS NOT NULL
BEGIN
    ALTER TABLE dbo.Runs DROP COLUMN EngineProvenanceJson;
END;
GO
