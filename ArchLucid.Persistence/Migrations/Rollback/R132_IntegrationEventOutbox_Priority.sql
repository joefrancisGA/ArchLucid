/* R132: Roll back 132 — drop IntegrationEventOutbox.Priority and restore dbo.sp_FinalizeManifest body (DbUp 120 shape). */

IF OBJECT_ID(N'dbo.IntegrationEventOutbox', N'U') IS NOT NULL
   AND COL_LENGTH(N'dbo.IntegrationEventOutbox', N'Priority') IS NOT NULL
BEGIN
    ALTER TABLE dbo.IntegrationEventOutbox DROP COLUMN Priority;
END;
GO
