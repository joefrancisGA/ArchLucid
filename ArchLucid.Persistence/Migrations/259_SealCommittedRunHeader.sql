-- TB-310 / ADR 0045: committed run header evidence-anchor immutability on dbo.Runs.
-- Lifecycle columns (status, archival, flags, governance) remain mutable post-commit.
