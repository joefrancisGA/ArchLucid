/*
  191: Filtered nonclustered indexes on dbo.AuditEvents for correlation-id lookups and per-run timelines.
  Idempotent with migration 055 (same index names); safe on catalogs that already applied 055.
*/
