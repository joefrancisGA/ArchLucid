...
public interface IHotPathReadCache
{
    ...
    /// When set, overrides <see cref="ArchLucid.Persistence.Coordination.Caching.HotPathCacheOptions.AbsoluteExpirationSeconds"/> for this entry only (clamped by the implementation).
    /// </param>
