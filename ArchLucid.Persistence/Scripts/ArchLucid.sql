...
/* Relational findings — greenfield parity with DbUp 129 (scope columns on child tables) and DbUp 148
   (no SQL Server RLS in consolidated bootstrap; optional RLS removal is forward migration only). */
