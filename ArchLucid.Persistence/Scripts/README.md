...
| **`ArchLucid.Master.sql`** | SQL Server **master** catalog DDL: `dbo.usp_ArchLucid_ResetDevelopmentCatalog` (development drop/create). Copied to build output; deployed by the Development host. |
