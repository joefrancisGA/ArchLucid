...
///     Scope comes from <see cref="IScopeContextProvider" /> (HTTP or test headers); background jobs should set scope
///     accordingly.
/// </summary>
...
{
    /// <summary>
    ///     Loads the full pack, resolves <see cref="IEffectiveGovernanceLoader.LoadEffectiveContentAsync" /> for the ambient
    ///     scope, then filters rules.
    /// </summary>
    /// <param name="ct">Cancellation token.</param>
    /// <returns>
    ///     A <see cref="ComplianceRulePack" /> whose rules are intersected with merged
    ///     <see cref="PolicyPackContentDocument" />; never <c>null</c>.
    /// </returns>
