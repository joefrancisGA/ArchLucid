...
public sealed class ProblemErrorCodesTests
{
    ...
    [InlineData(ProblemTypes.Unauthorized, ProblemErrorCodes.Unauthorized)]
    [InlineData(ProblemTypes.Forbidden, ProblemErrorCodes.Forbidden)]
    [InlineData(ProblemTypes.MethodNotAllowed, ProblemErrorCodes.MethodNotAllowed)]
    [InlineData(ProblemTypes.RateLimited, ProblemErrorCodes.RateLimited)]
