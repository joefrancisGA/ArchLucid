...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerHostPortSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_host_port_projects_host_port_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-host-port.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "ports": [ { "host_port": 9090 } ] }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.hostport"].Should().Be("9090");
    }
}
