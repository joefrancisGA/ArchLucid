...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerPortHostIpSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_port_host_ip_projects_host_ip_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-port-host-ip.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "ports": [ { "host_ip": "127.0.0.1" } ] }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.porthostip"].Should().Be("127.0.0.1");
    }
}
