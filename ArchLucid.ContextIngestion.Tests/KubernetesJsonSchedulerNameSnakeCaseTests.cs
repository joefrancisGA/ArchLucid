...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonSchedulerNameSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_scheduler_name_projects_scheduler_name_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "scheduler-name.json",
        ...
        deployment.Properties["k8s.schedulername"].Should().Be("stork");
    }
}
