...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsRotateSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_rotate_projects_dns_option_rotate_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-rotate.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "dns_config": {
                                "options": [ { "name": "rotate", "value": "true" } ]
                              },
        ...
        deployment.Properties["k8s.dnsoptionrotate"].Should().Be("true");
    }
}
