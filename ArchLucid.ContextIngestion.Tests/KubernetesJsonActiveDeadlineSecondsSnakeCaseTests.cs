...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonActiveDeadlineSecondsSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_active_deadline_seconds_projects_active_deadline_seconds_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "active-deadline-seconds.json",
        ...
        deployment.Properties["k8s.activedeadlineseconds"].Should().Be("120");
    }
}
