...
[Trait("Category", "Unit")]
public sealed class TerraformShowJsonResourceIndexStringWithoutAddressTests
{
    ...
    [Fact]
    public async Task ParseAsync_string_index_without_resource_address_appends_index_suffix_to_name()
    {
        InfrastructureDeclarationReference decl = new()
        {
            Name = "resource-index-string-without-address.json",
