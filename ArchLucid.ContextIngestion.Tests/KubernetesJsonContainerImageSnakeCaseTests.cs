...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerImageSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_image_projects_container_image_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-image.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "image": "nginx:1.25" }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.containerimage"].Should().Be("nginx:1.25");
    }
}
