...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonPodSecurityContextCapabilitiesAddSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_pod_security_context_capabilities_add_projects_capabilities_add_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "pod-security-context-capabilitiesadd.json",
