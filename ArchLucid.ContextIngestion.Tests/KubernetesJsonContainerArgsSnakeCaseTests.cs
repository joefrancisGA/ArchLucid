...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerArgsSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_args_projects_args_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-args.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "args": ["--verbose","serve"] }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.args"].Should().Be("--verbose,serve");
    }
}
