...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsLocaliseSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_localise_projects_dns_option_localise_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-localise.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "dns_config": {
                                "options": [ { "name": "localise", "value": "true" } ]
                              },
        ...
        deployment.Properties["k8s.dnsoptionlocalise"].Should().Be("true");
    }
}
