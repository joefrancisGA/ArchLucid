...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerPortProtocolSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_port_protocol_projects_port_protocol_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-port-protocol.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "ports": [ { "protocol": "TCP" } ] }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.portprotocol"].Should().Be("tcp");
    }
}
