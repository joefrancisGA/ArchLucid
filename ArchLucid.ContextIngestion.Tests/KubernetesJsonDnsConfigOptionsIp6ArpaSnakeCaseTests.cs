...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsIp6ArpaSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_ip6arpa_projects_dns_option_ip6arpa_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-ip6arpa.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "dns_config": {
                                "options": [ { "name": "ip6-arpa", "value": "true" } ]
                              },
        ...
        deployment.Properties["k8s.dnsoptionip6arpa"].Should().Be("true");
    }
}
