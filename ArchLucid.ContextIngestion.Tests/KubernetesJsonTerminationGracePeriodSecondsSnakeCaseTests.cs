...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonTerminationGracePeriodSecondsSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_termination_grace_period_seconds_projects_termination_grace_period_seconds_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "termination-grace-period-seconds.json",
        ...
        deployment.Properties["k8s.terminationgraceperiodseconds"].Should().Be("45");
    }
}
