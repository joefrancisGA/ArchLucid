...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsTimeoutSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_timeout_projects_dns_option_timeout_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-timeout.json",
        ...
        deployment.Properties["k8s.dnsoptiontimeout"].Should().Be("5");
    }
}
