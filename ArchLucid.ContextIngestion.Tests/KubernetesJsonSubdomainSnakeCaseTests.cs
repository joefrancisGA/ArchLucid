...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonSubdomainSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_subdomain_projects_subdomain_exposure()
    {
        ...
        deployment.Properties["k8s.subdomain"].Should().Be("batch");
    }
}
