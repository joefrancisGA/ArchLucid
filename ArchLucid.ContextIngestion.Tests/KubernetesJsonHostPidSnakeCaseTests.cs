...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonHostPidSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_host_pid_projects_host_pid_exposure()
    {
        ...
        deployment.Properties["k8s.hostPID"].Should().Be("true");
    }
}
