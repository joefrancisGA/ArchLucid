...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsNoglueSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_noglue_projects_dns_option_noglue_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-noglue.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "dns_config": {
                                "options": [ { "name": "noglue", "value": "true" } ]
                              },
        ...
        deployment.Properties["k8s.dnsoptionnoglue"].Should().Be("true");
    }
}
