...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerCommandSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_command_projects_command_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-command.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "command": ["/bin/sh","-c","echo hi"] }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.command"].Should().Be("/bin/sh,-c,echo hi");
    }
}
