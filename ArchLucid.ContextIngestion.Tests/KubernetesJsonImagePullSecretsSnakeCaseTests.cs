...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonImagePullSecretsSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_image_pull_secrets_projects_image_pull_secret_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "image-pull-secrets.json",
        ...
        deployment.Properties["k8s.imagepullsecret"].Should().Be("acr-creds");
    }
}
