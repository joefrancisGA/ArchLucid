...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonHostnameSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_hostname_projects_hostname_exposure()
    {
        ...
        deployment.Properties["k8s.hostname"].Should().Be("batch-worker-1");
    }
}
