...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonNodeNameSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_node_name_projects_node_name_exposure()
    {
        ...
        deployment.Properties["k8s.nodename"].Should().Be("gpu-node-1");
    }
}
