...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerPortNameSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_port_name_projects_port_name_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-port-name.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "ports": [ { "name": "http" } ] }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.portname"].Should().Be("http");
    }
}
