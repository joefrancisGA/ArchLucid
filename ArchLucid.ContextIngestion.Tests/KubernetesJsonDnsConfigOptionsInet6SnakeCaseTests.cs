...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsInet6SnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_inet6_projects_dns_option_inet6_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-inet6.json",
        ...
        deployment.Properties["k8s.dnsoptioninet6"].Should().Be("true");
    }
}
