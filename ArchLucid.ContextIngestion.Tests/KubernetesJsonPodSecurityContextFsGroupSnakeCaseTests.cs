...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonPodSecurityContextFsGroupSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_pod_security_context_fs_group_projects_fs_group_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "pod-security-context-fs-group.json",
        ...
        deployment.Properties["k8s.fsgroup"].Should().Be("2000");
    }
}
