...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonPodSecurityContextAppArmorProfileTypeSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_pod_security_context_app_armor_profile_type_projects_app_armor_profile_type_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "pod-security-context-apparmorprofiletype.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "security_context": {
                                "app_armor_profile": { "type": "RuntimeDefault" }
                              },
