...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigSearchesSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_searches_projects_dns_search_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-searches.json",
        ...
        deployment.Properties["k8s.dnssearch"].Should().Be("cluster.local");
    }
}
