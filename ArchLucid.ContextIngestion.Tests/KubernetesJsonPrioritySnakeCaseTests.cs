...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonPrioritySnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_priority_projects_priority_exposure()
    {
        ...
        deployment.Properties["k8s.priority"].Should().Be("1000");
    }
}
