...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsNdotsSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_ndots_projects_dns_option_ndots_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-ndots.json",
        ...
        deployment.Properties["k8s.dnsoptionndots"].Should().Be("2");
    }
}
