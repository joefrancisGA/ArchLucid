...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonHostIpcSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_host_ipc_projects_host_ipc_exposure()
    {
        ...
        deployment.Properties["k8s.hostIPC"].Should().Be("true");
    }
}
