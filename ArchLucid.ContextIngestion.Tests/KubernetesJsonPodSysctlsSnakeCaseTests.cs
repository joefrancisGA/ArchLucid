...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonPodSysctlsSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_sysctls_projects_sysctls_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "pod-sysctls.json",
        ...
        deployment.Properties["k8s.sysctls"].Should().Be("net.core.somaxconn=1024");
    }
}
