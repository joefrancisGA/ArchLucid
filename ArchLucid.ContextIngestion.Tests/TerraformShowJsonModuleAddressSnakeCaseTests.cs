...
[Trait("Category", "Unit")]
public sealed class TerraformShowJsonModuleAddressSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_module_address_prefixes_nested_module_resource_names()
    {
        InfrastructureDeclarationReference decl = new()
        {
            Name = "terraformshowjsonmoduleaddresssnakecasetests.json",
