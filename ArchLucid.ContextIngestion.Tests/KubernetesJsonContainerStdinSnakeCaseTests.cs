...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerStdinSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_stdin_projects_stdin_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-stdin.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "stdin": true }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.stdin"].Should().Be("true");
    }
}
