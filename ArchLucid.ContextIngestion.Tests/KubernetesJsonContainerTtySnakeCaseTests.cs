...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerTtySnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_tty_projects_tty_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-tty.json",
        ...
        deployment.Properties["k8s.tty"].Should().Be("true");
    }
}
