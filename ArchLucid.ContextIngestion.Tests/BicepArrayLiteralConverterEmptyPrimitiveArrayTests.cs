...
[Trait("Category", "Unit")]
public sealed class BicepArrayLiteralConverterEmptyPrimitiveArrayTests
{
    private readonly SimpleTerraformDeclarationParser _terraformParser = new();

    [Fact]
    public async Task ParseAsync_EmptyPrimitiveStringAddressPrefixesArray_PreservesTfProperty()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "subnet.tf",
            Format = "simple-terraform",
            DeclarationId = "decl-tf-empty-address-prefixes",
            Content = """
