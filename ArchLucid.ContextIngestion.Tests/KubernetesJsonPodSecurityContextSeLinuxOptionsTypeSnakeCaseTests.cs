...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonPodSecurityContextSeLinuxOptionsTypeSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_pod_security_context_se_linux_options_type_projects_se_linux_type_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "pod-security-context-selinuxoptionstype.json",
        ...
        deployment.Properties["k8s.selinuxtype"].Should().Be("spc_t");
    }
}
