...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsAttemptsSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_attempts_projects_dns_option_attempts_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-attempts.json",
        ...
        deployment.Properties["k8s.dnsoptionattempts"].Should().Be("3");
    }
}
