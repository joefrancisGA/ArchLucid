...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonReadinessGatesSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_readiness_gates_projects_readiness_gate_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "readiness-gates.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "readiness_gates": [
                                { "condition_type": "example.com/feature" }
                              ],
                              "containers": [
                                {
                                  "name": "app",
        ...
        deployment.Properties["k8s.readinessgate"].Should().Be("example.com/feature");
    }
}
