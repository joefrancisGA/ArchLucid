...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonShareProcessNamespaceSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_share_process_namespace_projects_share_process_namespace_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "share-process-ns.json",
        ...
        deployment.Properties["k8s.shareProcessNamespace"].Should().Be("true");
    }
}
