...
[Trait("Category", "Unit")]
public sealed class TerraformShowJsonResourceNameAliasTests
{
    ...
    [Fact]
    public async Task ParseAsync_resource_name_alias_uses_explicit_label()
    {
        InfrastructureDeclarationReference decl = new()
        {
            Name = "resource-name-alias.json",
