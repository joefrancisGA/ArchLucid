...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonSetHostnameAsFqdnSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_set_hostname_as_fqdn_projects_set_hostname_as_fqdn_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "set-hostname-as-fqdn.json",
        ...
        deployment.Properties["k8s.sethostnameasfqdn"].Should().Be("true");
    }
}
