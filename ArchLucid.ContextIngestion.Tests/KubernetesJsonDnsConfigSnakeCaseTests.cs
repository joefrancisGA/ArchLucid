...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_projects_dns_nameserver_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-config.json",
        ...
        deployment.Properties["k8s.dnsnameserver"].Should().Be("10.0.0.10");
    }
}
