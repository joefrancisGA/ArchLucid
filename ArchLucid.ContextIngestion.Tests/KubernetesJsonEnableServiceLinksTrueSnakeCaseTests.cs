...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonEnableServiceLinksTrueSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_enable_service_links_true_projects_enable_service_links_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "kubernetesjsonenableservicelinkstruesnakecasetests.json",
        ...
        deployment.Properties["k8s.enableservicelinks"].Should().Be("true");
    }
}
