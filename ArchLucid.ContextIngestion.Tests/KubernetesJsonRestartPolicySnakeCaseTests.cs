...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonRestartPolicySnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_restart_policy_projects_restart_policy_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "restart-policy.json",
        ...
        deployment.Properties["k8s.restartpolicy"].Should().Be("onfailure");
    }
}
