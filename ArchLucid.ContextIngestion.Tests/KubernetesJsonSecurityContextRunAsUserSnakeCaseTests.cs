...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonSecurityContextRunAsUserSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_security_context_run_as_user_projects_runasuser_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "security-context-run_as_user.json",
        ...
        deployment.Properties["k8s.runasuser"].Should().Be("1000");
    }
}
