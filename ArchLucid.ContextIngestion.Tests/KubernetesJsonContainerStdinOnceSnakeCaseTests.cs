...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerStdinOnceSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_stdin_once_projects_stdin_once_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-stdinonce.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "stdin_once": true }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.stdinonce"].Should().Be("true");
    }
}
