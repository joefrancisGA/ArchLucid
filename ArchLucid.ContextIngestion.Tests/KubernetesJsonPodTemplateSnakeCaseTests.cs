...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonPodTemplateSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_pod_template_projects_privileged()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "cluster-pod-template.json",
