...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsTrustAdSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_trustad_projects_dns_option_trustad_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-trustad.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "dns_config": {
                                "options": [ { "name": "trust-ad", "value": "true" } ]
                              },
        ...
        deployment.Properties["k8s.dnsoptiontrustad"].Should().Be("true");
    }
}
