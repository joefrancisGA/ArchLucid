...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsDebugSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_debug_projects_dns_option_debug_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-debug.json",
        ...
        deployment.Properties["k8s.dnsoptiondebug"].Should().Be("true");
    }
}
