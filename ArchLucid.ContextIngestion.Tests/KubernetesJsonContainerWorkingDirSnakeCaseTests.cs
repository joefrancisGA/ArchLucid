...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerWorkingDirSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_working_dir_projects_working_dir_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-workingdir.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "working_dir": "/app" }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.workingdir"].Should().Be("/app");
    }
}
