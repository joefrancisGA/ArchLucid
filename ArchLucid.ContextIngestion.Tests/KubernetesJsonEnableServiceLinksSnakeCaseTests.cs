...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonEnableServiceLinksSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_enable_service_links_projects_enable_service_links_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "enable-service-links.json",
        ...
        deployment.Properties["k8s.enableservicelinks"].Should().Be("false");
    }
}
