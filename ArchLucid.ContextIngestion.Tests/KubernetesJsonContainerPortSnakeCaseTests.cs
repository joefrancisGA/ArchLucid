...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonContainerPortSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_container_port_projects_container_port_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "container-port.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "containers": [
                                { "name": "app", "image": "nginx", "ports": [ { "container_port": 8080 } ] }
                              ]
                            }
                          }
                        }
        ...
        deployment.Properties["k8s.containerport"].Should().Be("8080");
    }
}
