...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonSecurityContextReadOnlyRootFilesystemSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_security_context_read_only_root_filesystem_projects_readonlyrootfilesystem_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "security-context-read_only_root_filesystem.json",
        ...
        deployment.Properties["k8s.readonlyrootfilesystem"].Should().Be("true");
    }
}
