...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsUseVcSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_use_vc_projects_dns_option_use_vc_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-use-vc.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "dns_config": {
                                "options": [ { "name": "use-vc", "value": "true" } ]
                              },
        ...
        deployment.Properties["k8s.dnsoptionusevc"].Should().Be("true");
    }
}
