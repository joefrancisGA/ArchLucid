...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonDnsConfigOptionsNoAaaaSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_dns_config_options_no_aaaa_projects_dns_option_no_aaaa_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "dns-options-no-aaaa.json",
            ...
            Content = """
                      {
                        ...
                        "spec": {
                          "template": {
                            "spec": {
                              "dns_config": {
                                "options": [ { "name": "no-aaaa", "value": "true" } ]
                              },
        ...
        deployment.Properties["k8s.dnsoptionnoaaaa"].Should().Be("true");
    }
}
