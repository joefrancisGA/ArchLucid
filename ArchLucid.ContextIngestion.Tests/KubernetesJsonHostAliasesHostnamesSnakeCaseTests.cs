...
[Trait("Category", "Unit")]
public sealed class KubernetesJsonHostAliasesHostnamesSnakeCaseTests
{
    ...
    [Fact]
    public async Task ParseAsync_snake_case_host_aliases_hostnames_projects_host_alias_hostname_exposure()
    {
        InfrastructureDeclarationReference declaration = new()
        {
            Name = "host-aliases-hostnames.json",
        ...
        deployment.Properties["k8s.hostaliashostname"].Should().Be("db.local");
    }
}
