...
public interface IBaselineMutationAuditService
{
    ...
    /// </summary>
    /// <param name="eventType">Stable event name (see <see cref="AuditEventTypes"/>).</param>
    /// <param name="actor">Non-empty actor string (use <see cref="IActorContext.GetActor"/>).</param>
