...
public sealed class SingleCompositionRootServiceCollectionExtensionsTests
{
    ...
    [
        ...
        typeof(ArchLucid.Integrations.AwsExtractor.HostedAwsExtractorClient).Assembly,
        ...
        typeof(ArchLucid.Integrations.GcpExtractor.HostedGcpExtractorClient).Assembly,
        typeof(ArchLucid.KnowledgeGraph.Services.KnowledgeGraphService).Assembly,
        typeof(RetrievalTools).Assembly,
