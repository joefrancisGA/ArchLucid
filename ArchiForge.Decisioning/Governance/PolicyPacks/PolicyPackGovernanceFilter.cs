...
/// <remarks>
/// <para>
/// <strong>Semantics:</strong> Empty <see cref="PolicyPackContentDocument.AlertRuleIds"/> / <see cref="PolicyPackContentDocument.CompositeAlertRuleIds"/>
...
public static class PolicyPackGovernanceFilter
{
    ...
    /// <remarks>When <see cref="PolicyPackContentDocument.AlertRuleIds"/> is empty, returns <c>rules.ToList()</c> (legacy behavior).</remarks>
