...
{
    /// <summary>
    /// Name of the environment variable whose value is the full ADO.NET connection string for <strong>ArchLucid.Persistence.Tests</strong>
    /// (includes <c>Initial Catalog</c>). When set, LocalDB fallback is skipped.
    /// </summary>
    public const string PersistenceSqlEnvironmentVariable = "ARCHIFORGE_SQL_TEST";
    ...
    /// </summary>
    public const string ApiIntegrationSqlEnvironmentVariable = "ARCHIFORGE_API_TEST_SQL";
}
