        ...
        try
        {
            ...
            switch (command)
            {
                ...
                case "pilot":
                    ...
                    Console.WriteLine("Expected: archlucid pilot up | archlucid pilot init | archlucid pilot success-criteria-template | archlucid pilot preflight [--no-api] [--include-itsm] [--simulate-production] [--md] [--markdown-out <path>] | archlucid pilot proof [-- args for collect-first-pilot-proof.ps1] | archlucid pilot proof-packet <runId> [--out <dir>] | archlucid pilot ship-gate-evidence --run-id <guid> [--json-out <path>] [--markdown-out <path>] [--no-write-artifacts] [--ui-base-url <url>] | archlucid pilot frontier-ai-baseline [--scoreboard <path>] [--init-scoreboard] [--json-out <path>] [--markdown-out <path>] | archlucid pilot itsm-pull-forward-gate [--ledger-dir <path>] [--evidence <path>] [--include-api] [--json-out <path>] [--markdown-out <path>] | archlucid pilot citation-integrity [--fixtures-dir <path>] [--manifest <path>] [--sample-size <n>] [--fail-threshold <n>] [--include-api] [--json-out <path>] [--markdown-out <path>] [--no-write-artifacts] | archlucid pilot tenant-isolation-negative-test [--run-id <guid>] [--alternate-tenant-id <guid>] [--alternate-workspace-id <guid>] [--alternate-project-id <guid>] [--manifest <path>] [--json-out <path>] [--markdown-out <path>] [--no-write-artifacts] | archlucid pilot return-trigger-telemetry [--ledger-dir <path>] [--rules <path>] [--json-out <path>] [--markdown-out <path>] [--no-write-artifacts] | archlucid pilot buyer-proof-evidence-ledger [--proof-dir <path>] [--rules <path>] [--json-out <path>] [--markdown-out <path>] [--no-write-artifacts] | archlucid pilot decision-owner-scoreboard [--ledger-dir <path>] [--rules <path>] [--json-out <path>] [--markdown-out <path>] [--sponsor-markdown-out <path>] [--no-write-artifacts]");
