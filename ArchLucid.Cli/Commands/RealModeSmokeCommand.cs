...
internal static class RealModeSmokeCommand
{
    ...
    internal static void WriteUsage()
    {
        ...
        Console.WriteLine(
            "  --rehearse   Practice review type alias for --allow-simulator (Simulator smoke; no Real AOAI requirement).");
        Console.WriteLine(
            "  Record path  Omit --rehearse on --staging to require Real execution tokens (Record-aligned smoke).");
    }
}
