    ...
    internal static string FormatSynthetic(RoiBulletinPreviewPayload payload, int realPublicationMinTenants)
    {
        ...
        return string.Join(
            ...
            [
                ...
                string.Empty,
                $"# Aggregate ROI bulletin — synthetic example ({quarter})",
                string.Empty,
                ...
                string.Empty,
                "## Headline statistics (baseline review-cycle hours — illustrative only)",
                "| Metric | Value |",
                "|--------|-------|",
                ...
                $"| p90 | {FormatHours(payload.P90BaselineHours)} h — {SyntheticRowStamp} |",
                string.Empty,
