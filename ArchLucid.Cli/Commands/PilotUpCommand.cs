...
internal static class PilotUpCommand
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        DateTime deadline = TimeProvider.System.UtcNowDateTime() + ReadyDeadline;
        bool ready = false;

        while (TimeProvider.System.UtcNowDateTime() < deadline && !cancellationToken.IsCancellationRequested)
        {
            try
            {
