...
internal sealed class PilotReadinessBundleOutputResolution
{
...
internal static class PilotReadinessBundleOutputPaths
{
    internal const string ArtifactDirectorySegment = "pilot-readiness-bundle";

    internal const string OfflineArtifactKey = "offline-fixture";

    internal static PilotReadinessBundleOutputResolution Resolve(
        ...
        string artifactKey)
    {
        ...
        return new PilotReadinessBundleOutputResolution
        {
    ...
    internal static string ResolveArtifactKey(PilotReadinessBundleReport report)
    {
    ...
    private static string? ResolveJsonPath(PilotReadinessBundleOptions options, string? defaultDirectory)
    {
        ...
        return Path.Combine(defaultDirectory, "pilot-readiness-bundle.json");
    }

    private static string? ResolveMarkdownPath(PilotReadinessBundleOptions options, string? defaultDirectory)
    {
        ...
        return Path.Combine(defaultDirectory, "pilot-readiness-bundle.md");
    }
}
