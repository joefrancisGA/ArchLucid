...
vi.mock("@/app/(operator)/settings/ai-usage/_sections/load-cost-reporting-settings-page-data", () => ({
  loadCostReportingSettingsPageData: vi.fn(async () => ({ demo: false })),
}));

vi.mock("@/app/(operator)/settings/ai-usage/_sections/CostReportingSettingsPageClient", () => ({
