...
import { PatternLibraryDomainPlatformBadges, PatternLibrarySignalBadges } from "@/app/(operator)/patterns/_sections/PatternLibraryFiltersPanel";
...
import { patternLibraryDetailPath, resolvePatternLibraryProvenance } from "@/lib/pattern-library-provenance";
  ...
  return (
    <div className={cn("w-full max-w-4xl", OPERATOR_LAYOUT.majorSectionGap)} data-testid="pattern-library-detail-page">
      <p className={cn("m-0", OPERATOR_TYPOGRAPHY.helper)}>
        <Link href="/patterns" className={OPERATOR_LINK.nav}>
          ← Pattern library
        </Link>
      </p>
