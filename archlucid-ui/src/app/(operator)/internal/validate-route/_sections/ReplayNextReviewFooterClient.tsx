...
import { ReplayNextReviewFooter, replayNextReviewHref } from "./ReplayNextReviewFooter";

export type ReplayNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review validation footer when available. */
export function ReplayNextReviewFooterClient(
  props: ReplayNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: replayNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <ReplayNextReviewFooter target={nextReview} />;
}
