export const ADMIN_HEALTH_READY_PATH = "/api/proxy/health/ready";

export const ADMIN_HEALTH_VERSION_PATH = "/api/proxy/version";

export const ADMIN_HEALTH_DIAGNOSTICS_PATH = "/api/proxy/health/diagnostics";
