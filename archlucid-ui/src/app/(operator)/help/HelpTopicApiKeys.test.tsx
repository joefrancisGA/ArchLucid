...
describe("HelpApiKeysGuideView", () => {
  ...
  it("renders release availability, live action panel CTAs, and no retired settings href", () => {
    if (entry === undefined) {
  ...
  it("renders reachable steps, supplemental follow-ups, claim discipline, and five Sources chips", () => {
    if (entry === undefined) {
      throw new Error("Expected api-keys documentation entry.");
    }
    ...
    expect(screen.getByTestId("help-api-keys-step-follow-ups")).toBeInTheDocument();
