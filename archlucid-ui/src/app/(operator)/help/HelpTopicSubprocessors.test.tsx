...
describe("HelpTopicMarkdownView subprocessors", () => {
  ...
  it("renders orientation strip, DPA primary action, and diligence links without self-link", () => {
    renderSubprocessorsPage();
    ...
    expect(screen.getByTestId("help-subprocessors-primary-action")).toHaveAttribute(
      "href",
