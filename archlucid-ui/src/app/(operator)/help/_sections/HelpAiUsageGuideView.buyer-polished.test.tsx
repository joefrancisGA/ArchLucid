...
describe("HelpAiUsageGuideView buyer-polished shell (HAI)", () => {
  ...
  it("renders skip link, header claim discipline, first-viewport intro, and bottom Sources", () => {
    ...
    expect(screen.queryByTestId("help-ai-usage-overview")).not.toBeInTheDocument();
    ...
    expect(firstViewport.compareDocumentPosition(tileItems) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy();
