...
import { dataHandlingTenantIsolationHelpLeavesStaysCards } from "@/lib/data-handling-tenant-isolation-help-guide-content";
...
export function HelpDataHandlingTenantIsolationLeavesStaysChrome(): React.JSX.Element {
  const leavesStaysCards = dataHandlingTenantIsolationHelpLeavesStaysCards(resolveProductLineIdFromEnv());
