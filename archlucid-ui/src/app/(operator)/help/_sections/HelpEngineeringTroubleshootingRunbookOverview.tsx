    ...
    >
      ...
      <dl className="m-0 grid gap-3 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          <dd className={cn("m-0 mt-1", OPERATOR_TYPOGRAPHY.body)}>
            <span>{ENGINEERING_TROUBLESHOOTING_HELP_RUNBOOK_OVERVIEW.documentTitle}</span>
            <span className="text-al-text-secondary">
              {" "}
              · {ENGINEERING_TROUBLESHOOTING_HELP_RUNBOOK_OVERVIEW.documentVersion} · Last verified {entry.lastReviewed}
            </span>
          </dd>
        </div>
      </dl>
