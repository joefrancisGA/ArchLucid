...
describe("HelpAdvisoryScansGuideView", () => {
  ...
  it("renders breadcrumb, provenance, role precondition, and claim discipline heading", () => {
    if (entry === undefined) {
    ...
    expect(screen.getByRole("heading", { name: ADVISORY_SCANS_HELP_CLAIM_DISCIPLINE_HEADING })).toBeInTheDocument();
    ...
    expect(screen.getByRole("link", { name: "Scan generation" })).toBeInTheDocument();
