...
/** Working-mode wayfinding trail: Help → Engineering troubleshooting runbook. */
export function HelpEngineeringTroubleshootingBreadcrumb(): React.JSX.Element {
  return (
    <nav
    ...
    >
      <ol className="m-0 flex list-none flex-wrap items-center gap-1.5 p-0">
        ...
        <li aria-current="page" className="text-al-text-primary">
          {ENGINEERING_TROUBLESHOOTING_HELP_TOPIC_LABEL}
        </li>
      </ol>
    </nav>
  );
