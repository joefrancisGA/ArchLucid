    ...
    >
      ...
      <div className="space-y-4 border-b border-neutral-200 pb-6 dark:border-neutral-800">
        ...
        <section
          ...
          aria-labelledby="help-api-contracts-sources-heading"
          data-testid="help-api-contracts-sources"
        >
          <h2
            id="help-api-contracts-sources-heading"
            className={cn("m-0 text-al-text-primary", OPERATOR_TYPOGRAPHY.cardTitle)}
          >
            Related Admin guides
          </h2>
          <p className={cn("m-0 mt-1 max-w-3xl text-al-text-secondary", OPERATOR_TYPOGRAPHY.helper)}>
            Keep buyer approval workflows on Governance approval; use this page only for HTTP/OpenAPI contract detail.
          </p>
