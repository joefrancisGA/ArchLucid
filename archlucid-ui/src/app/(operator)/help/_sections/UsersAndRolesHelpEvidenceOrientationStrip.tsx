...
/** Workspace Sources + claim discipline for HOE/HUX users-and-roles help. */
    ...
    <div className="space-y-3" data-testid="users-and-roles-help-orientation">
      ...
      >
        <h2 className={cn("m-0 text-al-text-primary", OPERATOR_TYPOGRAPHY.cardTitle)}>
          Access orientation only
        </h2>
        <p className={cn("m-0 mt-2", OPERATOR_TYPOGRAPHY.body)}>{USERS_AND_ROLES_HELP_CLAIM_DISCIPLINE}</p>
      </aside>
    </div>
  );
}
