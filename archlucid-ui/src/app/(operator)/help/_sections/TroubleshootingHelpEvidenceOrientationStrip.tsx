...
/** Workspace Sources + claim discipline for HTX `/help/troubleshooting`. */
  ...
  return (
    <div className="space-y-3" data-testid="troubleshooting-help-orientation">
      <section
        ...
        aria-labelledby="troubleshooting-help-sources-heading"
        data-testid="troubleshooting-help-sources"
      >
        <h2
          id="troubleshooting-help-sources-heading"
      ...
      >
        <h2 className={cn("m-0 text-al-text-primary", OPERATOR_TYPOGRAPHY.cardTitle)}>
          Operator unblocking only
        </h2>
        <p className={cn("m-0 mt-2", OPERATOR_TYPOGRAPHY.body)}>{TROUBLESHOOTING_HELP_CLAIM_DISCIPLINE}</p>
      </aside>
    </div>
  );
}
