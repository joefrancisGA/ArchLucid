...
import { HelpConnectionStatusClaimOrientationStrip } from "@/app/(operator)/help/_sections/HelpConnectionStatusClaimOrientationStrip";
...
import {
  CONNECTION_STATUS_HELP_CANONICAL_PATH,
...
export function HelpConnectionStatusGuideView(props: HelpConnectionStatusGuideViewProps): React.ReactElement {
  ...
  return (
    ...
    >
      <a href={`#${CONNECTION_STATUS_HELP_SKIP_TARGET_ID}`} className={HELP_PAGE_LAYOUT.technicalReferenceSkipLink}>
        {CONNECTION_STATUS_HELP_SKIP_LINK_LABEL}
      </a>
      <HelpTopicHashScroll />

      <div
        id={CONNECTION_STATUS_HELP_PRIMARY_CONTENT_ID}
        data-testid={CONNECTION_STATUS_HELP_PRIMARY_CONTENT_ID}
      ...
      >
        <HelpTopicGuidePageHeader
          ...
          headingLevel="h1"
          claimDiscipline={CONNECTION_STATUS_HELP_CLAIM_DISCIPLINE}
          claimDisciplineTestId={CONNECTION_STATUS_HELP_HEADER_CLAIM_DISCIPLINE_TEST_ID}
        ...
        >
          <p className={readingBodyClass} data-testid="help-connection-status-overview">
            {CONNECTION_STATUS_HELP_OVERVIEW}
          </p>
        ...
        <div className={contentGridClass}>
          <div className={cn(HELP_PAGE_LAYOUT.contentColumn, "space-y-4")}>
            ...
            >
              ...
              <p className={cn("m-0", HELP_PAGE_LAYOUT.readingBody)}>{CONNECTION_STATUS_HELP_STATUS_LEGEND_INTRO}</p>
              <ul
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className={cn("font-medium text-al-text-primary", HELP_PAGE_LAYOUT.readingBody)}>
                          {row.meaning}
                        </span>
                      </div>
        ...
        <div data-testid="help-connection-status-orientation-bottom">
          <HelpConnectionStatusClaimOrientationStrip />
        </div>
      </div>
    </article>
  );
