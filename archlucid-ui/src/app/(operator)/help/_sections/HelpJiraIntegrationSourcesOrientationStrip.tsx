...
export function HelpJiraIntegrationSourcesOrientationStrip(): React.JSX.Element {
  ...
  const helpJiraIntegrationSourcesOpenParam = searchParams.get("helpJiraIntegrationSourcesOpen");
  const [sourcesOpen, setSourcesOpenState] = useState(() =>
    parseHelpJiraIntegrationSourcesOpenFromSearch(helpJiraIntegrationSourcesOpenParam),
  );
  ...
  useEffect(() => {
    setSourcesOpenState(parseHelpJiraIntegrationSourcesOpenFromSearch(helpJiraIntegrationSourcesOpenParam));
  }, [helpJiraIntegrationSourcesOpenParam]);
