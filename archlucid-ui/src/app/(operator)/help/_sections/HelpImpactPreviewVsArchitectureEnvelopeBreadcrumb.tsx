...
import { CHEAP_EXPLORATION_HELP_IMPACT_PREVIEW_VS_ENVELOPE_TOPIC_LABEL } from "@/lib/cheap-exploration-help-impact-preview-vs-envelope-evidence-copy";
import {
...
/** Working-mode wayfinding trail: Help → Impact preview vs architecture envelope (CE-020). */
export function HelpImpactPreviewVsArchitectureEnvelopeBreadcrumb(): React.JSX.Element {
  return (
    <nav
