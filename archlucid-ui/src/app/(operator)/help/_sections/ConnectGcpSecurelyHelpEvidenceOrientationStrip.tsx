...
/** Workspace Sources + claim discipline for HGC `/help/cloud-connections/gcp`. */
export function ConnectGcpSecurelyHelpEvidenceOrientationStrip(): React.JSX.Element {
  return (
    <div className="mb-4 space-y-3" data-testid="connect-gcp-securely-help-orientation">
      <section
      ...
      >
        ...
        <p className={cn("m-0 mt-2", OPERATOR_TYPOGRAPHY.body)}>{CONNECT_GCP_SECURELY_CLAIM_DISCIPLINE}</p>
      </aside>
    </div>
  );
}
