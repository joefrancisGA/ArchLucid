...
/** Related next steps links for the path chooser help topic (HPX). */
export function HelpPathChooserRelatedNextStepsLinks(): React.ReactElement {
  return (
    <ul
      className={cn("m-0 list-none space-y-1 p-0", OPERATOR_TYPOGRAPHY.body)}
      data-testid="help-path-chooser-related-next-steps-links"
    >
      {PATH_CHOOSER_HELP_RELATED_NEXT_STEPS.map((link) => (
