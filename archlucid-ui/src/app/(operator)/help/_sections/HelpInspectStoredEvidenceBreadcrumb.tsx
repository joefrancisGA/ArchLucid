...
/** Working-mode wayfinding trail: Help → Inspect stored evidence (ESI-08 exception to TB-2090). */
export function HelpInspectStoredEvidenceBreadcrumb(): React.JSX.Element {
  return (
    <nav
