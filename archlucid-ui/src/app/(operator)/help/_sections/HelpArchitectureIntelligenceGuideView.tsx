...
import {
  ...
  ARCHITECTURE_INTELLIGENCE_HELP_PAGE_EYEBROW,
...
export function HelpArchitectureIntelligenceGuideView(
  ...
  const buyerPrimaryBody = (
    <>
      ...
      >
        <div className="space-y-4" data-testid="help-architecture-intelligence-buyer-intro">
          <p className={readingBodyClass} data-testid="help-architecture-intelligence-intro">
            {ARCHITECTURE_INTELLIGENCE_HELP_PAGE_LEAD}
          </p>
          <p
            className={cn("m-0 max-w-3xl text-al-text-secondary", OPERATOR_TYPOGRAPHY.helper)}
            data-testid="help-architecture-intelligence-start-here-helper"
          >
            {ARCHITECTURE_INTELLIGENCE_HELP_START_HERE_HELPER}
          </p>
        </div>
    ...
    >
      ...
      >
        <HelpTopicGuidePageHeader
          eyebrow={buyerPolishedShell ? undefined : ARCHITECTURE_INTELLIGENCE_HELP_PAGE_EYEBROW}
          title={ARCHITECTURE_INTELLIGENCE_HELP_PAGE_TITLE}
          titleTestId="help-architecture-intelligence-page-title"
          subtitle={architectureIntelligenceHelpPageSubtitle(buyerPolishedShell)}
        ...
        {buyerPolishedShell ? buyerPrimaryBody : operatorPrimaryBody}
      </div>
    </article>
  );
}
