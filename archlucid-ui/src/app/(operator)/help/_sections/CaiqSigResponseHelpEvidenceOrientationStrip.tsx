...
/** Workspace Sources + claim discipline for ECA `/help/caiq-sig-response`. */
export function CaiqSigResponseHelpEvidenceOrientationStrip(): React.JSX.Element {
  return (
    <div className="mb-4 space-y-3" data-testid="caiq-sig-response-help-orientation">
      <section
      ...
      >
        <h2 className={cn("m-0 text-al-text-primary", OPERATOR_TYPOGRAPHY.cardTitle)}>
          Questionnaire orientation only
        </h2>
        <p className={cn("m-0 mt-2", OPERATOR_TYPOGRAPHY.body)}>{CAIQ_SIG_RESPONSE_HELP_CLAIM_DISCIPLINE}</p>
      </aside>
    </div>
  );
}
