 ...
 */
export function ExecutiveRoiBoardPackEvidenceBanner(
  props: ExecutiveRoiBoardPackEvidenceBannerProps,
): ReactElement {
    ...
    >
      ...
      <p className={cn("m-0 mt-1 text-al-text-secondary", OPERATOR_TYPOGRAPHY.helper)}>
        ...
        {props.includeNarrative
          ? " The optional AI narrative is advisory and not part of the governed review package."
          : ""}
      </p>
      ...
      <p className={cn("m-0 mt-3 text-al-text-secondary", OPERATOR_TYPOGRAPHY.helper)}>
        See{" "}
        <Link href={EXECUTIVE_ROI_PROOF_STATUS_HELP_HREF} className={OPERATOR_LINK.inline}>
          ROI methodology
        </Link>{" "}
