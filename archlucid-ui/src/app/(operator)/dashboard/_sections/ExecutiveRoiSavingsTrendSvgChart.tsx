...
export type ExecutiveRoiSavingsTrendPoint = {
  readonly snapshotUtc: string;
  readonly totalEstimatedUsdSavings: number;
};

export type ExecutiveRoiSavingsTrendSvgChartProps = {
  readonly points: ExecutiveRoiSavingsTrendPoint[];
...
/** Inline SVG bar chart for executive ROI savings trend (TB-245). */
export function ExecutiveRoiSavingsTrendSvgChart(props: ExecutiveRoiSavingsTrendSvgChartProps): ReactNode {
