...
import { EvolutionReviewPageView } from "@/app/(operator)/evolution-review/_sections/EvolutionReviewPageView";
import type { EvolutionReviewPageViewModel } from "@/app/(operator)/evolution-review/_sections/evolution-review-view-model";
import {
...
describe("EvolutionReviewPageView buyer-polished shell", () => {
  it("uses buyer subtitle and collapses orientation and trust copy", () => {
    ...
    expect(screen.getByText(IMPACT_PREVIEW_SCOPE_DETAILS_TRIGGER)).toBeInTheDocument();
