...
export type PolicyPacksNextReviewFooterClientProps = {
  readonly runId: string;
};

export function PolicyPacksNextReviewFooterClient(
  props: PolicyPacksNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: policyPacksNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <PolicyPacksNextReviewFooter target={nextReview} />;
}
