...
import { POLICY_PACKS_PAGE_SUBTITLE, POLICY_PACKS_PAGE_TITLE } from "@/lib/policy-packs-page";
  ...
  return (
    <div className="w-full max-w-[1440px]">
      {m.buyerPolishedShell ? (
        <PolicyPackBasisStatusBanner className="mb-3" />
      ) : (
      ...
      <OperatorPageHeader
        ...
        subtitle={m.buyerPolishedShell ? POLICY_PACKS_PAGE_SUBTITLE : "Policy packs bundle rules and scope defaults. Assign them to workspaces to enforce governance."}
      />
