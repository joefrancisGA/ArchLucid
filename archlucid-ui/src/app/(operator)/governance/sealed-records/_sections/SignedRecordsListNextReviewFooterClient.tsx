...
export type SignedRecordsListNextReviewFooterClientProps = {
  readonly runId: string;
};

export function SignedRecordsListNextReviewFooterClient(
  props: SignedRecordsListNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: signedRecordsListNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <SignedRecordsListNextReviewFooter target={nextReview} />;
}
