...
export type SignedRecordsListPickReviewBeforeFilteringStripProps = {
  readonly selectedReviewId: string;
  readonly onSelectReview: (reviewId: string) => void;
};

/** Review picker shown before filtering signed records without a scoped review. */
export function SignedRecordsListPickReviewBeforeFilteringStrip(
  props: SignedRecordsListPickReviewBeforeFilteringStripProps,
): React.JSX.Element {
  ...
  return (
    <section
      aria-labelledby="signed-records-list-pick-review-before-filtering-heading"
      className="rounded-lg border border-neutral-200 bg-al-surface-raised px-4 py-3 dark:border-neutral-800"
      data-testid="signed-records-list-pick-review-before-filtering-strip"
    >
      <h2
        id="signed-records-list-pick-review-before-filtering-heading"
