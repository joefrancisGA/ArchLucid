...
export type GovernanceStandardsRulesNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review standards footer when available. */
export function GovernanceStandardsRulesNextReviewFooterClient(
  props: GovernanceStandardsRulesNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: standardsRulesNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <GovernanceStandardsRulesNextReviewFooter target={nextReview} />;
}
