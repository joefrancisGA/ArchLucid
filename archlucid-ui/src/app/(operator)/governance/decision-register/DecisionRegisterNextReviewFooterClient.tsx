...
export type DecisionRegisterNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review decision register footer when available. */
export function DecisionRegisterNextReviewFooterClient(
  props: DecisionRegisterNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: decisionRegisterNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <DecisionRegisterNextReviewFooter target={nextReview} />;
}
