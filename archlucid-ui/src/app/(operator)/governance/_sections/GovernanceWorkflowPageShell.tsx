...
import type { GovernanceWorkflowPageModel } from "./use-governance-workflow-page";
import type { GovernanceEnvironmentCatalog } from "@/types/governance-environment-catalog";

export type GovernanceWorkflowPageShellProps = {
  readonly model: GovernanceWorkflowPageModel;
  readonly environmentCatalog: GovernanceEnvironmentCatalog | undefined;
};

export function GovernanceWorkflowPageShell(props: GovernanceWorkflowPageShellProps) {
  const {
    canMutateWorkflow,
    buyerPolishedShell,
    submitSectionRef,
        ...
        <>
          ...
          <div ref={submitSectionRef}>
            <GovernanceWorkflowSubmitSectionDeferred
              ...
              environmentCatalog={props.environmentCatalog}
            />
          </div>
