...
export type GovernanceApprovalQueueNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review approval queue footer when available. */
export function GovernanceApprovalQueueNextReviewFooterClient(
  props: GovernanceApprovalQueueNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: governanceApprovalQueueNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <GovernanceApprovalQueueNextReviewFooter target={nextReview} />;
}
