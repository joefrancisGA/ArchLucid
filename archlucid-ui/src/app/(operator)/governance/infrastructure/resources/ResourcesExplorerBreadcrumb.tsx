...
/** Resource explorer breadcrumb (NRE). */
export function ResourcesExplorerBreadcrumb(): React.JSX.Element {
  return (
    <OperatorPageBreadcrumb
      data-testid="infra-resource-explorer-breadcrumb"
      items={[
        { label: GOVERNANCE_INFRASTRUCTURE_OVERVIEW_PAGE_TITLE, href: GOVERNANCE_INFRASTRUCTURE_PATH },
        { label: GOVERNANCE_INFRASTRUCTURE_RESOURCES_PAGE_TITLE },
      ]}
    />
  );
}
