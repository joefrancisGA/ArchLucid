...
export function TerraformBreadcrumb(): React.JSX.Element | null {
  ...
  return (
    <nav aria-label="Breadcrumb" data-testid="infra-terraform-breadcrumb">
      <ol className={cn("m-0 flex flex-wrap items-center gap-1 p-0 list-none", OPERATOR_TYPOGRAPHY.helper)}>
        <li>
          <Link href={GOVERNANCE_INFRASTRUCTURE_PATH} className={cn("text-al-link hover:underline", OPERATOR_LINK.inline)}>
            {GOVERNANCE_INFRASTRUCTURE_OVERVIEW_PAGE_TITLE}
          </Link>
        </li>
