...
/** Declared connections workbench breadcrumb (IND). */
export function DeclaredConnectionsBreadcrumb(): React.JSX.Element | null {
  ...
  return (
    <nav aria-label="Breadcrumb" data-testid="infra-declared-connections-breadcrumb">
