...
/** Workspace Sources + claim discipline for SAX `/governance/alert-rules` hub (non-routing tabs). */
  ...
  return (
    <div className="mb-4 space-y-3" data-testid="alert-rules-orientation">
      <section
        ...
        aria-labelledby="alert-rules-sources-heading"
        data-testid="alert-rules-sources"
      >
        <h2
          id="alert-rules-sources-heading"
