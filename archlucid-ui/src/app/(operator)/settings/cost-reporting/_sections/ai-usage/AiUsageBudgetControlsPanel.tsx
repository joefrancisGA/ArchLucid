    ...
    <Card data-testid="ai-usage-budget-controls-panel">
      ...
      <CardContent className={cn(OPERATOR_CARD.content, "flex flex-wrap gap-2")}>
        <Button asChild variant="outline" size="sm">
          <Link href="/settings/billing#billing-ai-credits">Edit monthly budget</Link>
        </Button>
        <Button asChild variant="outline" size="sm">
          <Link href="/settings/billing#billing-usage">Set warning threshold</Link>
        </Button>
        <Button asChild variant="outline" size="sm">
          <Link href="/settings/billing#billing-usage">Configure hard-stop behavior</Link>
        </Button>
        <Button asChild variant="outline" size="sm">
          <Link href="/settings/recurrence">Pause scheduled AI operations</Link>
        </Button>
        <p className={cn("m-0 w-full text-al-text-secondary", OPERATOR_TYPOGRAPHY.helper)}>
          ...
          <Link href="/settings/billing" className={OPERATOR_LINK.nav}>
            billing settings
          </Link>
          .
        </p>
