...
export const SETTINGS_MASTER_SECTIONS: readonly SettingsMasterSection[] = [
  {
    ...
    keywords: ["appearance", "theme", "color", "help", "guide"],
    tier: "common",
    destinations: [],
  },
  {
    ...
    destinations: [
      {
        ...
        emptyStateHint: "Workspace defaults load on the destination page.",
      },
    ],
  },
  {
    ...
    destinations: [
      {
        ...
        source: "inherited",
        editability: "admin-only",
        emptyStateHint: "No custom policy packs assigned yet.",
      },
    ],
  },
  {
    ...
    destinations: [
      {
        ...
        saveBehavior: "Save on destination page",
        highImpact: true,
        emptyStateHint: "No cloud connection configured.",
      },
      {
        id: "itsm-jira",
        title: "Jira",
        ...
        saveBehavior: "Save on destination page",
        highImpact: true,
        emptyStateHint: "No Jira connection configured.",
      },
      {
        id: "itsm-servicenow",
        title: "ServiceNow",
        ...
        saveBehavior: "Save on destination page",
        highImpact: true,
        emptyStateHint: "No ServiceNow connection configured.",
      },
    ],
  },
  {
    ...
    destinations: [
      {
        ...
        description: "Internal tools for local demos, diagnostics, and support workflows.",
