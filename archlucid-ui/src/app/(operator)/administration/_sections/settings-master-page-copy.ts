...
export const SETTINGS_MASTER_PAGE_DESCRIPTION_OPERATOR =
  "Manage workspace, governance, integration, security, billing, and support configuration." as const;

export const SETTINGS_MASTER_PAGE_DESCRIPTION_BUYER =
  "Search workspace, governance, integration, security, billing, and support destinations from one administration hub." as const;
