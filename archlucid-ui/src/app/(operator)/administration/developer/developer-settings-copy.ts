...
export const INTERNAL_DEVELOPER_TOOLS_ACCESS_NOTE =
  "ReadAuthority workspace readers can open this page. The Administration hub lists it only when the internal operator shell is enabled; customer shells redirect to Preferences." as const;
