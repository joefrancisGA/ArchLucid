        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <Button asChild size="sm">
              <Link href="/administration/settings/identity-providers/saml">Edit SAML role mapping</Link>
            </Button>
            <Button asChild variant="outline" size="sm">
              <Link href="/administration/settings/identity-providers/diagnostics">Test role mapping</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
