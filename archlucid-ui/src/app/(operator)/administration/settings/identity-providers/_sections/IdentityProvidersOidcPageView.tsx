        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <Button asChild size="sm">
              <Link href="/administration/settings/identity/sso-wizard">Open SSO wizard</Link>
            </Button>
            <Button asChild variant="outline" size="sm">
              <Link href="/administration/settings/identity-providers/diagnostics">Validate discovery</Link>
            </Button>
          </div>
          <p className={cn("m-0 text-al-text-secondary", OPERATOR_TYPOGRAPHY.helper)}>
            Host-level OIDC/JWT settings are configured in your deployment environment. Use the{" "}
            <Link href="/administration/settings/identity/sso-wizard" className={OPERATOR_LINK.inline}>
