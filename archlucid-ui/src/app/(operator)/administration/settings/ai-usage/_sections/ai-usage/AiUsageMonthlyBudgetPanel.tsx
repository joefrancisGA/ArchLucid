          ...
          {props.canManageBudget ? (
            <div className="flex flex-wrap gap-2">
              <Button asChild variant="outline" size="sm">
                <Link href="/administration/settings/billing#billing-ai-credits">Edit budget</Link>
              </Button>
              <Button asChild variant="outline" size="sm">
                <Link href="/administration/settings/billing#billing-usage">Review limit behavior</Link>
              </Button>
            </div>
          ) : (
            <p className={cn("m-0 text-al-text-secondary", OPERATOR_TYPOGRAPHY.helper)}>
