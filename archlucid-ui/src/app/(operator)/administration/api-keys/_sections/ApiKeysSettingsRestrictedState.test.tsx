...
describe("ApiKeysSettingsRestrictedState", () => {
  it("renders parked-surface copy, links, and compact empty state (P0-1, P0-2)", () => {
    ...
    const settingsLink = screen.getByRole("link", { name: "All settings" });
    expect(settingsLink).toHaveAttribute("href", "/administration");
  });
