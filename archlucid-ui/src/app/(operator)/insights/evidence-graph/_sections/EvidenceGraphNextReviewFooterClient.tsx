...
export type EvidenceGraphNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review evidence graph footer when available. */
export function EvidenceGraphNextReviewFooterClient(
  props: EvidenceGraphNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: evidenceGraphHref({ runId: target.runId }),
    };
  }, [props.runId, runs]);
  ...
  return <EvidenceGraphNextReviewFooter target={nextReview} />;
}
