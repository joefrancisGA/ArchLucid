...
export type PatternLibraryNextReviewFooterClientProps = {
  readonly runId: string;
};

export function PatternLibraryNextReviewFooterClient(
  props: PatternLibraryNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: patternLibraryNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <PatternLibraryNextReviewFooter target={nextReview} />;
}
