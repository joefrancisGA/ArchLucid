...
export type SponsorReportNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review sponsor report footer when available. */
export function SponsorReportNextReviewFooterClient(
  props: SponsorReportNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: sponsorReportNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <SponsorReportNextReviewFooter target={nextReview} />;
}
