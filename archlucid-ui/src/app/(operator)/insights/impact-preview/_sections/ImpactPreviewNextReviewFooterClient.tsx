...
export type ImpactPreviewNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review impact preview footer when available. */
export function ImpactPreviewNextReviewFooterClient(
  props: ImpactPreviewNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: impactPreviewNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <ImpactPreviewNextReviewFooter target={nextReview} />;
}
