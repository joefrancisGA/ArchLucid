...
export type RoiSummaryNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review ROI summary footer when available. */
export function RoiSummaryNextReviewFooterClient(
  props: RoiSummaryNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: roiSummaryNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <RoiSummaryNextReviewFooter target={nextReview} />;
}
