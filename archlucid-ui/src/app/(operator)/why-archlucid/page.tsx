...
function CounterGrid({ snapshot }: { readonly snapshot: WhyArchLucidSnapshot }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
      <Counter label="Architecture reviews created" value={snapshot.runsCreatedTotal} hint="archlucid_runs_created_total" />
      <Counter
  ...
  return (
    <div className="space-y-4">
      <p className="text-xs text-neutral-500">
        Generated {formatWhyPageInstant(sponsorPack.generatedUtc)} · demo review <code>{sponsorPack.demoRunId ?? "—"}</code> · telemetry
