...
vi.mock("next/navigation", () => ({
  usePathname: () => "/integrations/cloud-connections/azure",
...
import {
  ...
  AZURE_CLOUD_CONNECTION_ORIENTATION_BOTTOM_TEST_ID,
...
describe("AzureCloudConnectionDetailClient buyer-polished shell (IAZ)", () => {
  it("renders skip link, intro lead, start-here panel before follow-ups, header claim discipline, and hides contextual help", async () => {
    ...
    for (const source of filterOrientationSourcesForJobContext(
      filterWhereToGoNextFollowUpLinks(cloudProviderConnectionSources("azure")),
