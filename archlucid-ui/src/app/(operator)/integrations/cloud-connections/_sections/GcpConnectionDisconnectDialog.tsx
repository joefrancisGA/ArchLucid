...
export function GcpConnectionDisconnectDialog(props: GcpConnectionDisconnectDialogProps): React.JSX.Element {
  ...
  return (
    <ConfirmationDialog
      ...
      description="Scheduled read-only inventory collection for this GCP project will stop. Previously collected inventory packages and any finalized review records that cite them are retained."
