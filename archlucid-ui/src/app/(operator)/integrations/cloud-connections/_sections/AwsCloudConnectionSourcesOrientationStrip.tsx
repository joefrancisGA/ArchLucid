...
export function AwsCloudConnectionSourcesOrientationStrip(): React.JSX.Element {
  ...
  const awsCloudConnectionSourcesOpenParam = searchParams.get("awsCloudConnectionSourcesOpen");
  const [sourcesOpen, setSourcesOpenState] = useState(() =>
    parseAwsCloudConnectionSourcesOpenFromSearch(awsCloudConnectionSourcesOpenParam),
  );
  ...
  useEffect(() => {
    setSourcesOpenState(parseAwsCloudConnectionSourcesOpenFromSearch(awsCloudConnectionSourcesOpenParam));
  }, [awsCloudConnectionSourcesOpenParam]);
