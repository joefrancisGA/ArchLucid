...
describe("AwsConnectionDisconnectDialog", () => {
  it("delegates disconnect copy to ConfirmationDialog (TB-2371)", () => {
    ...
    expect(
      screen.getByText(
        "Scheduled read-only inventory collection for this AWS account will stop. Previously collected inventory packages and any finalized review records that cite them are retained.",
      ),
    ).toBeInTheDocument();
