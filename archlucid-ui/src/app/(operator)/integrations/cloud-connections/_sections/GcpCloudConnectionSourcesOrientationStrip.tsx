...
export function GcpCloudConnectionSourcesOrientationStrip(): React.JSX.Element {
  ...
  const gcpCloudConnectionSourcesOpenParam = searchParams.get("gcpCloudConnectionSourcesOpen");
  const [sourcesOpen, setSourcesOpenState] = useState(() =>
    parseGcpCloudConnectionSourcesOpenFromSearch(gcpCloudConnectionSourcesOpenParam),
  );
  ...
  useEffect(() => {
    setSourcesOpenState(parseGcpCloudConnectionSourcesOpenFromSearch(gcpCloudConnectionSourcesOpenParam));
  }, [gcpCloudConnectionSourcesOpenParam]);
