...
describe("GcpConnectionDisconnectDialog", () => {
  it("delegates disconnect copy to ConfirmationDialog (TB-2372)", () => {
    ...
    expect(
      screen.getByText(
        "Scheduled read-only inventory collection for this GCP project will stop. Previously collected inventory packages and any finalized review records that cite them are retained.",
      ),
    ).toBeInTheDocument();
