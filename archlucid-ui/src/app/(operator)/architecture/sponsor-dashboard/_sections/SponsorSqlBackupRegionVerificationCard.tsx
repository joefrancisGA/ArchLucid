...
/** Sponsor dashboard tile — reads persisted Terraform CI verification artifact. */
export function SponsorSqlBackupRegionVerificationCard() {
  const v = BUYER_SPONSOR_SUMMARY_VOCABULARY.sqlBackupRegionVerificationMetric;
  ...
  if (loading) {
    return (
      <Card data-testid="sponsor-sql-backup-region-verification-card">
      ...
      <CardContent>
        ...
        >
          ...
          <div className="min-w-0 space-y-1">
            <Link
              href={SPONSOR_KPI_DRILL_THROUGH.sqlBackupRegion}
