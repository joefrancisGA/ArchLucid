...
export type SponsorRoiDashboardNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review sponsor dashboard footer when available. */
export function SponsorRoiDashboardNextReviewFooterClient(
  props: SponsorRoiDashboardNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: sponsorRoiDashboardNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <SponsorRoiDashboardNextReviewFooter target={nextReview} />;
}
