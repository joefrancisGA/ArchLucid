...
/** Live business-impact tiles from sponsor ROI summary (TB-062 / Batch C item 7). */
              ...
              <>
                ...
                {data ? (
                  <CardDescription className={cn("mt-2", OPERATOR_KPI_CARD_DESCRIPTION)}>
                    {formatSponsorRoiPricingBasisLabel(data.savingsPricingBasis, data.eaDiscountMultiplier)}
                  </CardDescription>
                ) : null}
              </>
            )}
