...
type RunDetailSponsorReportCtaCardProps = {
...
export function RunDetailSponsorReportCtaCard(props: RunDetailSponsorReportCtaCardProps) {
    ...
    <Card className="rounded-lg border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-950/30">
      <CardHeader className={OPERATOR_CARD.header}>
        ...
        <CardDescription className={OPERATOR_TYPOGRAPHY.helper}>
          Board-ready risk posture, evidence basis, and governance status. Start here before the Finalized review record and
          deliverables.
        </CardDescription>
      </CardHeader>
