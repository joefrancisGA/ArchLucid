      ...
      <div className={cn("flex flex-col gap-6", !canMutateSubscriptions && "flex-col-reverse")}>
        <section style={{ marginBottom: 0, padding: 16, border: "1px solid #ddd", borderRadius: 8 }}>
          ...
          <div style={{ display: "grid", gap: 12, maxWidth: 700 }}>
            ...
            >
              {canMutateSubscriptions ? "Create subscription" : digestSubscriptionsCreateSubscriptionButtonLabelReaderRank}
            </button>
          </div>
        </section>
        ...
        <div>
          ...
          <div style={{ display: "grid", gap: 12 }}>
            {items.length === 0 ? (
              <p style={{ color: "#666" }}>
                {canMutateSubscriptions ? digestSubscriptionsEmptyListOperatorLine : digestSubscriptionsEmptyListReaderLine}
              </p>
            ) : (
              items.map((item) => (
                <div
                ...
                >
                  ...
                  <div style={{ marginTop: 12, display: "flex", gap: 8, flexWrap: "wrap" }}>
                    ...
                    >
                      {canMutateSubscriptions ? "Show delivery attempts" : digestSubscriptionsDeliveryAttemptsButtonLabelReaderRank}
                    </button>
                  </div>
