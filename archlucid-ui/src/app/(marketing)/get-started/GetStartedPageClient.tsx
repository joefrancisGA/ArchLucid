  ...
  return (
    <div className="space-y-12" data-testid="get-started-page">
      <header className="max-w-3xl">
        ...
        <p className={cn("mt-3 text-al-text-primary", MARKETING_TYPOGRAPHY.body)} data-testid="get-started-outcome-led-lead">
          {GET_STARTED_OUTCOME_STATEMENT}
        </p>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          >
            ...
            <Button
              ...
              onClick={() => setSelectedPath("sample")}
          ...
          >
            ...
            <p className={cn("mt-2 text-al-text-secondary", MARKETING_TYPOGRAPHY.body)}>
              Sign in with your work account, choose an industry profile, and complete a guided sample review in
      ...
      <section
        ...
        className={cn(selectedPath !== "sample" && "opacity-80")}
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className={cn("m-0 mt-1 text-al-text-secondary", MARKETING_TYPOGRAPHY.body)}>{vertical.scenario}</p>
                    </div>
                  </div>
      ...
      <section
        ...
        className={cn(selectedPath !== "trial" && "opacity-80")}
      ...
      <section aria-labelledby="sample-disclosure-heading" className={MARKETING_SURFACES.mutedPanel}>
        ...
        <p className={cn("mt-2 max-w-3xl text-al-text-secondary", MARKETING_TYPOGRAPHY.body)}>{GET_STARTED_SAMPLE_DISCLOSURE}</p>
        <p className={cn("mt-3 max-w-3xl text-al-text-secondary", MARKETING_TYPOGRAPHY.body)}>{GET_STARTED_REAL_REVIEW_NOTE}</p>
      </section>
