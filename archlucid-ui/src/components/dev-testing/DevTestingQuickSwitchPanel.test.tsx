...
describe("DevTestingQuickSwitchPanel", () => {
  ...
  it("renders quick-jump link chips for each entity cluster", async () => {
    ...
    expect(manifestLink).toHaveAttribute("href", "/signed-records/44444444-aaaa-bbbb-cccc-dddddddddddd");
    expect(artifactLink).toHaveAttribute(
      "href",
      "/signed-records/44444444-aaaa-bbbb-cccc-dddddddddddd/artifacts/55555555-aaaa-bbbb-cccc-dddddddddddd",
    );
  });
