...
describe("DevTestingQuickSwitchPanel", () => {
  ...
  it("renders quick-jump link chips for each entity cluster", async () => {
    ...
    expect(manifestLink).toHaveAttribute("href", "/manifests/44444444-aaaa-bbbb-cccc-dddddddddddd");
    expect(artifactLink).toHaveAttribute(
      "href",
      "/manifests/44444444-aaaa-bbbb-cccc-dddddddddddd/artifacts/55555555-aaaa-bbbb-cccc-dddddddddddd",
    );
  });
