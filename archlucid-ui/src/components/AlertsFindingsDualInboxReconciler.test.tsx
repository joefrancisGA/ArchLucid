...
describe("AlertsFindingsDualInboxReconciler (TB-2221)", () => {
  it("renders compact strip on alerts inbox with peer link to findings", () => {
    ...
    const strip = screen.getByTestId("alerts-findings-dual-inbox");
    ...
    const peer = screen.getByTestId("alerts-findings-dual-inbox-peer-link");
  ...
  it("renders compact strip on findings queue with peer link to alerts", () => {
    ...
    expect(screen.getByTestId("alerts-findings-dual-inbox")).toHaveAttribute(
  ...
  it("renders full variant with why-two explanation", () => {
    ...
    expect(screen.getByTestId("alerts-findings-dual-inbox-current")).toHaveTextContent(
