...
export type AskRunIdPickerProps = {
  ...
  /**
   * Notifies parents when list availability changes — used to avoid duplicate downstream error surfaces.
   */
...
export function AskRunIdPicker(props: AskRunIdPickerProps) {
  ...
  const reviewsUnavailableHint =
    reviewsLoadErrorHint ?? "Check workspace setup or retry.";
