  ...
  return (
    ...
    >
      ...
      <p className="m-0 mt-1 text-sm text-neutral-800 dark:text-neutral-200">
        This run has a committed manifest. If you need questions Core Pilot does not answer—diff two runs, re-validate
        the authority chain, or explore a graph—use the links below (enable <em>Show more links</em> in the sidebar if
        needed).
      </p>
