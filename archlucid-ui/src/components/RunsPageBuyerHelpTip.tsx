...
export function RunsPageBuyerHelpTip(props: RunsPageBuyerHelpTipProps) {
  ...
  const hint =
    variant === "search"
      ? "Use Search review packages below to narrow by title or description. Each row opens the full review package — manifest, evidence trail, findings, and deliverables — for that run."
      : demoMarketing
