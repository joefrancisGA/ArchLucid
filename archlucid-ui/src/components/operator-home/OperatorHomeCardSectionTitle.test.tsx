...
describe("OperatorHomeCardSectionTitle", () => {
  it("renders peer overview card heading typography", () => {
    render(<OperatorHomeCardSectionTitle id="card-title-test">Setup and walkthroughs</OperatorHomeCardSectionTitle>);

    const heading = screen.getByRole("heading", { level: 2, name: "Setup and walkthroughs" });
