...
export function ReviewListDisplayTitle(props: ReviewListDisplayTitleProps): React.JSX.Element {
  return (
    ...
    >
      <span
        className="block truncate group-hover/title:whitespace-normal group-hover/title:overflow-visible group-focus-visible/title:whitespace-normal group-focus-visible/title:overflow-visible"
      >
        {props.title}
      </span>
    </Link>
