...
import {
  ...
  advisoryScansNextReviewHref,
} from "./AdvisoryScansNextReviewFooter";

export type AdvisoryScansNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review advisory scans footer when available. */
export function AdvisoryScansNextReviewFooterClient(
  props: AdvisoryScansNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: advisoryScansNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <AdvisoryScansNextReviewFooter target={nextReview} />;
}
