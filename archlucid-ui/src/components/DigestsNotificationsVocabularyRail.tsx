...
export function DigestsNotificationsVocabularyRail(
  ...
  if (variant === "compact") {
    return (
      <p
        ...
        data-testid="digests-notifications-vocabulary"
      ...
      >
        ...
        <Link
          ...
          data-testid="digests-notifications-vocabulary-peer-link"
        >
          {peer.label}
        </Link>
      </p>
  ...
  return (
    <section
      ...
      aria-labelledby="digests-notifications-vocabulary-heading"
      data-testid="digests-notifications-vocabulary"
      data-variant="full"
      data-current-surface={props.currentSurfaceId}
    >
      <h2
        id="digests-notifications-vocabulary-heading"
      ...
      <div className="flex flex-wrap gap-x-4 gap-y-1">
        <span
          ...
          data-testid="digests-notifications-vocabulary-current"
          aria-current="page"
        >
          {currentLink.label}
        </span>
