...
/**
 * Right-edge contextual help drawer: full-viewport backdrop, fixed width, slide-in panel.
 */
export const HelpDrawerContent = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content>,
  HelpDrawerContentProps
>(({ className, children, closeAriaLabel = "Close help", returnFocusRef, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay className="bg-black/50 backdrop-blur-0" />
