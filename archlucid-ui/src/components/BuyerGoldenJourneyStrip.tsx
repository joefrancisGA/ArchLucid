...
import { OPERATOR_HOME_SECTION_HEADING, OPERATOR_LINK, OPERATOR_SHORT_HELPER_MEASURE_CLASS, OPERATOR_TYPE_SCALE } from "@/lib/design-tokens";
...
export function BuyerGoldenJourneyStrip() {
  ...
  return (
    ...
    >
      ...
      <p className={cn("m-0 mt-2", OPERATOR_SHORT_HELPER_MEASURE_CLASS, OPERATOR_TYPE_SCALE.body, "text-al-text-secondary")}>
        Follow the finalized review from sponsor decision through finalized review record, evidence graph, resolve
