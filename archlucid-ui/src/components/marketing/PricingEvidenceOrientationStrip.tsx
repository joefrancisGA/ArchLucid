...
export function PricingEvidenceOrientationStrip(): React.JSX.Element {
  return (
    <div className="mb-10 space-y-3" data-testid="pricing-orientation">
      <section
        className="rounded-md border border-neutral-200 bg-neutral-50/80 p-3 dark:border-neutral-700 dark:bg-neutral-900/40"
        aria-labelledby="pricing-sources-heading"
        data-testid="pricing-sources"
      >
        <h2
          id="pricing-sources-heading"
      ...
      <aside
        ...
        data-testid="pricing-claim-discipline"
      >
        <h2 className={cn("m-0 text-al-text-primary", MARKETING_TYPOGRAPHY.cardTitle)}>
          Commercial packaging only
        </h2>
        <p className={cn("m-0 mt-2", MARKETING_TYPOGRAPHY.body)}>{PRICING_CLAIM_DISCIPLINE}</p>
      </aside>
    </div>
  );
}
