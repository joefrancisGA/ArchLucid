...
import { SEE_IT_SCOPE_DISCLOSURE_BODY } from "@/lib/see-it-evidence-copy";
import { TRUST_CENTER_PUBLIC_LAYOUT } from "@/lib/trust-center-public-layout";
import { cn } from "@/lib/utils";

/** Demoted scope boundary — what this marketing page does not replace. */
export function SeeItScopeDisclosure(): ReactNode {
  return (
    <details
      className={TRUST_CENTER_PUBLIC_LAYOUT.vocabularyDisclosure}
      data-testid="see-it-scope-disclosure"
    >
