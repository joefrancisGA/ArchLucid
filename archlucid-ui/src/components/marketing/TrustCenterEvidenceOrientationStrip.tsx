...
export function TrustCenterEvidenceOrientationStrip(): React.JSX.Element {
  return (
    <div className="space-y-3" data-testid="trust-center-orientation">
      <section
        className="rounded-md border border-neutral-200 bg-neutral-50/80 p-3 dark:border-neutral-700 dark:bg-neutral-900/40"
        aria-labelledby="trust-center-sources-heading"
        data-testid="trust-center-sources"
      >
        <h2
          id="trust-center-sources-heading"
      ...
      <aside
        ...
        data-testid="trust-center-claim-discipline"
      >
        <h2 className={cn("m-0 text-al-text-primary", MARKETING_TYPOGRAPHY.cardTitle)}>
          Public assurance posture only
        </h2>
        <p className={cn("m-0 mt-2", MARKETING_TYPOGRAPHY.body)}>{TRUST_CENTER_CLAIM_DISCIPLINE}</p>
      </aside>
    </div>
  );
}
