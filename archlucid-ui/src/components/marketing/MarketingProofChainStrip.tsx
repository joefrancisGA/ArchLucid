      ...
      <ol className="m-0 mt-4 flex list-none flex-wrap items-center gap-2 p-0">
        {PROOF_CHAIN_STEPS.map((step, index) => (
          <li key={step} className="flex items-center gap-2">
            <span className="rounded-md border border-teal-200 bg-teal-50 px-2 py-1 text-xs font-semibold text-teal-900 dark:border-teal-900 dark:bg-teal-950/50 dark:text-teal-100">
              {index + 1}. {step}
            </span>
