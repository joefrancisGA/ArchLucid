...
export function GetStartedEvidenceOrientationStrip(): React.JSX.Element {
  return (
    <div className="space-y-3 text-left" data-testid="get-started-orientation">
      <section
        className="rounded-md border border-neutral-200 bg-neutral-50/80 p-3 dark:border-neutral-700 dark:bg-neutral-900/40"
        aria-labelledby="get-started-sources-heading"
        data-testid="get-started-sources"
      >
        <h2
          id="get-started-sources-heading"
      ...
      <aside
        ...
        data-testid="get-started-claim-discipline"
      >
        <h2 className={cn("m-0 text-al-text-primary", MARKETING_TYPOGRAPHY.cardTitle)}>
          First-run orientation only
        </h2>
        <p className={cn("m-0 mt-2", MARKETING_TYPOGRAPHY.body)}>{GET_STARTED_CLAIM_DISCIPLINE}</p>
      </aside>
    </div>
  );
}
