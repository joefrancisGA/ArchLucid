...
export function MarketingPricingPublicCutoverNotice() {
  return (
    ...
    >
      ...
      packaging. Until then, figures may change — confirm a quote with your account team before budgeting. Self-serve
      Stripe checkout on this page is opt-in; most buyers use the quote request on this page.
    </aside>
  );
}
