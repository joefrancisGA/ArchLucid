...
export function SponsorScorecardEmptyStatePreview(props: { readonly embedded?: boolean } = {}): React.JSX.Element {
  ...
  if (props.embedded) {
    return (
      <div data-testid="sponsor-scorecard-empty-preview">
        {list}
      </div>
    );
  }
  ...
  return (
    <section
      aria-labelledby="sponsor-scorecard-empty-preview-heading"
      className="rounded-md border border-neutral-200 bg-neutral-50/60 px-4 py-3 dark:border-neutral-800 dark:bg-neutral-950/40"
      data-testid="sponsor-scorecard-empty-preview"
    >
      <h2 id="sponsor-scorecard-empty-preview-heading" className={`m-0 ${OPERATOR_TYPOGRAPHY.sectionTitle}`}>
