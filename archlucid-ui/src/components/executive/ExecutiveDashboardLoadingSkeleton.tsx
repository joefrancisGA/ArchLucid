...
/**
 * Structured loading chrome for the executive dashboard first viewport (TB-1532).
 * Mirrors header actions, time-range control, and primary KPI grid shape.
 */
export function ExecutiveDashboardLoadingSkeleton(): React.JSX.Element {
  return (
    <div
      aria-busy="true"
      aria-label="Loading executive dashboard"
      className="space-y-4"
      data-testid="executive-dashboard-loading-skeleton"
      role="status"
    >
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="space-y-2">
          ...
          <Skeleton className="h-9 w-44" data-testid="executive-dashboard-loading-time-range" />
        </div>
      </div>
