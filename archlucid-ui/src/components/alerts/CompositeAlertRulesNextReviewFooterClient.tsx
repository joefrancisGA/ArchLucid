...
} from "@/components/alerts/CompositeAlertRulesNextReviewFooter";
...
export type CompositeAlertRulesNextReviewFooterClientProps = {
  readonly runId: string;
};

export function CompositeAlertRulesNextReviewFooterClient(
  props: CompositeAlertRulesNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: compositeAlertRulesNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <CompositeAlertRulesNextReviewFooter target={nextReview} />;
}
