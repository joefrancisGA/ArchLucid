...
import { AlertRoutingNextReviewFooter, alertRoutingNextReviewHref } from "@/components/alerts/AlertRoutingNextReviewFooter";
...
export type AlertRoutingNextReviewFooterClientProps = {
  readonly runId: string;
};

export function AlertRoutingNextReviewFooterClient(
  props: AlertRoutingNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: alertRoutingNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <AlertRoutingNextReviewFooter target={nextReview} />;
}
