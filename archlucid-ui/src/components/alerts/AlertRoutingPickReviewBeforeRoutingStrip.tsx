...
export type AlertRoutingPickReviewBeforeRoutingStripProps = {
  readonly selectedReviewId: string;
  readonly onSelectReview: (reviewId: string) => void;
};

/** Review picker shown before creating notification destinations without a scoped review. */
export function AlertRoutingPickReviewBeforeRoutingStrip(
  props: AlertRoutingPickReviewBeforeRoutingStripProps,
): React.JSX.Element {
  ...
  return (
    <section
      aria-labelledby="alert-routing-pick-review-before-routing-heading"
      className="rounded-lg border border-neutral-200 bg-al-surface-raised px-4 py-3 dark:border-neutral-800"
      data-testid="alert-routing-pick-review-before-routing-strip"
    >
      <h2
        id="alert-routing-pick-review-before-routing-heading"
