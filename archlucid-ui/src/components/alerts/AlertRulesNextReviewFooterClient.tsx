...
import { AlertRulesNextReviewFooter, alertRulesNextReviewHref } from "@/components/alerts/AlertRulesNextReviewFooter";
...
export type AlertRulesNextReviewFooterClientProps = {
  readonly runId: string;
};

export function AlertRulesNextReviewFooterClient(
  props: AlertRulesNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: alertRulesNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <AlertRulesNextReviewFooter target={nextReview} />;
}
