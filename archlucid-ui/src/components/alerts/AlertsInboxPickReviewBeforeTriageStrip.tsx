...
export type AlertsInboxPickReviewBeforeTriageStripProps = {
  readonly selectedReviewId: string;
  readonly onSelectReview: (reviewId: string) => void;
};

/** Review picker shown before triaging alerts without a scoped review. */
export function AlertsInboxPickReviewBeforeTriageStrip(
  props: AlertsInboxPickReviewBeforeTriageStripProps,
): React.JSX.Element {
  ...
  return (
    <section
      aria-labelledby="alerts-inbox-pick-review-before-triage-heading"
      className="rounded-lg border border-neutral-200 bg-al-surface-raised px-4 py-3 dark:border-neutral-800"
      data-testid="alerts-inbox-pick-review-before-triage-strip"
    >
      <h2
        id="alerts-inbox-pick-review-before-triage-heading"
