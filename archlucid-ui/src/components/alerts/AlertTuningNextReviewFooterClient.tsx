...
export type AlertTuningNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review alert tuning footer when available. */
export function AlertTuningNextReviewFooterClient(
  props: AlertTuningNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: alertTuningNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <AlertTuningNextReviewFooter target={nextReview} />;
}
