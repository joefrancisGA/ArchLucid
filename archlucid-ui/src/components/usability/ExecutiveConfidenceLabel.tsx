...
type ExecutiveConfidenceLabelProps = {
  readonly confidenceLevel: "high" | "medium" | "low" | "unknown";
  readonly className?: string;
};

const CONFIDENCE_COPY: Record<ExecutiveConfidenceLabelProps["confidenceLevel"], string> = {
...
/** Plain-language confidence label for executive / sponsor surfaces. */
export function ExecutiveConfidenceLabel(props: ExecutiveConfidenceLabelProps) {
  return (
    <span
      ...
      data-testid="executive-confidence-label"
    >
