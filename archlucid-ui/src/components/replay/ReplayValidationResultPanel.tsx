      ...
      >
        ...
        <div>
          ...
          <dl className={cn("m-0 grid gap-2 sm:grid-cols-2", OPERATOR_TYPOGRAPHY.body)}>
            ...
            <div>
              <dt className={cn("text-al-text-secondary", OPERATOR_TYPOGRAPHY.helper)}>Signed record present</dt>
            ...
            <div>
              <dt className={cn("text-al-text-secondary", OPERATOR_TYPOGRAPHY.helper)}>Signed record hash matches</dt>
