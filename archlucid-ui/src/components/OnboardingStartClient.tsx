    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      {error !== null && !loading && recovery !== null ? (
        <section
          ...
          className="rounded-md border border-rose-600/40 bg-al-surface-raised px-3 py-2 text-sm text-al-text-primary dark:border-rose-700/50 p-5"
          role="alert"
        >
          <h2 id="onb-error-heading" className="m-0 text-sm font-semibold text-al-text-primary">
            {recovery.headline}
          </h2>
      ...
      {!loading && status !== null ? (
        <section aria-labelledby="onb-status-heading" className="rounded-lg border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
          <h2 id="onb-status-heading" className="text-sm font-semibold text-al-text-primary">
            Trial workspace
          </h2>
          ...
          <div className="rounded-md border border-neutral-200 bg-al-surface-raised dark:border-neutral-800 mt-4 p-4 text-sm">
