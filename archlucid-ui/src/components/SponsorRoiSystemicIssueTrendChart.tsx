...
import type { SponsorRoiSystemicIssueTrendSeries } from "@/lib/sponsor-report-markdown";

export type SponsorRoiSystemicIssueTrendChartProps = {
  series: SponsorRoiSystemicIssueTrendSeries[];
...
export function SponsorRoiSystemicIssueTrendChart(props: SponsorRoiSystemicIssueTrendChartProps) {
