...
export function PlanningPlanDetailHubVocabularyRail(
  ...
  if (variant === "compact") {
    return (
      <p
        ...
        data-testid="planning-plan-detail-hub-vocabulary"
      ...
      >
        ...
        <Link
          ...
          data-testid="planning-plan-detail-hub-vocabulary-peer-link"
        >
          {peer.label}
        </Link>
      </p>
  ...
  return (
    <section
      ...
      aria-labelledby="planning-plan-detail-hub-vocabulary-heading"
      data-testid="planning-plan-detail-hub-vocabulary"
      data-variant="full"
      data-current-surface={props.currentSurfaceId}
    >
      <h2
        id="planning-plan-detail-hub-vocabulary-heading"
      ...
      <div className="flex flex-wrap gap-x-4 gap-y-1">
        <span
          ...
          data-testid="planning-plan-detail-hub-vocabulary-current"
          aria-current="page"
        >
          {currentLink.label}
        </span>
