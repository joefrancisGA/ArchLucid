...
export function SignedRecordsReviewDetailVocabularyRail(
  ...
  if (variant === "compact") {
    return (
      <p
        ...
        data-testid="signed-records-review-detail-vocabulary"
      ...
      >
        ...
        <Link
          ...
          data-testid="signed-records-review-detail-vocabulary-peer-link"
        >
          {peer.label}
        </Link>
      </p>
  ...
  return (
    <section
      ...
      aria-labelledby="signed-records-review-detail-vocabulary-heading"
      data-testid="signed-records-review-detail-vocabulary"
      data-variant="full"
      data-current-surface={props.currentSurfaceId}
    >
      <h2
        id="signed-records-review-detail-vocabulary-heading"
      ...
      <div className="flex flex-wrap gap-x-4 gap-y-1">
        <span
          ...
          data-testid="signed-records-review-detail-vocabulary-current"
          aria-current="page"
        >
          {currentLink.label}
        </span>
