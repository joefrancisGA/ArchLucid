...
import {
  DigestsBrowseNextReviewFooter,
  digestsBrowseNextReviewHref,
} from "./DigestsBrowseNextReviewFooter";

export type DigestsBrowseNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review digests browse footer when available. */
export function DigestsBrowseNextReviewFooterClient(
  props: DigestsBrowseNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: digestsBrowseNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <DigestsBrowseNextReviewFooter target={nextReview} />;
}
