...
export type RiskExceptionsNextReviewFooterClientProps = {
  readonly runId: string;
};

/** Loads reviews list context and renders the next-review risk exceptions footer when available. */
export function RiskExceptionsNextReviewFooterClient(
  props: RiskExceptionsNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: riskExceptionsNextReviewHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <RiskExceptionsNextReviewFooter target={nextReview} />;
}
