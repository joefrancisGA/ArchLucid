...
import { RecurrenceSchedulesNextReviewFooter, recurrenceSchedulesNextReviewFooterHref } from "@/components/governance/RecurrenceSchedulesNextReviewFooter";
...
export type RecurrenceSchedulesNextReviewFooterClientProps = {
  readonly runId: string;
};

export function RecurrenceSchedulesNextReviewFooterClient(
  props: RecurrenceSchedulesNextReviewFooterClientProps,
  ...
  const nextReview = useMemo(() => {
    ...
    return {
      runId: target.runId,
      reviewTitle,
      href: recurrenceSchedulesNextReviewFooterHref(target.runId),
    };
  }, [props.runId, runs]);
  ...
  return <RecurrenceSchedulesNextReviewFooter target={nextReview} />;
}
