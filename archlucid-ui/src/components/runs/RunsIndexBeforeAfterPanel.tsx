 ...
 */
export function RunsIndexBeforeAfterPanel({
  committedRunId,
  embeddedInCollapsible = false,
}: RunsIndexBeforeAfterPanelProps) {
  if (committedRunId === null || committedRunId.length === 0) return null;

  return <BeforeAfterDeltaPanel runId={committedRunId} embeddedInCollapsible={embeddedInCollapsible} />;
}
