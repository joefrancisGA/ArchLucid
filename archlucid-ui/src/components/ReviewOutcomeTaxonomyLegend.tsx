...
export function ReviewOutcomeTaxonomyLegend(): ReactElement {
  return (
    ...
    >
      <strong className="font-semibold text-neutral-800 dark:text-neutral-200">Decision</strong> — approved architecture choice recorded on the finalized signed manifest.{" "}
