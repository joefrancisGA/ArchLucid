...
const DOC_PATH_TO_SLUG: Readonly<Record<string, string>> = {
  ...
  "docs/library/release_smoke.md": "troubleshooting",
  ...
  "docs/library/live_e2e_happy_path.md": "troubleshooting",
  ...
  "docs/runbooks/common_errors.md": "troubleshooting",
  "docs/go-to-market/trust_center.md": "troubleshooting",
  "docs/go-to-market/how_to_request_procurement_pack.md": "troubleshooting",
