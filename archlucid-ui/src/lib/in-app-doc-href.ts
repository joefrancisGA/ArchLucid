...
const DOC_PATH_TO_SLUG: Readonly<Record<string, string>> = {
  ...
  "docs/runbooks/first_pilot_operator_path.md": "first-pilot-operator-runbook",
  ...
  "docs/library/product_packaging.md": "billing-and-plans",
  ...
  "docs/go-to-market/privacy_policy.md": "privacy-policy",
  "docs/go-to-market/sample_aggregate_roi_bulletin_synthetic.md": "example-roi-bulletin",
  "docs/quality/game-day-log/readme.md": "resilience-exercises",
