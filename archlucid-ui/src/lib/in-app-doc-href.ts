...
const DOC_PATH_TO_SLUG: Readonly<Record<string, string>> = {
  ...
  "docs/library/observability.md": "engineering-troubleshooting",
  "docs/troubleshooting.md": "engineering-troubleshooting",
  ...
  "docs/runbooks/troubleshooting.md": "engineering-troubleshooting",
  ...
  "docs/library/release_smoke.md": "engineering-troubleshooting",
  ...
  "docs/runbooks/common_errors.md": "engineering-troubleshooting",
