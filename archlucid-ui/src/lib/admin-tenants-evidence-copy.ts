...
export const ADMIN_TENANTS_CLAIM_DISCIPLINE =
  "Tenant provisioning and shut-off controls manage tenant lifecycle for platform operators — they are not a signed-review diligence Sources package. Open Tenant health or Audit when you need engagement scores or governed trails.";
