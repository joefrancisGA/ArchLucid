...
import {
  HOW_ARCHLUCID_WORKS_HELP_TRAFFIC_NOTE,
  HOW_ARCHLUCID_WORKS_HELP_TRAFFIC_PATH,
  HOW_ARCHLUCID_WORKS_HELP_TRAFFIC_ROW_ID,
  HOW_ARCHLUCID_WORKS_HELP_TRAFFIC_SECTION,
} from "@/lib/ui-route-traffic-how-archlucid-works-help";
...
describe("ui-route-traffic-how-archlucid-works-help (HHX)", () => {
  it("tracks How ArchLucid works help with honest workbook notes", () => {
    const rows = extractMasterTableRows(readTemplateMarkdown());
    const row = rows.find((candidate) => candidate.id === HOW_ARCHLUCID_WORKS_HELP_TRAFFIC_ROW_ID);
