...
export const HOW_ARCHLUCID_WORKS_CLAIM_DISCIPLINE =
  "This guide orients evaluators on how evidence becomes findings, decisions, and exports — it is not a signed-review diligence Sources package, a CPA SOC 2 attestation, or a published third-party pen-test report. Open Assurance status or Getting started before treating workflow copy as assurance evidence.";
