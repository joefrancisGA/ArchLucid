...
import type { CostEvidenceFreshnessPresentation } from "@/lib/sponsor/sponsor-roi-kpi-display";
...
export function formatSponsorHeadlineScopeCodeLabel(scopeCode: string | undefined): string | null {
