/** Shared sponsor dashboard/scorecard time windows (TB-269). */

export type SponsorTimeRange = "30d" | "quarter" | "year" | "all";
...
export function windowForSponsorRange(range: SponsorTimeRange): { fromUtc: string | null; toUtc: string } {
