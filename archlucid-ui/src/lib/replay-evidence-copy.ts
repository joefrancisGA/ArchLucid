...
export const REPLAY_CLAIM_DISCIPLINE =
  "Validate review re-runs checks on one finalized review — not a full audit export on its own. Open the review record, Evidence trail, or Audit when you need official activity records.";
