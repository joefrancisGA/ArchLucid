...
export const POLICY_PACKS_HELP_TRAFFIC_NOTE =
  "Policy packs help (Help topic) - HelpPolicyPacksGuideView with PageContextualHelp +, curated POLICY_PACKS_OPERATOR_GUIDE.md, Evidence orientation strip (Sources + claim discipline), and header Open Policy packs CTA. Sibling GPP = live policy packs; GOT = standards-and-rules; POL = standalone Admin delta-demo runbook. Template HPO renamed to HEO to match owner. Not bare catch-all help chrome.";
