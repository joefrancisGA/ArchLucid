...
export const ACCELERATOR_JOB_CHOOSER_LEAD =
  "Optional. Pick the job that matches this review to preload a starter architecture request and matching policy packs — the finalized review record, findings, and export-ready output stay the same.";
