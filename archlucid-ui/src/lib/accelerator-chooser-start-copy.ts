...
export const ACCELERATOR_JOB_CHOOSER_LEAD =
  "Optional. Use the form above or the greenfield pack for your first review. Specialty packs preload follow-up reviews for specific buyer jobs and unlock after you finalize at least one architecture review in this tenant — the finalized review record, findings, and export-ready output stay the same.";
