...
export const BUYER_EVIDENCE_TRAIL_REVIEWS_LOAD_HINT =
  "Reviews could not be loaded right now. Start a new review or explore the sample evidence graph.";
...
export const BUYER_EVIDENCE_TRAIL_EMPTY_BODY =
  "Choose a finalized review to load its evidence graph, or explore the sample evidence graph.";
...
export const BUYER_EVIDENCE_GRAPH_SAMPLE_BANNER_BODY =
  "This example shows how findings link to evidence, decisions, and audit records in a completed review.";
...
export const BUYER_EVIDENCE_GRAPH_PICKER_SAMPLE_REVIEW = "Showing sample review";
...
export const OPERATOR_GRAPH_IDLE_BODY =
  "Create a review or open the sample evidence graph to explore how evidence connects to findings and decisions.";
