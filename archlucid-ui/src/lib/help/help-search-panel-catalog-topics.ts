...
export const START_HERE_TOPICS: readonly HelpSearchPanelTopic[] = [
  ...
  },
  {
    ...
    description:
      "Working help — architecture desk is the instrument after desk lock; nested architecture package review is an inspector, not Working Home.",
    keywords: [
      "system gravity",
      "desk lock",
      "architecture desk",
...
export const HELP_DRAWER_SEARCH_ALIASES: Readonly<Record<string, readonly string[]>> = {
  ...
  "nested review inspector": ["system-gravity"],
