...
export const HELP_TOPIC_CATCHALL_CLAIM_DISCIPLINE =
  "Residual help topics render curated product markdown — orientation only, not a full audit export from your workspace. Specialty guides (alerts, resolve outcomes, review guide, and siblings) have richer pages of their own.";
