...
export const ARCHITECTURES_NEW_PAGE_SUBTITLE_BUYER_WITH_DRAFTS =
  `${ARCHITECTURES_NEW_DRAFTING_SCOPE_SENTENCE} Continue a saved draft above or describe a new system below.`;
...
export const ARCHITECTURES_NEW_PAGE_SUBTITLE_OPERATOR =
  `${ARCHITECTURES_NEW_DRAFTING_SCOPE_SENTENCE} Describe the system, the outcome it must deliver, and the people and systems it touches. Start a new draft below.`;

export const ARCHITECTURES_NEW_PAGE_SUBTITLE_OPERATOR_WITH_DRAFTS =
  `${ARCHITECTURES_NEW_DRAFTING_SCOPE_SENTENCE} Continue a saved draft below, or describe a new system — outcome, people, and systems it touches.`;
