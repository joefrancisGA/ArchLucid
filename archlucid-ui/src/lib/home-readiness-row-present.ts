...
const EXECUTIVE_READINESS_ROW_PRESENT: Readonly<Record<string, ReadinessRowPresentation>> = {
  ...
  "sample-review": { label: "Sample review availability", cta: "Open sample" },
  "azure-extractor": { label: "Azure extractor evidence", cta: "Upload evidence" },
  "roi-baselines": { label: "ROI assumptions", cta: "Add assumptions" },
...
const OPERATOR_READINESS_ROW_CTA: Readonly<Partial<Record<string, string>>> = {
  ...
  "azure-extractor": "Upload evidence",
  "roi-baselines": "Add ROI baseline",
