export const MODEL_GOVERNANCE_HELP_PRIMARY_CONTENT_ID = "help-model-governance-primary-content" as const;

export const MODEL_GOVERNANCE_HELP_FIRST_VIEWPORT_TEST_ID = "help-model-governance-first-viewport" as const;
