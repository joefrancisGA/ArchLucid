...
export const FIRST_PILOT_OPERATOR_STATUS_VOCABULARY = {
  ...
  blocked: "BLOCKED — resolve before sharing with leadership or procurement follow-up.",
  deferred: "DEFERRED — explicitly out of first-pilot scope; document in proof status.",
