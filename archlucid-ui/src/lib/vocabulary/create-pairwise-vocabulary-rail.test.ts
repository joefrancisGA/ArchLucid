...
describe("createExternalPeerPairwiseVocabularyRail (TB-2365)", () => {
  it("builds reviewTab current side and external peer href", () => {
    const model = createExternalPeerPairwiseVocabularyRail({
      ...
      copy: {
        heading: "Review Activity and Audit trail serve different purposes",
        whyTwo: "Review Activity shows assessment progress for one architecture package.",
        compactLine: "Review Activity is assessment progress on one review; Audit trail is the workspace audit trail.",
