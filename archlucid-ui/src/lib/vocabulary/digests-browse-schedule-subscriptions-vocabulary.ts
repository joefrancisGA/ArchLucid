 ...
 * - Schedule (`?tab=schedule`) is sponsor digest email cadence and recipients.
...
export const DIGESTS_BROWSE_SCHEDULE_SUBSCRIPTIONS_SCHEDULE_LINK: DigestsBrowseScheduleSubscriptionsLink =
  {
    ...
    whenToUse: "Configure sponsor digest email cadence and direct recipients.",
  };
