...
export const TEAMS_SLACK_NOTIFICATION_WHY_TWO =
  "Microsoft Teams and Slack each deliver governance alerts through their own webhook destinations. Configure the product your workspace actually uses — setting up one channel does not configure the other." as const;

export const TEAMS_SLACK_NOTIFICATION_COMPACT_LINE =
  "Teams and Slack are separate notification channels — open the other when you need that product." as const;
