...
export const DEMO_ENTRY_CLAIM_DISCIPLINE =
  "This URL is a shareable demo entry that immediately redirects into the CTO tour or home — it is not a signed-review diligence Sources package. Open Assurance status or the Trust Center when you need assurance artifacts.";
