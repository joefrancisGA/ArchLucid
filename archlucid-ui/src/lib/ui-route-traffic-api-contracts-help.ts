 ...
 */
export const API_CONTRACTS_HELP_TRAFFIC_ROW_ID = "HG";

/** Canonical path tracked on the HG workbook row. */
export const API_CONTRACTS_HELP_TRAFFIC_PATH = API_CONTRACTS_HELP_PATH;

/** Workbook Section column value — in-app help, not marketing. */
export const API_CONTRACTS_HELP_TRAFFIC_SECTION = "Help topic";

/**
 * Owner workbook Notes for HG — documents the specialty Admin API contracts surface.
 */
export const API_CONTRACTS_HELP_TRAFFIC_NOTE =
