...
export const ARCHITECTURE_SCORECARD_TRAFFIC_NOTE =
 "Architecture scorecard (Insights) - PilotScorecardPageView with PageContextualHelp (Architecture scorecard label; Learn more pilot-roi-model), shared Insights Outcomes strip, related ROI/Baseline/Workspace health links, empty CTA hero to #roi-assumptions, live ROI preview before save, deep-linked KPI tiles, deduped operational metrics, claim-discipline note, scope cue, form validation (TB-2005). Formerly `/scorecard` and `/sponsor-report/architecture-scorecard` (retired; no redirect). Sibling ARE = executive-dashboard. Not a signed-record Sources trail. Evidence 68/100 (2026-08-09) - aggregate KPI launcher hard-caps higher Evidence. UX 80/100 (2026-08-09) - live preview, deep-linked KPIs, form validation, Outcomes hub consistency. Owner pass: Evidence chrome shipped; cannot improve Evidence toward 80 without turning this into a signed-record diligence Sources trail.";
