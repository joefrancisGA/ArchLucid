...
export const SECURITY_TRUST_HELP_CLAIM_DISCIPLINE =
  "This Security and trust help topic orients operators and buyers on the assurance ladder, data handling, and diligence materials — it is help orientation, not a CPA SOC 2 attestation, a published third-party pen-test report, or a signed-review diligence Sources package from your tenant. Open the live Security & trust hub or Trust Center when you need public assurance surfaces or downloadable packs.";
