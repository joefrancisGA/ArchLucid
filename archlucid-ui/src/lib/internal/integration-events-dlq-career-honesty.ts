...
export const INTEGRATION_EVENTS_DLQ_CAREER_HONESTY_BODY =
  "Dead-lettered outbound integration events await retry after a delivery failure. A row here is not sealed-record proof — open the review workspace for posture before citing outcomes.";
