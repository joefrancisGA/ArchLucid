...
export const FIRST_PILOT_BUYER_COPY = {
  ...
  ingestEvidenceWithoutUpload:
    "Add a brief, documents, diagrams, or IaC — or upload a cloud inventory ZIP (AWS, Azure, or GCP) for production-faithful evidence. Open the sample review to preview outputs before your own upload.",
} as const;
