...
export const ARCHITECTURES_DRAFT_CLAIM_DISCIPLINE =
  "Editing a saved architecture draft does not start a review - this page is drafting-first workspace, not a signed-review diligence Sources package, a CPA SOC 2 attestation, or a published third-party pen-test report. Open Start a review when the brief is ready for evidence intake.";
