...
describe("infra-evidence-terraform-filter-url", () => {
  ...
  it("parses scoped terraform workbench hrefs", () => {
    expect(
      parseInfraTerraformWorkbenchPath(
        `${SECURENOW_INFRASTRUCTURE_TERRAFORM_PATH}?cloudResourceId=11111111-1111-1111-1111-111111111111&snapshotId=22222222-2222-2222-2222-222222222222`,
      ),
    ).toEqual({
      cloudResourceId: "11111111-1111-1111-1111-111111111111",
      snapshotId: "22222222-2222-2222-2222-222222222222",
