...
export const GOLDEN_SPONSOR_PACKAGE_WALKTHROUGH_LEAD =
  "Follow a labeled sample review from architecture package through sponsor-ready exports — no facilitator required.";
...
export const GOLDEN_SPONSOR_PACKAGE_WALKTHROUGH_STEPS: readonly GoldenSponsorPackageWalkthroughStep[] = [
  {
    id: "open-package",
    label: "Open the sample architecture package",
