    ...
    return [
      ...
      },
      {
        ...
        content:
          ...
          "Evidence:\n\nFinalized review record disposition, evidence trail anchors, and audit events for approval and findings capture.\n\n" +
          "Mitigation:\n\nAlign adapters to the minimization posture documented in the review before sign-off.\n\n" +
          "Validation:\n\nConfirm checklist completion on the findings record and Finalized review record before go-live.",
