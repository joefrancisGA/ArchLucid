...
export const AUTHENTICATION_SIGN_IN_HELP_CLAIM_DISCIPLINE =
  "This Authentication and sign-in guide orients operators on how people sign in and how identity connects to workspace access — it is help orientation, not a CPA SOC 2 attestation, a published third-party pen-test report, or a signed-review diligence Sources package from your tenant. Open Users and roles, Account security, or Configuration reference when you need live access or SSO setup.";
