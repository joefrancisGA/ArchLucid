...
export const FAQ_CLAIM_DISCIPLINE =
  "Product FAQ answers are evaluation orientation for architects and sponsors — they are not a sealed-review diligence Sources package. Open Assurance status or Pricing before treating FAQ copy as procurement evidence.";
