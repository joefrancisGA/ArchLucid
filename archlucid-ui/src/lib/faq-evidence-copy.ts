...
export const FAQ_CLAIM_DISCIPLINE =
  "Product FAQ answers are evaluation orientation for architects and sponsors — they are not a signed-review diligence Sources package, a CPA SOC 2 attestation, or a published third-party pen-test report. Open Security & trust or Pricing before treating FAQ copy as procurement evidence.";
