...
export const SYSTEM_NOT_JOB_WORKING_REVIEWS_HUB_PAGE_SUBTITLE =
  "Cross-architecture review list for this workspace — resume work from Architectures or your last open desk (Alt+R), not from here." as const;
...
export const SYSTEM_NOT_JOB_WORKING_REVIEWS_HUB_CLAIM_DISCIPLINE =
  "This list shows draft, active, and finalized jobs across architectures — not your Monday-morning desk. Open Architectures or press Alt+R to resume named systems." as const;

export const SYSTEM_NOT_JOB_WORKING_REVIEWS_HUB_RECENT_EMPTY_BODY =
  "Reviews appear here after you start a job from an architecture desk. Open Architectures to pick a system and resume work — this page is triage, not home." as const;

export const SYSTEM_NOT_JOB_WORKING_REVIEWS_HUB_RECENT_EMPTY_WITH_SOLE_DRAFT_BODY =
  "Continue the architecture draft from the header, or open Architectures to pick a system desk — this list shows jobs; desks own the work." as const;

export const SYSTEM_NOT_JOB_WORKING_REVIEWS_HUB_RECENT_EMPTY_WITH_DRAFTS_BODY =
  "Pick an architecture ready for review below, or open Architectures to browse named systems — resume from a desk, not from this list alone." as const;
