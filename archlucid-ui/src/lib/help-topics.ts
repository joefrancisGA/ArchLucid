...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    summary:
      "The first-review path stays focused until your first review package is finalized; analysis and governance groups unlock on demand or automatically after finalize.",
