...
export const APPROVAL_LINEAGE_CONTEXTUAL_HELP_ROWS: readonly PageContextualHelpRow[] = [
  {
    ...
    entry: {
      whatIsThisPage:
        `Approval lineage — inspect how an approval request links to its review, findings, risk posture, and signed-record version (${APPROVAL_LINEAGE_HELP_TOPIC_LABEL.toLowerCase()}).`,
      whatToDoNext:
