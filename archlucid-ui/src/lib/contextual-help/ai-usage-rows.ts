...
const AI_USAGE_HUB_CONTEXTUAL_HELP = {
  ...
  taskSteps: [
    ...
    "Open AI and model policy when execution profiles drive spend.",
  ],
} as const;
...
export const AI_USAGE_CONTEXTUAL_HELP_ROWS: readonly PageContextualHelpRow[] = [
  ...
  },
  {
    ...
    entry: {
      ...
      whatToDoNext:
        "Open AI usage to review spend signals, then follow billing or AI and model policy when plan or execution-profile changes are needed.",
