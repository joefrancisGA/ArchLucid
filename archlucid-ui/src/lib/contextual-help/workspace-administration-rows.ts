...
export const WORKSPACE_ADMINISTRATION_CONTEXTUAL_HELP_ROWS: readonly PageContextualHelpRow[] = [
  ...
  },
  {
    ...
    entry: {
      whatIsThisPage:
        "Extract and Upload - schedule a customer-owned inventory agent or run a one-time packager, then upload the ZIP for architecture reviews.",
      whatToDoNext:
      ...
      taskSteps: [
        "Set up a scheduled customer-owned inventory agent, or copy the one-time packager command.",
