...
const ASK_REVIEW_QUESTIONS_HUB_CONTEXTUAL_HELP = {
  whatIsThisPage:
    "Ask plain-language questions about a finalized review; answers use the finalized review record and cite findings when available.",
  whatToDoNext:
...
export const PRIOR_MANIFEST_RETRIEVAL_CONTEXTUAL_HELP_ROWS: readonly PageContextualHelpRow[] = [
  ...
  },
  {
    ...
    entry: {
      ...
      whatToDoNext:
        "Open Ask review questions to ground answers in a selected finalized review record, then follow cited findings or search.",
