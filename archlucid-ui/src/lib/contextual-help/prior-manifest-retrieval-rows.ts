...
import {
  ASK_REVIEW_QUESTIONS_CANONICAL_PATH,
  PRIOR_MANIFEST_RETRIEVAL_HELP_TOPIC_LABEL,
} from "@/lib/ask-review-questions-evidence-copy";
import { PRIOR_MANIFEST_RETRIEVAL_HELP_CANONICAL_PATH } from "@/lib/prior-manifest-retrieval-help-evidence-copy";
...
export const PRIOR_MANIFEST_RETRIEVAL_CONTEXTUAL_HELP_ROWS: readonly PageContextualHelpRow[] = [
  ...
  },
  {
    ...
    entry: {
      whatIsThisPage: `Prior manifest retrieval — ${PRIOR_MANIFEST_RETRIEVAL_HELP_TOPIC_LABEL.toLowerCase()} against finalized review memory.`,
      whatToDoNext:
