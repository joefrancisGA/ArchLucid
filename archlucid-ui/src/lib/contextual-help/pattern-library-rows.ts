...
const PATTERN_LIBRARY_HUB_CONTEXTUAL_HELP = {
  ...
  taskSteps: [
    ...
    "Filter the catalog by adoption or risk signals.",

    "Open a pattern detail when a match fits your change.",

    "Start a review when you are ready to evaluate evidence.",
