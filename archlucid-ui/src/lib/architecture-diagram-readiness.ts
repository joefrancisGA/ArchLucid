import { ARCHITECTURE_DIAGRAM_MISSING_CATEGORY_LABELS } from "@/lib/architecture-diagram-copy";
import type { ArchitectureStructuredParseResult, ArchitectureStructuredSection } from "@/lib/architecture-structured-content-types";
import type {
