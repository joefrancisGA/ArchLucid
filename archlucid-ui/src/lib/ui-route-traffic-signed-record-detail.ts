...
export const SIGNED_RECORD_DETAIL_TRAFFIC_NOTE =
  "Signed review record detail (Alerts/gov) - ManifestDetailPageView with PageContextualHelpButton (topic map review-packages; Category-1 registry on /governance/signed-records), workspace Sources + claim-discipline orientation strip, summary/decisions/artifacts/bundle downloads, OperatorEvidenceLimitsFooter. Formerly `/signed-records/[manifestId]` (retired bookmark). Application-layer package lineage — not CPA SOC 2 or third-party pen-test publication. Score 58/100 (2026-08-03) — package detail hard-caps higher Evidence without Trust Center attestation artifacts.";
