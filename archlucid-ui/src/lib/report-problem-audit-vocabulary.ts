 ...
 * searching the governance activity log. Distinct from TB-2255 (Audit ≠
...
export const REPORT_PROBLEM_AUDIT_WHY_TWO =
  "Report a problem is support intake — structured defect reporting with correlation identifiers and a next-business-day response commitment. Audit trail is the operator activity log for governance and review events. Opening support intake is not the same as searching the governance activity log." as const;

export const REPORT_PROBLEM_AUDIT_COMPACT_LINE =
  "Report a problem is support intake; Audit trail is the activity log — open the other when you need both." as const;
