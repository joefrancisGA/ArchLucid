...
export const SERVICENOW_INTEGRATION_HELP_CLAIM_DISCIPLINE =
  "This guide explains ServiceNow outbound routing, connection health, and CMDB behavior — use it to configure how findings create ServiceNow incidents, then open Integration readiness or Audit trail when procurement setup or official activity records need follow-up.";
