...
export const ARCHITECTURE_SPONSOR_DASHBOARD_TRAFFIC_NOTE =
  "Sponsor ROI portfolio dashboard (Sponsor) - SponsorRoiDashboardPageView with PageContextualHelpButton (topic map sponsor-report; Category-1 registry), hero, KPI tiles, trend charts, sponsor exports, board-pack evidence posture. Workspace health lives on sibling INW `/insights/workspace-health` (standalone Insights page). Absorbs retired ESX `/sponsor/scorecard` sponsor scorecard bookmark. Legacy /dashboard (DSH), /sponsor/dashboard (EXD), /portfolio, and `/sponsor/scorecard` bookmarks are hard-retired (host-gate 404). Legacy `/governance/dashboard` (GOD) redirects to INW. Sibling SCX = scorecard; INW = workspace-health; ASK = ask-review-questions. Not a signed-record Sources trail by itself. Score 72/100 (2026-08-08) - portfolio ROI launcher hard-caps higher Evidence. Owner pass: Evidence chrome shipped; cannot improve further toward 80 without turning this into a sealed-record diligence Sources trail.";
