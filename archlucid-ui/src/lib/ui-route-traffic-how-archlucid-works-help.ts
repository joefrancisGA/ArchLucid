/**
 * Traffic workbook row ID for How ArchLucid works help.
 * Owner backlog shorthand: HHX.
 */
export const HOW_ARCHLUCID_WORKS_HELP_TRAFFIC_ROW_ID = "HHX";

/** Canonical path tracked on the HHX workbook row. */
