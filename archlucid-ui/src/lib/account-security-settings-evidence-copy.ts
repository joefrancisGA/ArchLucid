...
export const ACCOUNT_SECURITY_SETTINGS_CLAIM_DISCIPLINE =
  `This ${ACCOUNT_SECURITY_PAGE_TITLE} page manages your personal sign-in methods - it is not a signed-review diligence Sources package. Open Security and trust help, Preferences, or Assurance status when you need trust cites, theme settings, or published diligence.`;
