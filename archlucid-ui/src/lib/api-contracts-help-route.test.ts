...
describe("api-contracts-help-route (HG)", () => {
  ...
  it("matches Python workbook without governance-api-contracts help migration", () => {
    ...
    expect(catalogSource).not.toContain('"/help/governance-api-contracts": "/help/api-contracts"');
  });
});
