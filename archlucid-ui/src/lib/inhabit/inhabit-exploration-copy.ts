...
export const INHABIT_SKETCH_IS_PRACTICE_NOT_RECORD_BODY =
  `${WORKING_REHEARSAL_DOOR_LABEL} sketches stay practice-labeled until you explicitly execute a ${WORKING_CAREER_DOOR_LABEL} review and finalize. A sketch cannot seal as sealed-record proof.` as const;
