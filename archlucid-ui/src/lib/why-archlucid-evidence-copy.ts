...
export const WHY_ARCHLUCID_CLAIM_DISCIPLINE =
  "This Why ArchLucid page is an operator demo/proof surface over seeded telemetry and sample review outputs — it is not a signed-review diligence Sources package from your production tenant, a CPA SOC 2 attestation, or a published third-party pen-test report. Open the public /why comparison, Security & trust, or a finalized review package when you need diligence-grade trails.";
