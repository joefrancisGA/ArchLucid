/**
 * Traffic workbook row ID for Trust Center marketing page.
 * Owner backlog shorthand: TXX.
 */
export const TRUST_CENTER_TRAFFIC_ROW_ID = "TXX";

/** Canonical path tracked on the TXX workbook row. */
export const TRUST_CENTER_TRAFFIC_PATH = "/trust";
