...
export const PREFERENCES_SETTINGS_CLAIM_DISCIPLINE =
  "This Preferences page covers personal appearance choices — not a full audit export. Open Getting started, Sign-in methods, or Assurance status when you need onboarding or official materials.";
...
export function preferencesSettingsSources(productLineId: ProductLineId): readonly EvidenceAdminSourceLink[] {
  return [
