...
import {
  FIRST_PILOT_PATH_HELP_ALIAS_CANONICAL_PATH,
  FIRST_PILOT_PATH_HELP_ALIAS_TRAFFIC_NOTE,
  FIRST_PILOT_PATH_HELP_ALIAS_TRAFFIC_PATH,
  FIRST_PILOT_PATH_HELP_ALIAS_TRAFFIC_ROW_ID,
  FIRST_PILOT_PATH_HELP_ALIAS_TRAFFIC_SECTION,
