/** MG-011 — Account → Preferences explains workspace mode and Working door separately. */
export const MODE_GRAVITY_PREFERENCES_TWO_CONTROLS_HEADING =
  "Two controls, one story" as const;

export const MODE_GRAVITY_PREFERENCES_WORKSPACE_MODE_LEAD =
