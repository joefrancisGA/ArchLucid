...
export type BuildExecutiveScorecardRecommendedActionsInput = {
  readonly complianceDriftChangeCount: number;
  readonly orphanCandidates: ExecutiveOrphanCandidateSummary | null | undefined;
...
export function buildExecutiveScorecardRecommendedActions(
  input: BuildExecutiveScorecardRecommendedActionsInput,
): ExecutiveScorecardRecommendedAction[] {
  const candidates: ExecutiveScorecardRecommendedAction[] = [];
