...
export const SIGNED_RECORDS_LIST_SOURCES_INTRO =
  "Use these follow-ups when a finalized package needs findings triage, audit trail, or official assurance materials. Open a finalized review record row for package lineage.";
