...
export const SETTINGS_SECURITY_TRUST_CLAIM_DISCIPLINE =
  "This page lists security and trust materials for your workspace — architect orientation only. It is not an audit export bundle, a CPA-issued SOC 2 report, or a published third-party pen-test report. Open Assurance status, Trust Center, or Audit when you need live assurance pages or activity trails.";
