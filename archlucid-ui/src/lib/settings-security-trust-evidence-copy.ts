...
const SETTINGS_SECURITY_TRUST_SOURCES_ARCHITECTURE: readonly EvidenceSourceLink[] = [
...
export const SETTINGS_SECURITY_TRUST_SOURCES: readonly EvidenceSourceLink[] =
  SETTINGS_SECURITY_TRUST_SOURCES_ARCHITECTURE;

export function settingsSecurityTrustSourcesForProductLine(
  productLineId: ProductLineId,
): readonly EvidenceSourceLink[] {
  return SETTINGS_SECURITY_TRUST_SOURCES_ARCHITECTURE.map((link) => ({
    ...link,
