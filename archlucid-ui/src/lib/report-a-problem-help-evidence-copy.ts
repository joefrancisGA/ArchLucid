...
export const REPORT_A_PROBLEM_HELP_CLAIM_DISCIPLINE =
  "This Report a problem guide orients architects on structured support intake and correlation identifiers — it is help orientation, not a signed-review diligence Sources package from your tenant. Open Support or Troubleshooting when you need live triage or workspace support tools.";
