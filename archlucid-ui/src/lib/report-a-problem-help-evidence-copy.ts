...
export const REPORT_A_PROBLEM_HELP_CLAIM_DISCIPLINE =
  "This Report a problem guide orients operators on structured support intake and correlation identifiers — it is help orientation, not a CPA SOC 2 attestation, a published third-party pen-test report, or a signed-review diligence Sources package from your tenant. Open Troubleshooting or Support when you need live triage or workspace support tools.";
