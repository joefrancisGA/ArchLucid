...
export const CONTEXTUAL_HELP_DRAWER_CLAIM_DISCIPLINE =
  "Contextual help suggests next steps and in-app documentation — it does not open a finalized review record, evidence trail export, or resolve outcomes on its own. Follow links into reviews, findings, or audit surfaces before treating guidance as authoritative.";
