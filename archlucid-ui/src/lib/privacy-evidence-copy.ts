...
export const PRIVACY_CLAIM_DISCIPLINE =
  "This Privacy Policy is a public legal notice for website visitors and product users — not a full audit export. Open Assurance status or Trust Center for official materials.";
