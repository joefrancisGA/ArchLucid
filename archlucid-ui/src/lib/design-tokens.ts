...
/** Primary marketing CTA — white on teal-800 meets WCAG 2.2 AA 4.5:1 at 14px (`text-sm`). */
export const MARKETING_PRIMARY_CTA_CLASS =
  "inline-flex rounded-md bg-teal-800 px-4 py-2 text-sm font-medium text-white no-underline hover:bg-teal-900 dark:bg-teal-700 dark:hover:bg-teal-600";
