...
export const OPERATOR_BILLING_SETTINGS_CLAIM_DISCIPLINE =
  "This Billing & plans page shows workspace subscription, usage, and wallet controls - it is not a signed-review diligence Sources package, financial reporting, a CPA SOC 2 attestation, or a published third-party pen-test report. Open Pricing, Billing help, or Audit when you need public packaging, methodology, or governed trails.";
