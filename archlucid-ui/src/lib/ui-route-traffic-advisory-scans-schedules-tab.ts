...
export const ADVISORY_SCANS_SCHEDULES_TAB_TRAFFIC_NOTE =
 "Advisory scans Schedules tab (Tab surface) - inherits ADV hub Evidence chrome (PageContextualHelpButton + Category-1 registry on /governance/advisory-scans; Sources follow-up chrome removed (TB-2092) Sources + claim-discipline above tabs). AdvisorySchedulesContent + AdvisoryScheduleCreateForm; digest send-test and setup-gap handoffs. Legacy /advisory-scheduling redirects via TB-1124. Sibling ADV = hub/scans. Score 48/100 (2026-08-04) â€” schedule-config tab hard-caps higher Evidence (below ADV launcher 50). Owner pass: Evidence chrome shipped; cannot improve further toward 80 without turning this into a signed-record diligence Sources trail.";
