...
export const ROUTE_TITLES: Record<string, string> = {
  ...
  "/replay": OPERATOR_NAV_LINK_LABELS.replayReview,
  ...
  "/administration/connection-status": OPERATOR_NAV_LINK_LABELS.integrationReadiness,
  ...
  "/sponsor-report/pilot-outcomes": PILOT_OUTCOMES_PAGE_TITLE,
  ...
  "/admin/demo-readiness": BUYER_CTO_DEMO_READINESS_HEADING,
  ...
  "/admin/pricing-quote-aging": "Pricing quote follow-up",
  "/admin/trial-funnel": "Trial funnel",
  "/admin/fleet-llm-cogs": "Fleet LLM COGS",
  "/admin/tenant-health": "Tenant health",
  "/admin/tenants": "Tenants",
  "/admin/health": "Diagnostics dashboard",
  "/admin/deployment-status": "Deployment status",
  "/admin/rag-health": OPERATOR_NAV_LINK_LABELS.knowledgeIndexHealth,
  "/admin/configuration": "Configuration",
  "/operate/integration-events/dlq": OPERATOR_NAV_LINK_LABELS.failedIntegrationMessages,
  "/admin/evidence-proposals": "Evidence proposals",
  "/internal-operations/recommendation-learning": OPERATOR_NAV_LINK_LABELS.recommendationTuning,
