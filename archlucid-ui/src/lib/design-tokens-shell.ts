...
export const OPERATOR_TYPE_SCALE = {
  ...
  /** Button label — 13/18, semibold; uniform across all operator Button sizes and native triggers (TB-2290). */
   ...
   */
  nativeControlLabel: "text-[13px] font-semibold leading-[18px]",
