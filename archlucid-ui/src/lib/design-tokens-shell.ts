...
export const DESIGN_TOKENS = {
  ...
  interactive: {
    ...
    chip:
      `inline-flex rounded-full border border-neutral-300 bg-al-surface-raised px-2.5 py-1 ${OPERATOR_TYPE_SCALE.button} text-al-text-primary no-underline hover:bg-[var(--al-layer-hover)] dark:border-neutral-600`,
