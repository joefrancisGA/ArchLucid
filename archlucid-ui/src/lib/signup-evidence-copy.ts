...
export const SIGNUP_CLAIM_DISCIPLINE =
  "This page starts an evaluation workspace request. Assurance downloads, SOC self-assessment status, and pen-test summaries live on Assurance status and Trust Center—not on this form. Do not treat signup copy as a signed-review diligence Sources package.";
