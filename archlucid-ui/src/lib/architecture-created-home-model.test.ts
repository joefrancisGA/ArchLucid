...
const baseInput = {
  ...
  architectureOverview:
    "A governed workflow platform for analysts with Entra ID authentication, auditable evidence trails, and exportable architecture packages for enterprise tenants.",
