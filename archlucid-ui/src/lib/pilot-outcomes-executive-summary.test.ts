...
describe("buildPilotOutcomesExecutiveNarrative", () => {
  it("builds a deterministic narrative from report counts", () => {
    const narrative = buildPilotOutcomesExecutiveNarrative(sampleReport());
  ...
  it("uses singular phrasing for single counts", () => {
    const narrative = buildPilotOutcomesExecutiveNarrative(
      sampleReport({
