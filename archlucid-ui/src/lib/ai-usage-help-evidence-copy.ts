...
export const AI_USAGE_HELP_CLAIM_DISCIPLINE =
  "This guide explains workspace AI usage and cost signals for directional operations telemetry. It is not invoice-accurate financial reporting or a signed-review diligence Sources package.";
