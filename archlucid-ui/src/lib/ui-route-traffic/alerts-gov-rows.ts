...
export const ALERTS_GOV_TRAFFIC_ROWS: readonly UiRouteTrafficRow[] = [
  ...
  /** Traffic workbook row ID for governance approval queue. Owner backlog shorthand: GOP. */
  {
    ...
    noteMustContain: ["Score 58", "Record-decision deep link", "auto-fills sealed review record version", "cannot improve further toward 80"],
    noteMustMatch: [/TB-2092|PageContextualHelp|Learn more|claim-discipline/i],
  },
  ...
  /** Traffic workbook row ID for sealed review record detail. Owner backlog shorthand: MMX. */
  {
    rowId: "MMX",
