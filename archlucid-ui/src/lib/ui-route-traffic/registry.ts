...
export const UI_ROUTE_TRAFFIC_STANDALONE_MODULES: readonly string[] = [
  ...
  "ui-route-traffic-retired-example-roi-bulletin",
  ...
  "ui-route-traffic-retired-settings-sponsor-digest",
  ...
  "ui-route-traffic-sponsor-summary",
  "ui-route-traffic-sponsor-summary-help",
  "ui-route-traffic-why-archlucid",
];
