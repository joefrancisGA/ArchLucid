...
export const UI_ROUTE_TRAFFIC_STANDALONE_MODULES: readonly string[] = [
  ...
  "ui-route-traffic-demo-explain",
  "ui-route-traffic-developer-settings",
  "ui-route-traffic-digests-help",
  "ui-route-traffic-digests-schedule",
  "ui-route-traffic-evaluator-workbook-help-alias",
  "ui-route-traffic-evidence-graph",
  "ui-route-traffic-evidence-trace",
  "ui-route-traffic-executive-scorecard",
  "ui-route-traffic-executive-summary",
  "ui-route-traffic-executive-summary-help",
  ...
  "ui-route-traffic-legacy-onboard",
  "ui-route-traffic-legacy-onboarding-start",
  "ui-route-traffic-legacy-quick-start",
