...
function resolveCostClusterPosture(summary: ExecutiveRoiSummary): {
...
function countCostThemeFindings(summary: ExecutiveRoiSummary): number {
...
export function buildBoardPackEvidenceClusterRows(summary: ExecutiveRoiSummary): BoardPackEvidenceClusterRow[] {
