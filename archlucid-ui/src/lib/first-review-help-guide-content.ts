...
export const FIRST_REVIEW_HELP_CLAIM_DISCIPLINE =
  "Checklist completion and a Finalized review record are architecture-review evidence for SE demos — not certification.";
...
export const FIRST_REVIEW_HELP_EVIDENCE_ARC = [
  ...
  "Execute and finalize — Finalized review record with non-empty artifacts.",
