...
describe("usability lib", () => {
  it("pageHelpTopicForPathname maps review routes", () => {
    ...
    expect(pageHelpTopicForPathname("/architecture/architectures")?.label).toBe("Architectures");
    expect(pageHelpTopicForPathname("/architecture/architectures/draft-id-123")?.slug).toBe("getting-started");
    expect(pageHelpTopicForPathname("/architecture/architectures/draft-id-123")?.label).toBe("Architectures");
