/** Operator, pilot, and internal-ops contextual help rows (administration routes). */
...
export const PAGE_HELP_TOPIC_ROWS_ADMIN_COMPOSE: readonly { prefix: string; topic: PageHelpTopic }[] = [
  {
