...
export const POLICY_PACKS_HELP_CLAIM_DISCIPLINE =
  "This Policy packs guide orients operators on pack assignment and conflict resolution — it is help orientation, not a CPA SOC 2 attestation, a published third-party pen-test report, or a signed-review diligence Sources package from your tenant. Open Policy packs or Standards and rules when you need live pack/rule state.";
