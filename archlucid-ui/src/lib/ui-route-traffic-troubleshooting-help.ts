/**
 * Traffic workbook row ID for Troubleshooting help.
 * Owner backlog shorthand: HTX.
 */
export const TROUBLESHOOTING_HELP_TRAFFIC_ROW_ID = "HTX";

/** Canonical path tracked on the HTX workbook row. */
export const TROUBLESHOOTING_HELP_TRAFFIC_PATH = "/help/troubleshooting";
