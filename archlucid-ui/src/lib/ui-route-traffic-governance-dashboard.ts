...
export const GOVERNANCE_DASHBOARD_TRAFFIC_NOTE =
 "Standalone workspace health KPIs at `/insights/workspace-health`. Legacy `/governance/dashboard` and sponsor-dashboard `#workspace-health` bookmarks redirect here.";
