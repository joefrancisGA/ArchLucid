...
export const GOVERNANCE_POLICY_PACKS_SKIP_LINK_LABEL = "Skip to policy packs" as const;
...
export const GOVERNANCE_POLICY_PACKS_LOAD_ERROR =
  "Could not load policy packs for this workspace. Try again in a moment." as const;

export const GOVERNANCE_POLICY_PACKS_LOAD_ERROR_RETRY_LABEL = "Try again" as const;
