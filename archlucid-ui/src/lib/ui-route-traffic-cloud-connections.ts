...
/**
 * Traffic workbook row ID for Cloud connections landing.
 * Owner backlog shorthand: SCE.
 */
export const CLOUD_CONNECTIONS_TRAFFIC_ROW_ID = "SCE";

/** Canonical path tracked on the SCE workbook row. */
export const CLOUD_CONNECTIONS_TRAFFIC_PATH = CLOUD_CONNECTIONS_PATH;
