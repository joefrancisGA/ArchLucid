...
export const AUDIT_TRAIL_HELP_CLAIM_DISCIPLINE =
  "This guide explains how immutable events and correlation identifiers support approval review — open Audit, Findings, or Assurance status when you need live trails or assurance surfaces.";
