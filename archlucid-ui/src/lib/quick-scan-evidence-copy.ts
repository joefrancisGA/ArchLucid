...
export const QUICK_SCAN_CLAIM_DISCIPLINE =
  "Quick Scan is a limited marketing demonstration — results are not saved as workspace reviews, not a signed-review diligence Sources package. Open Assurance status or start an evaluation when you need live workspace evidence.";
