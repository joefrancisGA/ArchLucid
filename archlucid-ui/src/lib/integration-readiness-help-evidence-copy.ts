...
export const INTEGRATION_READINESS_HELP_CLAIM_DISCIPLINE =
  "This integration readiness guide is operator orientation for connector setup priority - it is not a CPA SOC 2 attestation, a published third-party pen-test report, or a signed-review diligence Sources package. Open Connection status or a specific integration settings page when you need live connector health.";
