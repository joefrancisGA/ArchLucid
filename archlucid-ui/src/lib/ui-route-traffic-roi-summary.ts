...
export const ROI_SUMMARY_TRAFFIC_NOTE =
  "Sponsor ROI summary report (canonical). Absorbs former VRX hit share from retired legacy `/value-report/roi` bookmark row. Does not imply CPA SOC 2 or third-party pen-test publication.";
