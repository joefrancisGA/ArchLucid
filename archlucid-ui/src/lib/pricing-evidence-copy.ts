...
export const PRICING_CLAIM_DISCIPLINE =
  "Tier cards and quote requests describe commercial packaging and trial access — they are not a signed-review diligence Sources package, a CPA SOC 2 attestation, or a published third-party pen-test report. Open Security & trust or the Trust Center before treating assurance language as procurement evidence.";
