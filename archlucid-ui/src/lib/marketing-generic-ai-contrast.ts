...
export const MARKETING_GENERIC_AI_CONTRAST_POINTS: readonly MarketingGenericAiContrastPoint[] = [
  {
    ...
    archlucid: "Committed golden manifest in SQL with manifest id and audit trail",
    genericAi: "Chat transcript — no durable manifest tied to your tenant",
  },
  {
    label: "Governance before commit",
    archlucid: "Optional pre-commit gate blocks policy violations before the manifest is canonical",
