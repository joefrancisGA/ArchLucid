...
export function buildCompareComparisonTrustItems(input: {
  ...
  if (input.hasAiNarrative) {
    items.push({
      ...
      detail:
        "Summaries and AI-generated narratives summarize posture shifts. Per-finding trust labels on inspect, signed review record, and export paths remain authoritative for provenance.",
    });
  }
