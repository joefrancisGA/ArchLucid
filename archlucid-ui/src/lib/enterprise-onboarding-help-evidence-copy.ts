...
export const ENTERPRISE_ONBOARDING_HELP_CLAIM_DISCIPLINE =
  "This checklist orients architects on SSO, identity, and hosted tenant setup — open Identity providers, Security and trust, or Audit when you need live evidence trails or resolve outcomes records.";
