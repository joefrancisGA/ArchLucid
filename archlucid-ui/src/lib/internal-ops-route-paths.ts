...
export const INTERNAL_INTEGRATION_EVENTS_DLQ_PATH = "/internal/failed-integration-messages" as const;
export const INTERNAL_OPERATIONAL_ERRORS_PATH = "/internal/operational-errors" as const;
