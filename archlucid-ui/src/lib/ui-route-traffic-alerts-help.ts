/**
 * Traffic workbook row ID for Alerts help.
 * Owner backlog shorthand: HA.
 */
export const ALERTS_HELP_TRAFFIC_ROW_ID = "HA";

/** Canonical path tracked on the HA workbook row. */
export const ALERTS_HELP_TRAFFIC_PATH = "/help/alerts";
