...
export const ACCELERATOR_CHOOSER_HELP_PREREQUISITE_TENANT_STATE = {
  ...
  met: "This tenant has a finalized review record.",
  notMet: "No finalized review record found in this tenant yet.",
  unknown: "Finalized review record status is unavailable — sign in with review read access to verify.",
} as const;
...
export const ACCELERATOR_CHOOSER_HELP_WORKFLOW_STEPS: readonly AcceleratorChooserHelpWorkflowStep[] = [
  ...
  },
  {
    ...
    description:
      "Attach pack evidence, finalize the architecture review, then export the proof checklist with the finalized review record.",
