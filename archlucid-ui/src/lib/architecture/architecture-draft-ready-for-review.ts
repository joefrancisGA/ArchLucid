...
/** Architectures eligible to start a review from the architecture drafts registry. */
...
/** Count of architectures eligible to start a review from the architecture drafts registry. */
