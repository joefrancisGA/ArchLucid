...
export const ARCHITECTURE_OPEN_QUESTIONS_HELPER =
  "Track follow-ups for business analysts and stakeholders. Saved with this architecture draft only — not part of a sealed review unless you later record them through the review trail." as const;
...
export const ARCHITECTURE_IDENTITY_DESK_OPEN_QUESTIONS_EMPTY =
  "No open questions recorded on the current architecture draft." as const;
