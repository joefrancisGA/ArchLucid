...
export const INVITE_REVIEWER_CLAIM_DISCIPLINE =
  "Inviting a reviewer grants Reader or Auditor access for architecture review sign-off — not a full audit export. Open Users and roles or Users and roles help for the full directory and role matrix.";
