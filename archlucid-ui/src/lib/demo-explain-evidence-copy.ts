...
export const DEMO_EXPLAIN_CLAIM_DISCIPLINE =
  "This page shows an example provenance graph and citations-bound explanation for a seeded demo review — it is not a signed-review diligence Sources package, a CPA SOC 2 attestation, or a published third-party pen-test report. Open live Reviews, Provenance, or Assurance status when you need workspace packages or assurance claims.";
