...
export const DEMO_EXPLAIN_CLAIM_DISCIPLINE =
  "This page shows an example evidence trail and citations-bound explanation for a seeded demo review — it is not a sealed-review diligence Sources package. Open live Reviews, Provenance, or Assurance status when you need workspace packages or assurance claims.";
