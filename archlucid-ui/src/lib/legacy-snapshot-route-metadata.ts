...
export const LEGACY_SNAPSHOT_ROUTE_METADATA: Metadata = {
  ...
  description:
    "Legacy /snapshot bookmark — redirects immediately to the canonical review workspace with readOnly=1. Inbound query params such as v=demo are preserved (TB-1953).",
