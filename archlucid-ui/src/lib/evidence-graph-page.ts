...
export const EVIDENCE_GRAPH_BANNER_BODY = "Evidence trail for this review package.";
...
export const EVIDENCE_GRAPH_EMPTY_TITLE = "No completed review packages yet";

export const EVIDENCE_GRAPH_EMPTY_BODY =
  "Complete a review package to generate an evidence graph, or open the sample graph to see how evidence relationships work.";
