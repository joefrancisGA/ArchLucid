...
export const EVIDENCE_PROPOSALS_CLAIM_DISCIPLINE =
  "Evidence proposals are internal agent-suggested catalog candidates awaiting promote — they are not signed-review diligence Sources, a CPA SOC 2 attestation, or a published third-party pen-test report. Open System health or Evidence trail help when you need operational or provenance context.";
