...
export const DEMO_PREVIEW_CLAIM_DISCIPLINE =
  "This demo preview shows a sample finalized architecture review for evaluation — it is not a signed-review diligence Sources package from your tenant, a CPA SOC 2 attestation, or a published third-party pen-test report. Open Security & trust or start an evaluation when you need live workspace evidence.";
