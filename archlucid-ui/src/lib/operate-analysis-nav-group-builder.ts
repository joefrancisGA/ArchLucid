...
export class OperateAnalysisNavGroupBuilder extends NavGroupBuilderBase {
  build(): NavGroupConfig {
    const links: NavGroupConfig["links"] = [
      ...
      {
        href: "/insights/architecture-scorecard" as const,
        label: OPERATOR_NAV_LINK_LABELS.scorecard,
        title: "Review scorecard — also available under Outcomes",
        icon: BarChart3,
        tier: "advanced",
        requiredAuthority: "ReadAuthority",
      },
    ...
    return {
      ...
      caption: "Explore evidence, ask and search, compare reviews, and open the Outcomes hub for sponsor value reports.",
      links,
    };
  }
}
