...
export const PRODUCT_DOCUMENTATION_REGISTRY_ENTRIES_OPERATOR_WORKSPACE: readonly ProductDocumentationRegistryInput[] = [
  ...
  },
  {
    ...
    "sourcePaths": [],
    "lastReviewed": "2026-09-12",
    "releaseApplicability": "Cheap-exploration help (CE-019 / ADR 0092)",
  },
  {
    "slug": "impact-preview-vs-architecture-envelope",
    "title": "Impact preview vs architecture envelope",
    "summary": "Policy cheap envelope re-simulates packs on a sealed baseline; Sketch a change is the architecture desk rehearsal sketch.",
    "audience": "operator",
    "sourcePaths": [],
    "lastReviewed": "2026-09-12",
  ...
  {
    "slug": "background-wait",
    "title": "Work continues in the background",
    "summary": "Working seats use background wait and operations poll — not stay-on-this-page chrome (ADR 0096).",
    "audience": "operator",
    "sourcePaths": [],
    "lastReviewed": "2026-09-12",
    "releaseApplicability": "Daytime-wait help (DW-015 / ADR 0096)",
  },
  {
    "slug": "proxy-timeout-real-execute",
    "title": "Proxy timeout vs Real execute",
    "summary": "Edge proxy timeouts vs async Career Real execute — poll operations, not a fictional run-progress URL.",
    "audience": "operator",
    "sourcePaths": [],
    "lastReviewed": "2026-09-12",
    "releaseApplicability": "Daytime-wait help (DW-007 / TB-2072)",
  },
  {
