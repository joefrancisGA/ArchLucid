...
export const ACCESSIBILITY_CLAIM_DISCIPLINE =
  "This accessibility statement describes our public WCAG target, testing posture, and how to report barriers — it is not a sealed-review diligence Sources package, or a completed VPAT download. Open Assurance status or Trust Center when you need evaluation assurance materials.";
