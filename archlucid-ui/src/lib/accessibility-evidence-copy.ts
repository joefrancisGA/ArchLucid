...
export const ACCESSIBILITY_CLAIM_DISCIPLINE =
  "This accessibility statement describes our public WCAG target, testing posture, and how to report barriers — it is not a signed-review diligence Sources package, a CPA SOC 2 attestation, a published third-party pen-test report, or a completed VPAT download. Open Assurance status or Trust Center when you need evaluation assurance materials.";
