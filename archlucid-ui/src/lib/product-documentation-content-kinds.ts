...
> = {
  ...
  "decision-register": "product-help",
  "improvement-planning": "product-help",
  "impact-preview": "product-help",
  ...
  "inhabit-the-architecture": "product-help",
  ...
  "impact-preview-vs-architecture-envelope": "product-help",
  "background-wait": "product-help",
  "proxy-timeout-real-execute": "product-help",
