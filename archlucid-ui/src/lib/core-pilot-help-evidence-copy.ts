...
export const CORE_PILOT_HELP_CLAIM_DISCIPLINE_HEADING = "Before you share externally";
...
export const CORE_PILOT_HELP_FOLLOW_UPS_TITLE = "Where to go next";

export const CORE_PILOT_HELP_CLAIM_HEADING_ID = "help-core-pilot-claim-discipline-heading" as const;
