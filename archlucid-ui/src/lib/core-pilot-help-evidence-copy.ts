...
export const CORE_PILOT_HELP_CLAIM_DISCIPLINE =
  "This first-architecture-review guide is architect orientation for your first evidence-to-finalize path — it is not a sealed-review diligence Sources package. Open Reviews, Audit, or Assurance status when you need live packages or assurance claims.";
