...
export const CORE_PILOT_HELP_CLAIM_DISCIPLINE =
  "This first-architecture-review guide is operator orientation for your first evidence-to-finalize path — it is not a signed-review diligence Sources package. Open Reviews, Audit, or Assurance status when you need live packages or assurance claims.";
