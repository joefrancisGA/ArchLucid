...
export const CORE_PILOT_HELP_CLAIM_DISCIPLINE =
  "This first-architecture-review guide is operator orientation for your first evidence-to-finalize path — it is not a signed-review diligence Sources package, a CPA SOC 2 attestation, or a published third-party pen-test report. Open Reviews, Audit, or Security & trust when you need live packages or assurance claims.";
