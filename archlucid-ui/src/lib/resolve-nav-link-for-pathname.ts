...
const SECURENOW_NAV_LOOKUP_ALIASES: Readonly<Record<string, string>> = {
  ...
  [SECURENOW_INFRASTRUCTURE_DRIFT_PATH]: GOVERNANCE_INFRASTRUCTURE_DRIFT_PATH,
  [SECURENOW_INFRASTRUCTURE_TERRAFORM_PATH]: GOVERNANCE_INFRASTRUCTURE_TERRAFORM_PATH,
  [SECURENOW_INFRASTRUCTURE_DIAGRAMS_PATH]: GOVERNANCE_INFRASTRUCTURE_DIAGRAMS_PATH,
  [SECURENOW_INFRASTRUCTURE_DIAGRAM_RECONCILE_PATH]: GOVERNANCE_INFRASTRUCTURE_DIAGRAM_RECONCILE_PATH,
  [SECURENOW_INFRASTRUCTURE_RESOURCES_PATH]: GOVERNANCE_INFRASTRUCTURE_RESOURCES_PATH,
  [SECURENOW_INFRASTRUCTURE_ASK_PATH]: GOVERNANCE_INFRASTRUCTURE_ASK_PATH,
  [SECURENOW_INFRASTRUCTURE_EXTRACT_UPLOAD_PATH]: GOVERNANCE_INFRASTRUCTURE_EXTRACT_UPLOAD_PATH,
