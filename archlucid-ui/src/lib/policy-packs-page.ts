...
export const POLICY_PACKS_RESOLUTION_LINK_HREF = "/governance/resolution" as const;
...
export const POLICY_PACK_BASIS_VIEW_SIGNED_RECORD = "View signed review record";
