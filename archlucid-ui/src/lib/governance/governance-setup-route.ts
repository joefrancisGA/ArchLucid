...
export const GOVERNANCE_SETUP_PAGE_SUBTITLE =
  "Set policy, alerts, approvals, and sponsor reporting so approval workflows can run day to day." as const;
...
export const GOVERNANCE_SETUP_OUTCOMES_INTRO =
  "Complete the steps to stand up an operating approval loop — not a one-time checklist." as const;
