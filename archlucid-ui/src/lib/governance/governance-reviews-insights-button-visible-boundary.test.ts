...
const GOVERNANCE_REVIEWS_INSIGHTS_BUTTON_PATHS = [
  ...
  "src/components/governance/findings/GovernanceFindingsQueueActiveFilterChips.tsx",
  "src/app/(operator)/governance/findings/_sections/GovernanceFindingsQueueToolbarSection.tsx",
  "src/app/(operator)/architecture/reviews/_sections/ReviewsHubActiveFiltersStrip.tsx",
  "src/app/(operator)/architecture/reviews/_sections/ReviewsHubInventoryTable.tsx",
  "src/components/operator-home/RunsDashboardRecentTab.tsx",
  "src/components/operator-home/RunsDashboardGovernanceWarningsActiveFilter.tsx",
