...
export const GOVERNANCE_OVERVIEW_SAMPLE_OVERVIEW_LINE =
  "Sample reviews already include recorded approval decisions. Open the audit trail to inspect approval events — you do not need to submit or approve sample packages here.";
