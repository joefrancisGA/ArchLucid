...
export const EXECUTIVE_ROI_IDENTIFIED_PENDING_LABEL = "Identified savings (pending approval)";
export const EXECUTIVE_ROI_IDENTIFIED_PENDING_DESCRIPTION =
  "Open findings and those awaiting evidence — estimated USD not yet realized through remediation.";
export const EXECUTIVE_ROI_REALIZED_COMMITTED_LABEL = "Realized savings (committed & applied)";
export const EXECUTIVE_ROI_REALIZED_COMMITTED_DESCRIPTION =
  "Findings marked remediated in the governance workflow — defensible realized value, not headline potential.";

/** Maps executive-summary API fields to sponsor-facing identified vs realized buckets. */
export function resolveExecutiveRoiIdentifiedVsRealized(
  summary: ExecutiveRoiSummary,
): ExecutiveRoiIdentifiedVsRealizedBuckets {
