export const ACCESS_DENIED_PAGE_TITLE = "Access denied" as const;
...
export const ACCESS_DENIED_BREADCRUMB_HUB_PATH = "/welcome" as const;

export const ACCESS_DENIED_BREADCRUMB_TOPIC_TITLE = ACCESS_DENIED_PAGE_TITLE;
