export const AUTH_CALLBACK_CLAIM_DISCIPLINE =
  "The OAuth callback completes sign-in token exchange — it is an authentication handoff, not a signed-review diligence Sources package, a CPA SOC 2 attestation, or a published third-party pen-test report. After you reach a workspace, open Assurance status or a finalized review when you need live evidence.";
