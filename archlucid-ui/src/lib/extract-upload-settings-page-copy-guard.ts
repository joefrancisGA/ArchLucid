...
export const EXTRACT_UPLOAD_CLOUD_NEUTRAL_COPY_SURFACES = {
  ...
  scheduledAgentTitle: EXTRACT_UPLOAD_SCHEDULED_AGENT_TITLE,
  scheduledAgentDescription: EXTRACT_UPLOAD_SCHEDULED_AGENT_DESCRIPTION,
  oneTimeLocalDisclosure: EXTRACT_UPLOAD_ONE_TIME_LOCAL_DISCLOSURE,
