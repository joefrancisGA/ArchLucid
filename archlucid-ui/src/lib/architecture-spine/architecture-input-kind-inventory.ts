...
export const ARCHITECTURE_INPUT_KIND_INVENTORY: readonly ArchitectureInputKindRow[] = [
  ...
  },
  {
    ...
    sourceRoots: [WIZARD_ACCEPT_ROOT, API_CONTRACTS_ROOT, INTAKE_CONTEXT_BUILDER_ROOT],
    wizardAccepts: true,
    intakeContextBuilderToday: "structured-parse",
    authorityContextIngestionToday: "structured-parse",
    esiCatalogToday: "stored-file",
    ...
    status: "shipped",
    ownerPrompt: "AS-010",
    notes: "Vsdx posts as base64 Open Packaging zip; legacy .vsd remains unsupported.",
  },
  {
    id: "drawio",
    ...
    status: "shipped",
    ownerPrompt: "AS-009",
    notes: "Uncompressed draw.io mxfile parses on authority; compressed pages warn when not extracted.",
  },
  {
    id: "diagram-json",
    extensions: [".diagram.json"],
    mimeTypes: ["application/vnd.archlucid.diagram+json"],
    sourceRoots: [INTAKE_CONTEXT_BUILDER_ROOT, AUTHORITY_MIME_ROOT],
    wizardAccepts: true,
    intakeContextBuilderToday: "structured-parse",
    authorityContextIngestionToday: "structured-parse",
    ...
    status: "shipped",
    ownerPrompt: "AS-012",
    notes: "Native ArchitectureDiagramModelRecord JSON posts as application/vnd.archlucid.diagram+json with asserted provenance.",
  },
  {
    id: "mermaid",
