 ...
 * Owner backlog shorthand: HFI.
 */
export const FIRST_ARCHITECTURE_REVIEW_HELP_TRAFFIC_ROW_ID = "HFI";

/** Canonical path tracked on the HFI workbook row. */
...
/**
 * Owner workbook Notes for HFI - documents the specialty HelpCorePilotGuideView surface.
 */
