...
export const RESPONSIBLE_AI_POLICY_PACK_DESCRIPTION =
  "Use this pack to review AI-enabled architectures for data handling, model policy, transparency, monitoring, human oversight, and risk controls.";
...
export const RESPONSIBLE_AI_ACTION_MANAGE_WORKSPACE_ASSIGNMENT = "Manage workspace assignment";

/** @deprecated Prefer {@link RESPONSIBLE_AI_ACTION_MANAGE_WORKSPACE_ASSIGNMENT}. */
export const RESPONSIBLE_AI_ACTION_MANAGE_ASSIGNMENT = RESPONSIBLE_AI_ACTION_MANAGE_WORKSPACE_ASSIGNMENT;
