...
export const PILOT_GUIDE_HELP_CLAIM_DISCIPLINE =
  "This pilot guide is operator orientation for running an evaluation pilot — it is not a signed-review diligence Sources package, a CPA SOC 2 attestation, or a published third-party pen-test report. Open Reviews, Audit, or Security & trust when you need live packages or assurance claims.";
...
export const PILOT_GUIDE_HELP_SOURCES: readonly PilotGuideHelpSourceLink[] = [
  ...
  { label: "Pilot outcomes report", href: "/sponsor-report/pilot-outcomes" },
