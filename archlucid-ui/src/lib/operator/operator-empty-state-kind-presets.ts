...
export const OPERATOR_EMPTY_STATE_PRESET_KINDS: Readonly<Record<string, OperatorEmptyStateKind>> = {
  ...
  GOVERNANCE_ASSIGNED_TO_ME_FINDINGS_LOAD_FAILED_COMPACT: "error",
  GOVERNANCE_ASSIGNED_TO_ME_FINDINGS_EMPTY_COMPACT: "collection",
  GOVERNANCE_ASSIGNED_TO_ME_FINDINGS_FILTER_NO_MATCH_COMPACT: "filtered",
