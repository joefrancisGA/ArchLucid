...
export const OPERATOR_EMPTY_STATE_MIGRATION_INVENTORY: readonly OperatorEmptyStateMigrationEntry[] = [
  ...
  },
  {
    ...
    notes: "Compact + GettingStartedSteps in description (**TB-1556**).",
  },
  {
    id: "governance-workflow-no-promotions",
    pathOrSurface: "/governance/approval-queue",
    kind: "collection",
    chrome: "compact",
    disposition: "migrated",
  ...
  },
  {
    ...
    componentOrModule: "app/(operator)/governance/_sections/GovernanceWorkflowPromotionsActivationsSection.tsx",
    notes: "Compact + GettingStartedSteps for environment activations (**TB-1556**).",
  },
  {
