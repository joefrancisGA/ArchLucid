...
export function resolveDeferredChunkImportLoader(
  ...
  switch (entryId) {
    ...
    case "run-detail-review-workspace-shell":
      return deferredChunkLoader(() =>
        import("@/components/reviews/ReviewWorkspaceShell").then(
          (module) => module.ReviewWorkspaceShell,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-workspace-sticky-actions":
      return deferredChunkLoader(() =>
        import("@/app/(operator)/architecture/reviews/[reviewId]/_sections/RunDetailWorkspaceStickyActionsResolved").then(
          (module) => module.RunDetailWorkspaceStickyActionsResolved,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    case "run-detail-section-nav":
      return deferredChunkLoader(() =>
        import("@/components/runs/RunDetailSectionNav").then(
          (module) => module.RunDetailSectionNav,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    case "run-detail-outcome-cards":
      return deferredChunkLoader(() =>
        import("@/components/runs/RunDetailOutcomeCards").then(
          (module) => module.RunDetailOutcomeCards,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-progress-tracker":
      return deferredChunkLoader(() =>
        import("@/components/runs/RunProgressTracker").then(
          (module) => module.RunProgressTracker,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    case "run-detail-estimated-llm-cost-card":
      return deferredChunkLoader(() =>
        import("@/components/runs/RunEstimatedLlmCostCard").then(
          (module) => module.RunEstimatedLlmCostCard,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-last-failure-card":
      return deferredChunkLoader(() =>
        import("@/components/runs/RunDetailLastFailureCard").then(
          (module) => module.RunDetailLastFailureCard,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-first-week-route-guidance":
      return deferredChunkLoader(() =>
        import("@/components/FirstWeekRouteGuidance").then(
          (module) => module.FirstWeekRouteGuidance,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-tabbed-section-nav":
      return deferredChunkLoader(() =>
        import("@/components/runs/RunDetailTabbedSectionNav").then(
          (module) => module.RunDetailTabbedSectionNav,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-savings-summary":
      return deferredChunkLoader(() =>
        import("@/components/RunSavingsSummary").then(
          (module) => module.RunSavingsSummary,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-sample-review-package-summary":
      return deferredChunkLoader(() =>
        import("@/components/SampleReviewPackageSummary").then(
          (module) => module.SampleReviewPackageSummary,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-run-explanation-section":
      return deferredChunkLoader(() =>
        import("@/components/runs/RunExplanationSection").then(
          (module) => module.RunExplanationSection,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-email-run-to-sponsor-banner":
      return deferredChunkLoader(() =>
        import("@/components/EmailRunToSponsorBanner").then(
          (module) => module.EmailRunToSponsorBanner,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    ...
    case "run-detail-generate-adr-from-run-modal":
      return deferredChunkLoader(() =>
        import("@/components/GenerateAdrFromRunModal").then(
          (module) => module.GenerateAdrFromRunModal,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    case "run-detail-compare-to-baseline-cta":
      return deferredChunkLoader(() =>
        import("@/components/CompareToBaselineCta").then(
          (module) => module.CompareToBaselineCta,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
    case "run-detail-post-commit-habit-loop":
      return deferredChunkLoader(() =>
        import("@/components/PostCommitHabitLoopCard").then(
          (module) => module.PostCommitHabitLoopCard,
        ),
      ) as () => Promise<ComponentType<Record<string, unknown>>>;
