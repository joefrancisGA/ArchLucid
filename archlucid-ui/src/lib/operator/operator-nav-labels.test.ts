...
import { CLOUD_CONNECTIONS_PATH, INTEGRATIONS_TEAMS_PATH } from "@/lib/integrations-nav-paths";
...
describe("operator-nav-labels", () => {
  ...
  it("AO-14 / SY-56: Working reviews list nav is labeled Reviews", () => {
    const source = {
      href: "/architecture/reviews",
      label: OPERATOR_NAV_LINK_LABELS.reviewPackage,
      title: "Browse architecture reviews",
  ...
  it("uses Azure connections instead of Cloud connections in the SecureNow shell", () => {
    const source = {
