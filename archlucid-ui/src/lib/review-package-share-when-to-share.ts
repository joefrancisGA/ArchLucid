...
export const REVIEW_PACKAGE_SHARE_WHEN_TO_SHARE_TITLE = "When to share this signed record" as const;
  ...
  return {
    ...
    rows: [
      ...
      },
      {
        ...
        occasion:
          "Use when sponsors or auditors need a formal deliverable from the signed review record (ADR, packet, or similar).",
      },
    ],
  };
}
