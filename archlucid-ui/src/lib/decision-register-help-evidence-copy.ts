...
export const DECISION_REGISTER_HELP_CLAIM_DISCIPLINE =
  "This guide explains how the decision register indexes architecture decisions locked with finalized review records — filter and open decisions, then follow Architecture reviews, Findings, or Finalized review records when follow-up needs review or audit context.";
