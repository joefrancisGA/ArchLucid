...
const ERROR_CODE_REMEDIATION: Record<string, string> = {
  ...
  COMPARISON_VERIFICATION_FAILED: "The architecture reviews you selected cannot be compared. Ensure they belong to the same project and have compatible reviews.",
