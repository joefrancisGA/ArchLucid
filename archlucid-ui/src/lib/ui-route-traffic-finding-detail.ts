...
export const FINDING_DETAIL_TRAFFIC_NOTE =
  "Finding detail (Core review) - FindingDetailPageView with PageContextualHelpButton (topic map findings; Category-1 path matcher), FindingDetailEvidenceOrientationStrip (Sources + claim-discipline: single-finding disposition only), wayfinding, policy citation hero, operational actions, Evidence trace CTA. Sibling ERU = evidence-trace. Not a full signed-record diligence package alone. Does not imply CPA SOC 2 or third-party pen-test publication. Score 58/100 (2026-08-08) - disposition Evidence pass; hard-caps higher Evidence without full diligence packing. Owner pass: Evidence chrome shipped; cannot improve further toward 80 without turning this into a signed-record diligence Sources trail.";
