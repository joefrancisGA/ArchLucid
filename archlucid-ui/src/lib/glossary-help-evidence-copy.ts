...
export const GLOSSARY_HELP_CLAIM_DISCIPLINE =
  "This glossary defines product terms for operators and buyers — it is orientation vocabulary, not a signed-review diligence Sources package, a CPA SOC 2 attestation, or a published third-party pen-test report. Open Getting started, Security & trust, or Audit when you need live workflow or assurance trails.";
