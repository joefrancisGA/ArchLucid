...
export const PACKAGE_PRINT_CLAIM_DISCIPLINE =
  "This print view summarizes one architecture review for screen or PDF output — not a full audit export. Open the review workspace, provenance, or finalized review record when you need tenant evidence.";
