...
describe("integrations-nav-paths (TB-407)", () => {
  it("exposes canonical integrations paths under /integrations/*", () => {
    ...
    expect(INTEGRATIONS_READINESS_PATH).toBe("/integrations/operations");
  });
  ...
  it("matches integration readiness and legacy ITSM redirect source", () => {
