...
export const WHY_CLAIM_DISCIPLINE =
  "Product differentiation only — use your own evidence for formal evaluation. Open Assurance status, Trust Center, or start an evaluation when you need live workspace evidence.";
