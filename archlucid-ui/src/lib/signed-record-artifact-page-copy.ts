...
export const SIGNED_RECORD_ARTIFACT_PAGE_SUBTITLE =
  "Inspect synthesized review outputs — metadata, in-shell preview, download, and sibling artifacts from the same signed record.";

export const BUYER_SIGNED_RECORD_ARTIFACT_PAGE_SUBTITLE =
  "Preview a deliverable from the signed review record and open related outputs.";
...
export const SIGNED_RECORD_ARTIFACT_SCOPE_OVERVIEW =
  "Artifacts are synthesized files linked to a finalized signed review record. Use preview for orientation; download when you need the full file offline.";

export const SIGNED_RECORD_ARTIFACT_WHAT_IS_THIS_HEADING = "What this artifact is";

export const SIGNED_RECORD_ARTIFACT_SIBLINGS_HEADING = "Artifacts in this signed record";
