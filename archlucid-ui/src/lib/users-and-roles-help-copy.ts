...
export const USERS_AND_ROLES_REVIEW_PARTICIPATION_BODY =
  "Workspace administrators can invite reviewers from Settings. Reviewer invitations typically assign the Reader role so colleagues can view reviews, findings, and governance decisions without changing evidence or finalizing reviews.";
