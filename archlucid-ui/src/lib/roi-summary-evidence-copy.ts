...
export type RoiSummarySourceLink = {
  readonly label: string;
  readonly href: string;
};

/** Operator Sources — no self-href to ROI summary. */
export const ROI_SUMMARY_SOURCES: readonly RoiSummarySourceLink[] = [
