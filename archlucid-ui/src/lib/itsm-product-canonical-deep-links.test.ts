...
} from "@/lib/itsm-product-canonical-deep-links";
...
const ITSM_PRODUCT_DEEP_LINK_SCAN_SURFACES = [
  ...
  "archlucid-ui/src/lib/itsm-connectors-admin-scope.ts",
  "archlucid-ui/src/lib/itsm-oauth-callback-evidence-copy.ts",
