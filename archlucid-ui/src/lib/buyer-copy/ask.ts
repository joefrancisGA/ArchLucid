/**
 * Ask-review-questions copy — prompts, grounding, and anchors.
 *
...
export const BUYER_ASK_GROUNDING_ONCE =
  "Answers are scoped to selected review evidence. Validate conclusions against the finalized review record — Ask does not replace formal approval records.";
