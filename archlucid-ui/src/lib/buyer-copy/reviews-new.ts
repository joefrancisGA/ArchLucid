...
export const NEW_REVIEW_SAMPLE_ESCAPE_CTA =
  "See a completed finalized review record and its evidence trail.";

export const NEW_REVIEW_SAMPLE_ESCAPE_HINT =
  "Skip setup and explore a finished finalized review record.";
...
export const REVIEWS_NEW_SPECIMEN_PREVIEW_LEAD =
  "Open the Claims Intake Demo specimen — a finalized review record with findings — before you commit to intake.";

export const REVIEWS_NEW_SPECIMEN_PREVIEW_PRIMARY_CTA = "Open sample finalized review record";
