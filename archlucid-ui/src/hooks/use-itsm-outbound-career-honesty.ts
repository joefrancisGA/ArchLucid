...
import {
  ...
  type ItsmOutboundCareerHonestyPresentation,
} from "@/lib/itsm/itsm-outbound-career-honesty";

export type UseItsmOutboundCareerHonestyInput = {
  readonly scopedRunId?: string;
  readonly isSample?: boolean;
};

export function useItsmOutboundCareerHonesty(
  input: UseItsmOutboundCareerHonestyInput,
