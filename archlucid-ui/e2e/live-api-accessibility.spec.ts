...
const PAGES = [
  ...
  { name: "Help", path: "/help" },
  { name: "Settings security & trust", path: "/administration/settings/security-trust" },
  ...
  { name: "Users & roles", path: "/administration/settings/users" },
  { name: "Settings support", path: "/administration/settings/support" },
