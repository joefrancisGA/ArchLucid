...
const PAGES = [
  ...
  { name: "Alert rules routing tab", path: "/governance/alert-rules?tab=routing" },
  ...
  { name: "Executive dashboard", path: "/architecture/executive-dashboard" },
  { name: "Executive dashboard workspace health", path: "/architecture/executive-dashboard#workspace-health" },
  ...
  { name: "Value report", path: "/insights/executive-summary" },
  { name: "Sponsor report pilot outcomes", path: "/insights/pilot-outcomes" },
