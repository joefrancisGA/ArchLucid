"""TB-240 executive ROI invariant drift guards (Batch 5AN)."""
...
class TestAdoptionBatch5AN(unittest.TestCase):
    def test_tb_240_invariant_tests_file_exists(self) -> None:
        path = REPO_ROOT / "ArchLucid.Application.Tests" / "Roi" / "ExecutiveRoiSummaryInvariantTests.cs"
        text = path.read_text(encoding="utf-8")
        self.assertIn("ExecutiveRoiSummaryInvariantTests", text)
