 ...
 * Usage: k6 run -e ARCHIFORGE_BASE_URL=https://host:port scripts/load/k6-expensive-rate-limit.js
 *
...
const base = __ENV.ARCHIFORGE_BASE_URL || "http://127.0.0.1:5128";
// Default: health is NOT rate-limited — swap for an execute/replay path when testing 429s.
const path = __ENV.ARCHIFORGE_EXPENSIVE_PATH || "/health/live";
