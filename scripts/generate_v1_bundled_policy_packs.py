...
PACKS: list[dict] = [
    ...
    },
    {
        ...
        "description": "Snowflake identity, RBAC, network policies, and data-protection themes for warehouse architectures.",
        "category": "Data Platform Security",
        "disclaimer": "Snowflake mapping is thematic only; not Snowflake certification.",
        "framework": "Snowflake Security",
        "themes": ["Identity", "RBAC", "Network policies", "Encryption"],
    },
    {
        "slug": "aws-waf",
        "prefix": "waf-aws",
        ...
        "description": "WAF pillar themes grounded in AWS inventory ZIP and Terraform aws_* evidence. Not an official AWS Well-Architected Review.",
        "category": "Architecture",
        "disclaimer": "AWS WAF references are thematic mapping only.",
    ...
    },
    {
        ...
        "description": "Architecture framework themes grounded in GCP inventory ZIP and Terraform google_* evidence.",
        "category": "Architecture",
        "disclaimer": "GCP framework references are thematic mapping only.",
    ...
    },
    {
        ...
        "description": "CIS-aligned AWS hardening themes for architecture review. Not CIS benchmark pass/fail.",
        "category": "Security",
        "disclaimer": "CIS references are thematic alignment only.",
        "framework": "CIS AWS Foundations",
        "themes": ["Identity", "Logging", "Network", "Storage"],
    },
    {
        ...
        "description": "CIS-aligned GCP hardening themes for architecture review. Not CIS benchmark pass/fail.",
        "category": "Security",
        "disclaimer": "CIS references are thematic alignment only.",
    ...
    },
    {
        ...
        "description": "IAM, Organizations SCP, Identity Center, and workload identity themes for AWS architectures.",
        "category": "Identity",
        "disclaimer": "Identity mapping is thematic only.",
        "framework": "AWS IAM",
        "themes": ["RBAC", "Workload identity", "SCP guardrails"],
    },
    {
        ...
        "description": "Cloud IAM, org policies, service accounts, and workload identity themes for GCP architectures.",
        "category": "Identity",
        "disclaimer": "Identity mapping is thematic only.",
        "framework": "GCP Cloud IAM",
        "themes": ["RBAC", "Workload identity", "Org policies"],
    },
    {
        ...
        "description": "Organizations, Control Tower, SCP guardrails, and hub-spoke networking themes.",
        "category": "Platform",
        "disclaimer": "Landing zone mapping is thematic only.",
        "framework": "AWS Control Tower",
        "themes": ["Organizations", "Networking", "Guardrails"],
    },
    {
        ...
        "description": "Org/folder/project hierarchy, Shared VPC, and VPC Service Controls themes.",
        "category": "Platform",
        "disclaimer": "Landing zone mapping is thematic only.",
        "framework": "GCP Landing Zone",
        "themes": ["Hierarchy", "Shared VPC", "Service controls"],
    },
    {
        ...
        "description": "Multi-AZ, Route 53, AWS Backup, and cross-region replication themes for AWS workloads.",
        "category": "Reliability",
        "disclaimer": "DR mapping is thematic only.",
        "framework": "AWS Resiliency",
        "themes": ["Multi-AZ", "Backup", "Failover"],
    },
    {
        ...
        "description": "Multi-region GCE/Cloud SQL, Cloud DNS failover, and backup/DR themes for GCP workloads.",
        "category": "Reliability",
        "disclaimer": "DR mapping is thematic only.",
        "framework": "GCP Resiliency",
        "themes": ["Multi-region", "Backup", "Failover"],
    },
    {
        ...
        "description": "Kubernetes on AWS EKS production hardening themes (IRSA, network policy, control plane logging).",
        "category": "Platform",
        "disclaimer": "EKS mapping is thematic only.",
        "framework": "Amazon EKS",
        "themes": ["IRSA", "Network policy", "Logging"],
    },
    {
        ...
        "description": "Kubernetes on GKE production hardening themes (workload identity, Binary Authorization, private clusters).",
        "category": "Platform",
        "disclaimer": "GKE mapping is thematic only.",
        "framework": "Google GKE",
        "themes": ["Workload identity", "Binary Authorization", "Private clusters"],
    },
    {
        ...
        "description": "Lambda, API Gateway, App Runner, and ECS Fargate identity and network exposure themes.",
        "category": "Application Platform",
        "disclaimer": "PaaS mapping is thematic only.",
        "framework": "AWS PaaS",
        "themes": ["VPC integration", "Workload identity", "Public access disabled"],
    },
    {
        ...
        "description": "Cloud Run, Cloud Functions, and App Engine ingress, secrets, and VPC connector themes.",
        "category": "Application Platform",
        "disclaimer": "PaaS mapping is thematic only.",
        "framework": "GCP PaaS",
        "themes": ["Ingress", "Secrets", "VPC connector"],
    },
    {
        ...
        "description": "RDS, DynamoDB, S3, and KMS encryption and private access themes for AWS data platforms.",
        "category": "Data Platform",
        "disclaimer": "Data-layer mapping is thematic only.",
        "framework": "AWS data services",
        "themes": ["Encryption", "Private access", "Auditing"],
    },
    {
        ...
        "description": "Cloud SQL, Spanner, Firestore, BigQuery, and Cloud Storage data-control themes.",
        "category": "Data Platform",
        "disclaimer": "Data-layer mapping is thematic only.",
        "framework": "GCP data services",
        "themes": ["Encryption", "Private access", "Auditing"],
    },
]
