...
Describe 'FirstPilotMultiRunStickinessProof' {
    It 'RunNumber 1 resolves pilot-proof bundle directory' {
        $dir = Resolve-FirstPilotStickinessBundleDirectory -ProofDirectory 'C:\proof' -RunNumber 1
        $dir | Should Be 'C:\proof\pilot-proof'
    }

    It 'RunNumber 2 resolves pilot-proof-run2 bundle directory' {
        $dir = Resolve-FirstPilotStickinessBundleDirectory -ProofDirectory 'C:\proof' -RunNumber 2
        $dir | Should Be 'C:\proof\pilot-proof-run2'
    }
