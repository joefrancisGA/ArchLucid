...
| Compare | `/insights/compare-two-reviews` | Scanned |
| Ask | `/insights/ask-review-questions` | Scanned |
| Graph | `/insights/evidence-graph` | Scanned |
| Advisory | `/governance/advisory-scans` | Scanned |
| Governance dashboard | `/architecture/sponsor-dashboard` | Scanned |
| Governance workflow | `/governance/approval-queue` | Scanned |
| Tenant settings | `/administration/workspace-settings` | Scanned |
| Value report | `/insights/sponsor-report` | Scanned |
