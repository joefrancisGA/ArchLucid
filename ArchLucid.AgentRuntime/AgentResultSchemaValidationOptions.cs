...
/// <summary>
///     Options for JSON schema validation of raw LLM <see cref="ArchLucid.Contracts.Agents.AgentResult" /> payloads before
///     domain checks.
/// </summary>
public sealed class AgentResultSchemaValidationOptions
{
    ...
    /// <summary>
    ///     When <see langword="true" /> (default), <see cref="AgentResultParser" /> throws
    ///     <see cref="AgentResultSchemaViolationException" />
