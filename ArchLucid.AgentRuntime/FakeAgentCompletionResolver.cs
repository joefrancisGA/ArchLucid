...
/// <summary>
///     Routes offline <see cref="FakeAgentCompletionClient" /> completions by system-prompt markers.
/// </summary>
public static class FakeAgentCompletionResolver
{
    ...
    /// <summary>Resolves deterministic JSON/text for a fake completion request.</summary>
    public static string Resolve(string systemPrompt, string userPrompt)
    {
