...
public sealed class LlmCompletionResponseCacheOptions
{
    ...
    /// <summary>
    ///     Optional Redis connection when <see cref="Provider" /> is <c>Distributed</c> and no shared
    ///     <c>IDistributedCache</c> is registered yet.
    /// </summary>
    ...
    /// <summary>
    ///     When true, the cache key includes tenant, workspace, and project from
    ///     <see cref="ArchLucid.Core.Scoping.IScopeContextProvider" />.
