...
/// <summary>
///     Expected shape and quality bar for evaluating an in-memory <see cref="AgentResult" /> (tests, harnesses, offline
///     QA).
/// </summary>
public sealed class AgentOutputExpectation
{
    /// <summary>
    ///     Each listed category must appear on at least one finding (case-insensitive trim). Empty = no category
    ///     requirement.
    /// </summary>
