...
/// </summary>
public sealed class HeuristicOnlyAgentOutputSemanticEvaluator : IAgentOutputSemanticEvaluator
{
    private readonly IHeuristicAgentOutputSemanticEvaluator _heuristic;

    public HeuristicOnlyAgentOutputSemanticEvaluator(IHeuristicAgentOutputSemanticEvaluator heuristic)
    {
