...
/// reserves a seam for cosine-similarity or entailment models without coupling the harness to Azure OpenAI embeddings yet.
/// </summary>
public interface ISemanticScorer
{
    /// <summary>
    /// Returns a score in [0, 1] comparing <paramref name="candidateText"/> to <paramref name="referenceText"/>, or <see langword="null"/> when scoring is skipped.
    /// </summary>
