...
///     <see cref="AgentEvidencePackage" />, calls the completion client, parses <see cref="AgentResult" />, and records
///     traces.
/// </summary>
/// <remarks>
...
public interface IAgentHandler
{
    ...
    /// <summary>
    ///     Runs the LLM (or simulator) pipeline for <paramref name="task" /> and returns a validated
