...
/// <summary>
///     Options for <see cref="CachingLlmCompletionClient" /> (nested under configuration path
...
public sealed class LlmCompletionCacheOptions
{
    ...
    /// <summary>
    ///     When true, the cache key includes tenant, workspace, and project IDs from current scope (
