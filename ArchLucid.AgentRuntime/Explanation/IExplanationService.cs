...
/// </summary>
/// <remarks>
///     Default implementation: <see cref="ExplanationService" /> (uses <see cref="IAgentCompletionClient" />). HTTP entry
///     points: <c>ArchLucid.Api.Controllers.ExplanationController</c>, <c>DocxExportController</c> (optional sections).
...
public interface IExplanationService
{
    ...
    ///     Optional decision provenance graph; when <see langword="null" />, provenance section of the
    ///     prompt notes it is missing.
    /// </param>
    ...
    /// <summary>
    ///     Explains base → target changes described by <paramref name="comparison" /> (decisions, requirements, security,
    ///     topology, cost).
    /// </summary>
