...
public sealed class AgentSchemaRemediationOptions
{
    ...
    /// <summary>
    ///     Total completion attempts allowed for one handler invocation (minimum 1, capped at
    ///     <see cref="MaxCompletionAttemptsCeiling" />).
    ///     The first failure that is a schema violation triggers a follow-up completion with remediation instructions when
    ///     this is &gt; 1.
    /// </summary>
