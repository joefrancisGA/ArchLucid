...
Copy templates into `artifacts/second-review/<cohort-label>/` before running [`docs/go-to-market/SECOND_REVIEW_HABIT_LOOP_EXECUTION_BOARD.md`](../../docs/go-to-market/SECOND_REVIEW_HABIT_LOOP_EXECUTION_BOARD.md).
