...
public sealed class ComplianceAgentHandlerTests
{
    ...
    {
        const string runId = AgentHandlerTestRunIds.Run001;
        StubAgentCompletionClient completionClient = new("""{"resultId":"r1","taskId":"TASK-COMP-LEDGER","runId":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","agentType":"Compliance","claims":[],"evidenceRefs":[],"confidence":0.5,"findings":[],"proposedChanges":{"proposalId":"p1","sourceAgent":"Compliance","addedServices":[],"addedDatastores":[],"addedRelationships":[],"requiredControls":[],"warnings":[]},"createdUtc":"2026-03-15T14:00:00Z"}""");
        ...
        AgentTask task = new() { TaskId = "TASK-COMP-LEDGER", RunId = runId, AgentType = AgentType.Compliance, Objective = "Produce compliance output." };
        AgentEvidencePackage evidence = new()
        {
            RunId = runId,
            RequestId = request.RequestId,
