...
[Trait("Suite", "Core")]
[Trait("Category", "Unit")]
public sealed class SanitizedLoggerTrialBootstrapExtensionsTests
{
    [Fact]
    public void LogInformationTrialBootstrapEmailVerificationBlocked_logs_domain_only()
    {
