...
public sealed class SanitizedLoggerInformationExtensionsTests
{
    ...
    [Fact]
    public void LogInformationGovernanceManifestPromoted_strips_control_chars_in_user_strings()
    {
        Mock<ILogger> mock = new();
        mock.Setup(l => l.IsEnabled(It.IsAny<LogLevel>())).Returns(true);
        ...
        mock.Object.LogInformationGovernanceManifestPromoted("prom\n1", "run\t2", "v\r3", "prod\n4");

        rendered.Should().NotBeNull();
        string text = rendered!;

        text.Should().Contain("prom_1");
        text.Should().Contain("run_2");
        text.Should().Contain("v_3");
        text.Should().Contain("prod_4");
        text.Should().NotContain("\n");
        text.Should().NotContain("\t");
        text.Should().NotContain("\r");
    }
    ...
    [Fact]
    public void LogInformationGovernanceManifestPromoted_throws_when_logger_null()
    {
        ILogger logger = null!;

        Action act = () => logger.LogInformationGovernanceManifestPromoted("p", "r", "m", "t");
    ...
    [Fact]
    public void LogInformationFirstValueReportRunNotFound_strips_control_chars_in_run_id()
    {
        Mock<ILogger> mock = new();
        mock.Setup(l => l.IsEnabled(It.IsAny<LogLevel>())).Returns(true);
        ...
        mock.Object.LogInformationFirstValueReportRunNotFound("run\nid");
    ...
    [Fact]
    public void LogInformationFirstValueReportRunNotFound_throws_when_logger_null()
    {
        ILogger logger = null!;

        Action act = () => logger.LogInformationFirstValueReportRunNotFound("r");
    ...
    [Fact]
    public void LogInformationInternalArchitectureRunReplayed_strips_control_chars_in_user_strings()
    {
        Mock<ILogger> mock = new();
        mock.Setup(l => l.IsEnabled(It.IsAny<LogLevel>())).Returns(true);
        ...
        mock.Object.LogInformationInternalArchitectureRunReplayed(
            "orig\n1",
            "replay\t2",
            "mode\r3",
            "user\n4",
        ...
        text.Should().Contain("orig_1");
        text.Should().Contain("replay_2");
        text.Should().Contain("mode_3");
        text.Should().Contain("user_4");
        text.Should().Contain("corr_id");
        text.Should().NotContain("\n");
        text.Should().NotContain("\t");
        text.Should().NotContain("\r");
    }
    ...
    [Fact]
    public void LogInformationInternalArchitectureRunReplayed_throws_when_logger_null()
    {
        ILogger logger = null!;

        Action act = () =>
            logger.LogInformationInternalArchitectureRunReplayed("a", "b", "c", "d", "e");
    ...
    [Fact]
    public void LogInformationFindingInsightSignalRecorded_strips_control_chars()
    {
        Mock<ILogger> mock = new();
        mock.Setup(l => l.IsEnabled(It.IsAny<LogLevel>())).Returns(true);
        ...
        mock.Object.LogInformationFindingInsightSignalRecorded(
            "Helpful\nKind",
            runId,
            "find\rid-9",
            created: true);
        ...
        text.Should().Contain("Helpful_Kind");
        text.Should().Contain("find_id-9");
        text.Should().Contain(runId.ToString());
        text.Should().NotContain("\n");
        text.Should().NotContain("\r");
    }
