...
public sealed class SanitizedLoggerWarningExtensionsTests
{
    ...
    [Fact]
    public void LogWarningIntegrationEventSerializationFailed_strips_control_chars_in_event_type()
    {
        Mock<ILogger> mock = new();
        mock.Setup(l => l.IsEnabled(It.IsAny<LogLevel>())).Returns(true);
        ...
        mock.Object.LogWarningIntegrationEventSerializationFailed(
            new InvalidOperationException("serialize failed"),
            "com.archlucid\n.test.v1");
