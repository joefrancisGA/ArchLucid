...
public sealed class GraphJsonElementReadersPropertiesTests
{
    ...
    [Fact]
    public void ReadProperties_string_encoded_boolean_values_coerce_to_lowercase_strings()
    {
        const string json =
            """{"nodeId":"n1","nodeType":"t","label":"l","properties":{"enabled":"True","region":"eastus"}}""";
    ...
    [Fact]
    public void ReadProperties_whole_number_double_values_coerce_to_strings()
    {
        const string json =
            """{"nodeId":"n1","nodeType":"t","label":"l","properties":{"resourceId":42.0}}""";
