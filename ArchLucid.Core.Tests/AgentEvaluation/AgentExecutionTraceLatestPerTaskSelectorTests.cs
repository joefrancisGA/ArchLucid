...
public sealed class AgentExecutionTraceLatestPerTaskSelectorTests
{
    ...
    [Fact]
    public void Select_when_empty_traces_returns_empty_list()
    {
        AgentExecutionTraceLatestPerTaskSelector.Select([])
            .Should().BeEmpty();
    }
    ...
    [Fact]
    public void Select_when_higher_attempt_accepted_wins_over_lower_attempt_warned()
    {
        ...
        IReadOnlyList<AgentExecutionTrace> latest =
            AgentExecutionTraceLatestPerTaskSelector.Select([supersededWarned, latestAccepted]);
    ...
    [Fact]
    public void Select_throws_when_traces_null()
    {
        Action act = () => AgentExecutionTraceLatestPerTaskSelector.Select(null!);

        act.Should().Throw<ArgumentNullException>();
    }

    [Fact]
    public void Select_when_same_attempt_accepted_newer_and_rejected_older_prefers_accepted_trace()
    {
    ...
    [Fact]
    public void Select_when_same_attempt_quality_rejected_accepted_duplicate_loses_to_clean_accepted()
    {
        ...
        latest.Should().ContainSingle();
        latest[0].TraceId.Should().Be("trace-clean-accepted");
    }

    [Fact]
    public void Select_when_same_attempt_quality_rejected_rejected_outcome_and_warned_prefers_warned_trace()
    {
