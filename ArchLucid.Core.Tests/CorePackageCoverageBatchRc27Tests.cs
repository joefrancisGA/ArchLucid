...
public sealed class CorePackageCoverageBatchRc27Tests
{
    ...
    [InlineData("FindingVerificationCompleted", IntegrationEventTypes.FindingVerificationCompletedV1)]
    [InlineData("finding-verification-completed", IntegrationEventTypes.FindingVerificationCompletedV1)]
    ...
    [InlineData(IntegrationEventTypes.FindingVerificationCompletedV1)]
