...
[Trait("Suite", "Core")]
[Trait("Category", "Unit")]
public sealed class RequestConstraintCompoundIdentifierAtHashTests
{
    [Fact]
    public void HasEncryptionConstraint_does_not_false_positive_on_at_delimited_product_name_embedding_encryption_token()
    {
    ...
    [Fact]
    public void RequiresAiCapability_does_not_false_positive_on_at_delimited_product_name_embedding_openai_token()
    {
    ...
    [Fact]
    public void RequiresSearchCapability_does_not_false_positive_on_at_delimited_product_name_embedding_search_token()
    {
    ...
    [Fact]
    public void RequiresSqlCapability_does_not_false_positive_on_at_delimited_product_name_embedding_sql_token()
    {
    ...
    [Fact]
    public void HasEncryptionConstraint_does_not_false_positive_on_hash_delimited_product_name_embedding_encryption_token()
    {
        ArchitectureRequest request = CreateRequest(constraints: ["field#encryption#module integration only"]);
    ...
    [Fact]
    public void RequiresAiCapability_does_not_false_positive_on_hash_delimited_product_name_embedding_openai_token()
    {
        ArchitectureRequest request = CreateRequest(capabilities: ["email#openai#gateway integration only"]);
