...
public sealed class ProductLineRouteGateEvaluatorTests
{
    ...
    [InlineData(EffectiveProductLineKind.Architecture, "security", ProductLineRouteGateDecision.Allow)]
    ...
    [InlineData(EffectiveProductLineKind.Security, "security", ProductLineRouteGateDecision.Allow)]
