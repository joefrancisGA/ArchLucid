...
public sealed class RealLlmOutputStructuralValidatorTests
{
    ...
    [Fact]
    public void ValidateAgentResultStructure_accepts_string_encoded_whole_number_double_agentType()
    {
        const string json = """
            {
              "resultId": "r1",
    ...
    [Fact]
    public void ValidateAgentResultStructure_accepts_string_encoded_whole_number_double_agentType_parameter()
    {
        const string json = """
            {
              "resultId": "r1",
        ...
        RealLlmStructuralValidationResult result =
            RealLlmOutputStructuralValidator.ValidateAgentResultStructure("1.0", json);
    ...
    [Fact]
    public void ValidateAgentResultStructure_rejects_string_encoded_boolean_agentType()
    {
        const string json = """
            {
              "resultId": "r1",
    ...
    [Fact]
    public void ValidateAgentResultStructure_rejects_string_encoded_boolean_agentType_parameter()
    {
        const string json = """
            {
              "resultId": "r1",
        ...
        RealLlmStructuralValidationResult result =
            RealLlmOutputStructuralValidator.ValidateAgentResultStructure("True", json);

        result.IsValid.Should().BeFalse();
    }

    [Fact]
    public void ValidateAgentResultStructure_rejects_on_synonym_agentType()
    {
        const string json = """
            {
              "resultId": "r1",
