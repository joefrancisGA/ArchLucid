...
public sealed class AzureExtractorPackageInventoryReaderTests
{
    ...
    public void TryReadFromZip_fails_on_malformed_resources_json()
    {
        ...
        result.Succeeded.Should().BeFalse();
        result.Error.Should().Be("resources.json is not valid JSON.");
    }

    [Fact]
    public void TryReadFromZip_fails_on_malformed_diagnostic_settings_companion_json()
    {
        byte[] zipBytes = BuildZipWithCompanion(
            """
            [
        ...
        result.Succeeded.Should().BeFalse();
        result.Error.Should().Be("diagnostic-settings.json is not valid JSON.");
    }

    [Fact]
    public void TryReadFromZip_reads_pascal_case_location_on_resource_row()
    {
        byte[] zipBytes = BuildZip(
            """
            [
        ...
        result.Succeeded.Should().BeTrue();
        result.Resources.Should().ContainSingle();
        result.Resources[0].Location.Should().Be("northeurope");
    }

    [Fact]
    public void TryReadFromZip_reads_pascal_case_resource_group_on_row()
    {
        byte[] zipBytes = BuildZip(
            """
            [
    ...
    [Fact]
    public void TryReadFromZip_trims_whitespace_from_explicit_resource_group_on_row()
    {
        byte[] zipBytes = BuildZip(
            """
            [
    ...
    public void TryReadFromZip_treats_whitespace_only_location_as_null()
    {
        ...
        result.Succeeded.Should().BeTrue();
        result.Resources.Should().ContainSingle();
        result.Resources[0].Location.Should().BeNull();
    }
    ...
    [Fact]
    public void TryReadFromZip_trims_whitespace_from_location_on_resource_row()
    {
        byte[] zipBytes = BuildZip(
            """
            [
    ...
    [Fact]
    public void TryReadFromZip_treats_numeric_sku_property_as_null()
    {
        byte[] zipBytes = BuildZip(
            """
            [
        ...
        result.Succeeded.Should().BeTrue();
        result.Resources.Should().ContainSingle();
        result.Resources[0].SkuName.Should().BeNull();
    }

    [Fact]
    public void TryReadFromZip_fails_on_malformed_role_assignments_companion_json()
    {
        byte[] zipBytes = BuildZipWithCompanion(
            """
            [
        ...
        result.Succeeded.Should().BeFalse();
        result.Error.Should().Contain("role-assignments.json");
    }
    ...
    [Fact]
    public void TryReadFromZip_reads_pascal_case_name_on_resource_row()
    {
        byte[] zipBytes = BuildZip(
            """
            [
    ...
    [Fact]
    public void TryReadFromZip_reads_pascal_case_resource_id_on_resource_row()
    {
        byte[] zipBytes = BuildZip(
            """
            [
    ...
    [Fact]
    public void TryReadFromZip_reads_pascal_case_sku_object_name_property()
    {
        byte[] zipBytes = BuildZip(
            """
            [
    ...
    [Fact]
    public void TryReadFromZip_trims_whitespace_from_object_sku_name_property()
    {
        byte[] zipBytes = BuildZip(
            """
            [
    ...
    [Fact]
    public void TryReadFromZip_fails_on_malformed_network_associations_companion_json()
    {
        byte[] zipBytes = BuildZipWithCompanion(
            """
            [
        ...
        result.Succeeded.Should().BeFalse();
        result.Error.Should().Be("network-associations.json is not valid JSON.");
    }
