...
public sealed class AzureExtractorResourceInventoryReaderTests
{
    ...
    [Fact]
    public void TryReadFromZip_skips_resource_rows_with_whitespace_only_name()
    {
        byte[] zipBytes = BuildZip(
            """
            [
    ...
    [Fact]
    public void TryReadFromZip_trims_whitespace_from_name_and_resource_type()
    {
        byte[] zipBytes = BuildZip(
            """
            [
