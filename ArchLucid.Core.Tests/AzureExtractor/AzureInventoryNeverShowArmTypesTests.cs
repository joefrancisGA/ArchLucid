...
public sealed class AzureInventoryNeverShowArmTypesTests
{
    ...
    [InlineData("Microsoft.Insights/actionGroups")]
    [InlineData("microsoft.insights/actiongroups")]
    [InlineData("actiongroups")]
    [InlineData("Microsoft.Insights/dataCollectionRules")]
    [InlineData("microsoft.insights/datacollectionrules")]
    [InlineData("datacollectionrules")]
    [InlineData("Microsoft.OperationsManagement/solutions")]
    [InlineData("microsoft.operationsmanagement/solutions")]
    [InlineData("solutions")]
    [InlineData("Microsoft.Network/enterprisePolicies")]
    [InlineData("microsoft.network/enterprisepolicies")]
    [InlineData("enterprisepolicies")]
    ...
    [InlineData("Microsoft.Network/networkWatchers")]
    [InlineData("microsoft.network/networkwatchers")]
    [InlineData("networkwatchers")]
    [InlineData("Microsoft.Network/networkWatchers/flowLogs")]
    [InlineData("microsoft.network/networkwatchers/flowlogs")]
    [InlineData("flowlogs")]
    ...
    [InlineData("Microsoft.Web/serverFarms")]
    [InlineData("microsoft.web/serverfarms")]
    [InlineData("serverfarms")]
    ...
    [InlineData("/subscriptions/sub/resourceGroups/rg/providers/Microsoft.Insights/actionGroups/ops-ag")]
    [InlineData("/subscriptions/sub/resourceGroups/rg/providers/Microsoft.Insights/dataCollectionRules/dcr1")]
    [InlineData("/subscriptions/sub/resourceGroups/rg/providers/Microsoft.Network/enterprisePolicies/policy1")]
    [InlineData("/subscriptions/sub/resourceGroups/rg/providers/Microsoft.Web/serverFarms/plan1")]
    ...
    [InlineData("/subscriptions/sub/resourceGroups/rg/providers/Microsoft.Network/networkWatchers/NW")]
    [InlineData("/subscriptions/sub/resourceGroups/rg/providers/Microsoft.Network/networkWatchers/NW/flowLogs/flowlog1")]
