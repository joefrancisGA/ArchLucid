---
name: "source-command-al-api"
description: "Migrated source command `al-api`"
---

# source-command-al-api

Use this skill when the user asks to run the migrated source command `al-api`.

## Command Template

# /al-api — Launch a Cloud Agent via API

You are invoking the **/al-api** slash command. Your job is to start a Codex Cloud Agent through the local helper script, using **Composer 2.5 standard** (not Fast). This is hardcoded in the script and cannot be overridden.
