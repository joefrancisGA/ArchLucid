---
name: "source-command-al-ui-tableupdate"
description: "Reconcile the owner UI route traffic master table with the live App Router, help, and tab route catalog"
---

# source-command-al-ui-tableupdate

Use this skill when the user asks to run the migrated source command `al-ui-tableupdate`.
