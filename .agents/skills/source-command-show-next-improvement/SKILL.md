---
name: "source-command-show-next-improvement"
description: "Preview which backlog or assessment item ship-next-improvement would pick next (read-only)"
---

# source-command-show-next-improvement

Use this skill when the user asks to run the migrated source command `show-next-improvement`.
...
### Step 3 — Next Codex-actionable assessment item
...
3. **Validation-first** — if the row or assessment says live pilot / owner execution / GTM-only, classify as **not Codex-shippable** and say why.
