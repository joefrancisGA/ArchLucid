---
name: "source-command-al-ui-rate-lowest"
...
# source-command-al-ui-rate-lowest

Use this skill when the user asks to run the migrated source command `al-ui-rate-lowest`.
