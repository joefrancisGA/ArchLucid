# SG-043 — Continue-last-review nested under architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-009, SY-64 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Continue last review opens the nested job under the parent architecture when known.
