# CE-038 — Support: envelope vs Career execute

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** ops. **Depends on:** CE-019.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Runbook: rehearsal envelope vs Career run. Stamp/door in bundle (CG-092).
