# SG-004 — Inventory review-detail as all-day shell
...
Produce `docs/architecture/SYSTEM_GRAVITY_REVIEW_DETAIL_SHELL_INVENTORY.md`: Which Working surfaces make nested review-detail the shell for hours (findings, dispose, finalize, wait chrome) vs a short inspector. Shrink-only. Do not mutate copy yet (SG-016+).
...
- RunDetailWorkspaceChrome.tsx · resolve-run-detail-tabbed-workspace.tsx · ReviewWorkbenchLayout.tsx

## What to build

1. Grep Working UI/docs for the leak class. Write `SYSTEM_GRAVITY_REVIEW_DETAIL_SHELL_INVENTORY.md` with path, string/call, whether AO/SY/SN already covers it, leak class.
