# LY-116 — Explicit skip: G-REAL-06

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** skip. **Depends on:** LN-026 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not implement G-REAL-06 or flip host Mode to Real. Record skip.

## Why

0099 Real finalize judge is not live estate packets.
...
1. Residuals: G-REAL-06 skipped. Simulator host default stays.
