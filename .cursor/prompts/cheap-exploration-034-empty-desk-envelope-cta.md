# CE-034 — Empty architecture: no envelope CTA leftover
...
Envelope CTA hidden until a committed parent exists (R12). Empty desk uses Start review, not Sketch.

## Why

Sketch without a parent is a new job.
