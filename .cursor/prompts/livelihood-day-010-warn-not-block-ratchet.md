# LY-010 — Ratchet: judge does not block seal
...
UnsupportedSemanticSupportFinalizeHoldEvaluator still opt-in PilotStrict. Judge errors never throw ConflictException.

## Why

0099 must not quietly become a commit gate.
...
1. Grep FinalizeJudge for ConflictException — none.
2. Hold evaluator default remains false.
3. Contract honesty examples unchanged for PilotStrict.
