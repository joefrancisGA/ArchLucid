# SG-042 — Working `?reviewTab=` is not Home leftover
...
`?reviewTab=` deep-links a nested inspector tab. It must not become Working Home, Start, or Alt+R.
...
- first-review-guide-status.ts · review workspace tabs
