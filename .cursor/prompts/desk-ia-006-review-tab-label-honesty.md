# DI-006 — Review-detail tab labels leftover
...
Tab `review-package` already “Finalized review record.” Leftover: any UI still saying Review tab for finalize/export. Do not collapse tabs.

## Why

Wrong tab names are job IA.

## Context

- REVIEW_DETAIL_TAB_LABELS · no-collapse rule

## What to build

1. Label sweep.
2. Ratchet: moreTabIds empty on desktop.
3. Do not hide tabs.
