# SG-085 — Webhook/ITSM links include architecture when known leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** outbound. **Depends on:** SG-012, CG-093 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Outbound payloads that include a UI href nest under architecture when known. Rehearsal/Practice flag stays (CG).
