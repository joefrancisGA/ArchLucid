# SG-051 — Keyboard Alt+R stays the desk leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-039, SY-07 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Alt+R opens last-open architecture desk or portfolio — never the reviews inbox as Home.
...
- resolve-working-alt-r-href.ts · shortcut-registry.ts
