# LN-025 — Explicit skip: LLM judge default-on

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** out-of-wave. **Depends on:** LN-008.

Do not implement from the wave index. Implement only *What to build*.

## Goal

AS-074 LLM judge stays default off. Do not turn it on to “fix” semantic truth. Residual: TB-1228 lanes.

## Why

Non-reproducible judge is not livelihood-grade.
