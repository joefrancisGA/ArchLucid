# SG-030 — Governance queue return to architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-019, SY-67 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Governance findings opened from the desk return to the architecture, not a platform-console Home.
