# LN-016 — Open questions not sealed facts leftover

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** honesty. **Depends on:** LN-005.

Do not implement from the wave index. Implement only *What to build*.

## Goal

LP-16 leftover: openQuestions cannot leak into career artifacts as asserted. Sweep remaining export paths.

## Why

WS-19 field as asserted is a livelihood lie.

## Context

- OpenQuestionsExportHonesty

## What to build

1. Grep exports.
2. Empty arrays OK; missing bucket blocks.
3. Do not drop the desk field.
