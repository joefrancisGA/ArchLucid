# LY-088 — Ratchet: do not fuse density leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** AS-066.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Keep ArchitectureSpineAs066. LY does not read band inside density gate.

## Why

Fusion is the hidden-risk defect.
