# AS-062 — Stamp / finalize chrome includes support band counts

**Wave:** architecture-spine (**AS**). **Cluster:** semantic-desk. **Depends on:** AS-061.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Career stamp: N Supported / N Unchecked / N Unsupported among decision-grade. Do not replace insight-density counts; add a line.

## Why

Stamp is what gets screenshotted for sponsors.

## Context

- ADR 0078
- IS-06 stamp formatters

## What to build

1. Formatter + tests.
2. Guided eval may keep a shorter line; Working must show it.

## Acceptance criteria

- Stamp cannot show all-clear while Unsupported > 0 without listing them.
