# LN-036 — Architect restatement does not mint hard leftover

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** gate. **Depends on:** LN-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

AS-070 leftover: restatement does not reset semantic band. Also: restatement cannot upgrade soft to hard without citation.

## Why

Human overlay as a theorem is a new lie.

## Context

- LP-15 append-only · AS-070

## What to build

1. Confirm restatement cannot set hard without citation.
2. Append-only stays.
3. Do not mutate sealed Message.
