# SY-70 — Sponsor / value-report Working primary Open is the architecture, not only the last run

Do not fork sponsor KPI honesty (FC). Primary href only.

## Goal

Working sponsor tiles: Open architecture desk; secondary “latest sealed review” nested. Do not make the run the only object.

## Why

Sponsors bookmark whatever Open is. If it is a run, the org’s object is a job.

## Context

- Sponsor dashboard / scorecard Working links

## What to build

1. Primary href helper + test.

## Acceptance criteria

- Primary Open contains `/architecture/architectures/` when architectureId known.
