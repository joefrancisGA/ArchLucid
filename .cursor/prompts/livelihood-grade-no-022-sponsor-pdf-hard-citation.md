# LN-022 — Sponsor PDF hard citation leftover

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** export. **Depends on:** LN-013.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Sponsor PDF lists hard infeasible with citations or omits hard. Uncited hard cannot appear as hard.

## Why

Sponsor PDF is the lie that matters.
...
1. PDF section.
2. Tests.
3. Rehearsal watermark still applies (CG).
