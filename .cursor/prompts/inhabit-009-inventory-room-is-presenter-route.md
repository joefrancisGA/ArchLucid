# IH-009 — Inventory: room elicitation is still a presenter route
...
Inventory R4 room (yes / no / another question) that exists only on presenter/demo overlays, not on the inhabited architecture.

## Why

Liability stance is conference-room mediation. The SPA is still an inspector.

## Context

- Debate R4 · PC-09 · SG-033 leftover · LY-064 leftover
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. List presenter / elicitation mounts. Note whether they require leaving the architecture findings document.
2. No avatars. No finding-comment chat.
