# AS-070 — Architect restatement does not reset support band to Supported

**Wave:** architecture-spine (**AS**). **Cluster:** semantic-honesty. **Depends on:** AS-060, LP-15.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Append-only restatement may add human judgment; scorer band stays on the **model/typed claim**, or splits: claim-band vs restatement-as-human. Do not mark Supported because a human restated.

## Why

Otherwise restatement becomes a cheat code around Unsupported.
...
1. Rules + tests.
2. UI copy if two lines are shown.
