# SG-117 — Explicit skip: re-implement daytime wait

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** out-of-wave. **Depends on:** SG-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

ADR 0096 / DW-001–024 shipped. This wave only forbids wait-copy from making review the locator (SG-070).

## Why

Issue 2 leftovers must not reverse prior bets.

## Context

- SYSTEM_GRAVITY_OUT_OF_WAVE_RESIDUALS.md (create in SG-082 or this prompt)

## What to build

1. Ensure `docs/architecture/SYSTEM_GRAVITY_OUT_OF_WAVE_RESIDUALS.md` names this skip.
2. Vitest that the residuals module lists this skip id.
3. Do not implement the forbidden feature.
