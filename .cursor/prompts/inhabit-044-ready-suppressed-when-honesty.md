# IH-044 — Ready suppressed on the inhabited document when honesty options apply

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** completeness. **Depends on:** IH-041, CG-021 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working inhabited findings/finalize Ready stays suppressed when Career honesty options apply (Simulator, missing trail, uncited hard, quiet floor unmet as already contracted).

## Why

New inhabit chrome must not reintroduce Ready.

## Context

- `career-gravity-unlabeled-ready-inventory.ts`
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Add inhabit findings/finalize call sites to the unlabeled-Ready inventory (shrink-only).
