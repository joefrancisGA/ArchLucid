# LY-115 — Ratchet: contract keeps AS-074 and 0099

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** ratchet. **Depends on:** LY-020.

Do not implement from the wave index. Implement only *What to build*.

## Goal

As075 still requires AS-074 in the contract doc. 0099 row also present.

## Why

Deleting AS-074 from the contract to “simplify” loses emit-off.
