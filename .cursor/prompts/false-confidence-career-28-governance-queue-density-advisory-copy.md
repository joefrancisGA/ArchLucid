# FC-28 — Governance Queue Density Advisory Copy

**Wave:** false-confidence-career (**FC**). **Do not fork** owners listed below unless this file names a leftover only.

## Goal

Governance findings queue density filter copy is advisory only
...
- Owners (do not re-implement): GovernanceFindingsQueueClient
