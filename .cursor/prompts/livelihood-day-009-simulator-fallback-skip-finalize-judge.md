# LY-009 — Simulator and Fallback never run the finalize judge
...
FindingSemanticSupportBandFinalizeJudgePolicy.ShouldRun is false unless StructuralExecutionMode is Real.

## Why

Rehearsal must not mint career-looking Supported chips (AS-068).
...
1. Policy tests for Simulator, Fallback, Mixed, Real+flag false.
2. FinalizeJudge skips without calling TryScoreAsync.
