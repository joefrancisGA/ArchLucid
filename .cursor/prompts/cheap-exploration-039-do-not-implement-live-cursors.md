# CE-039 — Explicit skip: live cursors

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** out-of-wave. **Depends on:** CE-007.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Cursors/occupancy forbidden. Residual: lease banner.
