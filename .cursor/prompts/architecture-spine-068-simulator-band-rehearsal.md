# AS-068 — Simulator: support band labeled rehearsal / NotScored as appropriate

**Wave:** architecture-spine (**AS**). **Cluster:** semantic-honesty. **Depends on:** AS-059, LP-06.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Simulator decision-grade must not display Supported as if Real evidence was judged. Prefer NotScored or “Rehearsal — not career support.”

## Why

Otherwise Simulator screenshots grow a green Supported chip.

## Context

- simulator-career-honesty.ts
- LP-06

## What to build

1. Presenter rules + tests.
2. Do not flip Mode default.

## Acceptance criteria

- No career-looking Supported on Simulator.
