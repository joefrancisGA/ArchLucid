# SN-034 — Ratchet: DraftRequests and Runs stay two tables

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** ratchet. **Depends on:** SN-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Vitest/C# or doc ratchet: SN wave did not merge tables. Close audit cites ADR 0068.

## Why

Cheap envelope pressure will tempt a merge.
...
1. Explicit test or acceptance line.
2. Do not add ORM entities that unify writes.
3. Compare API still run-based.
