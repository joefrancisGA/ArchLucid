# SG-065 — Golden journey pills architecture-first leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-013, SY-95 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working golden-journey pills start on architectures, not reviews hub.
