# LN-030 — C# tests: uncited hard cannot export as hard

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** ratchet. **Depends on:** LN-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Decisioning/Application tests for LN-004.
...
- CareerArtifact / feasibility tests

## What to build

1. Scoped dotnet test filter.
2. agent-compile-check if C# changed.
3. No ConfigureAwait(false) in tests.
