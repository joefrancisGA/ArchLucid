# LY-019 — Help slug: Real finalize may rescore Unchecked

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** copy. **Depends on:** LY-012.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help center slug that explains support bands mentions ADR 0099 Real finalize rescore. Simulator: rehearsal, not judged.

## Why

First-session help still quoting LN-025 as current product will mis-train the seat.
...
1. Update the existing semantic-support help topic if present; do not add a second slug.
2. Record / Practice labels.
