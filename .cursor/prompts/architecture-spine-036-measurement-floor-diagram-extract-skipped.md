# AS-036 — Measurement floor: diagram extract skipped engines/sources

**Wave:** architecture-spine (**AS**). **Cluster:** diagram-honesty. **Depends on:** AS-005, AS-016.

Do not implement from the wave index. Implement only *What to build*.

## Goal

When structured extract is skipped (pixel-only, failed parse), the measurement/stamp floor already used for skipped engines lists diagram sources as skipped — not as zero findings “all clear.” Reuse DX-15 / career measurement copy; do not invent a new score.

## Why

Silent skip looks like a clean architecture.

## Context

- DX-15 measurement floor skipped engines
- career-artifact-honesty.ts
- ADR 0078 — do not rewrite body; Related pointer OK

## What to build

1. Hook diagram skip into existing skipped-source / skipped-engine presentation.
2. Tests: pixel-only package is not “no diagram gaps.”

## Acceptance criteria

- Career artifacts mention skipped diagram extract.
