# SG-080 — Help: the system is the object leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-059, SN-032 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help article: system is the object; review is a job; Sketch a change is Practice; Record what-if is a capped full run.

## Why

Help that starts at Create review trains the pipeline.
