# LY-090 — Adversarial band named leftover
...
Adversarial/eval bands stay named. Do not let 0099 Supported replace an adversarial label.

## Why

Judge must not wash eval rows into Career Supported.
...
1. Leftover classification honesty.
