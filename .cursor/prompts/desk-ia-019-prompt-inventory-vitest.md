# DI-019 — Vitest: DI-00 index + DI-001–DI-024 files exist

**Wave:** desk-ia (livelihood UX wave 28) (**DI**). **Cluster:** close. **Depends on:** prompt-set PR.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Add `desk-ia-prompt-inventory.test.ts`.
