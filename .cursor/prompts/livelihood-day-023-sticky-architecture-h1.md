# LY-023 — Sticky architecture H1 when nested review open leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-025 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Primary chrome H1 stays the architecture display name while a nested job inspector is open.

## Why

Review title as H1 makes the inspector Monday morning.
...
1. Leftover only. Do not collapse tabs. Do not merge kernels.
