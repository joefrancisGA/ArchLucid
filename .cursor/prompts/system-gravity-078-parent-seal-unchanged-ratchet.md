# SG-078 — Parent seal unchanged by child job/envelope ratchet

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** ratchet. **Depends on:** SG-072, CE-033 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Spawning a child review or Practice envelope must not unseal or mutate the parent sealed record.

## Why

Unsealing to sketch destroys the livelihood record.
