# LY-095 — Shortcut overlay is desk-first leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-054 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Shortcut overlay lists desk verbs first.

## Why

Review-first overlay is job gravity.
