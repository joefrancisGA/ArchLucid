# LY-037 — Palette: Open architecture before Open review leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-052 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Command palette lists Open architecture before Open review on Working.

## Why

Review-first palette is job gravity.
