# DI-015 — Governance-view half-wired leftover

**Wave:** desk-ia (livelihood UX wave 28) (**DI**). **Cluster:** ia. **Depends on:** DI-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

IA-008: governance-view filter unused in live shell. Either mount the Working-safe toggle or remove dead IA (do not localStorage-only).

## Why

Dead modes are a mode-matrix problem (MG) and an IA trap.
...
1. Mount or delete unused live path; tests-only helpers documented.
2. Do not invent a new persona mode.
3. Do not hide review tabs.
