# DI-011 — Help: which reporting page answers which question
...
Help: dashboard vs scorecard vs value report. Do not merge six routes in this wave; document the map.

## Why

IA-004 overlap. Merge is deferred; livelihood needs a map now.

## Context

- ui_routes.md · IA-009 deferred

## What to build

1. Help topic.
2. No route deletion unless already redirecting.
3. Rehearsal honesty on reports (CG).
