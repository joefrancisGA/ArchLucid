# SG-031 — ITSM / advisory return to architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-016, SY-68 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

ITSM and recurrence advisory deep links from a job return to the architecture desk. ITSM remains downstream collab (CE-011). No finding-comment chat.
