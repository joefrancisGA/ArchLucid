# SG-033 — Room elicitation is architecture plus job leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-016, AO-38 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Room/presenter elicitation URLs nest under the architecture. Answers append to the asserted trail (PC-09). No avatars.
...
- AO-38 · review-room-elicitation-url.ts · PC-09
