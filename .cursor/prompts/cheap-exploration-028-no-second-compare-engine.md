# CE-028 — Ratchet: Compare engine reused, not forked

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** ratchet. **Depends on:** CE-003.

Do not implement from the wave index. Implement only *What to build*.

## Goal

R12: reuse AuthorityCompareService. CE must not add draft-compare service.

## Why

Forked compare is a new kernel.
...
1. Acceptance line.
2. Grep for a second compare service — none.
3. Committed manifests only.
