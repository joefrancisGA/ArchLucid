# SG-024 — Architecture narrative on the desk after spawn is read-only snapshot

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-016, SN-004 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

After spawn-lock, the desk shows the submitted narrative as read-only. Clone/new version remains the edit path. No second live editor.
...
- SYSTEM_NOT_JOB_DUAL_EDITOR_INVENTORY.md · ArchitectureDraftFormFields editorLocked
