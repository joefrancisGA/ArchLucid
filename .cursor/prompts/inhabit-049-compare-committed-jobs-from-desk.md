# IH-049 — Compare committed child jobs from the inhabited desk

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** exploration. **Depends on:** SG-032 leftover, CE leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Compare from the architecture (palette Alt+C) prefills committed child jobs of this system. Committed-manifest only.

## Why

Empty Compare after leaving the desk is the remaining cheap-exploration hole.

## Context

- ADR 0092 · SN-038 skip · LY-045 leftover
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Working nested Compare entry prefills this architecture’s committed reviews. No draft-to-draft Compare.
