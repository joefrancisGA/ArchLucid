# LY-041 — Inventory: draft undo is in-tab only

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** reversibility. **Depends on:** ADR 0071.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Inventory Working draft undo. It is in-tab (ADR 0071). Cross-refresh undo is a named leftover, not a 300s toast change.

## Why

Architects treat Undo like an editor; in-tab-only is a livelihood cut.
...
1. Inventory surfaces. Do not lengthen 300s toast.
2. Do not unseal.
