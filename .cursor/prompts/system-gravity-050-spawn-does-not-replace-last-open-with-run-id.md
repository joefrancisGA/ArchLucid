# SG-050 — Spawn does not replace last-open with a run id leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-016, AO-16 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

`lastOpenArchitectureId` stays the architecture identity after spawn. Do not persist last-open as a run id.
...
- AO-48 server prefs · lastOpenArchitectureId.v1
