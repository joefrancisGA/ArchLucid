# LY-071 — Uncited hard leftover stays LN

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** LN leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not re-run LN uncited-hard. If a remaining export path still exports uncited hard as Career-hard, name it and close that path only.

## Why

False-hard is the livelihood-grade no.
...
1. Leftover path only. No 40th engine.
