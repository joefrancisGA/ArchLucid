# LY-070 — Collab help: no finding chat thread

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** LY-059.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help does not promise a finding comment thread.

## Why

Chat-shaped help will be built next wave by accident.
