# IH-077 — Explicit skip: draft-to-draft Compare

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** skip. **Depends on:** LY-046 leftover, SG-082 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not implement draft-diff Compare. Compare stays committed-manifest. Sketch remains clone-from-snapshot.

## Why

Inhabit exploration (IH-047–051) is not R12 draft-diff.
...
1. Residuals row: draft-diff not shipped. IH-049 stays committed children only.
