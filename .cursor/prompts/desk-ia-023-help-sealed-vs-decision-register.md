# DI-023 — Help: sealed record vs decision register

**Wave:** desk-ia (livelihood UX wave 28) (**DI**). **Cluster:** copy. **Depends on:** DI-005.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help: sealed review record is the package; decision register is the ledger of dispositions/approvals. Both rehearsal-labeled when applicable.

## Why

Vocabulary collision is a livelihood IA failure.
...
1. Topic.
2. Aliases.
3. No “signed decision record” for the package.
