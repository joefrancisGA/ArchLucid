# IH-013 — Compat matrix: SG / LY / PC done-tests vs inhabit leaks

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** contract. **Depends on:** IH-004–IH-012.

Do not implement from the wave index. Implement only *What to build*.

## Goal

One matrix: which SG/LY/PC done-tests already pass vs which inhabit leaks remain. Prevents re-running shipped bodies.

## Why

Without a matrix, agents will paste SG-019 or LY-021 again.

## Context

- `SYSTEM_GRAVITY_ACCEPTANCE_2026-09-13.md` · `LIVELIHOOD_DAY_ACCEPTANCE_2026-09-13.md` · `PROFESSIONAL_CORE_ACCEPTANCE_2026-09-06.md`
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Write `docs/architecture/INHABIT_COMPAT_MATRIX.md` (shrink-only). Rows are IH inventories; columns are prior wave done-tests.
2. Do not mark inhabit shipped from this file.
