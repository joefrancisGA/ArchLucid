# IH-069 — Working never mounts a pipeline stepper as the product

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** dual-spine. **Depends on:** IH-027, SG-056 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Ratchet: Working production mount graph does not show a create-review-execute-finalize stepper as Home or nested findings hero.

## Why

Dual spine leaks are how inhabit dies.

## Context

- PC-04 · `production-desk-chrome.test.ts`
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Extend production-desk / inhabit ratchet to nested findings and Home. Guided stepper allowed.
