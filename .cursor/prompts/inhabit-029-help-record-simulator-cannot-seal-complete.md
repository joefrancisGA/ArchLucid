# IH-029 — Help: Record + Simulator cannot seal as complete

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** default-day. **Depends on:** IH-025, IH-014.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help answers why Record looks available but finalize/export is incomplete on Simulator. Not G-REAL-06. Not “Career blocked.”

## Why

Support will get this question every day until Real is the default (skipped).

## Context

- CG help leftover · ADR 0091
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Category-1 or inhabit help: Record door vs host Simulator vs Real provision. Next step is workspace Real when available, not a fake Ready.
2. Do not instruct operators to flip host Mode in production docs as a self-serve.
