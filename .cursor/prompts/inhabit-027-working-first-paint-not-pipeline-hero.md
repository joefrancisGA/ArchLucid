# IH-027 — Working first-paint is not a pipeline hero

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** default-day. **Depends on:** IH-012, SG-056 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working first paint (Home / empty portfolio) is the architecture desk: last-open, recents, inhabit next step. Not create-review-execute-finalize.

## Why

First paint trains muscle memory for the rest of the day.

## Context

- PC-04 · LY-039 leftover · `operator-home-primary-cta-composition`
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Working Home primary composition: inhabit desk, not pipeline stepper. Sample CTAs fail closed on live recovery.
2. Guided may keep teaching heroes.
