# LY-006 — Persist LLM finalize overlays as as099-llm-finalize-v1

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** kernel. **Depends on:** LY-005.

Do not implement from the wave index. Implement only *What to build*.

## Goal

FindingSemanticSupportBandOverlayWriter.PersistAssignedOverlaysAsync stamps as099-llm-finalize-v1 without mutating sealed finding prose.

## Why

Export/stamp must tell heuristic emit from finalize LLM.
...
1. Add ScorerVersions.As099LlmFinalizeV1. Overlay scoring accepts version override.
2. Unit test persist + score version.
3. No new SQL table.
