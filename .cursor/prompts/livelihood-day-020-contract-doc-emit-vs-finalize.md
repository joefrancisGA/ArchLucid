# LY-020 — Contract doc: emit heuristic, finalize LLM overlay

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** contract. **Depends on:** LY-002.

Do not implement from the wave index. Implement only *What to build*.

## Goal

FINDING_SEMANTIC_SUPPORT_BAND_CONTRACT.md tables list both flags, as057-v1 and as099-llm-finalize-v1, fail-open, Simulator skip.

## Why

AS-075 ratchet still requires AS-074 in the doc.
...
1. Keep AS-074 emit-off. Add 0099 row. Honesty examples: paraphrase may become Supported only after Real finalize judge.
