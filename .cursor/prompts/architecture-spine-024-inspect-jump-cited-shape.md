# AS-024 — Finding inspect jumps to the cited diagram shape

**Wave:** architecture-spine (**AS**). **Cluster:** diagram-desk. **Depends on:** AS-022, AS-025 can parallel after preview exists.

Do not implement from the wave index. Implement only *What to build*.

## Goal

On finding inspect, `diagram:` citations are links that open the diagram preview and highlight the shape. Keyboard reachable. Not a new workspace tab.

## Why

All-day: click the citation, see the box you will defend in ARB.

## Context

- Finding inspect
- ESI preview dialog
- UI accessibility baseline — citation is a link

## What to build

1. Link + highlight API on the preview.
2. Vitest: citation control exists for diagram: refs.
3. Do not add a desktop More menu or extra review tab.

## Acceptance criteria

- Inspect → shape is one action.
