# MG-008 — Pre-commit nav vs Working leftover
...
Working already bypasses pre-commit sidebar gate. Leftover: copy/tests that still describe Working as phase-0 locked. Fix docs/tests, not the bypass.

## Why

Docs that say Insights hide until finalize fight all-day use.

## Context

- use-effective-nav-committed-architecture-review.ts

## What to build

1. Doc/test alignment.
2. Guided/eval may still lock.
3. Do not hide Operate from Working.
