# SG-074 — What-if cost-cap chrome leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-073, SN-009 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Record full-run what-if still shows cost cap. Cheap envelope stays Practice-stamped. Do not remount CE runner.

## Why

Uncapped full runs make every sketch a job bill.

## Context

- SN-009 · R12 constraint 2
