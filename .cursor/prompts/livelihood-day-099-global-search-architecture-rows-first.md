# LY-099 — Global search architecture rows first leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-089 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Global search ranks architecture rows before peer reviews on Working.

## Why

Review-first search is inbox gravity.
