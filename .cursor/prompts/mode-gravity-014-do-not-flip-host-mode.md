# MG-014 — Explicit skip: host Mode default

**Wave:** mode-gravity (livelihood UX wave 27) (**MG**). **Cluster:** out-of-wave. **Depends on:** MG-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

AS-085 / CG-080. Record skip. No appsettings flip.
