# SN-025 — Graph bound to open package leftover
...
Same bind honesty for Graph idle/global.

## Why

Global graph is a peer product.

## Context

- graph idle placeholders

## What to build

1. Working idle: pick architecture / nested route.
2. CD-02 one New review — do not add sample CTA.
3. No coverage engine.
