# LY-068 — Work-lease vs execute lease leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** DR leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not confuse execute lease with work-lease. Both stay; neither becomes presence.

## Why

One lease UI that implies live viewers is leftover.
