# LY-097 — Palette new version when spawn-locked leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-081 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Palette new-version when spawn-locked does not open a second Record editor.

## Why

Second editor is SN’s defect.
