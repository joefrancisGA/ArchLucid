# LY-002 — Quote 0085 warn-not-block vs 0099 finalize judge

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** kernel-adr. **Depends on:** LY-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Document the split: 0085 still forbids blocking seal on LLM faithfulness; 0099 only turns the judge on at Real finalize.

## Why

Reviewers will collapse “judge on” into “commit gate”. The livelihood defect is honesty, not a new persist gate.
...
1. Add a short split note in FINDING_SEMANTIC_SUPPORT_BAND_CONTRACT.md (emit off / finalize on).
2. Architecture test quotes 0085 warn-not-block and 0099 default-on finalize.
3. Do not change PilotStrict hold default.
