# DW-013 — OpenAPI operations poll documented

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** contract. **Depends on:** DW-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

OpenAPI documents 202 + operation id for Career Real execute leftover paths.

## Why

Clients will keep syncing otherwise.

## Context

- API_CONTRACTS.md · TB-2072

## What to build

1. Snapshot if changed.
2. Description forbids missing progress URL.
3. Generated TS.
