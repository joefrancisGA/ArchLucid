# SG-060 — Getting-started Working examples leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-059, SY-87 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Getting-started Working examples use nested architecture URLs.
