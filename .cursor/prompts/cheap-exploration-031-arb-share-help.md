# CE-031 — Help: share a rehearsal envelope with a reviewer

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** copy. **Depends on:** CE-008.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help: RestrictToShares + rehearsal label. Colleague sees practice, not Career.

## Why

Hub-and-spoke without chat.
