# SG-048 — ArchitectureId ≠ DraftId in Working deep links leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-005, PC-07 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working deep links must not pass a draft id as `sourceArchitectureId` / architecture identity.
...
- startReviewFromArchitectureHref · AO-22
