# SG-083 — CLI prints architecture URLs leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** cli. **Depends on:** SG-012, SY-29 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working CLI open/print uses nested architecture URLs when ArchitectureId is known.
