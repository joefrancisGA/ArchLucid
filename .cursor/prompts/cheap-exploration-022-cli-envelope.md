# CE-022 — CLI sketch/envelope leftover

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** cli. **Depends on:** CE-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CLI can spawn labeled envelope with one override flag. Honesty stdout. No unlabeled Career.
