# SG-091 — OpenAPI examples use nested architecture URLs leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** contract. **Depends on:** SG-012.

Do not implement from the wave index. Implement only *What to build*.

## Goal

If OpenAPI examples include UI hrefs for Working, they use nested architecture paths. Do not invent new progress URLs.
