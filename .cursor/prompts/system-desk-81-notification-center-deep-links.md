# SY-81 — In-app notification center Working rows open the architecture

Href only. Do not change notification storage.

## Goal

Notification center click-through uses nested architecture URLs when architectureId is on the payload.

## Why

The bell menu is a daily driver. Peer run links re-home the object.

## Context

- Notification center item href helper
...
- Payload with architectureId ⇒ nested href.
