# AS-054 — Ratchet: no second Azure collector types in this wave
...
CI/docs guard: AS wave must not add a new ARM harvest client or duplicate Get-ArchLucidAzurePackage. Grep/architecture test.

## Why

Naive implementers will “just collect ARM in the review API.”

## Context

- INFRA_EVIDENCE_PLANE.md §1
- ArchitectureReviewRobustnessArchitectureTests pattern

## What to build

1. Architecture test or script listing forbidden type names.
2. Comment in AS-046 contract.

## Acceptance criteria

- Fork collector fails CI.
