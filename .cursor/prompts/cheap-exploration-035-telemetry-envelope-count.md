# CE-035 — Optional: envelope count telemetry

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** ops. **Depends on:** CE-016.

Do not implement from the wave index. Implement only *What to build*.

## Goal

If cheap, emit a counter for envelope spawns vs Career executes. Do not build a product changelog.

## Why

Without telemetry, we cannot prove all-day sketch use.
...
1. Counter if a metrics seam exists.
2. No PII.
3. Skip if no seam — document residual.
