# CE-030 — Explicit skip: unseal to sketch

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** out-of-wave. **Depends on:** CE-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Cannot unseal to edit. Clone is the path. Residual stated.

## Why

Unseal pressure from all-day use.
