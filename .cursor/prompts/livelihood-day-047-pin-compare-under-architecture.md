# LY-047 — Pin Compare under the architecture leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** reversibility. **Depends on:** SG-032 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Compare entry when an architecture is open stays under that identity.

## Why

Compare that opens as a peer product is leftover AO.
...
1. Leftover. Committed manifests only.
