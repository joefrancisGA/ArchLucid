# LN-034 — Help: extraction fidelity is auditable

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** copy. **Depends on:** LN-003.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help: extracted nodes link to sources; pixels are NotVerifiable; architects should open ESI for originals.

## Why

Users must know where error enters.

## Context

- ESI help · diagrams help AS-029

## What to build

1. Topic links.
2. No second collector.
3. No OCR default-on.
