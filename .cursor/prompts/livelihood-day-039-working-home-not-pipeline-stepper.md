# LY-039 — Working Home is not a pipeline stepper leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-056 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Home copy is not create → execute → finalize as the product.

## Why

Pipeline stepper Home is the batch tool.
