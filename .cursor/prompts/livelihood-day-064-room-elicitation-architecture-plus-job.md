# LY-064 — Room elicitation is architecture plus job leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** SG-033 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Room/handoff elicitation names architecture plus job.

## Why

Room-as-review-only is leftover AO.
...
1. Leftover. No presenter=1 revival.
