# SG-025 — Sticky architecture identity when a nested review is open leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-016, AO-34 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

While nested review-detail is open, identity chrome still names the architecture. Review name is secondary. No breadcrumb trail (TB-2090).
...
- AO-34 · nested review layout document.title
