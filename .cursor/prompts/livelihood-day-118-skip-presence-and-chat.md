# LY-118 — Explicit skip: presence and finding chat (confirm)

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** skip. **Depends on:** LY-058, LY-059.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Confirm presence and finding-comment chat remain skipped.

## Why

Collab leftovers must not become chat.
