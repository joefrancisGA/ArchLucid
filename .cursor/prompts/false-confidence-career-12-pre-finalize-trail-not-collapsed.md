# FC-12 — Pre Finalize Trail Not Collapsed

**Wave:** false-confidence-career (**FC**). **Do not fork** owners listed below unless this file names a leftover only.

## Goal

Overview transparency trail expanded by default on Working pre-finalize
...
- Owners (do not re-implement): TransparencyTrailPanel
