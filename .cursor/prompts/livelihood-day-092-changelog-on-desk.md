# LY-092 — Changelog / activity on the desk leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SY leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Activity/audit deep links keep the architecture parent.

## Why

Activity exile is job-home.
