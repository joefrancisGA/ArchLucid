# LY-026 — Document title is the architecture name leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-036 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

document.title identity on Working after spawn is the architecture name.

## Why

Browser tab that says the review id is a job locator.
...
1. Leftover. Guided may keep review titles.
