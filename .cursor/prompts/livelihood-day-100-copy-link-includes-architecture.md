# LY-100 — Copy link includes architecture leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-086 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Copy link from a nested job includes architecture when known.

## Why

Job-only links are peer URLs.
