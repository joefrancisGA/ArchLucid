# AS-072 — CI: Working decision-grade UI shows band or NotScored

**Wave:** architecture-spine (**AS**). **Cluster:** semantic-ratchet. **Depends on:** AS-061.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Component inventory/grep: findings list + inspect + stamp include the band component. New decision-grade surfaces must use the helper.

## Why

A new table will forget the chip.
...
1. Guard test listing sourceRoots.
2. Shrink-only exceptions documented.

## Acceptance criteria

- Unchip’d decision-grade Working list fails CI.
