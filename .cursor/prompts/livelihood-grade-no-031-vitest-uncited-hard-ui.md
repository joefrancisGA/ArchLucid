# LN-031 — Vitest: uncited hard UI not Career-hard

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** ratchet. **Depends on:** LN-021.

Do not implement from the wave index. Implement only *What to build*.

## Goal

UI tests for demote/withhold presentation.
...
- findings inspect tests

## What to build

1. Working Career fixture.
2. Guided not required to match.
3. No Ready on Simulator (CG).
