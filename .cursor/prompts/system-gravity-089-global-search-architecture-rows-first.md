# SG-089 — Global search architecture rows first leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-052, SY-83 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working `/` search ranks architecture rows first. Reviews are jobs of a named system.
