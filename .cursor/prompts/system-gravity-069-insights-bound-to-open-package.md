# SG-069 — Insights bound to the open architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-011, SN-024 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Ask/Graph/Search/Compare on Working require or inherit the open architecture. Peer Insights remain Guided.
