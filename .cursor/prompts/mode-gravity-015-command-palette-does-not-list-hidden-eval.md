# MG-015 — Palette does not advertise eval destinations as Working tools leftover

**Wave:** mode-gravity (livelihood UX wave 27) (**MG**). **Cluster:** ia. **Depends on:** MG-008.

Do not implement from the wave index. Implement only *What to build*.

## Goal

IA: palette listed hidden destinations. Working palette should not teach demo-only or Guided-only destinations as desk verbs.

## Why

Hidden+listed is a mode.
...
1. Filter leftover eval destinations on Working.
2. Deep links still work.
3. Do not collapse review tabs.
