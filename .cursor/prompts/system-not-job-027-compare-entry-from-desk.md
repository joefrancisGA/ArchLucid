# SN-027 — Compare entry from the open architecture

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** desk. **Depends on:** SN-014.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Compare from desk pre-fills base run from the open system’s latest Career or selected child. Leftover: Compare opens empty peer page.

## Why

Empty Compare is a peer app.
...
1. Pre-fill base.
2. Stamps visible.
3. R12 still requires committed manifests.
