# CE-027 — Vitest: CE-00 index + CE-001–CE-040 files exist

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** close. **Depends on:** prompt-set PR.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Add `cheap-exploration-prompt-inventory.test.ts`.
