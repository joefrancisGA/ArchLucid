# LY-111 — Ratchet: faithfulness validator

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** ratchet. **Depends on:** LY-007.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Unit tests for invented Supported and exact-quote demotion remain.

## Why

Prompt-only faithfulness will rot.
...
1. Decisioning.Tests faithfulness + parser.
