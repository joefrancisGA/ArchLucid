# SN-020 — No peer Start CTAs on Working Home leftover

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** copy. **Depends on:** SN-012.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Grep Working Home for two peer start products. ADR 0069 forbade them; shrink leftovers.

## Why

Home dual cards were the original evaluator pattern.

## Context

- ADR 0069 · buyer-polish-copy

## What to build

1. Grep + remove leftover dual cards on Working.
2. Guided may keep teaching two jobs.
3. Vitest.
