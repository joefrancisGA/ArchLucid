# SY-67 — Governance findings queue Open returns to architecture desk or nested job

Do not fork AO-27. Verify leftover peer `reviewDetailPath`.

## Goal

Queue row Open uses `governance-return-locator` nested hrefs.

## Why

Queue is an inbox. Open must land on the system.

## Context

- `governance-return-locator.ts`

## What to build

1. Leftover conversions + extend AO-27 tests.

## Acceptance criteria

- Return href nested when architectureId on the finding.
