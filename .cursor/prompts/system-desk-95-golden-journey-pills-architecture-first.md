# SY-95 — Golden-journey pills on Working: architecture desk before review job

Do not fork journey content. Order/hrefs.

## Goal

Working journey: Open architecture → Start review (verb) → Findings on this system. Do not lead with “Open package.”

## Why

Journey pills are teaching chrome that survived Working default.

## Context

- Golden journey components

## What to build

1. Working pill hrefs/order + test.

## Acceptance criteria

- First Working pill is not the reviews hub.
