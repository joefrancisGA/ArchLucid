# SG-072 — Desk lists child jobs and sketches leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-017, CE-015 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Architecture desk lists envelope/clone children under the system. Opening one is an inspector. Parent seal unchanged.

## Why

Child jobs that only exist inside review-detail keep the job as the object.

## Context

- CE-015 · SN-017 · cheap-exploration-envelope-runner-entry.ts
