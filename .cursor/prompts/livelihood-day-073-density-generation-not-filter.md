# LY-073 — Insight density is generation, not a support-band filter leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** AS-066 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not fuse SemanticSupportBand into DeterministicInsightDensityGate. Density generate/judge remains DX; band remains honesty.

## Why

Fusing hides semantic risk inside checklist coverage.
...
1. Reuse As066 ratchet. Do not change typed-engine-protected.
