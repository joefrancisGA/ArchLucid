# SG-053 — Palette Finalize/Save is work on the open job leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-022, LI-07 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Palette work actions (Save, Finalize when ready, dispositions) apply to the open architecture’s job. Do not add a dead Home Finalize row.
