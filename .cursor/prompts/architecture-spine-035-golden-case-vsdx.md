# AS-035 — Golden corpus case: vsdx structured topology

**Wave:** architecture-spine (**AS**). **Cluster:** diagram-golden. **Depends on:** AS-010, AS-034.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Next golden case: vsdx with two labeled shapes and a connect. Same rules as AS-034.

## Why

Visio is the enterprise drawing. Golden must not be mermaid-only.

## Context

- AS-033 fixture skills
- LatestGoldenCorpusCaseNumber after AS-034

## What to build

1. New case; bump number once.
2. R5: unlabeled extra shape does not invent a resource (AS-019).
