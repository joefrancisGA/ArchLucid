# LY-045 — Compare stays committed-manifest leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** reversibility. **Depends on:** SN-038 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Compare remains two committed manifests. Do not implement draft-to-draft Compare.

## Why

Draft-diff launders unsealed work as Record proof.
...
1. Reuse SN/CE ratchets. Residual row if needed.
