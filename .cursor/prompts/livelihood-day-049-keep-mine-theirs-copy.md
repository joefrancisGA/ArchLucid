# LY-049 — Keep mine / theirs copy leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** reversibility. **Depends on:** LW leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

409 Keep mine / theirs copy stays CAS-honest. Do not invent merge-without-CAS.

## Why

Silent overwrite is the LW defect.
...
1. Leftover copy. expectedUpdatedUtc stays.
