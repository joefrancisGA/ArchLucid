# SG-087 — Notification center deep links leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** outbound. **Depends on:** SG-016, SY-81 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Notification rows open the architecture desk or nested job, not peer Insights as Home.
