# SY-94 — Working finish-setup next step is create/open architecture, not reviews hub

Do not rewrite finish-setup required steps. Next href only.

## Goal

When finish-setup completes on Working, primary next is architectures new/portfolio.

## Why

Setup success that dumps you on reviews hub creates the wrong first bookmark.

## Context

- Finish-setup completion CTA
...
- Completion CTA is not `REVIEWS_LIST_PATH`.
