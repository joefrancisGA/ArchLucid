# DI-008 — Architecture drafts list reachable leftover

**Wave:** desk-ia (livelihood UX wave 28) (**DI**). **Cluster:** ia. **Depends on:** SN-029.

Do not implement from the wave index. Implement only *What to build*.

## Goal

If SN-029 landed, confirm nav. If not, implement Working portfolio/desk drafts list. IA-002.
...
1. Reachable from nav or desk.
2. Save and exit resume.
3. Do not start a new draft as the only path.
