# LN-039 — Support triage: false-hard vs soft

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** ops. **Depends on:** LN-024.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Support runbook one-liner: uncited hard is a defect; soft envelope is expected. Correlation id still primary.

## Why

On-call will see angry architects.

## Context

- FIRST_PILOT_SUPPORT_TRIAGE

## What to build

1. Runbook bullet.
2. No new PII in logs.
3. Stamp/door from CG-092.
