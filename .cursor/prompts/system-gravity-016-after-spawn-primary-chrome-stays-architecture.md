# SG-016 — After spawn, Working primary chrome stays architecture identity

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-001, SG-008.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working H1, eyebrow, last-open, and restore stay the architecture display name after spawn. Review title is a job subtitle, not the shell identity.
...
- RunDetailWorkspaceChrome.tsx · working-architecture-document-title.ts · ArchitectureDraftHandoffPanel
