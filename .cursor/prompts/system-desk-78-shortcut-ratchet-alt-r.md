# SY-78 — Vitest ratchet: Working Alt+R resolver never returns `REVIEWS_LIST_PATH`

Depends on SY-07. Permanent guard.

## Goal

Contract test in `working-monday-object-contract` / shortcut tests.

## Why

Alt+R is the regression that would most quickly restore job-as-Home.

## Context

- shortcut resolver from SY-07

## What to build

1. Dedicated test file `working-alt-r-is-not-inbox-guard.test.ts`.

## Acceptance criteria

- Hardcoding alt+r to reviews list fails CI.
