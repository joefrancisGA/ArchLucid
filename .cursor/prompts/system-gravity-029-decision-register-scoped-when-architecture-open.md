# SG-029 — Decision register scoped when architecture open leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-017, SY-69 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

With an architecture open, decision register rows default to this system’s jobs. Unscoped register remains a Governance inventory, not Home.
...
- SY-69 · DI decision register cross-link
