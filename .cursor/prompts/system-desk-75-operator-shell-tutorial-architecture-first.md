# SY-75 — Operator shell tutorial Working chapter starts at the architecture desk

Docs in `archlucid-ui/docs/OPERATOR_SHELL_TUTORIAL.md`. Do not rewrite the whole tutorial.

## Goal

Working path: open Architectures → desk → start review as a verb. Reviews hub is Inbox. Update shortcut section to match SY-07–11.

## Why

Internal tutorial is what support and SE repeat to customers.
...
1. Working chapter edits.
2. No code required.

## Acceptance criteria

- Tutorial Working sequence does not start at `/architecture/reviews`.
