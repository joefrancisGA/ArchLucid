# SG-017 — Child reviews table is the job list leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-016, AO-23 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Architecture desk lists child reviews/drafts/sketches as the day’s job queue. Opening a row opens the inspector; closing returns to the desk.
...
- AO-23 · SN-017 · architecture desk children table
