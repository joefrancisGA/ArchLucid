# DW-019 — Operations poll tenant isolation leftover

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** security. **Depends on:** DW-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

TB-2073: poll endpoints enforce tenant/workspace. Leftover tests if a new client path.

## Why

Job GUID obscurity is not isolation.
...
1. Tests 404/403 cross-tenant.
2. No RLS.
3. No new public exposure.
