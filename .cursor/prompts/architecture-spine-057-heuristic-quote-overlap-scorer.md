# AS-057 — Heuristic quote-overlap support scorer (no LLM)

**Wave:** architecture-spine (**AS**). **Cluster:** semantic-score. **Depends on:** AS-056, AS-022.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Deterministic scorer: finding Message vs cited doc:/diagram:/ARM excerpt. Overlap / unsupported span → band. Empty citations stay a provenance problem (0082), not this scorer. Do not call Azure OpenAI.

## Why

Lane A-adjacent heuristic is the only sync-safe signal. It will miss paraphrase; that is OK — Unchecked.

## Context

- AgentResultEvidenceFaithfulnessChecker (reuse if applicable)
- TB-1228 Lane A

## What to build

1. Pure function + tests: exact quote Supported; disjoint nouns Unsupported; paraphrase Unchecked.
2. Do not use embeddings in this prompt.
