# LY-114 — Ratchet: prompt pack forbids seal language

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** ratchet. **Depends on:** LY-015.

Do not implement from the wave index. Implement only *What to build*.

## Goal

PremiumFindingSemanticSupportBandLlmJudgeTests asserts SystemPrompt forbids invented citations and prefers Unchecked when unsure.

## Why

Prompt drift will invent Supported.
