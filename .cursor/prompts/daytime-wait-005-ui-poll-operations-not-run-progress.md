# DW-005 — UI polls operations, not missing run progress

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** ui. **Depends on:** DW-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working progress tracker polls operations / SSE. Leftover clients calling missing progress URL removed.

## Why

AGENTS.md already forbids the missing URL. Leftover callers still exist possibly.

## Context

- use-run-progress-tracker · LONG_RUNNING_OPERATIONS_CONTRACT

## What to build

1. Grep progress URL.
2. Switch to operations.
3. HeartbeatUtc / stepLabel, not fake %.
