# SG-088 — Recents widget is architectures leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-040, SY-84 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working recents are architectures (with job chips), not a run list as Home.
