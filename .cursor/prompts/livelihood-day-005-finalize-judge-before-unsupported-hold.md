# LY-005 — Call finalize judge before Unsupported hold

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** kernel. **Depends on:** LY-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CommitOutputIntegrityService and FinalizeReadinessService call IFindingSemanticSupportBandFinalizeJudge.ApplyAsync before UnsupportedSemanticSupportFinalizeHoldEvaluator.

## Why

PilotStrict hold must see LLM-rescored bands, not stale Unchecked.
...
1. Wire both call sites. Update FinalizeReadinessServiceTests CreateSut.
2. Architecture test: judge call precedes hold evaluator.
3. Do not make the judge itself throw ConflictException.
