...
**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** ADR 0090 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Work-lease remains the collab primitive. No live presence.

## Why

Lease-without-honesty looks broken; presence is still forbidden.
...
1. Leftover copy/help. No avatars.
