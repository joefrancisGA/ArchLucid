# SG-059 — Help: Monday object is the architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-013, AO-42 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

In-app help for Working says the system is the object; review is a job. No GitHub blob links.
