# SN-012 — Portfolio resume is last-open architecture

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** desk. **Depends on:** SN-010.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Home/portfolio resume last-open architecture desk (AO/SY). Leftover: resume that opens a review job when ArchitectureId is known.

## Why

Resume is muscle memory.

## Context

- last-open · Home resume CD-11

## What to build

1. Resume href resolver leftover.
2. Tests.
3. Do not restore two peer start CTAs.
