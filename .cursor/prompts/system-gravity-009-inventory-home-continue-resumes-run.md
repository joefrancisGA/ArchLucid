# SG-009 — Inventory Home/continue that resume a run not an architecture
...
Produce `docs/architecture/SYSTEM_GRAVITY_HOME_RESUME_INVENTORY.md`: Continue last, unfinished work, recents, and overview that prefer a run id over last-open architecture. Shrink-only. Do not mutate copy yet (SG-016+).
...
- resolve-continue-last-review-package · reviews-hub-unfinished-work-href · system-not-job-portfolio-resume-href.ts

## What to build

1. Grep Working UI/docs for the leak class. Write `SYSTEM_GRAVITY_HOME_RESUME_INVENTORY.md` with path, string/call, whether AO/SY/SN already covers it, leak class.
