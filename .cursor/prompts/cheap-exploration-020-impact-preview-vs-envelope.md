# CE-020 — Help: impact preview vs architecture envelope

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** copy. **Depends on:** SN-007, CE-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Policy what-if (impact preview) vs architecture envelope (clone+compare). Both labeled. Neither is production observation.

## Why

Two what-ifs without a sentence.
