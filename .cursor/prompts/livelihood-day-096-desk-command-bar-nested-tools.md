# LY-096 — Desk command bar for nested tools leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-055 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Nested tools stay tools on the desk command bar, not a second app chrome.

## Why

Tool chrome that replaces H1 is leftover SY.
