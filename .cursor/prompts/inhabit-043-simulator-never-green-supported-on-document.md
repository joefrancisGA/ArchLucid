# IH-043 — Simulator never shows Career Supported on the findings document

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** completeness. **Depends on:** IH-042, AS-068 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Simulator (and Practice) findings document cannot show green Career Supported. Honesty before export.

## Why

LY-087 named export. The document can still look judged.

## Context

- AS-068 · LY-087 leftover · CG watermarks
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Ratchet: Simulator/Practice findings rows do not use Career Supported styling/copy. Unchecked/NotScored/rehearsal labels allowed.
