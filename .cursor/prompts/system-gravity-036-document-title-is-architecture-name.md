# SG-036 — Document title is the architecture name leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-016, SY-61 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Browser tab title uses architecture display name (optional ` · Review` suffix). Do not title the tab as a raw run id.
...
- working-architecture-document-title.ts · SY-85
