# LY-038 — Palette Finalize/Save is work on the open job leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-053 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Palette Finalize/Save verbs the open child job, then returns to the desk (LY-022).

## Why

Palette Finalize that navigates to governance Home is leftover.
