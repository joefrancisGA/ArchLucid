# DW-003 — Working never “stay on this page until finalize” leftover

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** chrome. **Depends on:** DW-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CD-13 already unmounts first-week. Grep remaining stay-on-this-page copy on Working.

## Why

First-week theater is the opposite of all-day.
...
1. Grep.
2. Working evalChrome false keeps it off.
3. Guided may keep teaching.
