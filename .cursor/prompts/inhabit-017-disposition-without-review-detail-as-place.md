# IH-017 — Disposition without treating review-detail as the place

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** document. **Depends on:** IH-016.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Accept / remediate / reject / N/A from the inhabited findings document. Do not require opening review Overview as the place you live.

## Why

SG-020 nested disposition. Remaining exile is inhabit leakage.

## Context

- SG-020 leftover · LY-021 leftover · ADR 0076 finding CAS
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Working architecture-scoped findings support disposition + 409 CAS without navigating to review Overview as Home.
2. Inspect may open a panel (IH-020). Full strip if the operator opens the inspector.
