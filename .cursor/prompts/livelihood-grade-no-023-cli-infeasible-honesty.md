# LN-023 — CLI infeasible honesty

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** cli. **Depends on:** LN-014.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CLI infeasible output distinguishes hard/soft and refuses unlabeled hard.

## Why

CLI is the other packet.
...
1. stdout + json.
2. Exit codes not claiming Career-complete on soft/hard miss.
3. CG door still applies.
