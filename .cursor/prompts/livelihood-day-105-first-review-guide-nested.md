# LY-105 — First-review guide nested leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-045 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

First-review guide is nested under the architecture when known.

## Why

Guide that is a peer tour of review-detail as Home is leftover SY.
...
1. Leftover. Guided may keep eval tour.
