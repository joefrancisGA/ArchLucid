# SY-52 — Working reviews hub title/helper say Inbox of jobs across architectures

Do not fork AO-26 if already shipped; verify leftovers in header/copy resolver.

## Goal

Page title, helper, and empty CTA: Inbox. Primary empty: open Architectures. Architecture name column links to desk.

## Why

If the hub still titles itself like Home, Alt+R remap is not enough.

## Context

- `reviews-hub-page-copy-resolver.ts`
- `ReviewsHubPageHeader.tsx`

## What to build

1. Copy leftovers + Vitest (AO-26 marker file).

## Acceptance criteria

- Working hub helper includes inbox language.
