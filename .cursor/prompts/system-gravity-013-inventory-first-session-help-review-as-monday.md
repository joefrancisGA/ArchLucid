# SG-013 — Inventory first-session/help that teach review as Monday
...
Produce `docs/architecture/SYSTEM_GRAVITY_FIRST_SESSION_INVENTORY.md`: Help, CORE_PILOT, first-review guide, and onboarding that still start the Working day on a review job. Shrink-only. Do not mutate copy yet (SG-016+).
...
- CORE_PILOT.md · FIRST_PILOT_OPERATOR_PATH.md · first-review-guide-status.ts

## What to build

1. Grep Working UI/docs for the leak class. Write `SYSTEM_GRAVITY_FIRST_SESSION_INVENTORY.md` with path, string/call, whether AO/SY/SN already covers it, leak class.
