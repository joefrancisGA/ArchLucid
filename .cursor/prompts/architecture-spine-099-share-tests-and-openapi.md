# AS-099 — OpenAPI + full share API tests

**Wave:** architecture-spine (**AS**). **Cluster:** share-ratchet. **Depends on:** AS-048-style for shares; AS-087–AS-096.

Do not implement from the wave index. Implement only *What to build*.

## Goal

OpenAPI for share CRUD + restrict flag. Generated TS. API test project coverage for grant, revoke, restrict, IDOR, empty-restrict, audit.

## Why

Wire drift will ship a UI that 500s.
