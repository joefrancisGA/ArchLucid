# SY-55 — Reviews hub related-links do not call the hub Home

Copy only.

## Goal

`reviews-hub-evidence-copy.ts` Working: link to Architectures as the object; hub self-links allowed as Inbox.

## Why

Self-related-links that say “Architecture reviews” as the parent object re-home the IA.

## Context

- `reviews-hub-evidence-copy.ts`
...
- Parent object label is Architectures or Inbox, not Home.
