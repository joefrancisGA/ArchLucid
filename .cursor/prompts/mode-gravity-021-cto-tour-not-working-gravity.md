# MG-021 — CTO tour / presenter is not Working gravity

**Wave:** mode-gravity (livelihood UX wave 27) (**MG**). **Cluster:** chrome. **Depends on:** MG-006.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CTO demo / presenter flags stay eval. Working Career does not auto-enter tour.

## Why

Tour mode as default day is casual-tool gravity.

## Context

- presenter query · demo flags

## What to build

1. Confirm Working default presenter off.
2. CG-049 rehearsal in presenter.
3. No auto tour.
