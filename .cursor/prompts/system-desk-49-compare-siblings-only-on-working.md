# SY-49 — Working Compare default picker is siblings of this architecture

Do not fork AO-29 / R12 two-manifest rule. Picker default only.

## Goal

Confirm Compare nested defaults. Forbid tenant-wide “pick any two reviews” as the first Working screen when architectureId is in the path.

## Why

A tenant-wide picker is Compare-as-product.
...
1. Tighten default + Vitest.
2. Explicit “compare across architectures” remains a secondary inbox action if it already exists — not the default.

## Acceptance criteria

- Nested Compare default base/candidate share architectureId.
