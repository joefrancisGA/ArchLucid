# IH-062 — Eight-hour: teaching overlays cannot trap the inhabited day

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** keyboard. **Depends on:** WD-12 leftover, teaching chrome fail-closed.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working teaching chrome stays fail-closed. No first-run modal that captures focus for eight hours. Help is press-triggered drawers.

## Why

A livelihood seat cannot be a perpetual onboarding overlay.

## Context

- `use-teaching-chrome-visible.ts` · TB-1666 press-triggered help
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Ratchet: Working production does not mount first-session modal teaching on nested findings. Help remains the page-header drawer.
