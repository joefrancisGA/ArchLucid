# CE-023 — Vitest: cheap envelope defaults Rehearsal

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** ratchet. **Depends on:** CE-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Tests: cheap CTA stamp rehearsal; Career full-run requires confirm.
...
1. Vitest.
2. Working fixtures Career door still; envelope spawn rehearsal.
3. Guided not required.
