# LN-038 — Decision receipt for infeasible leftover

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** export. **Depends on:** LN-014.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Infeasible Career receipt includes unsat-core/envelope and citations. Not an error payload.

## Why

R13 dignified artifact.
...
1. Receipt fields.
2. Honesty gates.
3. Rehearsal incomplete if Simulator.
