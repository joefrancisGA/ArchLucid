# FC-80 — Distribution Tests No Always Promote

**Wave:** false-confidence-career (**FC**). **Do not fork** owners listed below unless this file names a leftover only.

## Goal

Decisioning distribution docs/tests do not pin always-Promote for typed engines
...
- Owners (do not re-implement): CR-01, SD-01
