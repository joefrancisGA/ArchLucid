# CE-018 — Explicit skip: finding-comment chat

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** out-of-wave. **Depends on:** CE-010.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Chat remains forbidden. Residual: dispositions + ITSM + shares.
