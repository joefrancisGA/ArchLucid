# DW-015 — Help: work continues in the background

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** copy. **Depends on:** DW-006.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working help: you can leave the review; in-flight is in the shell. Cancel is confirmed.

## Why

All-day muscle memory.
...
1. Topic.
2. Keyboard: where to find in-flight.
3. Guided may still teach wait.
