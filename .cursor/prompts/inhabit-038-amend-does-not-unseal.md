...
Ratchet: record correction / amend never unseals. Clone-from-snapshot remains the new version path for sealed parents.

## Why

The tempting livelihood fix is unseal-to-edit.

## Context

- ADR 0039 · SG-115 skip · LY-055 leftover
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Guard: amend paths do not clear GoldenManifestId or rewrite sealed bytes. Help says clone for a new version.
