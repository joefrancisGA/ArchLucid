# LY-030 — Portfolio resume is last-open architecture leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-040 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working resume is last-open architecture, not last run id as Home.

## Why

Resume-to-run retrains the job as the object.
...
1. Leftover. Do not store run id as last-open architecture.
