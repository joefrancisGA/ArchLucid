# LN-037 — Compare shows hard/soft citation delta

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** desk. **Depends on:** LN-013.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Compare Issues/feasibility sections show whether hard citations appeared/disappeared. Unlabeled hard cannot appear on a side.

## Why

Envelope is the Compare delta (R12).

## Context

- Compare issues section

## What to build

1. Delta honesty.
2. Stamps per side (CG-057).
3. No draft-diff.
