# SG-028 — Activity and audit deep links keep the architecture parent leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-025, SY-28 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Activity and audit trails opened from a job still parent to the architecture. They are meta, not the work object (SN-022 leftover).
...
- resolve-audit-trail-review-href.ts · SN-022
