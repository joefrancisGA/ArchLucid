# FC-11 — Stamp Band Trail Sections Visible

**Wave:** false-confidence-career (**FC**). **Do not fork** owners listed below unless this file names a leftover only.

## Goal

Seal/stamp band renders asserted/inferred/skipped — not collapsed
...
- Owners (do not re-implement): RunDetailOverviewTransparencyTrail
