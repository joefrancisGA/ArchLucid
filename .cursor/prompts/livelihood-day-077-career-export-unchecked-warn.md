# LY-077 — Career export Unchecked warn leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** LN/AS leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Career export still warns on Unchecked after 0099. Judge may have reduced the count; remaining Unchecked still warn.

## Why

Export that hides Unchecked after judge is a lie.
