# LY-104 — Help: the system is the object leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-080 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help first-session: architecture is Monday; review is a job.

## Why

Help that teaches pipeline as product is leftover.
