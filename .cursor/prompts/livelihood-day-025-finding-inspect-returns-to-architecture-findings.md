# LY-025 — Finding inspect returns to architecture-scoped findings leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-027 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Finding inspect back/close returns to architecture-scoped findings when ArchitectureId is known.

## Why

Inspect that exiles to the governance register is still a job product.
...
1. Leftover only. Do not add finding-comment chat.
