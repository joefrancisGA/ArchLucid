# SG-076 — Sketch CTA stays a desk verb leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-055, CE-001 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Sketch a change remains a verb on the open architecture. Do not move it to reviews hub Home. Do not remount CE-001.

## Why

Hub Sketch re-centers the job list.

## Context

- cheap-exploration-envelope-runner-entry.ts · CE-013 palette
