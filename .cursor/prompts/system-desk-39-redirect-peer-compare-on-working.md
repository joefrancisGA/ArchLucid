# SY-39 — Working peer Compare redirects to nested Compare when architecture known

Depends on SY-38. Mirror SY-37.

## Goal

Working + architecture in scope → nested Compare. Guided unchanged.

## Why

Bookmarks keep Compare peer otherwise.

## Context

- Compare insights page
- `compare-two-reviews-route.ts`

## What to build

1. Redirect helper + Vitest.

## Acceptance criteria

- Working last-open does not remain on bare Compare path.
