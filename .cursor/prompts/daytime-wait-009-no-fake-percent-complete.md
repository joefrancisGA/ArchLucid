# DW-009 — Ratchet: no fake percentComplete

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** ratchet. **Depends on:** DW-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Contract: percentComplete not authoritative. Working UI must not invent a smooth 0–100 on Real.

## Why

Fake % is casual-tool gravity.
