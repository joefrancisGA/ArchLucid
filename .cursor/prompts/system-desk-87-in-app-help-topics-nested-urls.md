# SY-87 — In-app `/help` Working examples use architecture nested URLs

Do not dump GitHub blob links (product docs rule). Help content only.

## Goal

Working help examples: `/architecture/architectures/{id}` as the object. Jobs shown nested. Inbox mentioned as Inbox.

## Why

Help examples are copy-pasted by operators.

## Context

- Product documentation registry Working articles

## What to build

1. Example href strings + optional guard grep.

## Acceptance criteria

- Working getting-started examples do not use peer review URLs as Home.
