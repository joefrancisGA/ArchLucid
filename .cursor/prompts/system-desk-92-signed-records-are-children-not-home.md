# SY-92 — Sealed records list is not Working Home; open lands on architecture + child row

Do not fork AO-25 / PC-12. Leftover Home competition.

## Goal

Working signed-records index: child of architectures. Row open → desk focused on that seal, not a peer manifest island as Home.

## Why

The sealed record is career-critical and will be mistaken for the daily object.

## Context

- Signed records list path
- Working Start/Home

## What to build

1. Confirm Start/Home do not target signed-records.
2. Row href nested/desk.
3. Vitest.

## Acceptance criteria

- Working Start is still architecture, not signed-records list.
