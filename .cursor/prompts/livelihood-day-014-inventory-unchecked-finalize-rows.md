# LY-014 — Inventory Unchecked decision-grade rows at finalize

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** inventory. **Depends on:** LY-005.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Inventory which Working Career Real finalize surfaces show Unchecked so the judge pass has a named input set.

## Why

Judging checklist coverage or empty citations wastes spend and mints noise.
...
1. Only decision-grade rows with citations. Empty refs stay NotScored/provenance (0082).
2. Do not judge checklist coverage.
