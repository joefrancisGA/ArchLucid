# SN-024 — Ask bound to open package leftover
...
Working Ask without architectureId must not implied-global Career Q&A. Bind or empty-state: pick a system.

## Why

Unscoped Ask is a peer product.

## Context

- SY Ask bind · ADR 0079

## What to build

1. Empty state.
2. Redirect when id known.
3. Guided peer Ask stays.
