# SG-109 — CLI archlucid open architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** ratchet. **Depends on:** SG-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CLI help: open the architecture, not the last run, on Working.
