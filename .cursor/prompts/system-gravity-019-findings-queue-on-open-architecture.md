# SG-019 — Findings queue on the open architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-007, SY-43 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working nested `/architectures/{id}/findings` is the default findings instrument when an architecture is open. Review-detail Findings tab remains in the full strip as the same job, not a second app.
...
- architectureNestedFindingsPath · GovernanceFindingsQueueClient
