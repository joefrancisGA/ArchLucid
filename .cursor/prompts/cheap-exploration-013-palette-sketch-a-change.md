# CE-013 — Palette: Sketch a change
...
Palette work action when an architecture is open. Hidden on Guided if eval should not pay for branches — document either way.
