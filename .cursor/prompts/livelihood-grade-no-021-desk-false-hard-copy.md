# LN-021 — Desk copy for demoted hard→soft

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** desk. **Depends on:** LN-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

When a finding is demoted hard→soft, Working shows why (missing citation), not a silent band change.

## Why

Silent demotion looks like the product is inconsistent.
...
1. Inspect honesty line.
2. Do not use toast as the only message (TB-2005).
3. Keyboard inspect still works.
