# LY-054 — Practice clone undo honesty leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** reversibility. **Depends on:** CE leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Undoing a Practice clone does not unspawn a Record job.

## Why

Clone/undo confusion is kernel-merge gravity.
