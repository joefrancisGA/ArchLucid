# SG-035 — Second window restore to architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-016, SY-63 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Restore / last-open for a second window returns to the architecture desk (or nested job under it), never a peer review as Home.
...
- SY-63 · sessionStorage leftovers named in CR wave
