# IH-058 — Concurrent disposition 409 honesty (no presence)

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** room. **Depends on:** IH-037, LY-060 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working 409 on finding mutate explains another operator updated this finding — not “you’re both here.” Next step Keep mine/theirs.

## Why

Presence is skipped. Honesty still required.
...
1. 409 copy: conflict, not presence. Link to lease/CAS help. No live cursors help text implying avatars exist.
