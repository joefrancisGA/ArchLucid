# SG-034 — Share from a nested job includes the architecture URL leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-012, SY-20 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Copy link / share from nested review uses the nested architecture URL when parent is known. Unlinked reviews stay honest peer URLs.
