# SY-72 — Working onboarding / first-review chrome never names the reviews hub as Home

Do not delete Guided onboarding. Working-only strings.

## Goal

Finish setup / first-review Working copy: portfolio + desk. Hub mentioned only as Inbox.

## Why

Day-one copy outlives URL fixes.

## Context

- First-review guide copy
- Finish-setup Working strings

## What to build

1. String guard tests.

## Acceptance criteria

- Working onboarding fixtures do not use “Open packages” as Home.
