# IH-050 — Last Practice sketch listed next to the current job

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** exploration. **Depends on:** IH-047.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working desk/findings lists the latest Practice sketch sibling next to the current child job so exploration stays in the inhabit chrome.

## Why

Sketches that disappear into the inbox are second-class.

## Context

- CE rehearsal default · child reviews table SG-017 leftover
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Child job list on the architecture shows current job + latest sketch with Practice stamp. Not a second Start CTA.
