# LY-059 — Explicit skip: finding-comment chat

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** skip. **Depends on:** LY-056.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not invent finding-comment chat. Record skip.

## Why

Standing forbid. Disposition + trail remain.
