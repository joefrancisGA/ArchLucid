# LN-032 — Vitest: LN-00 index + LN-001–LN-040 files exist

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** close. **Depends on:** prompt-set PR.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Add `livelihood-grade-no-prompt-inventory.test.ts`.
