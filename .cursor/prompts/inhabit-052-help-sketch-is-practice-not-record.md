# IH-052 — Help: Sketch is Practice, not Record

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** exploration. **Depends on:** IH-047, CE leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help/on-desk copy: Sketch a change is Practice (rehearsal), not a Career record. Career what-if stays the full R12 path.

## Why

A sketch that looks like Record is false confidence.
...
1. Inhabit help and Sketch confirm copy: Practice watermark. Do not seal a sketch as Record.
