# IH-080 — Close audit: inhabit wave 34

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** close. **Depends on:** IH-079.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Write `docs/architecture/INHABIT_ACCEPTANCE_2026-09-13.md` listing ADR 0100 Proposed, which prompts shipped in the prompt-set PR vs remaining paste-ready bodies. Do not claim G-REAL-06. Do not claim findings-document landing shipped until IH-015 tests exist.

## Why

Without a close audit the next wave will re-run 001.

## Context

- INHABIT_COMPOSER_PROMPTS.md
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Acceptance table: contract (ADR + inventories + skips) vs product leftovers still open.
2. Link ADR 0100. No desktop More. No 40th engine.
