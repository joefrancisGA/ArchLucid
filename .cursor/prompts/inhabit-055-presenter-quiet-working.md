# IH-055 — Presenter is quiet on Working (not a second product)

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** room. **Depends on:** PT-15 leftover, WA leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working presenter/quiet mode is a density switch on the inhabited architecture, not a demo walkthrough product and not CTO-demo overlay as Home.

## Why

Conference-room is inhabit at projector DPI, not a second spine.

## Context

- PT-15 · WA-22 leftover · buyer cto-demo copy
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Working presenter quiet hides teaching chrome and keeps findings document + room card. Demo/trial may keep walkthrough.
2. Do not route Working presenter to `/demo`.
