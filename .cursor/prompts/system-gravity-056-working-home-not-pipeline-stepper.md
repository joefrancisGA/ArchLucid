# SG-056 — Working Home is not a pipeline stepper leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-010.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Home/overview is a portfolio/desk, not a 4-step intake→execute→finalize wizard.
