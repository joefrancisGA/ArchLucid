# LY-027 — Empty desk: Start review from this system leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-037 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Empty architecture empty-state CTA starts a job of this system, not a peer review.

## Why

Peer Start on Working is still eval chrome.
