# LY-032 — Continue-last-review nested under architecture leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-043 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Continue last review is nested under the open architecture when known.

## Why

Continue that routes to a peer /reviews/{id} as Home is leftover SN/SY.
