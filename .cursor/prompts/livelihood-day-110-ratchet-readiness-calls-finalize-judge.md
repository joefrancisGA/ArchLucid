# LY-110 — Ratchet: readiness calls finalize judge

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** ratchet. **Depends on:** LY-005.

Do not implement from the wave index. Implement only *What to build*.

## Goal

FinalizeReadinessService ApplyAsync after LoadFindingsAsync.

## Why

Readiness that does not rescore will disagree with commit.
