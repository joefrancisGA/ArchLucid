# SN-023 — Findings are a desk verb, not a peer risk app
...
Working Alt+G already nested findings. Leftover: governance risk register still feeling like the daily findings home. Copy: register is cross-architecture; desk findings are this system.

## Why

Two findings homes recreate job IA.
...
1. Copy on governance findings vs nested findings.
2. Do not merge routes.
3. Do not collapse tabs.
