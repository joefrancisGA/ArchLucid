# IH-076 — Explicit skip: G-REAL-06

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** skip. **Depends on:** LN-026 leftover, LY-116 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not implement G-REAL-06 or flip host `AgentExecution:Mode` to Real. Record the skip in inhabit residuals.

## Why

Inhabit default-day honesty is not live estate packets.

## Context

- GTM G-REAL-06 · ADR 0091
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Add G-REAL-06 row to `docs/architecture/INHABIT_OUT_OF_WAVE_RESIDUALS.md`. Host default Simulator stays.
