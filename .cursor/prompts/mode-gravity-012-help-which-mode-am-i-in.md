...
**Wave:** mode-gravity (livelihood UX wave 27) (**MG**). **Cluster:** copy. **Depends on:** MG-003.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help flowchart: Working vs Guided; then Career vs Rehearsal; demo/trial are eval. No operator-experience in the customer chart.

## Why

Support questions start here.
