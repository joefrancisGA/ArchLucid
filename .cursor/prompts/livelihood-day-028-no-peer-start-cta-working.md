# LY-028 — No peer Start CTA on Working leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-038 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working does not show a Guided-style peer Start as the primary empty action.

## Why

Peer Start teaches the review as the product.
...
1. Leftover. Guided may keep peer Start.
