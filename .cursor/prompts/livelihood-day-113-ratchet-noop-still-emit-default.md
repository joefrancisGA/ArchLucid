# LY-113 — Ratchet: NoOp still emit default

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** ratchet. **Depends on:** LY-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

ServiceCollectionExtensions.Decisioning still TryAddSingleton NoOp.

## Why

Removing NoOp would LLM-tax every host including tests/Simulator unless composition replaces it.
