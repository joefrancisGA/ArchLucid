# SN-039 — Explicit skip: live presence
...
Concurrent desk is LW-089 lease, not this wave. Do not add avatars.

## Why

Issue 7 collab is not presence.
...
1. Residual: run LW lease if not shipped.
2. No UI occupancy.
3. Collab strip remains history.
