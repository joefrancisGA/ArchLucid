# SG-054 — Shortcut overlay is desk-first leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-051, SY-13 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Shift+? overlay on Working lists architecture-desk shortcuts before inbox. KEYBOARD_SHORTCUTS.md must match.
...
- KeyboardShortcutProvider · archlucid-ui/docs/KEYBOARD_SHORTCUTS.md
