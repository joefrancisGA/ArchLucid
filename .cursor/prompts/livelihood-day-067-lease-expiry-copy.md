# LY-067 — Lease expiry copy leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** LY-056.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Lease expiry copy tells the architect the write is blocked, not that collaborators vanished.

## Why

Vanished-collaborator copy is presence.
