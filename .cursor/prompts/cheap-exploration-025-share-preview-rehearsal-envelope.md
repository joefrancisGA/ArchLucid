# CE-025 — Shared envelope preview is rehearsal

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** collab. **Depends on:** CE-008, CG-039.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Share preview of envelope runs uses rehearsal preview (CG-039).

## Why

ARB sees the preview first.
...
1. Preview copy.
2. RestrictToShares 404/403 unchanged.
3. No presence.
