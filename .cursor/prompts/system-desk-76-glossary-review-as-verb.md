# SY-76 — Glossary / CONCEPT_VOCABULARY: Working review is a job verb

Do not fork TB-645 sealed-record terms. Add Working vs Guided note.

## Goal

`docs/library/GLOSSARY.md` and `CONCEPT_VOCABULARY.md`: architecture = durable system; review = governed job; inbox = cross-architecture jobs. Reject “the review is the workspace.”

## Why

Vocabulary docs are cited in PR review. They still describe the pipeline object.
...
1. Short Working notes + reject list row.

## Acceptance criteria

- Glossary does not define Working Home as the reviews hub.
