# FC-43 — Sponsor Pdf Execution Mode Banner

**Wave:** false-confidence-career (**FC**). **Do not fork** owners listed below unless this file names a leftover only.

## Goal

Sponsor PDF shows Real/Simulator/Mixed banner — blocks HOLD external
...
- Owners (do not re-implement): EmailRunToSponsorBanner, PILOT_MISCONFIGURATION
