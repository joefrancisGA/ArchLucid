# LY-011 — CONFIGURATION_REFERENCE + catalog for finalize flag
...
Add ArchLucid:Findings:SemanticSupportBand:EnableLlmJudge and EnableLlmJudgeOnFinalize to ConfigurationKeyCatalog and CONFIGURATION_REFERENCE.md.

## Why

Operators cannot opt out of spend if the key is invisible.
...
1. Catalog + reference backticks (ConfigurationKeyCatalogTests).
2. Defaults: emit false, finalize true.
