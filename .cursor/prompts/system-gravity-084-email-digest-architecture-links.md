# SG-084 — Email digest links architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** outbound. **Depends on:** SG-012, SY-30 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Digest and notification emails nest review links under the architecture when known.
