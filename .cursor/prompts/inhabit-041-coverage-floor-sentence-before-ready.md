# IH-041 — Coverage floor sentence before any Ready chrome

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** completeness. **Depends on:** IH-040.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working must not show Ready on findings/finalize chrome unless the measurement floor sentence is co-visible or Ready is suppressed by honesty gates.

## Why

Ready without floor is a livelihood lie.

## Context

- CG unlabeled Ready inventory · `shouldSuppressReadyToFinalizeForCareerHonesty`
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Ratchet: Working Ready on inhabited findings/finalize is absent or adjacent to floor/honesty copy.
2. Simulator Career already suppresses Ready — keep that; extend to quiet-engine chrome.
