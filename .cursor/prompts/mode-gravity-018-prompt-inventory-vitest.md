# MG-018 — Vitest: MG-00 index + MG-001–MG-024 files exist

**Wave:** mode-gravity (livelihood UX wave 27) (**MG**). **Cluster:** close. **Depends on:** prompt-set PR.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Add `mode-gravity-prompt-inventory.test.ts` for 24 files.
...
- lost-write-prompt-inventory.test.ts
