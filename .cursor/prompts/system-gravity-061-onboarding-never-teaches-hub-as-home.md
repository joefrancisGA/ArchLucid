# SG-061 — Onboarding never teaches the reviews hub as Working Home leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-039, SY-72 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Onboarding / finish-setup Working does not teach `/architecture/reviews` as Home.
