# CE-026 — KEYBOARD_SHORTCUTS.md envelope leftover

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** copy. **Depends on:** CE-014.

Do not implement from the wave index. Implement only *What to build*.

## Goal

If CE-014 added a combo, update KEYBOARD_SHORTCUTS.md and overlay. PT-09 leftover pattern: docs must not lie.

## Why

Lying shortcut docs are professional-tool failure.
...
1. Doc table.
2. Overlay list.
3. Tests if registry documented.
