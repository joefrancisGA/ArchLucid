# LY-063 — Share from nested job includes architecture leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** SG-034 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Share URLs from a nested job include the architecture identity when known.

## Why

Job-only share URLs are peer-review gravity.
...
1. Leftover. RestrictToShares (0087) unchanged.
