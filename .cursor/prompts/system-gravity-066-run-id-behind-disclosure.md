# SG-066 — Run IDs stay behind disclosure on Working leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-016, SN-021 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Run ids remain disclosure metadata on Working. Architecture name is the identity.
