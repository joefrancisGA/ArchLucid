# SN-030 — In-flight reviews show on the architecture desk
...
Desk shows in-flight child reviews with background wait (PC-08). Not a “stay on this page” hero.

## Why

Job wait as a separate app is issue 8; this is object continuity.

## Context

- PC-08 · first-week unmount CD-13

## What to build

1. Child row: in-flight + link.
2. Cancel confirm is AD-02 leftover — do not skip confirm.
3. Do not own the tab.
