# DI-005 — Cross-link decision register ↔ sealed records
...
Decision register and sealed list state their relationship. Neither claims to be the other.

## Why

Two ledgers without a sentence is IA clutter.
...
1. One sentence + links both ways.
2. Stamps/rehearsal chips.
