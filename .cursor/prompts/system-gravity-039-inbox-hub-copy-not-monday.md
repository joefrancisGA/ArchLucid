# SG-039 — Reviews hub copy is inbox, not Monday leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-009, SN-011 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working `/architecture/reviews` copy stays inbox. Alt+R must not own it (0079).
