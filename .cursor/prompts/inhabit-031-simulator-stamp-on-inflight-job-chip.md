# IH-031 — In-flight job chip shows Simulator/Practice stamp, not Ready

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** default-day. **Depends on:** IH-025, DW leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working in-flight chip on the inhabited desk shows door + Mode honesty (Practice and/or Simulator). Never Ready while honesty gates apply.

## Why

Wait is backgrounded (0096). The chip can still look Career-complete.

## Context

- ADR 0096 · CG unlabeled Ready inventory
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. In-flight chip copy uses Record/Practice and Simulator honesty. No percentComplete. No stay-on-this-page.
2. Do not invent progress URL.
