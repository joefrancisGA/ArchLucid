# CE-002 — Envelope cost before spawn leftover
...
If SN-009 landed, wire it on the CE CTA. Confirm dialog names GPU/time cap. Over cap disabled (TB-2005).

## Why

All-day branching without a cap is R12 constraint 2 failure.
...
1. Confirm UI.
2. Cap source documented (config).
3. Do not silent-bill.
