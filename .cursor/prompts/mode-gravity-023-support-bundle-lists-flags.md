...
**Wave:** mode-gravity (livelihood UX wave 27) (**MG**). **Cluster:** ops. **Depends on:** MG-002.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Support bundle includes workspaceMode, door stamp, host Mode, demo flags. On-call can see which skin without assuming Career.

## Why

Eight flags without a dump is unsupportable.

## Context

- CG-092 · support bundle

## What to build

1. Fields list.
2. No PII beyond existing.
3. Runbook one-liner.
