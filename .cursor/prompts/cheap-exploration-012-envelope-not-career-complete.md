# CE-012 — Envelope complete ≠ Career-complete

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** honesty. **Depends on:** CE-004, CG-030.

Do not implement from the wave index. Implement only *What to build*.

## Goal

When cheap envelope finishes, NBA is Compare, not Finalize Career. Ready suppressed (CG).

## Why

Sketch complete as Ready is issue 1 again.
