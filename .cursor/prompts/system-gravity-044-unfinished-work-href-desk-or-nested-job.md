# SG-044 — Unfinished-work href is desk or nested job leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-009, SY-54 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Unfinished-work from inbox/overview points at the architecture desk or nested job, never peer Insights.
