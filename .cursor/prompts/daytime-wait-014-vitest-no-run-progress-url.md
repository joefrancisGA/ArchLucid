# DW-014 — Vitest/grep: no GET /v1/runs/{id}/progress

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** ratchet. **Depends on:** DW-005.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Grep ratchet in UI/API docs/code for the forbidden URL as a live caller.

## Why

Contract non-claim must stay true.
...
1. Grep test or script.
2. Comments/docs that say it does not exist are OK.
3. Fail on fetch callers.
