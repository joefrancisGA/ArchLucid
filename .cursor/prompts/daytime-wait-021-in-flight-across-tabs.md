# DW-021 — In-flight visible in sibling tabs leftover

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** ui. **Depends on:** DW-006, LW-083.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Sibling tab can see in-flight (not presence). Reuse broadcast if LW shipped. Do not invent occupancy of other users.
...
1. Same-user tab refresh.
2. No avatars.
3. Auth-cleared stops writes (LW).
