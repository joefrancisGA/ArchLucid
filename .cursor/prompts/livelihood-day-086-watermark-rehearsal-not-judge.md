# LY-086 — Rehearsal watermark is not a judged Record leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** CG leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Practice/Simulator watermark stays. Finalize judge does not run; do not imply it did.

## Why

Watermark + Supported chip is CG’s defect.
