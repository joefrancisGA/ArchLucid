# AS-030 — Operator guide: .vsdx parsed; .vsd unsupported; Visio app not required

**Wave:** architecture-spine (**AS**). **Cluster:** diagram-copy. **Depends on:** AS-010, AS-029.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Edit `docs/library/customer-facing/EVIDENCE_INTAKE_OPERATOR_GUIDE.md`: prefer vsdx/draw.io/mermaid; PNG is fallback stored evidence; native .vsd not supported.

## Why

Customer-facing docs still teach the lossy path.

## Context

- EVIDENCE_INTAKE_OPERATOR_GUIDE.md
- claim-language lint if this file is in the corpus

## What to build

1. Update the diagrams/images bullets.
2. Do not promise vision OCR.

## Acceptance criteria

- Guide matches AS-010 behavior.
