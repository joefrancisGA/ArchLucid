# AS-081 — Guided/demo/trial keep Simulator teaching; ratchet Working split
...
Chooser is Working-only. Guided remains eval (ADR 0067/0080). Ratchet: Working tests mock Career/Rehearsal; Guided tests must not require the Career door.

## Why

Do not destroy the teaching seat.
...
1. Ratchet tests.
2. Update OPERATOR_UI_EXPERIENCE_MODES.md with Career/Rehearsal.

## Acceptance criteria

- Guided screenshots still teach.
