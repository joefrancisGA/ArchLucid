# FC-39 — Finding Inspect Citation Required Grade

**Wave:** false-confidence-career (**FC**). **Do not fork** owners listed below unless this file names a leftover only.

## Goal

Decision-grade inspect requires visible citation or blocks export cite
...
- Owners (do not re-implement): finding inspect
