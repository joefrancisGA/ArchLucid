# LY-091 — Keyboard work-first leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** PC leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Work-first keyboard leftovers: desk before inbox, finalize as verb. Do not steal Guided keys.

## Why

Keyboard is the all-day seat.
