# LY-087 — Simulator never shows career Supported leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** AS-068 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Simulator presentation remains NotScored / rehearsal label. 0099 does not change this.

## Why

Green Supported in Simulator is unlabeled Career.
...
1. Reuse simulator-career-honesty tests.
