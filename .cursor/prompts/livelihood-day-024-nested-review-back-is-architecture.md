# LY-024 — Nested review-detail back is the architecture leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-026 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Back from nested review-detail is the parent architecture, not Reviews hub as Home.

## Why

Hub-as-back retrains the inbox as the object.
