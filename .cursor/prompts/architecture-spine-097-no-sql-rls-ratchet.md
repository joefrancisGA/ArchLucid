# AS-097 — Ratchet: ArchitectureShares must not introduce SQL RLS
...
Architecture test: no ENABLE ROW LEVEL SECURITY on new tables. Enforcement is application + catalog (ADR 0037/0047).

## Why

RLS was explicitly rejected.
