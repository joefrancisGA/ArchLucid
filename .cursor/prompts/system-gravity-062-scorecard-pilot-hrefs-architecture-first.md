# SG-062 — Scorecard/pilot hrefs architecture-first leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-016, SY-70 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Pilot scorecard finalized hrefs nest under the architecture when known.
