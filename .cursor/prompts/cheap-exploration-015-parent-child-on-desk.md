# CE-015 — Desk lists envelope children under the architecture

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** desk. **Depends on:** SN-017, CE-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Child envelope runs appear on the architecture desk with rehearsal chips and Compare links.

## Why

Sketches that vanish into the inbox are jobs again.
...
1. Child rows.
2. Stamps.
3. Do not use reviews hub as the only list.
