# SY-85 — History entries and OS titles for nested tools include the architecture name

Companion to SY-61 for nested Ask/Compare/Graph.

## Goal

Each nested tool layout sets title `{displayName} · Ask` etc.

## Why

Task switcher across tools must still show the system.
...
1. Title helper reuse + tests.

## Acceptance criteria

- Nested Ask title includes displayName.
