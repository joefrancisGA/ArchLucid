# SN-009 — What-if cost cap chrome (R12 constraint 2)
...
Before spawning a full-pipeline what-if, Working shows cost/cap. Over-cap is blocked with honesty, not a silent extra run.

## Why

R12: each branch is billable. All-day use without a cap breaks the seat promise.

## Context

- R12 cost cap · LLM budget (not as Mode)

## What to build

1. Confirm dialog with cap.
2. TB-2005 disable when over cap.
3. Do not use budget pill as door.
