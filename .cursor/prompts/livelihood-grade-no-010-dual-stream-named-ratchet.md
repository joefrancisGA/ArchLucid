# LN-010 — Dual-stream named bands ratchet (LP-05)

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** ratchet. **Depends on:** LN-006.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Confirm LP-05: quick-decision never synthesizes findings from explanation traces. Add any remaining call-site.

## Why

Trace-as-finding is false provenance.
...
1. Grep leftover synthesis.
2. Do not delete agent stream.
3. Named bands stay.
