# IH-032 — Ratchet: do not add a third Mode chooser

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** default-day. **Depends on:** IH-028.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Explicit ratchet: Working must not grow a Simulator vs Real customer chooser. Host Mode stays an ops/honesty concern.

## Why

The obvious “fix” for IH-025 is a third dropdown. That is a new mode matrix.

## Context

- ADR 0094 · MG-014 skip
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Vitest: Working execute chrome has Record/Practice, not a customer AgentExecution Mode picker.
2. Do not implement G-REAL-06 here.
