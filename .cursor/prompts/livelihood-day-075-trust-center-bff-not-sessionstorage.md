# LY-075 — Trust-center BFF vs stale sessionStorage leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** IS/LK leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Trust-center or session-status copy that still describes sessionStorage as SoT is stale. BFF session is source of truth.

## Why

Stale GTM trust-center.md can contradict the BFF.
...
1. Docs leftover in docs/go-to-market/trust-center.md only if the stale sentence still exists. Do not invent a new session store.
