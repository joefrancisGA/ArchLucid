# LN-017 — Skipped MUST blocks finalize leftover

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** gate. **Depends on:** LN-016.

Do not implement from the wave index. Implement only *What to build*.

## Goal

ADR 0078 §2 / 0073 leftover call sites where skipped MUST still finalizes on Working Career.

## Why

Skipped MUST + Career seal is the R4 liability failure.

## Context

- AuthorityCommitSkippedMustGate

## What to build

1. Grep finalize paths.
2. Tests.
3. Rehearsal may stay incomplete rather than Career-sealed.
