# LY-040 — Working first-session copy is not pipeline leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-057 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

First-session Working copy does not teach create-review-execute-finalize as Monday.

## Why

First session is the muscle-memory teacher.
...
1. Copy leftover. Guided may keep eval phrasing.
