# SG-020 — Disposition from architecture-scoped findings without exile

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-019.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Next/previous and Alt+1–3 dispositions work on the architecture-scoped findings queue. Do not require opening peer review-detail to dispose.
...
- command-palette-handler-actions.ts · finding pointer CAS ADR 0076 · FP wave
