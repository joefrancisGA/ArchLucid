# LY-055 — Undo does not unseal leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** reversibility. **Depends on:** ADR 0039.

Do not implement from the wave index. Implement only *What to build*.

## Goal

No undo path unseals a sealed review record.

## Why

Unseal is the career-record defect.
...
1. Ratchet grep if needed. Residual: unseal forbidden.
