# LY-012 — Help: finalize judge is honesty, not seal

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** kernel. **Depends on:** LY-002.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working help for semantic support band says Real finalize may LLM-rescore Unchecked; it is not legal truth and does not block seal.

## Why

Help that still says “judge default off” will contradict 0099.
...
1. Update FINDING_SEMANTIC_SUPPORT_BAND_CONTRACT.md and any help slug that quotes AS-074 as the whole story.
2. Keep AS-074 emit-off sentence.
3. Do not claim CPA/SOC attestation.
