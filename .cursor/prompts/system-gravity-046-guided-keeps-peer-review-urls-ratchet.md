# SG-046 — Guided keeps peer review URLs ratchet

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Guided/demo/trial keep peer `/architecture/reviews/{id}` and peer Insights. Do not auto-switch Guided→Working. Do not delete Guided.
