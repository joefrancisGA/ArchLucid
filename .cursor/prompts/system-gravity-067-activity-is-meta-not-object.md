# SG-067 — Activity tab is meta, not the work object leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-028, SN-022 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Activity is a job log, not Home and not the architecture object.
