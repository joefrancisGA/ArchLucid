# SN-031 — Vitest: spawn-locked draft not writable

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** ratchet. **Depends on:** SN-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Ratchet tests for SN-004 one-writer.

## Why

Without tests, dual editors return.
...
1. Vitest spawn-locked fields.
2. C# if PATCH still allowed.
3. Do not weaken CAS (LW).
