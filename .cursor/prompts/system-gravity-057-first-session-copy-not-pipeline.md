# SG-057 — Working first-session copy is not create-review-execute-finalize leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-013.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working first-week / first-session copy starts on the named architecture. Guided may keep stay-on-this-page.
