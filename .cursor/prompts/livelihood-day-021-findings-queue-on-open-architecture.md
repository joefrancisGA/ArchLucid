# LY-021 — Findings queue on the open architecture leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** LY-001, SG-019 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Findings work stays a verb on the open architecture. Do not re-run SG-019; close remaining exile hrefs this inventory still finds.

## Why

The paying day still leaves the desk to dispose findings.
...
1. Inventory remaining /governance/findings exile when ArchitectureId is known.
2. Prefer architecture-nested findings path. Full tab strip. No More menu.
