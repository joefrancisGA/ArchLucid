# SG-075 — Impact preview vs architecture envelope leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-011, SN-007 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help/desk copy: policy impact preview ≠ architecture Sketch a change. Do not merge the two entry points.

## Why

Two envelope names teach two products.
