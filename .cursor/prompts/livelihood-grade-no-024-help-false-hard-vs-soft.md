# LN-024 — Help: hard vs soft infeasibility

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** copy. **Depends on:** LN-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help topic: hard needs a law; soft is an envelope; false-hard is the worse error. Working Career exports follow this.

## Why

Architects will argue with the product. Help must teach R5.

## Context

- ADR 0050 · in-app help

## What to build

1. Topic + aliases.
2. No GitHub blob.
3. Do not promise a theorem prover.
