# SG-095 — C#: ArchitectureId on nested review DTO when parent known
...
API/UI contract: when a run has ArchitectureId, Working nested href builders receive it. Do not add SQL RLS.
