# IH-075 — Ratchet: Record + Simulator start honesty present

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** ratchet. **Depends on:** IH-025.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Vitest: Working Record + Simulator execute/Start mounts the incompleteness readiness line (or equivalent test id).

## Why

Copy drift will restore unlabeled Record.

## Context

- IH-025 selector / copy module
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Guard the copy module from IH-025. Practice path excluded. No host Mode flip.
