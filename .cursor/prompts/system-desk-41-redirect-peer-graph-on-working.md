# SY-41 — Working peer Evidence graph redirects to nested graph when architecture known

Depends on SY-40. Mirror SY-37.

## Goal

Working redirect; Guided peer graph remains.

## Why

Same bookmark problem as Ask/Compare.

## Context

- Evidence graph insights page
...
- Working last-open does not remain on bare `EVIDENCE_GRAPH_PATH`.
