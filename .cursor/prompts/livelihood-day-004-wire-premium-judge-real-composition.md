# LY-004 — Wire Premium semantic-support judge on non-Simulator composition

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** kernel. **Depends on:** LY-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Non-Simulator agent execution composition RemoveAll+AddScoped PremiumFindingSemanticSupportBandLlmJudge. Decisioning keeps NoOp TryAddSingleton.

## Why

Without Premium on Real, the finalize flag is a no-op.
...
1. AgentExecutionCompositionModule.ExecutorWiring.cs non-Simulator branch next to density judge.
2. Architecture grep ratchet.
3. Do not register Premium in Simulator composition.
