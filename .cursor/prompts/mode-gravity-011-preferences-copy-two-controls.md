# MG-011 — Preferences page two-control copy

**Wave:** mode-gravity (livelihood UX wave 27) (**MG**). **Cluster:** copy. **Depends on:** MG-005.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Account → Preferences explains workspace mode and, on Working, the door. Not eight flags.

## Why

Preferences is where gravity is chosen.
