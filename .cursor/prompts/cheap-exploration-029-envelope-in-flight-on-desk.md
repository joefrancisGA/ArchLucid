# CE-029 — In-flight envelope on desk leftover

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** desk. **Depends on:** CE-006, SN-030.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Desk child row for in-flight envelope. Cancel confirm.

## Why

Lost sketches if only inbox shows jobs.
