# LY-061 — Second window restore to architecture leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** SG-035 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Second window restore is the architecture, not a detached review Home.

## Why

Detached second window is a second product.
