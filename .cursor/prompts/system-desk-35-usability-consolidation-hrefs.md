# SY-35 — Usability consolidation map does not treat reviews hub as Working Home

Do not redo IA assessment. Fix href constants.

## Goal

`usability-consolidation.ts` (and similar maps) Working Home / daily object = architectures list or `/`, not `REVIEWS_LIST_PATH`.

## Why

Internal maps leak into help and next-best-action.

## Context

- `archlucid-ui/src/lib/usability/usability-consolidation.ts`
...
- Map’s Working home path is not the reviews hub.
