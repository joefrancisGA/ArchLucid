# DW-018 — Explicit skip: invent run progress URL

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** out-of-wave. **Depends on:** DW-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

TB-2072 non-claim. Residual: operations API only. Do not add GET /v1/runs/{id}/progress in this wave.
...
- LONG_RUNNING_OPERATIONS_CONTRACT

## What to build

1. Residual.
2. DW-005 removes callers.
3. No new route.
