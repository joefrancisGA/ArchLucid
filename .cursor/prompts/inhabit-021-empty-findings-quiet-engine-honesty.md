# IH-021 — Empty findings state names quiet engines and in-flight, not done

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** document. **Depends on:** IH-007, IH-016.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working empty or “no decision-grade findings” states name in-flight, quiet engines, or rehearsal — never implied completeness.

## Why

An empty queue looks like a clean review. That is false confidence.

## Context

- PC-13 · FC-69 leftover · DW in-flight chip
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Empty copy on Working nested findings includes what’s intact and next step (TB-2155 pattern) plus quiet-engine / in-flight honesty.
2. Do not show Ready. Do not add engines.
