# CE-036 — Explicit skip: pay-per-what-if SKU

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** out-of-wave. **Depends on:** CE-016.

Do not implement from the wave index. Implement only *What to build*.

## Goal

ADR 0052 seat license. Residual: no new SKU.
