# IH-022 — Spawn-lock handoff: continue this system, not open the review as Home

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** document. **Depends on:** IH-015, SG-049 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working spawn-lock handoff CTA continues inhabited findings on this architecture. It does not teach “the review is now your desk.”

## Why

Handoff is a lifecycle boundary (0072). Copy can still exile.

## Context

- `ArchitectureDraftHandoffPanel.tsx` · SN-013 · LY-065 leftover
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Working handoff primary continue href is nested findings (or desk + highlight). Copy: job of this architecture.
2. Draft stays locked. Clone-from-snapshot remains the new-version path.
