# IH-078 — Explicit skip: presence, finding chat, unseal, 40th engine

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** skip. **Depends on:** LY-058/059 leftover, SG-111–115 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not invent presence avatars, finding-comment chat, unseal, or a 40th coverage engine. Record skips.

## Why

These are the tempting inhabit “fixes” that violate standing bets.

## Context

- ADR 0090 · ADR 0039 · HOLD_NO_COVERAGE_ENGINES.md
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Residuals rows for presence/chat, unseal, 40th engine, merge kernels. Prompts exist to prevent scope creep.
