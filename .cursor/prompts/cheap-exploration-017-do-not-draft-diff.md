# CE-017 — Explicit skip: draft-diff Compare

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** out-of-wave. **Depends on:** SN-038.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Repeat skip so CE implementers do not “finish” with draft-diff.
