# SG-037 — Empty architecture: Start review from this system leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-016, SN-019 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Empty named architecture CTA starts a review **of this system**. It does not fork Create architecture vs Start review as peer products.
...
- SN-019 · SN-028 · ARCHITECTURES_NEW_PATH only when no identity exists
