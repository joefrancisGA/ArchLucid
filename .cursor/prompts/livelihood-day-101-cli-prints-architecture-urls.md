# LY-101 — CLI prints architecture URLs leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-083 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CLI peer URLs include architecture when known.

## Why

CLI is how automation bookmarks.
