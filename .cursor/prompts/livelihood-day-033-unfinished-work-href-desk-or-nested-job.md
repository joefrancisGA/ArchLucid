# LY-033 — Unfinished-work href is desk or nested job leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-044 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Unfinished work hrefs are architecture desk or nested job, not an unlabeled pipeline stepper.

## Why

Pipeline unfinished-work copy is still the batch product.
