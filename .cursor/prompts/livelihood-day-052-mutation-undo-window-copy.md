# LY-052 — Mutation undo window copy leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** reversibility. **Depends on:** LY-043.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Any copy that implies unlimited undo is a bug. Point at 300s window.

## Why

Unlimited-undo copy overclaims reversibility.
