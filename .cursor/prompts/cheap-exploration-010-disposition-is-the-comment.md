# CE-010 — Finding disposition is the collab primitive leftover

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** collab. **Depends on:** ADR 0076.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help: we do not have finding chat; accept/reject/remediate + restatement is the record. Keyboard Alt+1–3.

## Why

Issue 7 asked for collab. Chat is forbidden. Disposition is the substitute.

## Context

- FINDINGS_PAGE_SHORTCUTS · LP-15

## What to build

1. Help topic.
2. Do not add comments.
3. 409 conflict panel already exists.
