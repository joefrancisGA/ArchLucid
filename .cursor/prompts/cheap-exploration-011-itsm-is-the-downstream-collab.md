# CE-011 — ITSM is downstream collab leftover

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** collab. **Depends on:** LP-17.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help: ITSM tickets carry rehearsal honesty (CG-038). Pointer CAS is LP-17. Do not build in-app chat to replace ITSM.

## Why

Spoke systems already exist.
...
1. Help cross-link.
2. Divergence banner leftover if any.
3. No webhook spam.
