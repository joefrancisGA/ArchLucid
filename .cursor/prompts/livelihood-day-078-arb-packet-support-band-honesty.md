# LY-078 — ARB packet support-band honesty leftover
...
ARB/sponsor packets that list findings include support band + scorer version. Not legal truth.

## Why

Packets without band overclaim citation = support.
