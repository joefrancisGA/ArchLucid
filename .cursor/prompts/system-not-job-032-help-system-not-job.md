# SN-032 — Help: the system is the object; review is a job

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** copy. **Depends on:** SN-011.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working getting-started: architecture identity, nested jobs, clone after spawn. Do not teach two start products.

## Why

Help still teaching evaluator IA undoes the desk.

## Context

- WS-20 help resolvers

## What to build

1. Help topic.
2. In-app route.
3. Guided teaching stays two-job if desired.
