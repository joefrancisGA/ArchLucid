# LN-018 — Null trail blocks finalize leftover

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** gate. **Depends on:** LN-017.

Do not implement from the wave index. Implement only *What to build*.

## Goal

ADR 0073 leftover mounts. Working Career finalize still null-blocks. Do not rewrite 0073.

## Why

Trail is the liability precondition (R4).
...
1. Remaining call sites.
2. Export array-section rules 0078 §1.
3. Legacy re-export banner only.
