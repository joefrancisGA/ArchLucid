# IH-070 — Guided / demo / trial keep eval chrome

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** dual-spine. **Depends on:** ADR 0094, MG leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Ratchet: inhabit changes are Working-only. Guided, demo, and trial keep eval/teaching chrome and peer review URLs where already contracted.

## Why

Deleting Guided is MG-013 skip. Inhabit must not “fix” eval seats.

## Context

- `mode-gravity-demo-trial-eval-ratchet.test.ts` · SG-046
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Tests: Guided peer review URLs and eval chrome still exist after inhabit wiring. Do not delete Guided.
