# IH-005 — Inventory: Record CTA implies Simulator work is career-complete
...
Inventory Working Start / execute CTAs that read as Record-complete when host Mode is Simulator.

## Why

Career gravity blocks unlabeled finalize. The start of the day can still look like the career record.

## Context

- ADR 0091 · CG-021 leftover · `SimulatorCareerHonestyPresenter`
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. List Start review / Record / execute buttons on Working that lack Simulator-incompleteness copy when host Mode is Simulator.
2. Do not flip host Mode. Honesty before start is IH-025.
