# LY-046 — Explicit skip: draft-to-draft Compare

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** skip. **Depends on:** LY-045, SG-082 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not implement draft-diff Compare. Record skip.

## Why

CE/SN/SG already skipped this; LY must not reverse it.
...
1. Residuals: draft-diff skipped. No second Compare engine.
