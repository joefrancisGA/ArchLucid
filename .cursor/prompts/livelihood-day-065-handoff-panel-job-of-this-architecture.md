# LY-065 — Handoff panel: job of this architecture leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** SG-049 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Handoff panel copy: this is a job of the open architecture.

## Why

Handoff that says “continue in the review” as Home is leftover SN.
