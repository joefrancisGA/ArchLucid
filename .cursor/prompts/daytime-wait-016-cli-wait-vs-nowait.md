# DW-016 — CLI wait vs no-wait leftover

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** cli. **Depends on:** DW-004.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CLI Real execute: default or flag for wait vs return operation id. Honesty that wait can exceed proxy if pointed at HTTP sync.
...
1. Flag or default documented.
2. Do not document missing progress URL as real.
3. Rehearsal honesty (CG).
