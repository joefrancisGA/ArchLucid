# SG-064 — Finish-setup Working points at architectures leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-061, SY-94 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Finish-setup Working CTA points at the architecture portfolio/desk.
