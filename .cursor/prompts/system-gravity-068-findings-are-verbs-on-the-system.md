# SG-068 — Findings are verbs on the system leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-019, SN-023 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Findings copy is a desk verb, not a peer risk app.
