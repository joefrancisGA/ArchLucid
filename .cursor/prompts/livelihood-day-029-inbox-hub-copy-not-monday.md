# LY-029 — Reviews hub copy is inbox, not Monday leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-039 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Reviews hub copy is an inbox of jobs, not “your architecture desk”.

## Why

Hub-as-Monday fights ADR 0098.
...
1. Copy leftover. Alt+R stays desk (SY/SG leftover).
