# SG-045 — First-review guide nested leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-013, SY-18 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working first-review guide primary href is nested under the architecture. It must not teach peer review-detail as Home.
