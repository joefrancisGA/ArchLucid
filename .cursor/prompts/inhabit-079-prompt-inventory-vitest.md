# IH-079 — Vitest: IH-00 index + IH-001–IH-080 files exist

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** close. **Depends on:** prompt-set PR.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Add `archlucid-ui/src/lib/inhabit-prompt-inventory.test.ts` asserting the index plus IH-001–IH-080 files exist.
...
1. 00-index present; exactly one file per IH-001–080; 80 numbered files.
