# LY-035 — Spawn does not replace last-open with a run id leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-050 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Spawn updates last-open architecture, not last-open run.

## Why

Last-open run makes the job the restore target.
