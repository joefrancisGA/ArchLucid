# LY-060 — Concurrent edit 409 honesty leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** LW leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Concurrent draft edits stay 409 + Keep mine. No last-write-wins.

## Why

Last-write-wins is the LW defect.
