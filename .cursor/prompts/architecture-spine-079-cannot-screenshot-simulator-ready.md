# AS-079 — Rehearsal cannot screenshot as Ready to finalize

**Wave:** architecture-spine (**AS**). **Cluster:** rehearsal-honesty. **Depends on:** AS-077, LP-18.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Finish LP-18 leftover if still open: Rehearsal / Simulator Working cannot show Ready-to-finalize / Ready pipeline label. Career-only.

## Why

The screenshot is the career object.

## Context

- LP-18 RunDetailPreFinalizeGateHonestyStrip
- career-artifact-honesty.ts

## What to build

1. Suppress Ready labels on Rehearsal.
2. Tests.
3. Do not claim LP-18 closed if you only duplicate copy — wire the same helper.

## Acceptance criteria

- No Ready chrome on Simulator Working.
