# CE-019 — Help: how to sketch a change

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** copy. **Depends on:** CE-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help: cheap envelope vs Career full run; Compare after; rehearsal default.

## Why

Without help, people finalize sketches.
