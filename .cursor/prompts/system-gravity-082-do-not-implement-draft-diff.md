# SG-082 — Explicit skip: draft-to-draft Compare

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** out-of-wave. **Depends on:** SG-001, SN-038, CE-017.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do **not** implement draft-to-draft Compare. Record the skip in `docs/architecture/SYSTEM_GRAVITY_OUT_OF_WAVE_RESIDUALS.md`. Compare stays two committed manifests (0092 / R12).

## Why

Cheap thinking must not launder unsealed drafts as Record proof. CE/SN already skipped this; this wave must not reverse it.

## Context

- ADR 0092 · SN-038 · CE-017

## What to build

1. Add an out-of-wave residuals row: draft-diff Compare — skipped.
2. Vitest ratchet: Working Compare entry still requires committed manifests (reuse SN/CE tests; do not fork engines).
3. Do not add a second Compare engine.
