# LY-069 — Collab help: no live cursors

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** collab. **Depends on:** LY-058.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help for sharing/leases does not promise live cursors.

## Why

Help overclaim is a procurement lie.
