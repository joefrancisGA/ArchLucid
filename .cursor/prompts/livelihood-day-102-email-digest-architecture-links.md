# LY-102 — Email digest architecture links leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-084 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Email digest links include architecture when known.
...
1. Leftover. No live presence in email.
