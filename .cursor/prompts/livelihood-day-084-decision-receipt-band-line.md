# LY-084 — Decision receipt support-band line leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** FC leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Decision receipt includes a support-band line when decision-grade rows exist.

## Why

Receipt without band is a stamp without proof.
