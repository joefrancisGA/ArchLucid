# LY-109 — Ratchet: commit calls finalize judge before hold
...
CommitOutputIntegrityService contains judge ApplyAsync before Unsupported hold.

## Why

Hold on stale Unchecked is the bug 0099 exists to prevent.
