# SG-047 — Unlinked review honesty leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-005, AO-49 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Reviews with null ArchitectureId stay on peer URLs with honesty. Do not fuzzy-merge by SystemName (AO-49).
...
- resolve-working-run-review-locator.ts
