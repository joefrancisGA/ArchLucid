# SN-036 — CLI clone/new-version honesty

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** cli. **Depends on:** SN-008.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CLI clone/new-version prints rehearsal/Career rules. Cannot spawn unlabeled Career Simulator (CG-062).
...
- CLI draft/run commands

## What to build

1. Help + stdout.
2. Sends tokens (LW) if PATCH involved.
3. Do not omit CAS.
