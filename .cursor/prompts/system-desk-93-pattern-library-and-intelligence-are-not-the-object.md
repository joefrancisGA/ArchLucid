# SY-93 — Pattern library / architecture intelligence Working entry does not replace the desk

Do not build new intelligence. Nav/entry hrefs only.

## Goal

Working nav: these stay tools. Deep links back to the open architecture when launched from a desk.

## Why

Specialty tools become Home if they own first-viewport daily hrefs (already emptied in operate-analysis — keep it).

## Context

- Intelligence pages
- `architecture-intelligence-page-copy.ts`

## What to build

1. Entry from desk command bar optional; no daily Insights promotion.
2. Parent copy per SY-33.

## Acceptance criteria

- Working daily operate-analysis still does not lead with intelligence.
