# DW-008 — In-flight cancel confirm leftover (AD-02)

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** ui. **Depends on:** AD-02.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Confirm cancel still required on envelope and Career Real. Do not make cancel one-click.

## Why

Mis-click stops a multi-minute livelihood job.
...
1. Confirm on remaining cancel buttons.
2. TB-2005.
3. Do not cancel on door flip (CG-018).
