# SG-063 — Demo/showcase Working identity leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** copy. **Depends on:** SG-016, SY-74 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Demo/showcase Working identity still names architectures. Sample vs Practice vs Record three-way honesty (CG-050) stays.
