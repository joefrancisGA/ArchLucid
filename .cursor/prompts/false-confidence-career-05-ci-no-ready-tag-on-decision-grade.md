# FC-05 — Ci No Ready Tag On Decision Grade

**Wave:** false-confidence-career (**FC**). **Do not fork** owners listed below unless this file names a leftover only.

## Goal

Guard: StatusTag kind=ready banned on decision-grade without honesty line
...
- Owners (do not re-implement): FD-13, CR-12, SD-12
