# SY-66 — Finding inspect back / parent is architecture desk or nested findings, not reviews hub

Do not fork AD-03 / AO-44. Inspect chrome only.

## Goal

Working inspect `working-back-href` already should prefer architecture — verify leftover hub parents.

## Why

Inspect is deep work. Back to inbox is exile.

## Context

- `working-back-href.ts`
- Finding inspect header
...
- Working inspect back is not `REVIEWS_LIST_PATH`.
