# AS-067 — Honesty CI: support band is not legal/semantic truth of the seal

**Wave:** architecture-spine (**AS**). **Cluster:** semantic-hold. **Depends on:** AS-056.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Extend TB-1229 honesty CI / claim lint: forbid copy that says the seal is “semantically verified” or “faithfulness-gated” unless describing the opt-in AS-065 flag. Band = heuristic/async signal.

## Why

GTM will overclaim the chip.

## Context

- TB-1229
- WHAT_NOT_TO_PROMISE.md if a single sentence is needed — do not reopen GTM cohorts

## What to build

1. Lint fixtures: bad sentence fails; precise sentence passes.
2. Do not rewrite TB-1228 body except Related pointer.
