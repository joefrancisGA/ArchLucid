# LY-036 — Keyboard Alt+R stays the desk leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-051 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Alt+R on Working is the architecture desk, not Reviews inbox.

## Why

Alt+R inbox is the job product (SY leftover).
...
1. Leftover. Do not steal Guided shortcuts.
