# SY-96 — Nav config contract: Working daily object is Architectures

Do not fork NAV_CONFIG_CONTRACT hub rules except documenting Inbox vs Architectures.

## Goal

`archlucid-ui/docs/NAV_CONFIG_CONTRACT.md`: Working primary noun Architectures; Reviews/Inbox secondary. Drift tests still pass.

## Why

Agents read this contract. If it still says Reviews are the lifecycle Home, they will revert SY.
...
1. Doc paragraph + existing drift tests green.

## Acceptance criteria

- Contract text does not call reviews hub Working Home.
