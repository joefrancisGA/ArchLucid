# SY-33 — Intelligence / provenance page copy does not parent to the reviews hub on Working

Companion to SY-31 for remaining `REVIEWS_LIST_PATH` parents.

## Goal

`architecture-intelligence-page-copy.ts`, `provenance-evidence-copy.ts`, `review-workspace-evidence-copy.ts` Working parents: architecture desk or inbox-labeled hub, not “reviews as Home.”

## Why

Same climb-out problem on specialty pages.
...
1. Working resolvers + Vitest.

## Acceptance criteria

- Working intelligence breadcrumb parent is not `REVIEWS_LIST_PATH` unless labeled Inbox.
