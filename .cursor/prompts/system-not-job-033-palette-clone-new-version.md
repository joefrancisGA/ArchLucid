# SN-033 — Palette: New version (clone) when spawn-locked
...
Command palette shows clone when the open draft is spawn-locked. Not a dead row.

## Why

Power users never see buried CTAs.

## Context

- palette work actions

## What to build

1. Action + handler.
2. Hidden when not spawn-locked.
3. Cost cap confirm SN-009.
