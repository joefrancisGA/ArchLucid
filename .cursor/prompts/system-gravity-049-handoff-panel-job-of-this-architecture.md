# SG-049 — Handoff panel: job of this architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-014, SN-013 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Spawn-lock handoff copy: this review is a job of **this architecture**. Primary action returns to the desk with the job selected; secondary opens the inspector.
...
- ArchitectureDraftHandoffPanel · LK-04
