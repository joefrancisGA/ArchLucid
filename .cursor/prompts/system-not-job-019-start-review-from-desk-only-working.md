# SN-019 — Working Start is from the open architecture

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** desk. **Depends on:** SN-012.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Alt+N on Working with an open architecture creates under that identity, not a floating job. No open architecture → portfolio new.

## Why

Start that ignores the open system is job gravity.

## Context

- ADR 0077 locator · Alt+N

## What to build

1. Resolver leftover.
2. Tests.
3. Guided Alt+N may stay intake wizard.
