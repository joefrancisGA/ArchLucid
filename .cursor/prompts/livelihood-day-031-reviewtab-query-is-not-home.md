# LY-031 — Working ?reviewTab= is not Home leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-042 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Query reviewTab is inspector chrome, not Working Home.

## Why

Deep links that open reviewTab as the shell identity are still job-home.
