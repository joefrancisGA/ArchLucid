# LN-013 — Hard vs soft on career exports leftover
...
Exports show hard vs soft and envelope. Hard without citation blocked (LN-004). Soft shows envelope, not failed review alone (0078 §7).

## Why

Export is the ARB moment for infeasibility.
