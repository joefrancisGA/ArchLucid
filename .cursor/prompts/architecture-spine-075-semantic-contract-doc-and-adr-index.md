# AS-075 — Semantic support band contract doc + ADR 0085 index completeness

**Wave:** architecture-spine (**AS**). **Cluster:** semantic-close. **Depends on:** AS-056–AS-074 as landed; this prompt may ship with 056 if 056 forgot the contract file.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Write `docs/library/FINDING_SEMANTIC_SUPPORT_BAND_CONTRACT.md` summarizing enum, scorer, warn vs hold, Simulator, density non-fusion. Link TB-1228. Honesty examples.

## Why

Scattered prompts need one PA-facing page.
...
1. Contract + links from ADR 0085.
2. Guard test file exists.

## Acceptance criteria

- One URL for “what does Supported mean?”
