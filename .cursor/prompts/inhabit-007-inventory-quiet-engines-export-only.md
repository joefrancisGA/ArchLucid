# IH-007 — Inventory: quiet engines named only on export
...
Inventory Working findings/desk surfaces that look complete while quiet engines are named only on Career export or the stamp.

## Why

False confidence on the desk is the career-ending class of bug.

## Context

- ADR 0070 · PC-01 · FC-19 leftover · insight-density measurement floor
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. List findings empty/complete states and Ready chrome that omit quiet-engine / coverage-floor sentences.
2. Do not add a 40th engine. Do not change typed-engine-protected.
