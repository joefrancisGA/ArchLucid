# DI-018 — Ask empty-state before finalized record leftover
...
IA: Ask nav-visible before finalized record. Working empty-state: bind to architecture / need a seal. Do not 500.

## Why

Nav-visible dead Ask is evaluator IA.
...
1. Empty-state.
2. Nested Ask bind (SN-024).
3. Guided teaching may differ.
