# SG-040 — Portfolio resume is last-open architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-009, SN-012 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working portfolio resume / Start uses last-open architecture. `reviewDetailPath` fallback only when ArchitectureId is unknown (honesty).
...
- system-not-job-portfolio-resume-href.ts · working-start-route.ts
