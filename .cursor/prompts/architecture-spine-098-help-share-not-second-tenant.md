# AS-098 — Help: sharing is not a second tenant and not chat

**Wave:** architecture-spine (**AS**). **Cluster:** share-copy. **Depends on:** AS-086.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Help topic: restrict-to-shares, roles, grandfather default open, still one tenant. No presence, no finding comments.

## Why

Users will ask for Slack-in-the-finding next; help must refuse that as out of product.
