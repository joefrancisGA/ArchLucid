# DI-016 — Pattern library empty-state leftover
...
IA-008 pattern library needs ≥5 tenants. Working empty-state must not look like a broken Career feature.

## Why

Empty aggregate as a nav item is console clutter.

## Context

- PatternLibraryPageClient

## What to build

1. Honest empty-state.
2. Consider Working nav hide until data — if hidden, palette honesty (DI-007).
3. Do not fake patterns.
