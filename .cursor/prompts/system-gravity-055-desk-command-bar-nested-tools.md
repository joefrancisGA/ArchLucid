# SG-055 — Desk command bar for nested tools leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-016, SY-60 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Architecture desk exposes Ask/Compare/Graph/Findings/Sketch as verbs on this system. Not a More menu for review tabs.
...
- SY-60 · CE Sketch a change (already shipped — do not remount)
