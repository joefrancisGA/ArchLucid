# SG-081 — Palette: New version when spawn-locked leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-073, SN-033 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

When spawn-locked, palette offers New version (clone) on this architecture, not Edit draft anyway.

## Why

Edit anyway is a second live editor.
