# LN-035 — Explicit skip: density predicate rewrite

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** out-of-wave. **Depends on:** LN-007.

Do not implement from the wave index. Implement only *What to build*.

## Goal

ADR 0070 predicate stays. This wave does not retune demotion to fake density.

## Why

Relabeling cannot raise density (miss clause).

## Context

- INSIGHT_DENSITY_MISS_CLAUSE.md

## What to build

1. Residual: DX engines remain DX.
2. No predicate change.
3. No 40th engine.
