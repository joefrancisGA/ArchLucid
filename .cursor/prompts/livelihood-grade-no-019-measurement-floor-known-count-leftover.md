# LN-019 — Measurement floor known count leftover

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** gate. **Depends on:** LN-007.

Do not implement from the wave index. Implement only *What to build*.

## Goal

DR-01 / 0078 §4 leftover: `enginesSucceeded == null` is not Career-complete. Sweep exports that still fail-open.

## Why

Unknown floor as Career-complete is a stamp lie.

## Context

- CareerArtifactCompletenessValidator floor

## What to build

1. Remaining paths.
2. Do not add engines to raise the floor.
3. Simulator not Career-complete (LP-06).
