# CE-033 — Parent seal unchanged by envelope

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** ratchet. **Depends on:** CE-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Envelope spawn cannot mutate parent GoldenManifest. Tests.

## Why

Sketch that rewrites the seal is a livelihood incident.
...
1. Test parent hash stable.
2. Clone new run id.
3. No header FK games.
