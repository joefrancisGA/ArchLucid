# LY-048 — Version history honesty leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** reversibility. **Depends on:** DA leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Architecture version list is history of the system, not a second editor. Spawn-locked drafts are not versions.

## Why

Version = draft editor is the dual-kernel leftover.
