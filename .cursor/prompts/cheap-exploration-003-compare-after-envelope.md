# CE-003 — Compare opens after envelope completes

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** desk. **Depends on:** CE-001, SN-014.

Do not implement from the wave index. Implement only *What to build*.

## Goal

When envelope run commits, Working offers Compare vs parent. Stamps on both sides (CG-057).

## Why

Sketch without a delta is not thinking.
...
1. Next-best-action on envelope complete.
2. Requires committed manifests.
3. No draft-diff.
