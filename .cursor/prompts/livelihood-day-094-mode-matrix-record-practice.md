# LY-094 — Mode matrix: Record / Practice leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** MG leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working execute gravity remains one story (0091/0094/0097). Density is operator-experience, not Mode.

## Why

Mode matrix sprawl is MG’s defect.
...
1. Leftover copy. No G-REAL-06. Do not delete Guided.
