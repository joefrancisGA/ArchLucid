# CE-014 — Keyboard: envelope from review-detail

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** desk. **Depends on:** CE-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Review-page shortcut or palette-only is OK; if adding a combo, use Alt+modifier, document in KEYBOARD_SHORTCUTS.md, avoid browser conflicts.

## Why

All-day tools have a sketch key. Do not steal Ctrl+Z.
