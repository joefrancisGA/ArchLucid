# DI-007 — Palette vs sidebar honesty leftover

**Wave:** desk-ia (livelihood UX wave 28) (**DI**). **Cluster:** ia. **Depends on:** DI-002.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working palette should not list destinations the sidebar hides unless the row says why / deep-link only. MG-015 may overlap — implement remaining Working IA rows.

## Why

Hidden+listed strands beta users.

## Context

- command palette · nav-shell-visibility

## What to build

1. Remaining mismatches.
2. Deep links remain valid.
3. Do not add breadcrumbs.
