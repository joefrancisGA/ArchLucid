# LN-005 — Extraction source passage required for evidence-backed
...
Working Career evidence-backed classification requires a resolvable source pointer. Missing pointer cannot be evidence-backed.

## Why

0082 Kind A/B is structural. This is the extraction-honesty leftover, not a new engine.

## Context

- trust labels ADR 0063 · 0078 §6

## What to build

1. Trust label heuristic vs evidence-backed leftover.
2. Desk band already AS-056+; do not fuse density (AS-066).
3. Tests.
