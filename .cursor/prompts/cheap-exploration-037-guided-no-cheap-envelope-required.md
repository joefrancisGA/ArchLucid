# CE-037 — Guided need not mount cheap envelope
...
Guided may omit Sketch CTA (eval). Working mounts it. Split test.

## Why

Eval should not pay for branch fleets.

## Context

- AS-081 split pattern

## What to build

1. Working has CTA; Guided may not.
2. Do not auto-switch.
3. Demo stays eval.
