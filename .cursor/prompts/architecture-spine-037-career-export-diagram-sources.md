# AS-037 — Career export lists diagram sources and extract method

**Wave:** architecture-spine (**AS**). **Cluster:** diagram-honesty. **Depends on:** AS-028, AS-036.

Do not implement from the wave index. Implement only *What to build*.

## Goal

JSON/print/ADR export: each diagram source with ExtractionMethod and whether it contributed graph nodes. Not the seal.

## Why

ARB packet without the drawing list is indefensible.

## Context

- CareerArtifactCompletenessValidator
- AS-028

## What to build

1. Export fields + tests.
2. Simulator rehearsal label still applies (LP-06).

## Acceptance criteria

- Export includes the list.
