# SG-052 — Palette: Open architecture before Open review leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** inspector. **Depends on:** SG-040, AO-17 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working command palette lists Open architecture / this system before Open review. Inbox is not a file.
