# MG-007 — Product line is not a Career door
...
Architecture vs Security shells share doors or an honesty strip (CG-017). Product line is packaging, not execute posture.

## Why

Hidden chooser on Security was a gravity hole.
...
1. Docs + CG-017 leftover if not done.
2. Do not add a third door.
3. No SQL RLS.
