# SG-079 — Empty desk: no Sketch without an architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-037, CE-034 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Sketch a change does not appear on an empty portfolio with no architecture identity. Start by naming a system.

## Why

Sketch without a parent makes a job the object again.
