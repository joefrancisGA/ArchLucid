# LY-080 — Audit CSV scorer version leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** LY-018.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Audit CSV includes scorer version column from overlay when present.

## Why

CSV without version cannot tell as057 from as099.
