# LY-117 — Explicit skip: draft-diff Compare (confirm)

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** skip. **Depends on:** LY-046.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Confirm draft-diff Compare remains skipped after this wave’s leftovers.

## Why

Object leftovers must not sneak a draft Compare engine.
...
1. Reuse SN-038 / SG-082 skip docs.
