# DW-023 — Explicit skip: Gate 1 live review

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** out-of-wave. **Depends on:** LN-012.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Async wait does not equal Gate 1 PASS. Residual G-REAL-06.
