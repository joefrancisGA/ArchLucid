# LY-043 — Explicit skip: do not lengthen 300s undo toast

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** skip. **Depends on:** LY-041.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Do not change MUTATION_UNDO_WINDOW_SECONDS = 300. Record the skip.

## Why

Lengthening silent undo hides authority mistakes.
...
1. Residuals row: 300s stays. Vitest/C# ratchet if a constant exists.
