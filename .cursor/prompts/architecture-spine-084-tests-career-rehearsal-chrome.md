# AS-084 — Vitest: Career vs Rehearsal chrome matrix

**Wave:** architecture-spine (**AS**). **Cluster:** rehearsal-ratchet. **Depends on:** AS-077–AS-081.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Matrix: Working+Career+Real; Working+Career+no Real blocked; Working+Rehearsal Simulator labeled; Guided no chooser.

## Why

Without a matrix the next /al-ui-rate pass will polish Career away.
