# IH-030 — Empty desk: Start review from this system with Record honesty

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** default-day. **Depends on:** IH-025, SG-037 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Empty architecture on Working: Start review from this system, with IH-025 Simulator honesty when Record is selected. No peer Start CTA.

## Why

SG-037 nested Start. Inhabit needs honesty on that CTA.

## Context

- SN-019 · SN-020 · LY-027 leftover
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Empty desk CTA uses nested start under this architecture. Record+Simulator readiness line from IH-025.
2. No second product CTA.
