# DI-017 — Approval request parent detail leftover

**Wave:** desk-ia (livelihood UX wave 28) (**DI**). **Cluster:** ia. **Depends on:** DI-005.

Do not implement from the wave index. Implement only *What to build*.

## Goal

IA-015: lineage subpage without parent detail. Add parent detail or a Working back link that is not a 404.

## Why

Dead-end lineage is stranded work.

## Context

- approval-requests/[id]/lineage

## What to build

1. Parent route or banner+back.
2. No breadcrumbs trail.
3. Rehearsal labeled if applicable.
