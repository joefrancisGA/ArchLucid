# LN-002 — Inventory hard-infeasible without citation

**Wave:** livelihood-grade-no (livelihood UX wave 26) (**LN**). **Cluster:** inventory. **Depends on:** LN-001.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Inventory findings/exports that can say hard/impossible without a law/citation on Working Career.

## Why

Cannot gate what is not listed.

## Context

- feasibility classification · feasibility verdict UI

## What to build

1. Table: surface, field, citation present?
2. Simulator/rehearsal may stay labeled incomplete.
3. No copy change yet.
