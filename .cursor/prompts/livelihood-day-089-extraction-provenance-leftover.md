# LY-089 — Extraction provenance leftover (LN)
...
Do not re-run LN extraction provenance. Name any remaining unlabeled extraction path.

## Why

Unlabeled extraction is false confidence.
...
1. Leftover only. No 40th engine.
