# IH-074 — Ratchet: Working spawn/continue lands nested findings

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** ratchet. **Depends on:** IH-015.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Vitest: Working spawn success / continue-last with ArchitectureId uses architecture-nested findings, not review Overview as Home.

## Why

Href drift will restore the job as Monday.

## Context

- working continue/last-open helpers
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Guard the inhabit landing helper(s) introduced in IH-015. Guided excluded.
