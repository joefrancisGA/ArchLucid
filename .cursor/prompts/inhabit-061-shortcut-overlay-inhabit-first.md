# IH-061 — Shortcut overlay is inhabit-first

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** keyboard. **Depends on:** SG-054 leftover, LY-095 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Keyboard help overlay on Working lists findings work and architecture desk first, not pipeline nav.

## Why

The overlay is how people learn the day.

## Context

- `KEYBOARD_SHORTCUTS.md` · AppShell shortcut overlay
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Working overlay order: findings dispose, Alt+J/K, Alt+N nested start, Alt+R desk, Sketch, Finalize. Pipeline/admin last or omitted.
