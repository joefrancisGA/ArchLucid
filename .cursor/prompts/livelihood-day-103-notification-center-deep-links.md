# LY-103 — Notification center deep links leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** throughput. **Depends on:** SG-087 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Notification deep links restore architecture + nested job, not inbox Home.

## Why

Notifications that open the hub are leftover.
