# IH-026 — Practice cannot screenshot as Record-complete at start

**Wave:** inhabit (livelihood UX wave 34) (**IH**). **Cluster:** default-day. **Depends on:** IH-025.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working Practice start/execute chrome cannot screenshot as Record or Career-complete. Watermark or door label is visible before the run exists.

## Why

CG watermarks exports. The start screenshot can still look like Record.

## Context

- ADR 0097 · `career-artifact-honesty.ts` · CG-041 leftover
- Leftover owners named in Depends on — do not re-run those bodies.

## What to build

1. Working Practice start chrome shows Practice (rehearsal) before spawn. No Ready. No Record-complete language.
2. Stored token remains rehearsal.
