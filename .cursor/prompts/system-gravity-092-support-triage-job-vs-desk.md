# SG-092 — Support triage: job vs desk leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** ops. **Depends on:** SG-002.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Support/help triage distinguishes architecture desk vs nested job vs inbox vs Practice envelope vs Record execute.
