# LY-034 — ArchitectureId ≠ DraftId in Working deep links leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** object. **Depends on:** SG-048 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Working deep links do not pass DraftId as architectureId.

## Why

DraftId-as-architecture is the dual-editor leftover (PC/DA).
