# SG-086 — Copy-link includes architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** outbound. **Depends on:** SG-034, SY-86 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Clipboard copy of a nested job includes the architecture locator.
