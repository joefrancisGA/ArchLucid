# SG-094 — Grep ratchet: Working start modules do not import reviewDetailPath
...
Extend SY-77 / AO-15 guards to remaining Working start/resume modules the SG-005 inventory names.
