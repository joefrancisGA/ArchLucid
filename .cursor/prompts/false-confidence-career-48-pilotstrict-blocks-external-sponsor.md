# FC-48 — Pilotstrict Blocks External Sponsor

**Wave:** false-confidence-career (**FC**). **Do not fork** owners listed below unless this file names a leftover only.

## Goal

PilotStrict HOLD blocks external sponsor PDF without waiver copy
...
- Owners (do not re-implement): REAL_MODE_EVIDENCE
