# CE-016 — Envelope metering attribution leftover

**Wave:** cheap-exploration (livelihood UX wave 29) (**CE**). **Cluster:** ops. **Depends on:** CE-002.

Do not implement from the wave index. Implement only *What to build*.

## Goal

R12/ADR 0052: branches metered under the seat, not a new SKU. Cheap envelope still attributed. Do not invent pay-per-what-if.

## Why

Pricing is seat. Metering is cost-attribution.
...
1. Usage event feature name.
2. Do not add a SKU.
3. Budget pill still not Mode.
