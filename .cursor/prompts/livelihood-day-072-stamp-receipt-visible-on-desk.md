# LY-072 — Stamp and decision receipt visible on the desk leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** SG-023 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Stamp/receipt is visible on the architecture desk after finalize, not only inside the inspector.

## Why

Receipt exile is job-home.
