# DW-006 — Shell in-flight affordance leftover

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** ui. **Depends on:** DW-005, PC-08.

Do not implement from the wave index. Implement only *What to build*.

## Goal

In-flight affordance shows Career Real jobs. Leftover: wait heroes that still replace the desk.

## Why

Background wait shipped; heroes return.
...
1. Sweep wait heroes on Working review-detail.
2. Desk remains usable.
3. Cancel confirm AD-02.
