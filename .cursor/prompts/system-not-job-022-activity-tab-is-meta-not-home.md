# SN-022 — Activity tab is meta, not the work object
...
Review Activity tab remains. Working must not default to Activity. Default tab leftover if Activity became default.

## Why

Meta-as-home is a console, not a desk.
...
1. Confirm default overview/findings per existing Working preference.
2. Do not collapse tabs.
3. Do not hide Activity.
