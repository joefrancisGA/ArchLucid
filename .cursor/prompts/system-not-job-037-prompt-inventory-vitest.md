# SN-037 — Vitest: SN-00 index + SN-001–SN-040 files exist

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** close. **Depends on:** prompt-set PR.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Add or confirm `system-not-job-prompt-inventory.test.ts` for 40 files + index.
...
1. 40 numbered files + index.
2. npm test --run that file.
