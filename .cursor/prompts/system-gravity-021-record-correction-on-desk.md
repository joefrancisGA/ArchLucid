# SG-021 — Record correction / amend on the desk leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-020, PC-10 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Record correction on a finding is available from the architecture-scoped queue, not only from review-detail inspect after a toast.
...
- FindingDispositionRecordCorrectionControl · PC-10 · MUTATION_UNDO_WINDOW_SECONDS stays 300s
