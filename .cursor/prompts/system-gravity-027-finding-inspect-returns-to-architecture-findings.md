# SG-027 — Finding inspect returns to architecture-scoped findings leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-019, SY-66 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Inspect close returns to nested findings on this architecture, not peer `/governance/findings` as Home.
...
- finding inspect back href · SY-66
