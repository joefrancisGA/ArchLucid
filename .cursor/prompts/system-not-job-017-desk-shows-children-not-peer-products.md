# SN-017 — Desk lists child reviews/drafts, not peer products

**Wave:** system-not-job (livelihood UX wave 25) (**SN**). **Cluster:** desk. **Depends on:** SN-011.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Architecture desk lists nested drafts/reviews as children. Insights remain verbs. Leftover peer Insights CTAs on Working desk removed or redirected.

## Why

Peer products are the job IA.
...
1. Child list.
2. Redirect leftover peer buttons.
3. Guided peer Insights stay.
