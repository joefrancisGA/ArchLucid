# AS-082 — Help: rehearsal vs career in one topic

**Wave:** architecture-spine (**AS**). **Cluster:** rehearsal-copy. **Depends on:** AS-076.

Do not implement from the wave index. Implement only *What to build*.

## Goal

In-app help topic: Rehearsal is practice; Career is the sealed-record path; Simulator is not sponsor proof. No GitHub blob links.

## Why

Operators will ask which door to use on Monday.

## Context

- getting-started-help-working-examples
- TB-645
