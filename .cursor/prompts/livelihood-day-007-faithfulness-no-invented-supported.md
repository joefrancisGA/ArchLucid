# LY-007 — Faithfulness: no Supported from disjoint citations
...
FindingSemanticSupportBandLlmJudgmentFaithfulnessValidator rejects LLM Supported when heuristic is Unsupported.

## Why

A green chip on disjoint citations is a livelihood defect.
...
1. Validator + Premium judge tests. Fail-open retains heuristic.
2. Prompt pack forbids inventing citations.
