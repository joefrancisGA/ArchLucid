# DW-017 — Vitest: DW-00 index + DW-001–DW-024 files exist

**Wave:** daytime-wait (livelihood UX wave 30) (**DW**). **Cluster:** close. **Depends on:** prompt-set PR.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Add `daytime-wait-prompt-inventory.test.ts`.
