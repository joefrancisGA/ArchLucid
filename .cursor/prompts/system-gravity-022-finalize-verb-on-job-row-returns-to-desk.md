# SG-022 — Finalize is a verb on the job row and returns to the desk

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-006, AO-35 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

When a child job is Ready under honesty gates, Finalize is reachable from the desk job row. Success returns to the architecture desk with the sealed child visible. Do not weaken CG Record+Simulator blocks.
...
- AO-35 · career-artifact-honesty · shouldSuppressReadyToFinalizeForCareerHonesty
