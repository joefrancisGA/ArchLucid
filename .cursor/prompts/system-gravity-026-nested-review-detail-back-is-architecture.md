# SG-026 — Nested review-detail back is the architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-025, AO-33 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Back / close from nested review-detail returns to `/architecture/architectures/{architectureId}`, not the reviews inbox and not a peer Insights product.
...
- working-back-href.ts · AO-44 · SY-66
