# LY-081 — ITSM export band stamp leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** stamp. **Depends on:** DX leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

ITSM export of decision-grade rows includes band + version. Checklist coverage still blocked.

## Why

ITSM tickets without band look like verified defects.
...
1. Leftover. DecisionGradeFindingExportFilter unchanged.
