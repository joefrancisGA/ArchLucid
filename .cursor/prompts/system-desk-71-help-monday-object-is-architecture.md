# SY-71 — Working help: Monday object is the architecture you reopen

Do not fork AO-42. Leftover first-review-as-job copy.

## Goal

Category-1 Working topics for Home, Architectures, desk: reopen the named system; reviews are jobs; inbox is optional. Press-triggered drawers only.

## Why

Help search is how stuck professionals reconstruct the product model.

## Context

- `contextual-help-working-desk-copy-guard.test.ts`
- `contextual-help-registry.ts` / architecture-rows

## What to build

1. Copy leftovers + extend AO-42 guard strings.

## Acceptance criteria

- Working Home help does not say the reviews hub is Home.
