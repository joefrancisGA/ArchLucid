# SG-032 — Pin Compare under the architecture leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-016, AO-37 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Pinned Compare stays under the open architecture. Compare still requires two committed manifests (0092). No draft-diff.
