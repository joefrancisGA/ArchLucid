# FC-30 — Hard Infeasible Citation On Export

**Wave:** false-confidence-career (**FC**). **Do not fork** owners listed below unless this file names a leftover only.

## Goal

Hard infeasible exports include law/citation — no bare impossible
...
- Owners (do not re-implement): R5, FeasibilityVerdictValidator
