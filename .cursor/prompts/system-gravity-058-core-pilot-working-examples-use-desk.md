# SG-058 — CORE_PILOT Working examples use the architecture desk leftover
...
CORE_PILOT and FIRST_PILOT Working examples use architecture URLs. Treat runId as tracking metadata.
