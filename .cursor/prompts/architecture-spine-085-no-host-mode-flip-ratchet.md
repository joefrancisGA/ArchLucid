# AS-085 — CI ratchet: this wave does not flip AgentExecution:Mode default

**Wave:** architecture-spine (**AS**). **Cluster:** rehearsal-ratchet. **Depends on:** AS-076.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Guard: appsettings / compose / deploy examples still default Simulator unless a file is already Real for a named environment. Fail if someone “helpfully” changes the product default in this wave.

## Why

G-REAL-06 is owner execution, not a prompt side effect.
...
1. Script or test with allowlist of files that may set Real.
2. Comment pointing at ADR 0086.

## Acceptance criteria

- Accidental default Real fails CI.
