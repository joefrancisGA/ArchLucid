# LY-008 — Faithfulness: no demote exact-quote Supported to Unsupported

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** kernel. **Depends on:** LY-007.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Reject LLM Unsupported when heuristic is Supported (exact-quote).

## Why

TB-1228 false-reject on paraphrase/exact quote would hide a defensible row.
...
1. Validator test. Judge returns null on reject.
2. Do not change AS-057 exact-quote rule.
