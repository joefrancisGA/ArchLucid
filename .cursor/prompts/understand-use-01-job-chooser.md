...
2. On the signed-in home, above the existing dashboard, render two jobs:
...
3. The current product line is the selected job. The other job stays visible.
...
- SecureNow home shows both jobs, with SecureNow selected.
