# LY-050 — Draft CAS conflict copy leftover

**Wave:** livelihood-day (livelihood UX wave 33) (**LY**). **Cluster:** reversibility. **Depends on:** ADR 0088 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

CAS conflict copy names the colliding actor/work, not a generic retry.

## Why

Generic retry trains people to forceOverwrite.
...
1. Leftover. forceOverwrite remains explicit.
