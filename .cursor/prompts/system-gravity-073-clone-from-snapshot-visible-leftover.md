# SG-073 — Clone-from-snapshot visible leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-037, SN-008 leftover.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Clone/new version remains visible on spawn-lock. Do not re-implement SN-008/CE-001. Wire only a missing Working call site the inventory names.

## Why

Missing clone entry reopens the draft as the editor.

## Context

- SN-008 · palette clone
