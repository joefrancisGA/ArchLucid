# DI-003 — Sealed review records list page

**Wave:** desk-ia (livelihood UX wave 28) (**DI**). **Cluster:** ia. **Depends on:** DI-001, DI-002.

Do not implement from the wave index. Implement only *What to build*.

## Goal

Add Working-reachable list of sealed records in Governance. Empty state honest. Sample/rehearsal labeled (CG).
...
- manifests/[id] · decision register

## What to build

1. Index page + nav item (phase/Working rules: Working visible).
2. Table: architecture, stamp, Mode/door.
3. Do not 404 the parent. Carbon table.
