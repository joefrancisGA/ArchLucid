# SG-023 — Stamp and decision receipt visible on the desk leftover

**Wave:** system-gravity (livelihood UX wave 32) (**SG**). **Cluster:** desk. **Depends on:** SG-022.

Do not implement from the wave index. Implement only *What to build*.

## Goal

After finalize, the architecture desk shows the sealed-record stamp/receipt for that child without making sealed-records list Monday morning (DI owns Governance list).
...
- DecisionReceiptExportButton · ADR 0095 sealed Governance home · SY-92
