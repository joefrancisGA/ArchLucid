...
| Role | Next reads |
|------|------------|
| **Developer** | [BUILD.md](BUILD.md), [CONTRIBUTOR_ONBOARDING.md](CONTRIBUTOR_ONBOARDING.md), [CODE_MAP.md](CODE_MAP.md), [GOLDEN_CHANGE_PATH.md](GOLDEN_CHANGE_PATH.md) |
...
| **Run API locally** | Configure user secrets / `ConnectionStrings:ArchLucid`, then `dotnet run --project ArchLucid.Api` — [OPERATOR_QUICKSTART.md](../library/customer-facing/OPERATOR_QUICKSTART.md#local-api-example) |
