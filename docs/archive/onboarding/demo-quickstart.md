...
| Export history (optional) | `export-demo-baseline-001` — placeholder row for export **history**; not used for consulting DOCX replay (see [TRUSTED_BASELINE.md](../../library/TRUSTED_BASELINE.md)) |
