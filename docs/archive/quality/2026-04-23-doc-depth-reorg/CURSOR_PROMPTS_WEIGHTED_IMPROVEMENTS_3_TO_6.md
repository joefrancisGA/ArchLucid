...
1. Open [`V1_SCOPE.md`](library/V1_SCOPE.md) §§ 2–5 (in-scope capabilities, happy path, release criteria).
...
3. Align **[`PILOT_GUIDE.md`](library/PILOT_GUIDE.md)** and **[`operator-shell.md`](library/operator-shell.md)** so “first run” steps reference the same entry points.
