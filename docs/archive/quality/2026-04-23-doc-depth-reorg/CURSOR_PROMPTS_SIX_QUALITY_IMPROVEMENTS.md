...
After the six prompts above land or stabilize, use **[`CURSOR_PROMPTS_SIX_QUALITY_IMPROVEMENTS_FOLLOWUPS.md`](archive/quality/2026-04-23-doc-depth-reorg/CURSOR_PROMPTS_SIX_QUALITY_IMPROVEMENTS_FOLLOWUPS.md)** for paste-ready **Follow-up 1–7** prompts (k6 regression signals, golden catalog governance, audit export parity, Phase 7.5 dry-run inventory, coverage hotspots + FsCheck budgets, RLS/key drills, and live E2E ↔ k6 coherence).
