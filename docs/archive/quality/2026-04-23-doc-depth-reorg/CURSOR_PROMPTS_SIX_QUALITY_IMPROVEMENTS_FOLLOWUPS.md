...
**Purpose:** Paste-ready **second-wave** prompts that assume the primary work from [`CURSOR_PROMPTS_SIX_QUALITY_IMPROVEMENTS.md`](archive/quality/2026-04-23-doc-depth-reorg/CURSOR_PROMPTS_SIX_QUALITY_IMPROVEMENTS.md) is either **done** or **stable**, and you want to deepen correctness, operability, or governance without re-running the whole original brief.
