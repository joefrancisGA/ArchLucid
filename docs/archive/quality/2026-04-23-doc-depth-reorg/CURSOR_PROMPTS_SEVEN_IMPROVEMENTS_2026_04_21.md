...
**Shipped:** [`docs/architecture/adrs/0022-coordinator-phase3-deferred.md`](../../../architecture/adrs/0022-coordinator-phase3-deferred.md) tracking placeholder.
...
**Shipped:** `infra/terraform-container-apps` default **`location = "centralus"`**, [`docs/REFERENCE_SAAS_STACK_ORDER.md`](library/REFERENCE_SAAS_STACK_ORDER.md) primary-region note, [`docs/go-to-market/MARKETPLACE_PUBLICATION.md`](go-to-market/MARKETPLACE_PUBLICATION.md) checklist, [`docs/PENDING_QUESTIONS.md`](PENDING_QUESTIONS.md) subscription item aligned to Central US.
