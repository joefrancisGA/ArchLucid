> **Scope:** Archived — historical Cursor prompt pack (2026-04-14 assessment); moved from `docs/library/` 2026-05-16. **Spine:** [Five-document onboarding spine](../../../FIRST_5_DOCS.md).

# Cursor prompts for top-6 quality improvements (2026-04-14 assessment)

Five standalone prompts (improvements #1–#4 and #6 from the archived assessment [`docs/archive/QUALITY_ASSESSMENT_2026_04_14.md`](../../QUALITY_ASSESSMENT_2026_04_14.md) (stub: [`docs/QUALITY_ASSESSMENT_2026_04_14.md`](../../quality/2026-04-23-doc-depth-reorg/QUALITY_ASSESSMENT_2026_04_14.md)); improvement #5 — Terraform `state mv` + `NEXT_REFACTORINGS.md` triage — is excluded by request). Each prompt is self-contained and ready to paste into a Cursor Agent session.

> **Key difference from the April 12 prompts** ([`QUALITY_IMPROVEMENT_PROMPTS.md`](./QUALITY_IMPROVEMENT_PROMPTS.md)): every item referenced in those prompts has been partially or fully implemented since. These updated prompts target the **remaining gaps** identified by the April 14 assessment and reference the current codebase state.
...
> **Follow-on (split Cursor prompts):** after the baseline in this section landed in CI, use **[`CURSOR_PROMPTS_QUALITY_IMPROVEMENT_3.md`](../2026-04-23-doc-depth-reorg/CURSOR_PROMPTS_QUALITY_IMPROVEMENT_3.md)** for smaller, paste-ready tasks (per-tag assert, native k6 for `k6-ci-smoke`, `/version` parity, env var docs, optional composite action, soak docs).
