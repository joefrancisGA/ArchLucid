> **Scope:** Archived — historical Cursor prompt pack (top-6 quality improvements); moved from `docs/library/` 2026-05-16. **Spine:** [Five-document onboarding spine](../../../FIRST_5_DOCS.md).

# Cursor prompts for top-6 quality improvements

Six standalone prompts, one per improvement from the archived assessment [`docs/archive/QUALITY_ASSESSMENT.md`](../../QUALITY_ASSESSMENT.md) (stub: [`docs/QUALITY_ASSESSMENT.md`](../../quality/2026-04-23-doc-depth-reorg/QUALITY_ASSESSMENT.md)). Each is ready to paste into a Cursor Agent session.
