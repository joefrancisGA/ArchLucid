...
- **Why:** Clear seams (Api/Application/Persistence/Worker), ADRs present ([docs/architecture/adrs/](../architecture/adrs/)).
...
- **Improvements:** Explicit “neutral portability” boundaries in ADRs ([ADR 0020](../architecture/adrs/0020-azure-primary-platform-permanent.md)).
