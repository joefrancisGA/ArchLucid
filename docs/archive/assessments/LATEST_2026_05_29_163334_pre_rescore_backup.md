...
### 1. DEFERRED - Capture Fresh Real-LLM Golden Cohort Evidence
...
- **Reason deferred:** Meaningful execution requires live Azure OpenAI endpoint, key, deployment name, and a running real-mode environment.
- **Input needed later:** Azure OpenAI endpoint, deployment name, secret delivery method, target environment URL, and permission to run real-mode evaluation.
...
### 23. DEFERRED - Start SOC 2 CPA Attestation Program
...
- **Actionable now or DEFERRED:** DEFERRED.
- **Reason deferred:** Requires budget, auditor/readiness consultant selection, observation window decision, and leadership commitment.
...
### 25. DEFERRED - Execute Third-Party Pen-Test Program
...
- **Actionable now or DEFERRED:** DEFERRED.
- **Reason deferred:** Requires funded vendor selection, executed SoW, test window, remediation ownership, and publication decision.
...
Batch 5 - owner-blocked commercial/assurance actions: Improvements 1, 22, 23, 24, and 25. Do not batch into engineering implementation until the owner provides credentials, customer permissions, budget, or account access.

## 11. Pending Questions for Later

### DEFERRED - Capture Fresh Real-LLM Golden Cohort Evidence

- Which Azure OpenAI deployment should be used for real-mode evaluation?
- Which environment URL should produce the buyer-safe evidence?
- Should the run be one-time proof, scheduled weekly, or release-gated?
...
### DEFERRED - Start SOC 2 CPA Attestation Program
...
### DEFERRED - Execute Third-Party Pen-Test Program
