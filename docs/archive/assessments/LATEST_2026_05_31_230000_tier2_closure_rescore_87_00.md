> **Scope:** ArchLucid Assessment – (A) Headline Readiness: 87.00% - full detail, tables, and links in the sections below.

# ArchLucid Assessment – (A) Headline Readiness: 87.00%

This score represents the `(A)` headline readiness per `Assessment-Scope-V1_1.mdc`, excluding deferred items. Prior scores were revised after Tier 2 closure (improvements 6–12), TB-033 trace forensic completeness, TB-114 accelerator chooser + wizard deep-links, TB-115–117 pack validation harness, TB-091–092 Key Vault IaC parity, and TB-075 proxy scope hardening (2026-05-31).
...
Weighted calculation: total weighted points = `10,353 / 11,900 = 87.00%`.
...
ArchLucid is a credible V1 pilot-ready architecture proof system. Tier 2 is closed for the assessment batch: trace forensic completeness (TB-033), accelerator chooser with wizard deep-links (TB-114), starter-pack validation harness (TB-115–117), Key Vault IaC parity (TB-091–092), and production-like UI proxy scope (TB-075). The weighted score is now held down primarily by client-side run-savings heuristics outside the executive rollup, proof density for broadest GTM claims, and backlog items (TB-027–032 layering, TB-050–056 explainability, TB-057–063 recurring review).
