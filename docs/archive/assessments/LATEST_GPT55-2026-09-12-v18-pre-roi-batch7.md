...
**Inspected HEAD:** `cursor/arch-quality-roi-improvements-0d83` **`5a384600f9`** (ROI batch **6**: inspect showReason parity, compare classification band delta, typed-engine honesty on secondary/summary cards, RC bundle auto-attach `real-llm-evidence-gate.json`, AS-072 governance-queue desk guard, WK-21 on pack-delta help + impact preview, stamp Lane B microcopy, compare-journey + `@release-gate` witnesses).
