...
| **Connection string** | Set `ConnectionStrings:ArchLucid` (User Secrets in Development, or environment variables in production). See [OPERATOR_QUICKSTART.md](../library/customer-facing/OPERATOR_QUICKSTART.md#local-api-example). |
