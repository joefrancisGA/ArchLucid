...
| **Connection string** | Set `ConnectionStrings:ArchLucid` (User Secrets in Development, or environment variables in production). See [OPERATOR_QUICKSTART.md](../library/OPERATOR_QUICKSTART.md#local-api-example). |
