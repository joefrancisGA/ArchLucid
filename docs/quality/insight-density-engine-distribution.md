...
Historical `typed-engine-protected` bypass is superseded; demotion remains advisory checklist coverage, not procurement proof.
...
The golden corpus harness registers **38** engines; **26** appear in this table (≥1 finding across case-01..case-50). **24** built-in product engines are absent from this corpus-derived slice.
...
| topology-coverage | 50 | 60 | 60 | 60 | 0 |
