...
The golden corpus harness registers **38** engines; **22** appear in this table (≥1 finding across case-01..case-47). **28** built-in product engines are absent from this corpus-derived slice.
