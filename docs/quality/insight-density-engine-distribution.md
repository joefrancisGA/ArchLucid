...
The golden corpus harness registers **47** engines; **28** appear in this table (≥1 finding across case-01..case-73). **26** built-in product engines are absent from this corpus-derived slice.
...
| external-exposure | 3 | 100 | 100 | 100 | 0 | 0 | 0 | 0 | 0 | 0 |
