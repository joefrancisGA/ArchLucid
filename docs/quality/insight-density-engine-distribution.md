...
The golden corpus harness registers **41** engines; **39** appear in this table (≥1 finding across case-01..case-63). **12** built-in product engines are absent from this corpus-derived slice.
