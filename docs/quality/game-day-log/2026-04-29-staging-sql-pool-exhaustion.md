...
| **RTO/RPO target (staging)** | RTO ≤ **4h**, RPO ≤ **1h** ([RTO_RPO_TARGETS.md](../../RTO_RPO_TARGETS.md)) |
...
5. **`support-bundle`** — _Expected:_ archive includes correlation IDs for the window ([CLI_USAGE.md](../../CLI_USAGE.md)). _Observed:_ _TBD_
...
| [`DEGRADED_MODE.md`](../../DEGRADED_MODE.md) | _TBD_ | |
