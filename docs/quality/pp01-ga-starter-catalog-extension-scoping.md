...
**Status:** Option **B** pilot slice **shipped** (2026-08-28) — twelve previously unbacked declaration-mapped ids added to `ga-starter-compliance.rules.json` (`soc2-018`, `cis-az-012/018/019/025/027`, `hipaa-017/022/024`, `iso27001-025`, `aks-015/021`). **QR-12 (2026-09-09)** extended the HIPAA clinical boundary slice (`hipaa-011`..`hipaa-025`) and wired `hipaa-architecture.json` keys so the pack emits declaration themes at **P1**. **QR-20 (2026-09-09, `#2689`)** extended ISO 27001 P1 (`iso27001-010`..`iso27001-025`). Next Option B slice is **PCI DSS** mapped stubs (`pci-007`, `pci-009`) — **QR-31**. Full Option A (~144 rules) remains deferred.
...
HIPAA and ISO 27001 P1 slices ship (QR-12 / QR-20). PCI mapped encryption/transit ids and Zero Trust remain declaration-silent at **P1** until those catalog rows exist or packs stop advertising those keys.
