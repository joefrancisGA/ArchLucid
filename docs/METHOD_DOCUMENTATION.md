...
| 20 | Coordinator façade + persistence unit of work | `ICoordinatorService`, `CoordinatorService`, `IArchiForgeUnitOfWork`, `DapperArchiForgeUnitOfWork`, `InMemoryArchiForgeUnitOfWork`, `IArchiForgeUnitOfWorkFactory`, `DapperArchiForgeUnitOfWorkFactory`, `InMemoryArchiForgeUnitOfWorkFactory` |
