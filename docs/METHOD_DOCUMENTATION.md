...
| 20 | Coordinator façade + persistence unit of work | `ICoordinatorService`, `CoordinatorService`, `IArchiForgeUnitOfWork`, `DapperArchiForgeUnitOfWork`, `InMemoryArchiForgeUnitOfWork`, `IArchLucidUnitOfWorkFactory`, `DapperArchiForgeUnitOfWorkFactory`, `InMemoryArchLucidUnitOfWorkFactory` |
