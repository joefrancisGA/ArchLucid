...
> **Follow-on (not this set):** runtime declared / observed connections — [`SECURENOW_RUNTIME_CONNECTION_COMPOSER_PROMPTS.md`](SECURENOW_RUNTIME_CONNECTION_COMPOSER_PROMPTS.md) (**SN-RT-01–10**, **12–13**). Observed traffic is **SN-RT-06/07** (`ObservedRuntime`), never SN-PE **May access**.
