...
| `ArchitectureIdentityDeskReviewsTable.tsx` | Ready-to-finalize on child job row | **SG-022** (desk row verb) |
| `ArchitectureIdentityDeskReviewFinalizeAction.tsx` | Finalize CTA on desk when ready | **SG-022** |
