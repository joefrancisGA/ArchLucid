...
**Successor set (2026-09-04):** **LD-01–15** and **RS-01–15 shipped** on `master` (#1421/#1439, #1457) — do not re-run. **Wave 4:** [`.cursor/prompts/working-architect-00-index.md`](../../.cursor/prompts/working-architect-00-index.md) (**WA-01–24**) — owner index [`WORKING_ARCHITECT_COMPOSER_PROMPTS.md`](WORKING_ARCHITECT_COMPOSER_PROMPTS.md). **LI-01–15 shipped** (#1397). Predecessors: [`.cursor/prompts/professional-tool-00-index.md`](../../.cursor/prompts/professional-tool-00-index.md) (**PT-01–20**) and [`.cursor/prompts/working-desk-00-index.md`](../../.cursor/prompts/working-desk-00-index.md) (**WD-01–12**). Do not re-run DD-01–10. Each WA file names the prior owner and forbids a fork.
