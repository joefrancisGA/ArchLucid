> **Scope:** Copy-paste Composer prompts that close **sealed-desk wave-10 leftovers** after IS-01–15 and LS-01–12. Internal engineering only — not buyer-facing copy.
...
| Class | Prompt | Residual after IS + LS |
|-------|--------|------------------------|
| False confidence | **SD-01** | Library / generated density docs still say typed engines always Promote |
| False confidence | **SD-02** | ADR 0069 / 0070 still **Proposed** after implementation |
| Career defense | **SD-03** | Golden harness still omits most built-in engines (measurement only) |
| False confidence | **SD-04** | Remaining CLI / help / stream docs still recites the old gate |
| Eval-first spine | **SD-05** | Default mock E2E still boots buyer-polish as the operator identity |
...
|--------|-----------|------------|
| **SD-01** Docs honesty | Prefer first | IS-05 landed in code; do not edit the gate |
| **SD-02** ADR status | After 01 | Do not rewrite ADR bodies except Status + evidence |
| **SD-03** Harness coverage | After 01 | Do not add a 40th engine |
| **SD-04** Remaining contract copy | After 01 | LS-03 is UI; this is CLI/help/library remainder |
| **SD-05** / **SD-06** | Independent | Do not delete buyer golden-path suite |
| **SD-07** / **SD-08** | Independent | Do not fork WA-15 / WA-16 review-detail / draft autosave |
| **SD-09** Bearer residual | Independent | Do **not** implement IS-15 |
| **SD-10** / **SD-11** | After IS-02/03 preferred | Spawn lock already exists |
| **SD-12** Remaining chrome | After IS-06 / FD-13 | Do not fork LS-12 Ask/sponsor |

## Intentional — do not “fix”

- Desktop review tabs stay a full strip (no **More** menu).
- 300-second *immediate* undo stays short; IS-12 owns amend-after-window.
...
- Dual-pane shared selection is LS-01; wait-as-background is IS-09; BFF is IS-15.

## Global constraints

See [`.cursor/prompts/sealed-desk-00-index.md`](../../.cursor/prompts/sealed-desk-00-index.md). Same as LS: no desktop **More** menu; no GTM cohorts **M-90 / M-44 / M-91 / M-92**; no reopening **TB-135 / TB-136**; TB-645 vocabulary; focused Vitest; scoped compile only for C#. Do **not** change `DeterministicInsightDensityGate`. Do **not** add a 40th coverage engine.

## Do not re-run

- **LS-01–12** — wave 9; SD files name leftovers only
