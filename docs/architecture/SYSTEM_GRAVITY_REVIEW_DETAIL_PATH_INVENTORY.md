> **Scope:** Engineering inventory — SYSTEM GRAVITY REVIEW DETAIL PATH INVENTORY.

# System-gravity — reviewDetailPath when ArchitectureId known (SG-005)

**Generated:** 2026-09-12. Re-grep before each shrink PR.
