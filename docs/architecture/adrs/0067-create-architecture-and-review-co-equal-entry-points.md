...
5. **Parity of entry points and jobs — explicitly not parity of artifacts.** An architecture draft is mutable and unsealed; a sealed review record is sealed, governed, and export-bearing. Copy must keep that distinction and must never imply a draft is a governed or signed artifact.
