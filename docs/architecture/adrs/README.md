...
| [0095](0095-sealed-record-governance-home.md) | Sealed review records **Governance inventory home** — list at `/governance/sealed-records`; desk remains Monday-morning; no tab collapse; legacy redirects (**Status: Proposed** 2026-09-12; DI-001; does not merge kernels) |
