...
| [0074](0074-customer-visible-architecture-identity.md) | Customer-visible durable architecture identity — named `dbo.Architectures` anchor; drafts/reviews reference it; not a third kernel (**Status: Proposed** 2026-09-06) |
