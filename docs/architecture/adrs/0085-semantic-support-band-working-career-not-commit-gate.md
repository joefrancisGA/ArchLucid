...
- **Follow-ups:** AS-057 heuristic quote-overlap scorer; AS-058 async support-ratio job; AS-059 support band enum; AS-065 PilotStrict optional hold on Unsupported; AS-067 honesty CI not legal truth; AS-074 LLM judge default off; AS-075 semantic contract doc completeness.
