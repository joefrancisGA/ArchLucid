...
| [`INVENTORY_DIAGRAM_VNET_BOX_LUNA_PROMPTS.md`](INVENTORY_DIAGRAM_VNET_BOX_LUNA_PROMPTS.md) | **VN-01–VN-05** — Luna prompts: cited VNet membership, pack a VNet box inside its resource group, cross-group edges, PNG cluster parity, mode ratchet; **prompts only** |
...
**VNet as a bounding box inside its resource group (owner 2026-09-24):** run **VN-01**, then **VN-02**, then **VN-03**. **VN-04** after **VN-02**. **VN-05** last. Prompts: [`INVENTORY_DIAGRAM_VNET_BOX_LUNA_PROMPTS.md`](INVENTORY_DIAGRAM_VNET_BOX_LUNA_PROMPTS.md). Paste one numbered file from that index (start with [`.cursor/prompts/vnet-box-01-cited-membership.md`](../../.cursor/prompts/vnet-box-01-cited-membership.md)). Do **not** implement from the index. Do **not** add subnet boxes. Do **not** treat collocation as containment. Audience is GPT-5.6 Luna.
