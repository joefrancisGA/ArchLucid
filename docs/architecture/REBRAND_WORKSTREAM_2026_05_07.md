...
| **PR-2** | [`POSITIONING.md`](../go-to-market/POSITIONING.md), [`PRODUCT_DATASHEET.md`](../go-to-market/PRODUCT_DATASHEET.md), [`DEMO_QUICKSTART.md`](../go-to-market/DEMO_QUICKSTART.md), [`EXECUTIVE_ONE_EMAIL_KIT.md`](../go-to-market/EXECUTIVE_SPONSOR_BRIEF.md#12-one-email-sponsor--procurement-kit) | **Done** |
...
- Superseded tracker (first rename wave): `REBRAND_WORKSTREAM_2026_04_23.md` — deleted 2026-08-02; this document is its successor (see [`redirects.md`](../redirects.md))
