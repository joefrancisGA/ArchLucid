...
- **Onboarding narrative vs. platform mission (2026-06-15)** — [`PRODUCT_DRIFT_ONBOARDING_NARRATIVE_2026_06_15.md`](../archive/assessments/PRODUCT_DRIFT_ONBOARDING_NARRATIVE_2026_06_15.md) — evidence-first first-run realignment; **TB-337–344** (archived)
- **UX implementation leakage audit (2026-06-15)** — [`PRODUCT_UX_IMPLEMENTATION_LEAKAGE_AUDIT_2026_06_15.md`](../archive/assessments/PRODUCT_UX_IMPLEMENTATION_LEAKAGE_AUDIT_2026_06_15.md) — product narrative, AI budget, ops chrome, and V1 correction priorities (archived)
