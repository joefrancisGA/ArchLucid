...
### Orientation
- **Instrument-spine Composer prompts (wave 8 — run these)** — [`INSTRUMENT_SPINE_COMPOSER_PROMPTS.md`](INSTRUMENT_SPINE_COMPOSER_PROMPTS.md) · [`.cursor/prompts/instrument-spine-00-index.md`](../../.cursor/prompts/instrument-spine-00-index.md) (**IS-01–15**). Load-bearing bets waves 1–7 left intact: one Working work object (ADR 0069), density as a control (ADR 0070), instrument-first spine. Each file names the FD/CD/AD/WA owner; do not fork.
