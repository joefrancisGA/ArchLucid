...
### Orientation
- **Livelihood-instrument Composer prompts (run these)** — [`.cursor/prompts/livelihood-instrument-00-index.md`](../../.cursor/prompts/livelihood-instrument-00-index.md) (**LI-01–15** — finding honesty, infeasible-as-package, trail at finalize, skipped-MUST gate, amend, one-lifecycle start, keyboard work, in-flight desk, workbench, ops off primary path, compare-from-review, draft truth, restore/dirty guards, meeting session, eight-hour list-first). Each file names the PT/WD owner; do not fork.
