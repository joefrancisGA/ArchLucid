...
### Orientation
- **Career-desk Composer prompts (run these first)** — [`CAREER_DESK_COMPOSER_PROMPTS.md`](CAREER_DESK_COMPOSER_PROMPTS.md) · [`.cursor/prompts/career-desk-00-index.md`](../../.cursor/prompts/career-desk-00-index.md) (**CD-01–15**). Wave 5 after WA-01–24. Each file names the WA/LD/RS owner; do not fork.
