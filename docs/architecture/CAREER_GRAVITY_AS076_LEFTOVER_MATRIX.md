...
| **077** | `.cursor/prompts/architecture-spine-077-working-chrome-mode-chooser.md` | **Yes** — `WorkingCareerRehearsalChooser` | Chooser chrome | **CG-016** keyboard/Carbon; **CG-017** Security skip; **CG-011** persist. **Do not re-run the chooser.** Ready leaks are **CG-002 / CG-004 / CG-030** |
