...
Forest **RG-aware packing** + labeled frames on Full subscription. Nested VNet/subnet frames. Honesty copy when subgraphs exist but forest does not paint them. None of those belong in IDR chats.
