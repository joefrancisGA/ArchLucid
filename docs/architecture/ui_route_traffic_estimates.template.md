...
| HHX | `/help/how-it-works` | 0.12% | 0 | 0 | 12 | Help topic | Alias → `/help/getting-started#how-archlucid-works` (HGX). Fold hit share into HGX on next `/al-ui-tableupdate` pass. |
...
| PRC | `/internal/product-learning` | 0.06% | 0 | 0 | 6 | Marketing | None |
...
| HPR | `/help/product-overview` | 0.02% | 0 | 0 | 2 | Help topic | Alias → `/help/executive-summary` (EXE), preferably `#what-archlucid-is` (TB-1739). Fold hit share into EXE on next `/al-ui-tableupdate` pass. |
