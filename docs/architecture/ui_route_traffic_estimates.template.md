...
| ERU | `/architecture/reviews/[runId]/findings/[findingId]/evidence-trace` | 0.4% | 0 | 0 | 40 | Core review | Finding evidence-trace (canonical inspector). Absorbs former RR hit share from retired legacy `/inspect` bookmark (hard-retired — 404). Score transferred from RR Evidence hard-cap (redirect/shim honesty). Does not imply CPA SOC 2 or third-party pen-test publication. |
| GPP | `/governance/policy-packs` | 0.4% | 0 | 0 | 40 | Alerts/gov | None |
| GDO | `/governance/decision-register` | 0.3% | 0 | 0 | 30 | Alerts/gov | Decision register - DecisionRegisterClient with OperatorPageHeader PageContextualHelpButton (topic map how-it-works / Decision register, not governance-approval catch-all), Category-1 registry, Sources follow-up strip + claim-discipline callout (register browse, not diligence pack), filters/summary/cards/timeline. Not a signed-record Sources trail by itself. Does not imply CPA SOC 2 or third-party pen-test publication. |
...
| SPE | `/sponsor-report/executive-summary` | 0.22% | 0 | 0 | 22 | Sponsor report | Sponsor executive summary (Sponsor report) - ValueReportPageClient/View with PageContextualHelpButton (topic map executive-summary; Category-1 registry on /sponsor-report), workspace Sources + claim-discipline orientation strip, period preview/exports, Outcomes nav. Absorbs former VXX hit share from retired legacy `/value-report` bookmark (hard-retired — 404). Period summary — not a signed-record Sources trail alone. Does not imply CPA SOC 2 or third-party pen-test publication. |
...
| ASX | `/administration/settings/support` | 0.12% | 0 | 0 | 12 | Admin | None |
...
| SPR | `/sponsor-report/roi-summary` | 0.12% | 0 | 0 | 12 | Sponsor report | Sponsor ROI summary report (canonical). Absorbs former VRX hit share from retired legacy `/value-report/roi` bookmark (hard-retired — 404). Does not imply CPA SOC 2 or third-party pen-test publication. |
...
| SC | `/administration/settings/ai-usage` | 0.1% | 0 | 0 | 10 | Admin | None |
| SDX | `/administration/settings/developer` | 0.1% | 0 | 0 | 10 | Admin | None |
...
| SE | `/administration/settings/extract-upload` | 0.07% | 0 | 0 | 7 | Admin | None |
| SIS | `/administration/settings/identity/sso-wizard` | 0.07% | 0 | 0 | 7 | Admin | None |
| SSX | `/administration/settings/scim-provisioning` | 0.07% | 0 | 0 | 7 | Admin | None |
...
| STR | `/administration/settings/tenant/recycle-bin` | 0.04% | 0 | 0 | 4 | Admin | None |
...
| SOI | `/administration/settings/identity-providers/oidc` | 0.02% | 0 | 0 | 2 | Admin | None |
| SEO | `/administration/settings/identity-providers/role-mapping` | 0.02% | 0 | 0 | 2 | Admin | None |
| SSA | `/administration/settings/identity-providers/saml` | 0.02% | 0 | 0 | 2 | Admin | None |
| SEM | `/administration/settings/model-governance` | 0.02% | 0 | 0 | 2 | Admin | None |
...
| AAN | `/architecture/architectures/new` | 0.02% | 0 | 0 | 2 | Core review | None |
| RER | `/architecture/reviews/[runId]/artifacts/[artifactId]` | 0.02% | 0 | 0 | 2 | Core review | Run-scoped artifact Preview entry — App Router redirect to canonical `/signed-records/[manifestId]/artifacts/[artifactId]` (TB-1821). |
...
| HEV | `/help/evidence-only-review` | 0.02% | 0 | 0 | 2 | Help alias | None |
...
| PPP | `/insights/planning/plans/[planId]` | 0.02% | 0 | 0 | 2 | Marketing | Improvement plan detail - PlanningPlanDetailPageView with OperatorPageHeader PageContextualHelp (topic map how-it-works / Improvement planning; Category-1 registry for /insights/planning/plans), Sources follow-up strip + claim-discipline callout (derived plan, not diligence trail), plan sections. Not a signed-record Sources trail. Does not imply CPA SOC 2 or third-party pen-test publication. |
