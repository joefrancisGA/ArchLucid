...
| DSH | `/architecture/executive-dashboard` | 8.04% | 0 | 0 | 804 | Executive | Deprecated operator bookmark — merged to canonical executive dashboard on **ARE** (`/architecture/executive-dashboard`, TB-608). |
...
| ARE | `/architecture/architectures/new` | 0.02% | 0 | 0 | 2 | Core review | None |
...
| INP | `/insights/planning/plans/[planId]` | 0.02% | 0 | 0 | 2 | Marketing | None |
