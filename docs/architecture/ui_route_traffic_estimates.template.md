...
| AIN | `/architecture/architecture-intelligence` | 0.45% | 0 | 0 | 45 | Marketing | Closed-loop architecture reasoning operator surface - ArchitectureIntelligencePageClient runs reasoning/golden tests and publish-to-findings round trip. Deep links from reviews/findings via runId query. Canonical path /architecture/architecture-intelligence. |
