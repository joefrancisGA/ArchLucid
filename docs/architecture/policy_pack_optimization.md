...
- Re-running a review creates a new versioned scope; historical reviews retain their original scope; review packages and exports must use the same scope record as the underlying review. No user-visible internal API or engine language should appear.
