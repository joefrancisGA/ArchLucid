...
`docs/PROJECT_CONSOLIDATION_PROPOSAL.md` is open. After landing the Tier 5 assertions, pick the two smallest sibling projects with the heaviest mutual coupling and merge them under an ADR (`docs/architecture/adrs/0022-project-consolidation-step-1.md`). Update this roadmap when that lands.
