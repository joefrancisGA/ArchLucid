...
| M10 | Worker | Authority pipeline and integration outbox: **batch 25, sequential** processing, 2s poll | `AuthorityPipelineWorkProcessor.cs:55-62`; `IntegrationEventOutboxProcessor.cs:40-42` |
...
| ID range | Scope |
|----------|--------|
| **TB-574**–**TB-593** | Backend performance assessment recommendations — canonical detail in [`TECH_BACKLOG.md`](../library/TECH_BACKLOG.md); **TB-574**, **TB-575**, and **TB-576** **Done** (2026-07-02) |
...
| **TB-574**–**TB-593** | Partial — **TB-574**, **TB-575**, **TB-576** **Done** (2026-07-02); remainder open — see [`TECH_BACKLOG.md`](../library/TECH_BACKLOG.md) |
| **TB-018** | Open | Warm tenant catalogs (signup latency) |
