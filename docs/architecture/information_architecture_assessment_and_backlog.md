...
| `/administration/settings/ai-usage` → rewrite → `/settings/cost-reporting` | Tenant LLM spend | P ("AI usage") | Retain alias; remove legacy `/admin/ai-usage-cost` page file (IA-014) |
...
| `/settings/cost-reporting` | `/administration/settings/ai-usage` (rewrite), `/admin/ai-usage-cost` (redirect) | One page, three URLs | Aliases only | Low | Keep one alias; delete legacy admin page file | None |
