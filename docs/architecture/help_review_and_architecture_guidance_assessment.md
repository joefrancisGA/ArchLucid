...
**Confirmed repository bug — search mislabeling:** `archlucid-ui/src/lib/help-search-panel-catalog.ts:54-60` defines a "Start here" search-panel entry:
