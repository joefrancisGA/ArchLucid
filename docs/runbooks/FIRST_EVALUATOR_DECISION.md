...
| **Expected artifact** | Walkthrough of review create → execute → commit; static demo proof shape in [`demo-proof-packets/README.md`](../go-to-market/demo-proof-packets/README.md) |
