...
1. See **[Common operator errors (top 10)](COMMON_ERRORS.md)** for step-by-step fixes to startup, auth, migrations, OpenAI, rate limits, concurrency, and readiness checks.
...
- **`ReviewId=`** — ties log lines to a single architecture review.
