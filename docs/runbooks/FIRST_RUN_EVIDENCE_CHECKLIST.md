...
| 4 | Sign in to architect workspace; open **New architecture review** (`/reviews/new`; legacy `/runs/new`). | Wizard loads; auth succeeds (no endless 401/403). | [`FIRST_RUN_WALKTHROUGH.md`](../library/FIRST_RUN_WALKTHROUGH.md) |
