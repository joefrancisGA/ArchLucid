...
**Related:** [`docs/BILLING.md`](../library/BILLING.md) (operational considerations table), [`docs/AZURE_MARKETPLACE_SAAS_OFFER.md`](../AZURE_MARKETPLACE_SAAS_OFFER.md) (webhook actions table), [`docs/architecture/adr/0016-billing-provider-abstraction.md`](../architecture/adr/0016-billing-provider-abstraction.md), migration **086** (`086_Billing_MarketplaceChangePlanQuantity.sql`).
