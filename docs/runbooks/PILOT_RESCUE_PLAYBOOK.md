...
| Support ZIP before external | Residual secrets in attached files | Validate redaction against internal policy; item 37 posture | [TROUBLESHOOTING.md](../TROUBLESHOOTING.md) (support bundle); [PENDING_QUESTIONS.md](../PENDING_QUESTIONS.md) item 37 |
