...
| Proof packet | `collect-first-pilot-proof.ps1` or `archlucid pilot proof-packet <runId>` produces a packet with disposition, ROI source labels, and caveats. | readiness-only run has no finalized review yet. | missing ROI source, skipped real evidence, or failed PilotStrict renders as READY. | [`FIRST_PILOT_EVIDENCE_BUNDLE.md`](FIRST_PILOT_EVIDENCE_BUNDLE.md), [`QUOTE_TO_PROOF_PACKET.md`](../go-to-market/QUOTE_TO_PROOF_PACKET.md#readiness-checklist) |
