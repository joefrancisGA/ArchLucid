...
**Prevention:** Do not put Real mode or partial Azure OpenAI into **`appsettings.Pilot.json`**; it is loaded for non-Development hosts. Maintain **[RESILIENCE_CONFIGURATION.md](../library/RESILIENCE_CONFIGURATION.md)** non-default tuned profile per environment.
