...
**Canonical buyer narrative:** For sponsor-facing and outward buyer messaging, start with **[EXECUTIVE_SPONSOR_BRIEF.md](EXECUTIVE_SPONSOR_BRIEF.md)**. This document is the canonical inventory and packaging reference, not the primary sponsor summary.
