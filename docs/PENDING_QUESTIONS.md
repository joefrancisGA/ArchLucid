...
- **2026-05-30 — Team self-serve Stripe SKU at launch:** keep the **interim bundled Team Checkout SKU** (single `PriceIdTeam`) at commerce un-hold launch — do **not** split into per-component Stripe line items first. **Amount superseded 2026-07-29 (M-200):** bundled SKU is now **$499**/month USD (was $249) and the § 3.2 grandfathering clause is **deleted** (pre-launch, no subscribers to migrate). See *Resolved 2026-05-30 (Team self-serve Stripe SKU at launch)* below.
...
| Sub-decision | Decision | Affects |
|---|---|---|
| **Launch SKU shape** | **Yes** — at commerce un-hold launch, Team self-serve stays the **interim bundled Stripe Price** (one recurring **`Billing:Stripe:PriceIdTeam`** per [`PRICING_PHILOSOPHY.md`](go-to-market/PRICING_PHILOSOPHY.md) § **3.2**; amount was $249 at this resolution — **superseded 2026-07-29 (M-200): $499**/month USD). | [`STRIPE_CHECKOUT.md`](go-to-market/STRIPE_CHECKOUT.md), [`go-to-market/STRIPE_CHECKOUT.md`](go-to-market/STRIPE_CHECKOUT.md#operator-completion-checklist), `archlucid-ui/public/pricing.json` |
