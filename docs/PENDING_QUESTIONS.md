...
| Sub-decision | Decision | Affects |
|---|---|---|
| **Launch SKU shape** | **Yes** — at commerce un-hold launch, Team self-serve stays the **interim bundled Stripe Price** (one recurring **`Billing:Stripe:PriceIdTeam`**, **$249**/month USD per [`PRICING_PHILOSOPHY.md`](go-to-market/PRICING_PHILOSOPHY.md) § **3.2**). | [`STRIPE_CHECKOUT.md`](go-to-market/STRIPE_CHECKOUT.md), [`go-to-market/STRIPE_CHECKOUT.md`](go-to-market/STRIPE_CHECKOUT.md#operator-completion-checklist), `archlucid-ui/public/pricing.json` |
