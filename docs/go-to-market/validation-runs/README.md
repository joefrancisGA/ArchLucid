...
- Blind protocol: [`../FIRST_SESSION_COGNITIVE_LOAD_OBSERVATION.md#blind-insight-validation`](../FIRST_SESSION_COGNITIVE_LOAD_OBSERVATION.md#blind-insight-validation) (alias: [`../Architect_Evaluation/PRINCIPAL_ARCHITECT_INSIGHT_VALIDATION_PROTOCOL.md`](../Architect_Evaluation/PRINCIPAL_ARCHITECT_INSIGHT_VALIDATION_PROTOCOL.md#blind-insight-validation))
- Pre-registered tracker (fill this before scoring): [`../FIRST_SESSION_COGNITIVE_LOAD_OBSERVATION.md#blind-decision-delta-cohort-tracker`](../FIRST_SESSION_COGNITIVE_LOAD_OBSERVATION.md#blind-decision-delta-cohort-tracker) (alias: [`BLIND_DECISION_DELTA_COHORT_TRACKER.md`](BLIND_DECISION_DELTA_COHORT_TRACKER.md))
