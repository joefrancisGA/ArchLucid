...
**Cross-refs:** [`GTM_BACKLOG.md`](GTM_BACKLOG.md) § Proof-gated rollout · [`CLAIM_READINESS_CHECKLIST.md`](CLAIM_READINESS_CHECKLIST.md) · tech **TB-886** / **TB-925** / **TB-948**–**TB-951** in [`../library/TECH_BACKLOG.md`](../library/TECH_BACKLOG.md)
