...
## 1. Renewal timeline (annual subscription)

| Milestone | Action | Owner |
|-----------|--------|-------|
| **R-90 days** | Review health score ([CUSTOMER_HEALTH_SCORING.md](CUSTOMER_HEALTH_SCORING.md)); analyze usage trends; identify expansion signals | CSM |
...
| Doc | Use |
|-----|-----|
| [CUSTOMER_HEALTH_SCORING.md](CUSTOMER_HEALTH_SCORING.md) | Health scoring framework |
