...
| Tenant isolation | **Database-per-tenant** SQL catalogs plus application scope predicates ([ADR 0037](../architecture/adrs/0037-tenant-isolation-without-rls-defense-in-depth.md)) | Varies — confirm with your EA vendor DPA |
