...
0. **Workflow docs (TB-229):** Use [`REFERENCE_PUBLICATION_RUNBOOK.md#5-first-contact-email-template`](REFERENCE_PUBLICATION_RUNBOOK.md#5-first-contact-email-template) (alias [`NAMED_REFERENCE_CUSTOMER_CAPTURE.md`](../NAMED_REFERENCE_CUSTOMER_CAPTURE.md)) for the initial ask and the [tracking checklist](#per-customer-tracking-checklist-ah) below for steps **a–h** from pilot-complete through **Published**.
...
| **b** | Send first-contact email using [`REFERENCE_PUBLICATION_RUNBOOK.md#5-first-contact-email-template`](REFERENCE_PUBLICATION_RUNBOOK.md#5-first-contact-email-template). | ☐ |
