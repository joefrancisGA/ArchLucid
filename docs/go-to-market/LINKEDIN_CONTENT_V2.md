> **Scope:** Long-form LinkedIn articles M-51+ (builder / founder series). Copy is grounded in shipped V1 capabilities and internal build experience. Do not publish until screenshots referenced have been captured in a live tenant. Do not claim specific customer outcomes until reference customers have approved those statements.

> **Spine doc:** [`START_HERE.md`](../START_HERE.md).

# LinkedIn content — builder series (V2)

**Audience:** Architects, engineering leaders, and solo founders building technical products — especially anyone who has underestimated GTM production work.

**Tone:** Founder/builder diary. Specific and concrete. Self-deprecating where honest. No buzzwords that are not defined. No aspirational futures claimed as present.

**Posting cadence:** One article every two to three weeks after M-15 has had time to breathe. Publish from personal profile, not company page.

**Related:** [`GTM_BACKLOG.md`](GTM_BACKLOG.md) (M-51–M-87), [`WHAT_NOT_TO_PROMISE.md`](WHAT_NOT_TO_PROMISE.md), [`CLAIM_READINESS_STATUS.md`](CLAIM_READINESS_STATUS.md), [`UI_GLOSSARY_V1.md`](UI_GLOSSARY_V1.md), [`POSITIONING.md`](POSITIONING.md), [`SCREENSHOT_GALLERY.md`](SCREENSHOT_GALLERY.md), [`UI_DESIGN_SYSTEM.md`](../library/UI_DESIGN_SYSTEM.md), [`archlucid-ui/AGENTS.md`](../../archlucid-ui/AGENTS.md), [`ARCHLUCID_FOUNDATIONAL_DESIGN_DEBATE.md`](../ARCHLUCID_FOUNDATIONAL_DESIGN_DEBATE.md), [`FIRST_SESSION_DISMISSAL_PLAYBOOK.md`](FIRST_SESSION_DISMISSAL_PLAYBOOK.md).
