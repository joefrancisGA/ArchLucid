...
- **Do not** invent **Baseline** or **Result** numerics. Use **TBD** until measured, **See scorecard** for qualitative capture per [PMF_VALIDATION_TRACKER.md](../archive/gtm-internal/PMF_VALIDATION_TRACKER.md) §2.2, or **Unknown** when deliberately not measured (note why).
...
Within **5 business days** of a formal scorecard review, update every in-scope row in [PMF_VALIDATION_TRACKER.md](../archive/gtm-internal/PMF_VALIDATION_TRACKER.md) for that **Pilot ID**.
