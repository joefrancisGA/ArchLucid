...
- Expectation of **full production HA** on **minimal pilot** budget — start with [../deployment/PILOT_PROFILE.md](../deployment/PILOT_PROFILE.md) *or* align spend before enterprise HA ([../REFERENCE_SAAS_STACK_ORDER.md](../library/REFERENCE_SAAS_STACK_ORDER.md)).
