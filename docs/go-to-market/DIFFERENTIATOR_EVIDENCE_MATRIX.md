...
| "Will procurement catch over-claims?" | **Claim gates + honest trust center** | `scripts/ci/check_buyer_claim_drift.py`, `docs/library/TRUST_CENTER.md`, `docs/go-to-market/ASSURANCE_STATUS_CANONICAL.md` | Zero buyer friction on strict enterprise legal review |
