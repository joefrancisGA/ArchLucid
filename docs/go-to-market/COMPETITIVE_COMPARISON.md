...
- **Governance + audit depth:** Policy packs, approval paths, pre-finalize gates, and durable audit events are part of the shipped story (`POSITIONING.md`, `COMPETITIVE_LANDSCAPE.md` §3).
