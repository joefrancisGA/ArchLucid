...
> **Scope:** 45-minute first-session usability observation for Core Pilot, plus founder 3-session dismissal cohort operations (formerly `FIRST_SESSION_DISMISSAL_PLAYBOOK.md`). No UI implementation until bottlenecks are observed and clear the product decision gate.
...
- [`SPONSOR_EXPORT_DISCOVERY_TEST.md`](SPONSOR_EXPORT_DISCOVERY_TEST.md) — focused ~10-min export-discovery micro-test (H5/D4)
- [`GTM_BACKLOG.md`](GTM_BACKLOG.md) — GTM tracking (**M-38**, **M-44**, **M-46**, **M-48**)
...
- [`PRINCIPAL_ARCHITECT_DISMISSAL_INTERVIEW_SCRIPT.md`](PRINCIPAL_ARCHITECT_DISMISSAL_INTERVIEW_SCRIPT.md) — head-to-head dismissal interview
