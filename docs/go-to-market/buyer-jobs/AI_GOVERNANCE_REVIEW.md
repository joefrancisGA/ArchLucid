...
**Audience:** Risk, compliance, and architecture leaders who need a **Responsible AI** architecture package for internal or sponsor audiences.

**Full architect walkthrough:** [`../../library/walkthroughs/AI_GOVERNANCE_REVIEW.md`](../../library/walkthroughs/AI_GOVERNANCE_REVIEW.md)
