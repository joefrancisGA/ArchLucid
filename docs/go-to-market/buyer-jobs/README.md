...
| --- | --- | --- |
| Azure SaaS readiness | [AZURE_SAAS_READINESS.md](AZURE_SAAS_READINESS.md) | [#demo-proof-shape-demo-derived-only](AZURE_SAAS_READINESS.md#demo-proof-shape-demo-derived-only) |
