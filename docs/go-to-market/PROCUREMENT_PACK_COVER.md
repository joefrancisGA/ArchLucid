...
To: `<<PROCUREMENT_TEAM_OR_LEGAL>>`

Subject: ArchLucid — security & compliance documentation pack
...
2. **What is included** — Policies, tenant isolation (**database-per-tenant** catalogs per ADR 0037), audit coverage matrix, integration catalogue, API contracts, webhook catalogue, accessibility statement, DPA template, subprocessor register, and interim SOC 2 / pen-test **status** statements (see `SOC2_STATUS.md` and `PEN_TEST_SUMMARY.md` inside the pack).
