...
**Related:** [DiD structural vs convention (M-256)](#tenant-isolation-structural-vs-convention-m-256) · [Specialty help chrome ≤~50 (M-252)](#owner-screenshot-below-50-specialty-help-chrome-m-252) · [`INTEGRATION_CATALOG.md`](INTEGRATION_CATALOG.md) · [`PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise`](../library/PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise) · [`PA_CLAIM_HONESTY_INDEX.md`](PA_CLAIM_HONESTY_INDEX.md).
