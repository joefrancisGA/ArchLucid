...
**Related:** [AgentTask→decisioning leak seams (M-248)](#agenttask-decisioning-ungated-leak-seams-m-248) · [Empty-scope catalog routing (M-169)](#empty-scope-catalog-routing-m-169) · [`../library/TECH_BACKLOG.md`](../library/TECH_BACKLOG.md) (`## TB-881`) · [`PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise`](../library/PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise) · [`PA_CLAIM_HONESTY_INDEX.md`](PA_CLAIM_HONESTY_INDEX.md).
