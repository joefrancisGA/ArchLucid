...
**Related:** [Process vs provider idempotency (M-171)](#process-vs-provider-idempotency-m-171) · [Finalize vs outbox (M-163)](#transactional-finalize-vs-outbox-m-163) · [Authority vs AgentTask (M-159)](#authority-vs-agenttask-loop-m-159) · [`PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise`](../library/PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise) · [`PA_CLAIM_HONESTY_INDEX.md`](PA_CLAIM_HONESTY_INDEX.md).
