...
**Related:** [Offline-verifiable export (M-268)](#offline-verifiable-export-portability-m-268) · [GDPR erasure vs append-only (M-266)](#gdpr-erasure-vs-append-only-m-266) · [Append-only / sealed evidence (M-161)](#append-only-sealed-evidence-m-161) · [`../library/EVIDENCE_BACKUP_RESTORE_INVARIANT_MAP.md`](../library/EVIDENCE_BACKUP_RESTORE_INVARIANT_MAP.md) · [ADR 0040](../architecture/adrs/0040-tamper-evident-lineage-without-worm-storage.md) · [`PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise`](../library/PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise) · [`PA_CLAIM_HONESTY_INDEX.md`](PA_CLAIM_HONESTY_INDEX.md).
