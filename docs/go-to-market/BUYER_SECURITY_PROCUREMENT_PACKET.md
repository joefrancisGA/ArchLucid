...
**Related:** [Evidence backup/restore (M-270)](#evidence-backup-restore-invariant-m-270) · [GDPR erasure vs append-only (M-266)](#gdpr-erasure-vs-append-only-m-266) · [Append-only / sealed evidence (M-161)](#append-only-sealed-evidence-m-161) · [`../library/PROJECT_SOFT_DELETE_SEALED_EVIDENCE_MAP.md`](../library/PROJECT_SOFT_DELETE_SEALED_EVIDENCE_MAP.md) · [`PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise`](../library/PUBLIC_CLAIM_BOUNDARY_GUIDE.md#gtm-do-not-promise) · [`PA_CLAIM_HONESTY_INDEX.md`](PA_CLAIM_HONESTY_INDEX.md).
