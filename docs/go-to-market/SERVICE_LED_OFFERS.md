...
**Related:** [`GTM_BACKLOG.md`](GTM_BACKLOG.md) (tasks M-22–M-28, M-34), [`ORDER_FORM_TEMPLATE.md`](ORDER_FORM_TEMPLATE.md), [`POSITIONING.md`](POSITIONING.md), [`docs/assessments/LATEST.md`](../assessments/LATEST.md) (Marketing alignment Q8).
...
**Note:** Indicative bands are planning defaults for **founder-led / consulting-enabled** motion. **`LATEST.md`** Marketing alignment Q7 still applies: **no public paid-pilot $ band on the landing page** in the first 90 days — use **walkthrough → qualify → quote** and private SOWs.
...
Feed results into **`LATEST.md`** improvements and pack/report templates — **do not** expand **`V1_SCOPE.md`** breadth on speculation alone.

---

## Change control

When a SKU name, band, or deliverable list becomes **public** on `archlucid.net`, update **`PRICING_PHILOSOPHY.md`** / procurement templates if numbers are no longer private — and align **`LATEST.md`** Marketing alignment if Q7 posture changes.
