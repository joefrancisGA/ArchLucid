...
**Owner cadence rows:** **G-QA-01**–**G-QA-03** (engineering-adjacent table above)  
...
**Suggested implementation order:** **G-QA-01** → **M-96** → **M-97** → **M-98** → **M-104** / **M-105** → **M-99** → **M-101** → **M-106** (first dry-run) → ongoing **M-100** + **M-102** / **G-QA-03**; add **M-103** once the local/staging founder suite is stable.
