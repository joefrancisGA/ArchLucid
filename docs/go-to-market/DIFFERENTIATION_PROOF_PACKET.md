...
| "Can executives see ROI without reading logs?" | **First-value report + sponsor packet** from committed runs | `archlucid pilot proof-packet <runId>`, `sponsor-proof-packet-index.md`, [`PILOT_BUYER_SAFE_EVIDENCE_TEMPLATE.md`](PILOT_BUYER_SAFE_EVIDENCE_TEMPLATE.md) | Guaranteed dollar ROI without customer baseline inputs |
