...
**2026-04-21 — Readiness vs attestation:** **SOC 2 Type I readiness** (consultant shortlist + observation-period planning) is **in scope for Q2–Q3 2026**; a **CPA opinion** remains gated on executed attestation agreement and budget. Interim artifacts: **owner-led self-assessment** ([`../security/SOC2_SELF_ASSESSMENT_2026.md`](../security/SOC2_SELF_ASSESSMENT_2026.md)), CAIQ/SIG pre-fills, and an **awarded** third-party pen test SoW ([`../security/pen-test-summaries/2026-Q2-SOW.md`](../security/pen-test-summaries/2026-Q2-SOW.md)).
