...
| Be honest about V1 limitations (Azure-hosted product; AWS/GCP-target analysis in V1 with thinner costing; IaC ingest is json / simple-terraform / terraform-show-json / bicep / arm-json / kubernetes-json / kubernetes-yaml — not ArchiMate import or diagram OCR) | Imply multi-cloud unified graphs, certification attestation, or inbound CMDB connectors that do not exist |
