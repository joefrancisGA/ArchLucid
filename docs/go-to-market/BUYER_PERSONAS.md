...
> **Scope:** ArchLucid buyer personas and ideal customer profile (ICP) — who buys, firmographic fit, and how they evaluate — plus buyer self-routing / should-you-evaluate (formerly `SHOULD_YOU_EVALUATE.md`). Full detail in the sections below.
