> **Reviewed:** 2026-07-29
>
> **Scope:** GTM **M-24**–**M-26** Upwork service listing drafts. Copy-paste ready for the Upwork freelancer/agency profile. Not a public price list; not legal advice. Owner personalizes fee, calendar, and counsel before publish.
...
- Cloud Architecture · AI / ML · Solution Architecture · Technical Writing · Risk Management  
- Optional: Azure, Compliance, Enterprise Architecture  
...
1. Architecture Review Report (DOCX or PDF)  
2. Finalized architecture package summary (findings + evidence links)  
...
- [ ] Attach or link a redacted sample only if **M-93** / dogfood sample is cleared  
