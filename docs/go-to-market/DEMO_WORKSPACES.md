...
> **Scope:** Evaluator-facing demo workspaces (Workspace A Product Tour, Workspace B synthetic regulated storyline, stable URLs, scope headers, and export hints) plus `/welcome` hero CTAs, Clarity analytics, and compliance checklist (formerly `WELCOME_HERO_CTA_ANALYTICS.md`).
