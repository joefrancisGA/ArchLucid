...
- **Headline readiness vs procurement realism:** lack of SOC 2 Type I/II CPA attestation does **not** block V1.1 headline product work; procurement friction still requires **explicit** trust narratives ? **`docs/go-to-market/trust-center.md`**, **`docs/go-to-market/ASSURANCE_STATUS_CANONICAL.md#soc-2-readiness-roadmap`**, **`/compliance-journey`**, **`/trust`**, **`/security-trust`** on the apex.
