> **Scope:** Market validation protocol — tests whether experienced architects find ArchLucid outputs non-obvious, correct, evidence-backed, decision-changing, and worth repeating after demo novelty wears off. This is validation work, not a product spec.
...
- `BLIND_INSIGHT_VALIDATION_PROTOCOL.md`
- `PRINCIPAL_ARCHITECT_SESSION_SCORECARD.md`
- `templates/blind-insight-session-log.template.json`
- `templates/principal-architect-session.template.json`
- `PILOT_ROI_MODEL.md`
- `GENERIC_AI_BAKEOFF_PROTOCOL.md`
- `GTM_BACKLOG.md` § Proof-gated rollout
