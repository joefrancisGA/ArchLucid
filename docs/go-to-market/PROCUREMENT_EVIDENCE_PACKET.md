...
| Security posture | Authentication, tenant isolation, data handling, trust-center material, and known assurance status are documented. | [Trust Center](trust-center.md), [Security Overview](../library/contributor-reference/SECURITY.md), [Tenant Isolation](TENANT_ISOLATION.md) |
