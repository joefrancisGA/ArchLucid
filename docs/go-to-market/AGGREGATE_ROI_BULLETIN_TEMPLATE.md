...
> **Scope:** Path-stable alias for the quarterly aggregate ROI bulletin template (owner gate, minimum-N, sign-off audit format, CLI/API automation).

> **Spine doc:** [`START_HERE.md`](../START_HERE.md).

# Aggregate ROI bulletin — template (alias)

**Last reviewed:** 2026-07-28

**Canonical aggregate ROI bulletin template:** [`ROI_MODEL.md#aggregate-roi-bulletin-template`](ROI_MODEL.md#aggregate-roi-bulletin-template).
