...
> **Scope:** Path-stable alias for the Stage 0 minimum pilot trust packet without CPA SOC 2 or published third-party pen test (GTM **M-191** / **TB-1112**). Does **not** reopen Done **TB-135**/**TB-136**. Not an assurance attestation.

# Minimum pilot trust packet (no CPA / no 3P pen test) (alias)
