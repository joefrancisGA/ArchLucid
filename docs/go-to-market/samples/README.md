...
> **Scope:** Synthetic DOCX/PDF samples for buyers and partners previewing collateral formats, plus architecture review board export how-to, whitelabel, and logo rules (formerly `ARCHITECTURE_REVIEW_BOARD_EXPORT.md`). Not customer exports, signed legal deliverables, or authoritative product specs.
