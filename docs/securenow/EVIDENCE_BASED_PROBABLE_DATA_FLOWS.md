...
> **Hold:** [`../library/SECURENOW_PROBABLE_EVIDENCE_HOLD.md`](../library/SECURENOW_PROBABLE_EVIDENCE_HOLD.md). Do not claim observed traffic from **SN-PE** chats. Do not store numeric confidence percents. Do not compose private-endpoint hops without a DNS-zone join.
> **Follow-on (not this set):** runtime declared / observed connections — [`RUNTIME_DECLARED_AND_OBSERVED_DATA_FLOWS.md`](RUNTIME_DECLARED_AND_OBSERVED_DATA_FLOWS.md) · [`../architecture/SECURENOW_RUNTIME_CONNECTION_COMPOSER_PROMPTS.md`](../architecture/SECURENOW_RUNTIME_CONNECTION_COMPOSER_PROMPTS.md) (**SN-RT-01–10**, **12–13**). Observed overlay is **SN-RT-06/07**, not this wave.
