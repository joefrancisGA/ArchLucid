...
| `docs/go-to-market/DECISION_CYCLE_TELEMETRY.md` | [`docs/go-to-market/COMMERCIAL_CONVERSION_CHECKLIST.md`](go-to-market/COMMERCIAL_CONVERSION_CHECKLIST.md#6-decision-cycle-telemetry-local-learning) | Decision-cycle telemetry folded into commercial conversion checklist |
