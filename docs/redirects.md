...
| `docs/go-to-market/reference-customers/REFERENCE_EVIDENCE_PACK_DEMO_SCAFFOLD.md` | [`docs/go-to-market/reference-customers/REFERENCE_PUBLICATION_RUNBOOK.md`](go-to-market/reference-customers/REFERENCE_PUBLICATION_RUNBOOK.md#demo-tenant-scaffold-internal-shape-only) | Demo shape mapping folded into publication runbook (via former evidence pack template) |
| `docs/go-to-market/reference-customers/REFERENCE_EVIDENCE_PACK_TEMPLATE.md` (body) | [`docs/go-to-market/reference-customers/REFERENCE_PUBLICATION_RUNBOOK.md`](go-to-market/reference-customers/REFERENCE_PUBLICATION_RUNBOOK.md#reference-evidence-pack-template) | Evidence pack template folded into publication runbook; filename kept as path-stable alias |
