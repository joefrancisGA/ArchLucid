> **Scope:** Phase 3 exit-gate verification snapshot referenced from [ADR 0022](../../architecture/adr/0022-coordinator-phase3-deferred.md) and historical [`CHANGELOG.md`](../../CHANGELOG.md) entries.

# Phase 3 gate verification (historical snapshot)

This document anchors **mechanical verification** notes for ADR 0021 Phase 3 exit gates when [ADR 0022](../../architecture/adr/0022-coordinator-phase3-deferred.md) recorded blocked or deferred state.
...
Strangler work is re-scoped under [ADR 0030](../../architecture/adr/0030-coordinator-authority-pipeline-unification.md); pre-release waivers for gates **(i)** and **(iv)** are recorded in [ADR 0029](../../architecture/adr/0029-coordinator-strangler-acceleration-2026-05-15.md). Use [`COORDINATOR_TO_AUTHORITY_PARITY.md`](../../runbooks/COORDINATOR_TO_AUTHORITY_PARITY.md) for the live gate table and [`pr-a2-cohort-parity.md`](pr-a2-cohort-parity.md) for PR A2 cohort evidence.
