> **Scope:** Phase 3 exit-gate verification snapshot referenced from [ADR 0022](../../architecture/adrs/0022-coordinator-phase3-deferred.md) and historical [`CHANGELOG.md`](../../CHANGELOG.md) entries.
