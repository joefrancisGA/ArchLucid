...
**Batch 10 — Read-path concurrency hardening** — **partial (2026-05-24): #34 shipped**
...
**Shipped:** #34 — `DapperValueReportMetricsReader`, `DapperPilotReportCardMetricsReader`, `DapperPilotScorecardMetricsReader`, and `DapperWeeklyArchitectureCriticalFindingSummaryRepository` now inject `IReadOnlyDbConnectionFactory`; weekly digest SQL repo registration changed from singleton to scoped for lifetime alignment.
