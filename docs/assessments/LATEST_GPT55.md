...
`ArchLucid Assessment – (A) Headline Readiness: 74.74%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-660** rescore bumps Time-to-Value on the curated reference-architecture exemplar corpus for Topology style-prior cold-start quality.
...
| 10 | Adoption Friction | 95 | 5 | 4.75 | 25 |
| | **(A) Headline readiness** | | **100** | **74.74** | |
