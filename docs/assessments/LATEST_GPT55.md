...
# ArchLucid Assessment – (A) Headline Readiness: 81.92%
...
Rescore note: Through **81.86%** (5X); batch **5Y TB-208** (CLI global tool + self-contained binary publish) → **81.92%** (+1 Adoption Friction). G-REAL/TB-140 owner-blocked.
...
| Adoption Friction | 72 | 6 | 3.74% | 168 |
