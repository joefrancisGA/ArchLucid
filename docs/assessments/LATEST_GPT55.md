...
`ArchLucid Assessment – (A) Headline Readiness: 74.44%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-658** rescore bumps Time-to-Value on unified `archlucid stack doctor` deployment readiness routing.
...
| 10 | Adoption Friction | 91 | 5 | 4.55 | 45 |
| | **(A) Headline readiness** | | **100** | **74.44** | |
