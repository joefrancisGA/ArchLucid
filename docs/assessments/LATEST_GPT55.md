...
`ArchLucid Assessment – (A) Headline Readiness: 74.54%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-666** rescore bumps Adoption Friction on the highest-impact tab-semantics migration (`/reviews/new` start-mode selector).
...
| | **(A) Headline readiness** | | **100** | **74.54** | |
