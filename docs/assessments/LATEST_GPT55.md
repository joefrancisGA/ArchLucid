...
`ArchLucid Assessment – (A) Headline Readiness: 74.00%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-651** rescore bumps Adoption Friction on canonical pipeline status vocabulary.
...
| | **(A) Headline readiness** | | **100** | **74.00** | |
