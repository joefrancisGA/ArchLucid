...
# ArchLucid Assessment – (A) Headline Readiness: 82.22%
...
Rescore note: Through **82.16%** (5AC); batch **5AD TB-216** (`archlucid try --sponsor-packet`) → **82.22%** (+1 Adoption Friction). G-REAL/TB-140 owner-blocked.
