...
`ArchLucid Assessment – (A) Headline Readiness: 73.85%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-648** rescore bumps Adoption Friction on admin-tool nav gating and jargon relabeling.
...
| | **(A) Headline readiness** | | **100** | **73.85** | |
