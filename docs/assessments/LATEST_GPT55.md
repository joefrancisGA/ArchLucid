...
## 1. Title & Headline
ArchLucid Assessment - (A) Headline Readiness: **99.07%**.
...
|---|---------|------:|-------:|----------------------:|---------------------------:|
| 1 | Decision-Changing Insight Density | 98 | 13 | 12.74 | 26 |
...
|  | **(A) Headline readiness** |  | **100** | **99.07** |  |
