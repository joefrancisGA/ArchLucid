...
# ArchLucid Assessment – (A) Headline Readiness: 82.28%
...
Rescore note: Through **82.22%** (5AD); batch **5AE TB-217** (demo seed auto-apply on startup when AnonymousViewer enabled) → **82.28%** (+1 Time-to-Value). G-REAL/TB-140 owner-blocked.
