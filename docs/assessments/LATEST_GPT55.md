...
`ArchLucid Assessment – (A) Headline Readiness: 74.64%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-669** rescore bumps Adoption Friction on the buyer `/graph` evidence-trail presentation tabs.
...
| | **(A) Headline readiness** | | **100** | **74.64** | |
