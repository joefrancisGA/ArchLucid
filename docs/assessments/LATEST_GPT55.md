...
## 1. Title & Headline
ArchLucid Assessment - (A) Headline Readiness: **99.39%**.
...
|---|---------|------:|-------:|----------------------:|---------------------------:|
| 1 | Decision-Changing Insight Density | 99 | 13 | 12.87 | 13 |
...
| 5 | AI / Agent Readiness | 97 | 10 | 9.70 | 30 |
...
|  | **(A) Headline readiness** |  | **100** | **99.39** |  |
...
- **Score / Weight / Contribution / Deficiency:** 97 / 10 / 9.70 / 30
- **Affects outcomes:** 1, 2, 5
