...
`ArchLucid Assessment – (A) Headline Readiness: 74.17%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-657** rescore bumps Runtime & First-Review Reliability on CD-owned Container App image ownership.
...
| | **(A) Headline readiness** | | **100** | **74.17** | |
