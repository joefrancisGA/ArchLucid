...
`ArchLucid Assessment – (A) Headline Readiness: 73.24%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-617** rescore bumps Adoption Friction and Executive / Operator Comprehension on Review Package detail summary consolidation.
...
| | **(A) Headline readiness** | | **100** | **73.24** | |
