...
## 1. Title & Headline
ArchLucid Assessment - (A) Headline Readiness: **95.98%**.
...
|---|---------|------:|-------:|----------------------:|---------------------------:|
| 1 | Decision-Changing Insight Density | 91 | 13 | 11.83 | 117 |
...
|  | **(A) Headline readiness** |  | **100** | **95.98** |  |
