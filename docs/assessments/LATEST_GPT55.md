...
# ArchLucid Assessment – (A) Headline Readiness: 81.98%
...
Rescore note: Through **81.92%** (5Y); batch **5Z TB-209** (`archlucid request create --from-file`) → **81.98%** (+1 Adoption Friction). G-REAL/TB-140 owner-blocked.
...
| Adoption Friction | 73 | 6 | 3.80% | 162 |
