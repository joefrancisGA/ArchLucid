...
`ArchLucid Assessment – (A) Headline Readiness: 73.60%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-643** rescore bumps Adoption Friction on buyer-default shell decoupled from demo build flags.
...
| | **(A) Headline readiness** | | **100** | **73.60** | |
