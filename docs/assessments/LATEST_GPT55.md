...
`ArchLucid Assessment – (A) Headline Readiness: 71.34%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Computed fresh this pass from the Weighted Quality Model in §2 — no score carried forward from any prior assessment file.
...
| 10 | Adoption Friction | 65 | 5 | 3.25 | 175 |
| | **(A) Headline readiness** | | **100** | **71.34** | |
