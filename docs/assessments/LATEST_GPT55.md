...
`ArchLucid Assessment – (A) Headline Readiness: 73.95%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-650** rescore bumps Adoption Friction on operator health label product-language pass.
...
| | **(A) Headline readiness** | | **100** | **73.95** | |
