...
`ArchLucid Assessment – (A) Headline Readiness: 74.49%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-665** rescore bumps Adoption Friction on the shared accessible `Tabs` primitive prerequisite for the tab-semantics cluster.
...
| | **(A) Headline readiness** | | **100** | **74.49** | |
