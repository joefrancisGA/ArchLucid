...
`ArchLucid Assessment – (A) Headline Readiness: 74.59%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-667** rescore bumps Adoption Friction on the operator-home runs dashboard tab switcher.
...
| | **(A) Headline readiness** | | **100** | **74.59** | |
