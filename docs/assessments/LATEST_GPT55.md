...
## 1. Title & Headline
ArchLucid Assessment - (A) Headline Readiness: **97.98%**.
...
|---|---------|------:|-------:|----------------------:|---------------------------:|
| 1 | Decision-Changing Insight Density | 96 | 13 | 12.48 | 52 |
...
|  | **(A) Headline readiness** |  | **100** | **97.98** |  |
