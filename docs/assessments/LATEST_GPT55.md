...
`ArchLucid Assessment – (A) Headline Readiness: 73.80%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-647** rescore bumps Adoption Friction on architect-vs-ops sidebar regrouping.
...
| | **(A) Headline readiness** | | **100** | **73.80** | |
