...
## 1. Title & Headline
ArchLucid Assessment - (A) Headline Readiness: **94.87%**.
...
|  | **(A) Headline readiness** |  | **100** | **94.87** |  |
...
- **Score / Weight / Contribution / Deficiency:** 87 / 10 / 8.70 / 130
- **Affects outcomes:** 1, 2, 5
