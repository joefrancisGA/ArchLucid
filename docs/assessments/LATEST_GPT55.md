...
`ArchLucid Assessment – (A) Headline Readiness: 74.34%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-656** rescore bumps Runtime & First-Review Reliability on user-assigned Key Vault workload identities.
...
| 6 | Time-to-Value | 69 | 10 | 6.90 | 310 |
...
| | **(A) Headline readiness** | | **100** | **74.34** | |
