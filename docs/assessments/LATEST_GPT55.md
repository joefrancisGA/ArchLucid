...
`ArchLucid Assessment – (A) Headline Readiness: 73.75%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-646** rescore bumps Adoption Friction on outcome-first intake CTA wiring.
...
| | **(A) Headline readiness** | | **100** | **73.75** | |
