...
`ArchLucid Assessment – (A) Headline Readiness: 74.05%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-652** rescore bumps Adoption Friction on repeatable full-app UX audit capture (buyer + operator + marketing).
...
| | **(A) Headline readiness** | | **100** | **74.05** | |
