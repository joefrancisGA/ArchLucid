...
`ArchLucid Assessment – (A) Headline Readiness: 73.55%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-642** rescore bumps Adoption Friction on operator-shell header budget-pill authority gating.
...
| | **(A) Headline readiness** | | **100** | **73.55** | |
