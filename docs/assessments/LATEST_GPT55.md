...
`ArchLucid Assessment – (A) Headline Readiness: 73.65%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-644** rescore bumps Adoption Friction on cloud-neutral, outcome-first new-review intake defaults.
...
| | **(A) Headline readiness** | | **100** | **73.65** | |
