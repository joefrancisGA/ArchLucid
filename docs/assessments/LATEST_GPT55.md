...
`ArchLucid Assessment – (A) Headline Readiness: 74.10%`. Readiness excludes deferred (V1.1/V2) items per the governing scope docs. Base pass computed fresh from the Weighted Quality Model in §2; **TB-653** rescore bumps Adoption Friction on UX audit harness maintainability (drift guard + quarterly cadence).
...
| | **(A) Headline readiness** | | **100** | **74.10** | |
