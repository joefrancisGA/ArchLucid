...
3. **Archive vs active:** superseded narratives belong under **`docs/archive/`** with an explicit scope/status — do not leave orphan duplicates in **`docs/`** root (see [**Docs root markdown budget**](REPO_HYGIENE.md)).
