> **Scope:** Contributor-reference — Degraded mode — LLM and agent availability - full detail, tables, and links in the sections below.
...
| Architect workspace & governance dashboard | No | Continues for non-LLM pages | N/A |
