...
| `TenantItsmConnectorConnectionUpserted` | `TenantItsmConnectorConnectionUpserted` | `TenantItsmConnectorConnectionsController` (`POST /v1/integrations/itsm/connections/{provider}`) |
