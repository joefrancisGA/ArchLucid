...
| Architecture inventory snapshot bind | `ArchitecturesController` (`POST /v1/architectures/{architectureId}/inventory-binding`) | `ArchitectureInventorySnapshotBound` | Tenant/Workspace/Project from ambient scope | `{ architectureId, snapshotId }` |
| Architecture inventory snapshot unbind | `ArchitecturesController` (`DELETE /v1/architectures/{architectureId}/inventory-binding`) | `ArchitectureInventorySnapshotDetached` | Tenant/Workspace/Project from ambient scope | `{ architectureId }` |
...
| `ArchitectureInventorySnapshotBound` | `ArchitectureIdentity.InventorySnapshotBound` | `ArchitecturesController` (`POST /v1/architectures/{architectureId}/inventory-binding`) |
| `ArchitectureInventorySnapshotDetached` | `ArchitectureIdentity.InventorySnapshotDetached` | `ArchitecturesController` (`DELETE /v1/architectures/{architectureId}/inventory-binding`) |
