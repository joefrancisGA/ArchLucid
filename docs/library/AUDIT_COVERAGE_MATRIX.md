...
| User desk continuity preference upsert | `UserPreferencesController` (`PUT /v1/user/preferences/desk-continuity`) | — | — | Personal desk continuity state stored in `dbo.UserSettings`; **no** durable audit row (`[MutatingAuditExcluded]` on controller) |
...
| Operational security finding batch ingest (HTTP) | `OperationalSecurityFindingsController` (`POST /v1/operational-security/findings/ingest`); `OperationalSecurityFindingIngestService` | `OperationalSecurityFindingIngested`, `OperationalSecurityFindingDeduplicated` | Tenant/Workspace/Project from ambient scope | Controller `[MutatingAuditExcluded]` — service emits ingest/dedup audit rows |
| Operational security remediation pattern draft | `RemediationPatternsController` (`POST /v1/operational-security/remediation-patterns/draft`) | — | — | Tenant-scoped remediation pattern registry metadata — **no** durable audit row (`[MutatingAuditExcluded]` on controller) |
| Operational security remediation pattern import (bulk) | `RemediationPatternsController` (`POST /v1/operational-security/remediation-patterns/import/bulk`) | — | — | Bulk draft import with per-item validation — **no** durable audit row (`[MutatingAuditExcluded]` on controller) |
| Operational security remediation pattern import (JSON) | `RemediationPatternsController` (`POST /v1/operational-security/remediation-patterns/import/json`) | — | — | JSON draft import — **no** durable audit row (`[MutatingAuditExcluded]` on controller) |
| Operational security remediation pattern import (YAML) | `RemediationPatternsController` (`POST /v1/operational-security/remediation-patterns/import/yaml`) | — | — | YAML draft import — **no** durable audit row (`[MutatingAuditExcluded]` on controller) |
| Operational security remediation pattern approve | `RemediationPatternsController` (`POST /v1/operational-security/remediation-patterns/{patternId}/approve`) | — | — | Version approval with SoD enforced in service — **no** durable audit row (`[MutatingAuditExcluded]` on controller) |
| Operational security remediation pattern deprecate | `RemediationPatternsController` (`POST /v1/operational-security/remediation-patterns/{patternId}/deprecate`) | — | — | Version deprecation — **no** durable audit row (`[MutatingAuditExcluded]` on controller) |
| Operational security remediation pattern retire | `RemediationPatternsController` (`POST /v1/operational-security/remediation-patterns/{patternId}/retire`) | — | — | Version retirement — **no** durable audit row (`[MutatingAuditExcluded]` on controller) |
| Operational security remediation pattern submit | `RemediationPatternsController` (`POST /v1/operational-security/remediation-patterns/{patternId}/submit`) | — | — | Version submit-for-review transition — **no** durable audit row (`[MutatingAuditExcluded]` on controller) |
