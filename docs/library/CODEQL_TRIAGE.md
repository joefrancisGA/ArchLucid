...
| `js/user-controlled-bypass` | `shouldOfferItsmOAuthSupportMailto` / `showSupportMailto` — failure + correlation metadata | Convenience mailto after a failed OAuth callback; not an authorization decision. | 2026-09-15 |
