...
**Deferred:** wave 86 run-query findings export/inspect follow-ups completed in wave 110 — see [`ARCHITECTURE_REVIEW_ROBUSTNESS_WAVE111.md`](ARCHITECTURE_REVIEW_ROBUSTNESS_WAVE111.md) (1317–1328) when opened.
