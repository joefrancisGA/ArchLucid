...
- [adr/README.md](../architecture/adrs/README.md) is the durable decision log. The accompanying ADR for the membrane is **`adr/0029-mcp-membrane-and-agent-ecosystem.md`** (draft).
...
|---|---|---|
| **Scalability** | Membrane is stateless and horizontally scalable; bottleneck remains the SQL pipeline behind it. | Same hosting model as `ArchLucid.Api` per [adr/0001-hosting-roles-api-worker-combined.md](../architecture/adrs/0001-hosting-roles-api-worker-combined.md). |
...
- [adr/README.md](../architecture/adrs/README.md) — append `0029` (and any future MCP/agent ADRs) to the table.
