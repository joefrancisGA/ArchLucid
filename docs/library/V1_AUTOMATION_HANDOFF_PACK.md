...
**Claim boundary:** ROI figures are estimates — not invoiced Azure OpenAI spend. Sponsor-safe SEND requires baseline completeness per [`ROI_BASELINE_SEND_POLICY.md`](ROI_BASELINE_SEND_POLICY.md).
