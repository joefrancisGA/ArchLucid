...
**Deferred:** wave 86 run-coverage acknowledgement PUT/PATCH action-level mapper follow-ups — see [`ARCHITECTURE_REVIEW_ROBUSTNESS_WAVE109.md`](ARCHITECTURE_REVIEW_ROBUSTNESS_WAVE109.md) (1293–1304) when opened.
