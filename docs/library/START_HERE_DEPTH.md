...
**Inventory:** [`library/DOC_INVENTORY_2026_04_25.md`](DOC_INVENTORY_2026_04_25.md) lists every active markdown file (excluding `docs/archive/`) with last-modified metadata and audience tags.
