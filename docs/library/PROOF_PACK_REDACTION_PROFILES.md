...
| **LLM / traces** | Raw prompts/completions **discouraged**; prefer summaries. If shared for debugging, mark **internal-only** and retain per customer retention policy (**[SECURITY.md](contributor-reference/SECURITY.md)** — PII-sized exports). |
