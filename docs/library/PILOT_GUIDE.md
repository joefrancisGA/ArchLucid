...
**First real Azure OpenAI on the demo stack:** [FIRST_REAL_VALUE.md](FIRST_REAL_VALUE.md) (`archlucid try --real`, **`ARCHLUCID_REAL_AOAI=1`**, ADR **[`../architecture/adr/0033-first-real-value-single-env-var-flip.md`](../architecture/adr/0033-first-real-value-single-env-var-flip.md)**).
