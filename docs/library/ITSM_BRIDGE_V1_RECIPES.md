...
**Non-goals:** This page does not replace [INTEGRATION_CATALOG.md](../go-to-market/INTEGRATION_CATALOG.md), [INTEGRATION_EVENTS_AND_WEBHOOKS.md](INTEGRATION_EVENTS_AND_WEBHOOKS.md), or the OpenAPI contract. **First-party** **Jira**, **ServiceNow**, **Slack** (outbound), and **Confluence** publish are **V1.1** scope ([`V1_SCOPE.md`](V1_SCOPE.md) §2.13–§2.15). **Microsoft Teams**, **CloudEvents webhooks**, and these **customer-operated** recipes are **V1.1 buyer-contract** surfaces ([`V1_SCOPE.md`](V1_SCOPE.md) §2.8, §2.14, §3). **V1 GA** relies on **REST**, **CLI**, **operator UI**, and **§2.16+** paths for comparable workflows.
