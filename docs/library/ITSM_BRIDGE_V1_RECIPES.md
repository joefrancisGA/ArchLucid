> **Scope:** Buyer-facing end-to-end recipes bridging ArchLucid to enterprise workflows (Azure DevOps PR review, CloudEvents consumers, customer-owned Power Automate / Logic Apps); not a SKU matrix, endpoint inventory, or substitute for **V1.1** first-party **Jira** / **ServiceNow** ([`V1_SCOPE.md`](V1_SCOPE.md) §2.13), **Microsoft Teams** / **Slack** chat-ops ([`V1_SCOPE.md`](V1_SCOPE.md) §2.14), **Confluence** publish ([`V1_SCOPE.md`](V1_SCOPE.md) §2.15), or **V1.1** webhook / Service Bus commitments (**§2.8**).

> **Spine doc:** [`START_HERE.md`](../START_HERE.md).

# ITSM bridge — recipe hub (V1.1 buyer contract)
...
**Non-goals:** This page does not replace [INTEGRATION_CATALOG.md](../go-to-market/INTEGRATION_CATALOG.md), [INTEGRATION_EVENTS_AND_WEBHOOKS.md](INTEGRATION_EVENTS_AND_WEBHOOKS.md), or the OpenAPI contract. **First-party** **Jira**, **ServiceNow**, **Slack** (outbound), and **Confluence** publish are **V1.1** scope ([`V1_SCOPE.md`](V1_SCOPE.md) §2.13–§2.15). **Microsoft Teams**, **CloudEvents webhooks**, and these **customer-operated** recipes are **V1.1 buyer-contract** surfaces ([`V1_SCOPE.md`](V1_SCOPE.md) §2.8, §2.14, §3). **V1 GA** relies on **REST**, **CLI**, **architect workspace**, and **§2.16+** paths for comparable workflows.
