...
- The API is reachable with a configured auth mode — see **[`SECURITY.md`](SECURITY.md)** and **[`customer-facing/customer-facing/PILOT_GUIDE.md`](customer-facing/PILOT_GUIDE.md)**.
