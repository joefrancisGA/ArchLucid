...
- [x] (proven) GCP WIF audience `http://` provider double-prefixed — **hit 2026-08-25:** `NormalizeAudience` prepended `//iam.googleapis.com/` to full `http://iam.googleapis.com/...` URLs; regression in `NormalizeAudience_normalizes_http_iam_googleapis_com_prefix`
