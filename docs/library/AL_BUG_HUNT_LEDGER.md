...
- **consecutive-dry-hunts:** 0
- **last-hunt:** 2026-08-28
- **last-bug:** 2026-08-28 — `GovernanceController.BatchReviewApprovalRequests` duplicate `approvalRequestIds` silently deduped without per-item result row
- **related-pd-tb:** none
- **code-changed-since:** yes
...
2026-08-28 thorough hunt #260: re-shipped #256/#258 batch-review duplicate-id fix on master; cheap-disproved manifest-compare padded-version candidate (trim parity via `GetManifestInScopeAsync`).
