...
- **last-bug:** 2026-08-24 — `azurerm_maps_account` Terraform ids omitted from `LooksLikeTerraformServiceSourceId` (`maps_account` was only listed for datastore aliases)
- **related-pd-tb:** none
