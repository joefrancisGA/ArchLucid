...
2026-08-29 seed hunt #261: proved batch-review duplicate-id per-item validation; cheap-disproved manifest-compare padded-version 404 candidate; seeded bulk-disposition duplicate findingId candidate.
