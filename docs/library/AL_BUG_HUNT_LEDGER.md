...
- **last-bug:** 2026-08-29 — batch-review duplicate approvalRequestIds per-item validation
- **related-pd-tb:** none
- **code-changed-since:** yes
...
2026-08-29 thorough hunt #263: proved batch-review duplicate-id per-item validation; cheap-disproved manifest-compare padded-version 404 candidate; seeded bulk-disposition duplicate findingId candidate.
