...
- **last-hunt:** 2026-08-24
- **last-bug:** 2026-08-24 — `azurerm_healthcare_workspace` Terraform ids omitted from `LooksLikeTerraformServiceSourceId` (`healthcare_workspace` was only listed for datastore aliases)
- **related-pd-tb:** none
