...
- **last-hunt:** 2026-08-24
- **last-bug:** 2026-08-24 — `azurerm_cognitive_account` Terraform ids omitted from `LooksLikeTerraformServiceSourceId` (only `cognitive_services` / `cognitive_deployment` were listed)
- **related-pd-tb:** none
