...
- **consecutive-dry-hunts:** 0
- **last-hunt:** 2026-08-25
- **last-bug:** 2026-08-25 — structured claim `evidenceRefs` not merged into `AgentResult.EvidenceRefs`
- **related-pd-tb:** none
- **code-changed-since:** yes
