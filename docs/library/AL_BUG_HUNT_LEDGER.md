...
- [x] (candidate) Replay guard allows duplicate delivery of the same event id - fixed: TryClaimAsync atomically claims delivery id before mutation; ReleaseAsync on handler failure
