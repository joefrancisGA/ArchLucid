...
- **last-hunt:** 2026-08-24
- **last-bug:** 2026-08-24 — `azurerm_machine_learning_workspace` Terraform ids omitted from `LooksLikeTerraformServiceSourceId` (`machine_learning` was only listed for datastore aliases)
- **related-pd-tb:** none
