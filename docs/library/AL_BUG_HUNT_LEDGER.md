...
- **consecutive-dry-hunts:** 0
- **last-hunt:** 2026-08-25
- **last-bug:** 2026-08-25 — clarification answers POST returned 200 appliedCount 0 for missing run while GET returned 404
- **related-pd-tb:** none
- **code-changed-since:** no
...
- [x] (proven) `ReviewClarificationQuestionsController.ApplyKnowledgeModelClarificationAnswers` returned 200 `appliedCount: 0` for missing runs while GET returned 404 — **hit 2026-08-25:** POST skipped run-existence check; fixed by calling `GetQuestionsAsync` before apply (`ReviewClarificationQuestionsControllerTests.ApplyKnowledgeModelClarificationAnswers_returns_not_found_when_run_missing`).
