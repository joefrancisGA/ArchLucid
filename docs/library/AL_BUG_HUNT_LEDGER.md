...
- [ ] (candidate) `GovernanceController.GetDashboard` — cap validation tests assert HTTP 400 only and omit `ProblemTypes.ValidationFailed` problem-type regression (dashboard validation contract documentation gap).
