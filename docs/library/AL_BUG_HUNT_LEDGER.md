...
- **last-bug:** 2026-08-28 — deferred disposition accepted `default(DateTimeOffset)` revisit due (year 0001)
- **related-pd-tb:** none
- **code-changed-since:** no
