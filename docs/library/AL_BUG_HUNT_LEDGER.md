...
- **last-hunt:** 2026-08-24
- **last-bug:** 2026-08-24 — `azurerm_log_analytics_workspace` Terraform ids omitted from `LooksLikeTerraformServiceSourceId` (`log_analytics` was only listed for datastore aliases)
- **related-pd-tb:** none
