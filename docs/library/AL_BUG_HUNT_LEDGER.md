...
- **last-hunt:** 2026-08-24
- **last-bug:** 2026-08-24 — `azurerm_databricks_workspace` Terraform ids omitted from `LooksLikeTerraformServiceSourceId` (`databricks` was only listed for datastore aliases)
- **related-pd-tb:** none
