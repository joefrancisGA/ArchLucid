...
- **consecutive-dry-hunts:** 0
- **last-hunt:** 2026-08-25
- **last-bug:** 2026-08-25 — Azure ARM null tag values dropped from inventory records
- **related-pd-tb:** none
- **code-changed-since:** no
...
- [x] (proven) Azure ARM `MapResource` drops null tag values — **hit 2026-08-25:** `tags.owner: null` was omitted from `HostedAzureArmResourceRecord.Tags`; fixed by preserving null JSON tag values as empty strings (`ListSubscriptionResourcesAsync_preserves_null_arm_tag_values_as_empty_strings`).
