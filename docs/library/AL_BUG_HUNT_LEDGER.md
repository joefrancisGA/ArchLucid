...
- **consecutive-dry-hunts:** 0
- **last-hunt:** 2026-08-26
- **last-bug:** 2026-08-26 — JSON infra parser dropped numeric custom properties
- **related-pd-tb:** none
- **code-changed-since:** yes
...
- [x] (proven) `TerraformShowJsonInfrastructureDeclarationParser` ingested `mode: "data"` resources as topology — **hit 2026-08-26:** `azurerm_client_config` data sources appeared in infra declaration connector output; fixed with early return skip (`TerraformShowJsonInfrastructureDeclarationParserTests.ParseAsync_ModeDataResources_AreExcluded`).
...
2026-08-26 seed hunt #74: proved policy-hint dedupe, actor label casing, terraform data-mode skip, K8s generateName fallback, and JSON numeric custom properties.
