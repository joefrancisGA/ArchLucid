...
- **consecutive-dry-hunts:** 0
- **last-hunt:** 2026-08-31
- **last-bug:** 2026-08-31 — combined PRs #981–#991 plus #992 catalog/projectId/checklist validation; combined al-bug hunts #313–#334: governance scope gates, OTP RowVersion retry, link-proposal status guard, AgentResultJsonConverter evidenceRefs merge, product feedback score and checklist isCompleted validation
- **related-pd-tb:** none
- **code-changed-since:** yes
