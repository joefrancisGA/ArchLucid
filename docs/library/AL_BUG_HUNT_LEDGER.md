...
- **consecutive-dry-hunts:** 0
- **last-hunt:** 2026-08-27
- **last-bug:** 2026-08-27 — sponsor digest sign-in URL trailing-slash legacy path
- **related-pd-tb:** none
- **code-changed-since:** yes
...
- [x] (proven) `normalizeSignInUrl` in `exec-digest-sponsor-deep-link-server.ts` misses trailing-slash legacy `/auth/sign-in/` paths — **hit 2026-08-27:** regex required end/query after `sign-in`; `/auth/sign-in/` from API still 404'd; allow optional trailing slash before delimiter (`exec-digest-sponsor-deep-link-server.test.ts`).
