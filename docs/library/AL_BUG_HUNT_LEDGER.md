...
- **last-hunt:** 2026-08-24
- **last-bug:** 2026-08-24 — `azurerm_kusto_cluster` Terraform ids omitted from `LooksLikeTerraformServiceSourceId` (`kusto_cluster` was only listed for datastore aliases)
- **related-pd-tb:** none
