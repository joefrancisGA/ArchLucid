...
2026-08-31 seed hunt #367 (hit): reseeded from zone files; proved environment-catalog ghost tenant, empty `projectId` query validation, and checklist `isCompleted` omission on master; seeded ghost-workspace posture/coverage and product-feedback score candidates.
