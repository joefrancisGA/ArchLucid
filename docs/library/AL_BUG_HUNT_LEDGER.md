...
2026-08-31 thorough hunt #380 (hit): proved three hunt-ready ghost-workspace posture/coverage and product-feedback score rows on master; seeded environment-catalog ghost-tenant, empty `projectId` validation, and checklist `isCompleted` omission candidates.
