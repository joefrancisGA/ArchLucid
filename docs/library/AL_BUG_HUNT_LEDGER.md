...
- **last-hunt:** 2026-08-24
- **last-bug:** 2026-08-24 — `azurerm_application_insights` Terraform ids omitted from `LooksLikeTerraformServiceSourceId` (`application_insights` was only listed for datastore aliases)
- **related-pd-tb:** none
