...
| --- | --- | --- |
| **5DL-trust-p1** | Trustworthiness, Correctness | Remaining SEC/BE production blockers (scope binding, webhook HMAC gaps, additional `{tenantId}` routes, export/ingest tests) |
