> **Scope:** Contributor-reference — Azure App Configuration — future adoption plan - full detail, tables, and links in the sections below.
...
**Companion to:** [ADR 0017](../architecture/adrs/0017-azure-app-configuration-deferred.md)
