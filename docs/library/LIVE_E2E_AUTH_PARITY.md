> **Scope:** Contributor-reference — Live E2E — auth parity (DevelopmentBypass vs ApiKey vs JWT) - full detail, tables, and links in the sections below.
