...
| --- | --- | --- | --- | --- |
| [Azure SaaS readiness](AZURE_SAAS_READINESS_REVIEW.md) | Azure extractor Tier 1 ZIP or labeled demo workspace | Finalized architecture package, WAF/SaaS findings, policy pack when used | Demo-derived ROI must stay labeled | Not Azure certification or pen-test attestation |
| [AI governance](AI_GOVERNANCE_REVIEW.md) | Policy pack + finalized review | Governance dry-run output when enabled, sponsor export | Simulator vs real LLM must match proof labels | Not statutory AI compliance certification |
