...
| Field | Value |
| --- | --- |
| **Hasher schema version** | `v2` (`ManifestHashService.HasherSchemaVersion`; wave-5 `ArchitectureVersionId`) |
| **Fixture** | `BaseManifest` in `ArchLucid.Decisioning.Tests/ManifestHashServiceTests.cs` |
| **Committed artifact** | [`tests/manifest-hash/hasher-baseline-v2.json`](../../tests/manifest-hash/hasher-baseline-v2.json) |
| **Pinned SHA-256** | `E09775314D179A04ACF9E34DB70CBE461B7273B84A7A619E9AD5A5C6343BDBB9` |
...
4. **Run** `ManifestHashServiceTests.ComputeHash_MatchesPinnedBaseline_v2` (or successor) and export verify / replay tests as applicable.
...
| `tests/manifest-hash/hasher-baseline-v2.json` | Committed golden hash |
| `ManifestHashServiceTests.ComputeHash_MatchesPinnedBaseline_v2` | Regression proof |
