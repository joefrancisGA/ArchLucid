...
| Field | Value |
| --- | --- |
| **Hasher schema version** | `v5` (`ManifestHashService.HasherSchemaVersion`; wave-10 create-time κ content hash binding) |
| **Fixture** | `BaseManifest` in `ArchLucid.Decisioning.Tests/ManifestHashServiceTests.cs` |
| **Committed artifact** | [`tests/manifest-hash/hasher-baseline-v5.json`](../../tests/manifest-hash/hasher-baseline-v5.json) |
| **Pinned SHA-256** | `8C3A01C5026F0FF55AF44D254A4976A5F1EC33AAE8A54FEB234F951F67DB16DF` |
...
4. **Run** `ManifestHashServiceTests.ComputeHash_MatchesPinnedBaseline_v5` (or successor) and export verify / replay tests as applicable.
...
| `tests/manifest-hash/hasher-baseline-v5.json` | Committed golden hash |
| `ManifestHashServiceTests.ComputeHash_MatchesPinnedBaseline_v5` | Regression proof |
