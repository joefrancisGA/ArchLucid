...
Until **V1.1** surfaces in **§2.8** (integration events), **§2.14** (Teams / Slack), and **§2.13–§2.15** (first-party ITSM / docs) are available in a given environment, the **V1** buyer contract for comparable automation remains **REST**, **CLI**, **operator UI**, and **§2.16+** — not **webhooks**, **Teams**, or **recipe** bridges.
