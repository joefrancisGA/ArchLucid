...
For deeper flow detail, use [First architecture review walkthrough](FIRST_RUN_WALKTHROUGH.md) ([`FIRST_RUN_WALKTHROUGH.md`](FIRST_RUN_WALKTHROUGH.md)), [LIVE_E2E_HAPPY_PATH.md](LIVE_E2E_HAPPY_PATH.md), and [ARCHITECTURE_FLOWS.md](ARCHITECTURE_FLOWS.md).
