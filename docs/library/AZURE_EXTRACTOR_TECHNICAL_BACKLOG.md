> **Scope:** Engineering backlog for the customer Azure extractor ZIP path, Terraform export, and citations — extends V1_SCOPE.md sections 2.16–2.17; not procurement copy.
