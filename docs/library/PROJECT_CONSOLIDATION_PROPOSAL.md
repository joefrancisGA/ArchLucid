...
3. **Platform clarity:** Azure-first operations are explicit ([ADR 0020](../architecture/adr/0020-azure-primary-platform-permanent.md)); Terraform and runbooks stay aligned with IaC in `infra/`.
