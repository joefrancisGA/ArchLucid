> **Scope:** Contributor-reference — Project and documentation consolidation (proposal) - full detail, tables, and links in the sections below.
...
1. **Single navigation spine:** Treat [docs/architecture/README.md](../architecture/README.md) as the architecture doc graph root; [docs/START_HERE.md](../START_HERE.md) stays a short persona router only.
...
- When adding a new “hub” doc, link it from `docs/architecture/README.md` in one line.
