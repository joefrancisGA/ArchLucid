...
**Related:** [COMMITTED_GOLDEN_MANIFEST_UNIT_OF_TRUTH_CONTRACT.md](./COMMITTED_GOLDEN_MANIFEST_UNIT_OF_TRUTH_CONTRACT.md) (**TB-1003**) · [APPEND_ONLY_AND_SEALED_EVIDENCE_CONTRACT.md](./APPEND_ONLY_AND_SEALED_EVIDENCE_CONTRACT.md) (**TB-1009**) · [MANIFEST_DUAL_HASHER_PROJECTION_EVOLUTION_CONTRACT.md](./MANIFEST_DUAL_HASHER_PROJECTION_EVOLUTION_CONTRACT.md) (**TB-1156**) · [DAPPER_DDL_SATELLITE_BREAKDOWN_SIGNALS_CONTRACT.md](./DAPPER_DDL_SATELLITE_BREAKDOWN_SIGNALS_CONTRACT.md) (**TB-1263**) · [JSON_FALLBACK_AUDIT.md](./JSON_FALLBACK_AUDIT.md) · [EVIDENCE_IMMUTABILITY.md](./EVIDENCE_IMMUTABILITY.md) · ADR [0039](../architecture/adrs/0039-commit-sealed-evidence-immutability.md) / [0040](../architecture/adrs/0040-tamper-evident-lineage-without-worm-storage.md) / [0045](../architecture/adrs/0045-committed-run-header-immutability.md) · GTM **M-223** / **M-224** · Done **TB-303** / **TB-307** / **TB-575** · open **TB-1157** (production hasher re-lock)
