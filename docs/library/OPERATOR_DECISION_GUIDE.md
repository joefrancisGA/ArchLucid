...
**Canonical buyer narrative:** [EXECUTIVE_SPONSOR_BRIEF.md](../go-to-market/EXECUTIVE_SPONSOR_BRIEF.md). **Measurement companion:** [PILOT_SUCCESS_SCORECARD.md#pilot-roi-measurement](../go-to-market/PILOT_SUCCESS_SCORECARD.md#pilot-roi-measurement) (`PILOT_ROI_MODEL.md` alias). This document is usage guidance, not a second buyer narrative and not a second ROI brief.
...
Start with **Core Pilot** — it is the shortest path to one **architecture package** (finalized sealed review record + artifacts).
