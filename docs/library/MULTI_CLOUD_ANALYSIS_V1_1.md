...
- **Procurement:** Buyers requiring ArchLucid **hosted** in AWS/GCP remain **not a fit** for V1.1 — see [BUYER_PERSONAS.md#when-archlucid-is-not-a-fit](../go-to-market/BUYER_PERSONAS.md#when-archlucid-is-not-a-fit) until ADR supersedes.
