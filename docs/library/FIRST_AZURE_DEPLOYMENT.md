> **Scope:** Contributor-reference — First Azure deployment (ArchLucid) - full detail, tables, and links in the sections below.
...
- [V1_DEFERRED.md](V1_DEFERRED.md) §3 — Phase 7 rename closed; greenfield IaC uses **`archlucid`** labels only (no brownfield **`state mv`** pre-release).
