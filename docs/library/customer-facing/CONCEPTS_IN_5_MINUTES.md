> **Scope:** Customer-facing — one-page conceptual map for evaluators and pilot engineers; not a substitute for [`ARCHITECTURE_ON_ONE_PAGE.md`](../../ARCHITECTURE_ON_ONE_PAGE.md) or detailed runbooks.
