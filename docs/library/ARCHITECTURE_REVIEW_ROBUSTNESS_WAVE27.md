...
**Deferred to wave 29+:** stretch items beyond 281–310 from wave-26 planning notes. Shipped in [`ARCHITECTURE_REVIEW_ROBUSTNESS_WAVE28.md`](ARCHITECTURE_REVIEW_ROBUSTNESS_WAVE28.md). Wave 29 Tier 1 in [`ARCHITECTURE_REVIEW_ROBUSTNESS_WAVE29.md`](ARCHITECTURE_REVIEW_ROBUSTNESS_WAVE29.md).
