...
| UI dependency & supply-chain | **TB-860** – **TB-865** (6 tickets, open) | From [`docs/architecture/ui_dependency_assessment.md`](../architecture/ui_dependency_assessment.md): Tier 1 removals (**TB-858** App Insights React plugin **Done**; **TB-859** `ajv`/`ajv-formats` **Done**); Knip cross-validation (**TB-860**); `engines.node >=22` (**TB-861**); import-policy tests (**TB-862**/**TB-863**); weekly `npm audit` CI (**TB-864**); `optimizePackageImports` drift guard (**TB-865**). |
