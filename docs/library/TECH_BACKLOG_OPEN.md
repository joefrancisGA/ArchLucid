...
| UI dependency & supply-chain | **TB-861** – **TB-865** (5 tickets, open) | From [`docs/architecture/ui_dependency_assessment.md`](../architecture/ui_dependency_assessment.md): Tier 1 removals (**TB-858** App Insights React plugin **Done**; **TB-859** `ajv`/`ajv-formats` **Done**); Knip cross-validation (**TB-860** **Done**); `engines.node >=22` (**TB-861**); import-policy tests (**TB-862**/**TB-863**); weekly `npm audit` CI (**TB-864**); `optimizePackageImports` drift guard (**TB-865**). |


## Open items (auto-generated from summary table)

_Regenerated 2026-07-07. 34 open rows (+ **TB-754–TB-759** appended 2026-07-12, + **TB-858–TB-865** appended 2026-07-12; **TB-868** closed 2026-07-17; **TB-860** closed 2026-07-17; removed stale Front Door rows that wrongly reused Done help IDs **TB-760–TB-762**; full regen still **TB-673**)._
