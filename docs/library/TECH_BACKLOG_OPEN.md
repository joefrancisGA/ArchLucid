...
| Frontend / CDN stale shell | **TB-868** (open) | After green CD, users must get the new app shell while hashed static assets stay long-cacheable. Close HTML/bootstrap cache policy, Front Door/CDN purge-only-when-needed posture, cache-bypass public-page BUILD_ID check, and cache-propagation docs. Do not redesign the frontend; do not blanket-disable caching. |


## Open items (auto-generated from summary table)

_Regenerated 2026-07-07. 36 open rows (+ **TB-754–TB-759** appended 2026-07-12, + **TB-858–TB-865** appended 2026-07-12, + **TB-868** appended 2026-07-17; removed stale Front Door rows that wrongly reused Done help IDs **TB-760–TB-762**; full regen still **TB-673**)._

| ID | Title | Cluster |
| --- | --- | --- |
| TB-868 | Eliminate stale frontend/CDN app shell after successful CD | Deployability — cache policy + post-deploy BUILD_ID |
