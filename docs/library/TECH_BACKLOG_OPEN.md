...
| Cluster | IDs |
| --- | --- |
| Terraform composition waves | **TB-655** (Done 2026-08-16) |
...
| Strengthen reviews and architectures (closed loop) | **TB-2283**, **TB-2296**–**TB-2300** (**Done** 2026-08-14) |
...
| Non-policy-pack assessment pillars (deterministic + agent + integrity) | **TB-2201**–**TB-2231** (open **P0**/**P1**/**P2** **V1**–**V1.1**); **Done:** shipped topology wave + **TB-2225**/**TB-2231** (2026-08-16–2026-08-17) | **31 rows** across six pillars beyond policy packs: (1) requirements traceability **TB-2201**–**TB-2205**; (2) security baseline **TB-2206**–**TB-2210** (**TB-2210 Done** 2026-08-14); (3) cost constraints **TB-2211**–**TB-2215** (**TB-2215 Done** 2026-08-16); (4) inventory reality **TB-2216**–**TB-2220**; (5) agent critique **TB-2221**–**TB-2225** (**TB-2225 Done** 2026-08-16); (6) output integrity **TB-2226**–**TB-2231** (**TB-2231 Done** 2026-08-17). Reuses topology patterns (`TopologyExpectedCategoryResolver`, structure analyzers, merge gate, cross-run diff). **Recommended ship order:** **TB-2216**/**TB-2211** → scope engines → validate-before-overlay → structural gaps → **TB-2226**. Peers: Done **TB-1196**/**TB-1197**; open **TB-1369**/**TB-1370**; **TB-874**–**TB-876**. Owner ask 2026-08-13 || Stickiness (episodic-usage residual) | **TB-2197**–**TB-2199** (open **P2** **V1.1**); **Done:** **TB-2191**–**TB-2196**, **TB-2200** (2026-08-12–2026-08-16) | **V1 shipped:** stickiness cockpit (**TB-2191**); recurrence decline (**TB-2192**); waiver-expiry scanner (**TB-2193**); cross-review finding lifecycle (**TB-2194**); assigned-to-me queue (**TB-2195**); tokenized sponsor links (**TB-2196**); workspace Ask (**TB-2200**). **V1.1 open:** Teams/Slack actions; GitHub App; tenant registry. Owner ask 2026-08-12 |
...
| Container Apps Terraform authority + drift (PA 2026-07-26) | **TB-1317**–**TB-1318** (open P1 **V1**) | Escape classes (image/env/secret ignores, revisions, scale, KV values); ownership + plan/LiveAzure proof ladder; honesty CI vs TF-state-alone SoT; GTM **M-233**/**M-234**; complements Done **TB-657**/**TB-658**/**TB-655** / open **TB-915**/**G-OPS-01** |
