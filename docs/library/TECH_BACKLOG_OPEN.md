...
| Ghost signed-record artifact preview (`/signed-records/.../artifacts/...`) | **TB-1949**–**TB-1950** (open P1/P2 **V1**) | Traffic ghost **Done** **TB-1946**; page + hrefs **Done** **TB-1947**/**TB-1948**; docs; Vitest with **TB-1825**; ~10/100; traffic **MAM**; peer **RER** |
