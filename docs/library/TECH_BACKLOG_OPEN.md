...
| Page-scoped contextual help *quality* (Learn more job-match) | **TB-2049**–**TB-2052** (open **P0** **V1**); **TB-2048** **Done** | Digests golden remap + Schedule deep link; secondary-hub sweep; actionable Category-1 popover links; Vitest; design-system Learn more job-match **Done**; owner Digests review 2026-08-05; traffic **OCH**/**DI**; complements mount cluster **TB-1666**–**TB-1670** (do not reopen); IDs skip PA **TB-2042**–**TB-2047** |
...
| TB-2049 | `/digests` — job-matched Learn more + Schedule-tab deep link in Category-1 popover | Adoption friction P0 **V1** — after **TB-2048** Done; traffic **DI** |
| TB-2050 | Secondary hubs — remap Learn more off generic getting-started/how-it-works | Adoption friction P0 **V1** — with **TB-2048**; planning / decision-register / advisory / impact-preview / … |
...
| Page-scoped contextual help *quality* (Learn more job-match) | **TB-2049**–**TB-2052** (open **P0** **V1**); **TB-2048** **Done** | Digests golden + secondary-hub remap + actionable Category-1 links + Vitest; design-system Learn more job-match **Done**; traffic **OCH**/**DI**; complements **TB-1666**–**TB-1670**; IDs skip PA **TB-2042**–**TB-2047** |
