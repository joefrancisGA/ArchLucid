...
| UI performance wave 3 (owner top-10 ask) | **TB-2021**–**TB-2032** (open) + peers **TB-934**/**TB-935** (open) | Post-933 run-detail JS; operator slim first-paint; alerts inbox fan-out; alert-rules tab split; home empty-SSR refetch; Suspense streaming; loader/proxy waterfalls; `/welcome` shell cut; SSE/poll hygiene; First Load JS baseline expansion; field CWV triage; optional marketing `next/image`. Does not recreate Done **TB-933**/**TB-930**. Owner ask 2026-07-31 |
...
| Configuration reference help (`/help/configuration-reference`) | **TB-1326**, **TB-1328**, **TB-1330** (open; **TB-1327**/**TB-1329** Done) | Operator specialty guide + catalog split; SSO/identity/API-keys CTAs; in-app-only links; owner review ~39/100 2026-07-26; traffic **CON**; pairs **TB-1246**/**TB-1250**/**TB-1253**/**TB-734** |
...
| Governance API contracts help (`/help/governance-api-contracts`) | **TB-1386** (open P1 **V1**) | Title/slug honesty; **TB-1384**–**TB-1388** Done 2026-07-29 |
...
| Operator page contextual-help standard | **TB-1666**–**TB-1670** (open P1/P2 **V1**) | Design-system PageContextualHelpButton contract; pilot/analysis mount wave; governance/sponsor-report mount + `/governance/alerts` topic honesty; integrations + topic-map/registry completeness; Vitest allowlist/non-null guard; owner inventory 2026-07-27; traffic **OPH**; pairs **TB-1184**/**TB-1458** (do not reopen); IDs skip line-tabs **TB-1661**–**TB-1665** |
...
| TB-2021 | Post-933 `/reviews/[runId]` First Load JS — remaining sync workspace/overview | Performance P1 **V1** — owner UI speed ask 2026-07-31; pairs **TB-934** |
| TB-2022 | Operator (non-buyer) run-detail slim first-paint (extend **TB-930**) | Performance P1 **V1** — owner UI speed ask 2026-07-31 |
| TB-2023 | Alerts inbox mount fan-out — consolidate 4–6 RTTs | Performance P1 **V1** — owner UI speed ask 2026-07-31; pairs **TB-935** |
| TB-2024 | Alert-rules hub — `dynamic()` tabs + parallel list fetches | Performance P2 **V1** — owner UI speed ask 2026-07-31 |
| TB-2025 | Operator home — skip client refetch on authoritative empty SSR | Performance P2 **V1** — owner UI speed ask 2026-07-31 |
...
| TB-2031 | Field Web Vitals triage gate before next bundle cut | Performance P2 **V1** — pairs GTM **G-QA-06**/**G-QA-07** |
| TB-2032 | Marketing LCP — `next/image` when Lighthouse shows image-bound LCP | Performance P3 **V1** — after **TB-2031** triage |
