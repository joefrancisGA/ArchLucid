...
> **Updated:** 2026-08-09 (**TB-2158**–**TB-2167** opened — Performance wave 7; ten levers verified absent in tree). Prior: 2026-08-09 (**TB-2148**–**TB-2157** opened — confusion-reduction P0s). Prior: 2026-08-09 (**TB-2140**–**TB-2146** opened + **TB-946**/**TB-1484**/**TB-1517** promoted to **P0** — Performance wave 6). Prior: 2026-08-09 (**TB-2130**–**TB-2139** opened — easier-to-use / easier-to-understand P0s). Prior: 2026-08-08 (**TB-2125**–**TB-2129** opened — P0 help-topic Mermaid diagrams). Prior: 2026-08-08 (**TB-2117**–**TB-2124** Performance wave 5 — mostly **Done** 2026-08-09).
...
| Cluster | IDs | Summary |
| --- | --- | --- |
| Performance wave 7 (verified-absent levers) | **TB-2158**–**TB-2167** (open **P0** **V1**) | Conditional GET / ETag on hot reads; Azure OpenAI prompt-cache prefix + `cached_tokens`; cache single-flight; free runtime knobs (Server GC / TieredPGO / invariant globalization); STJ source-gen for API DTOs; `SocketsHttpHandler` tuning; findings TVP inserts; Query cache persistence; Web Worker INP offload; hosted-service leader election. **Already shipped — do not refile:** RCSI (migration **091**), Query Store + `automatic_tuning.tf`, `SqlConnectionStringPoolNormalizer`, response compression. **Excluded:** payload compression / streaming exports (Done **TB-932** measured ~**30 KB** max, **0%** ≥ 1 MB). Does not reopen Done **TB-2117**–**TB-2124**/**TB-2142**–**TB-2145**; does not duplicate open **TB-2140**/**TB-2141**/**TB-2146**. Owner ask 2026-08-09 |
