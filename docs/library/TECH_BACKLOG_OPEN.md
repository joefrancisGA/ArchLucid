...
| Operator page contextual-help standard | **TB-1666**–**TB-1670** (open P1/P2 **V1**); **TB-1667** HOM `/` **Partial Done** 2026-08-03 | Design-system PageContextualHelpButton contract; pilot/analysis mount wave (home remounted); governance/sponsor-report mount + `/governance/alerts` topic honesty; integrations + topic-map/registry completeness; Vitest allowlist/non-null guard; owner inventory 2026-07-27; traffic **OPH**/**HOM**; pairs **TB-1184**/**TB-1458** (do not reopen); IDs skip line-tabs **TB-1661**–**TB-1665** |
