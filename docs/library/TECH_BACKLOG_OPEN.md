...
| UI performance wave 3 (owner top-10 ask) | **TB-2022**–**TB-2030** (open); **TB-2021**/**TB-2031**/**TB-2032** **Done**; peers **TB-934**/**TB-935** (open) | Operator slim first-paint; alerts inbox fan-out; alert-rules tab split; home empty-SSR refetch; Suspense streaming; loader/proxy waterfalls; `/welcome` shell cut; SSE/poll hygiene; First Load JS baseline expansion. **TB-2021** run-detail deferrals Done (baseline remeasure pending); **TB-2031** field CWV triage Done; **TB-2032** marketing `next/image` **waived**. Does not recreate Done **TB-933**/**TB-930**. Owner ask 2026-07-31 |
