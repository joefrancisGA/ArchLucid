...
| Cluster | IDs | Summary |
| --- | --- | --- |
| Option-preserving API split (post OP-01–06) | **TB-2400**–**TB-2401** (open **P2** **V1.1**/**V2**) | **TB-2400:** second HTTP host **compile check** — facade-only web project must fail on `AddAuthorityCapability` / `Application.Runs`; one API + one Worker + one catalog until owner pickup. **TB-2401:** catalog / DDL split **last** — named integration contract, one DDL per surviving DB, no dual-write FKs; requires explicit owner reopen (not implied by **TB-2400**). Prerequisites Done: OP-01 map, OP-02 ratchet, OP-03 signal, OP-04 gate, OP-05 facades, OP-06 worker map. [`TECH_BACKLOG_TB2400_INDEX.md`](TECH_BACKLOG_TB2400_INDEX.md), [`OPTION_PRESERVING_API_SPLIT_COMPOSER_PROMPTS.md`](../architecture/OPTION_PRESERVING_API_SPLIT_COMPOSER_PROMPTS.md). Owner ask 2026-09-10 |
| Structural refactor (UI + graph orchestration) | **TB-2363**–**TB-2372** (open **P2** **V1**–**V1.1**) | Finish **TB-2355** href contract (**TB-2363**); shared find-a-page index (**TB-2364**); vocabulary rail factory (**TB-2365**); next-action registry (**TB-2366**); `ReviewWorkspaceShell` (**TB-2367**); home section composer (**TB-2368**); attention partitions (**TB-2369**); graph materialization pipeline (**TB-2370**); deferred-chunk manifests (**TB-2371**); lifecycle display projection (**TB-2372**). Ship: **2363** → **2364**/**2365** → **2366** → **2367**/**2368** → **2369**–**2372**. Does not duplicate **TB-2333**–**TB-2342** composition-root or Done **TB-2353**–**TB-2362** copy. Owner ask 2026-08-19 |
