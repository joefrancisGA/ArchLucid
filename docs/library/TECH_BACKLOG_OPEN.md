...
| Recurrence schedules empty-layout UX | **TB-1130**–**TB-1133** (open P0 **V1**; **TB-1129** Done) | Orientation shipped; remaining: collapse intro; single primary + dedupe CTAs; human cadence examples; empty first-viewport composition; owner screenshot ~47/100 2026-07-25 |
...
| Empty form+rail / first-viewport whitespace | **TB-1477**–**TB-1482** (open P0 **V1**) | Advisory schedules form+scope rail; Digests schedule readiness rail; Alert rules Rules empty two-col; Digests browse empty stack; Alert routing empty create+steps; shared Vitest inventory; owner Advisory schedules screenshot 2026-07-27; pairs open **TB-1133** / **TB-1177**/**TB-1194** / **TB-1449**/**TB-1454** |
