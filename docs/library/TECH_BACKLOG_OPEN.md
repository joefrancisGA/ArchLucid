...
| Exec digest settings redirect (`/settings/exec-digest`) | **TB-1901**–**TB-1905** (open **V1**) | Redirect-only traffic; dual shim; readiness/nav; docs T3-mock fix; Vitest; ~12/100; traffic **SEX**; pairs **TB-1492**/**TB-1493**; product on Digests Schedule |
