...
| Operator Overview empty-state UX | **TB-1037**–**TB-1039** (open P0 **V1**); **TB-1036** Done 2026-07-25 | Next-best-action hierarchy (**TB-1036** Done); suppress zero-theater; Do-this-next card; demo/seeded Overview → sample package; owner screenshot 2026-07-25; complements Done **TB-345**–**TB-353** / **TB-739** |
...
| TB-1037 | Suppress Overview zero-theater (metrics / median-delta / savings) | Adoption friction P0 **V1** — after **TB-1036** (Done); extends Done **TB-349** |
| TB-1038 | Single Do-this-next empty-home card | Adoption friction P0 **V1** — after **TB-1036** (Done) |
| TB-1039 | Demo/seeded workspace Overview lands on sample package | Adoption friction P0 **V1** — after **TB-1036** (Done); pairs `DEMO_WORKSPACES` |
