...
> **Updated:** 2026-08-08 (**TB-2125**–**TB-2129** opened — P0 help-topic Mermaid diagrams: governance approval, policy packs, evidence trail, repeat-review loop, compare/replay). Prior: 2026-08-08 (**TB-2117**–**TB-2124** opened + **TB-915**/**TB-947**/**TB-932** promoted to **P0** — Performance wave 5). Prior: 2026-08-07 (**TB-1949** **Done** — MAM traffic workbook retagged Core review; ui_routes.md honesty; Vitest). Prior: 2026-08-06 (**TB-1947**/**TB-1948** **Done** — signed-records artifact preview page + manifest-scoped Preview hrefs via `artifactPreviewHref`/`signedRecordArtifactPath`; Vitest). Prior: 2026-08-06 (**TB-934**/**TB-935**/**TB-2028**–**TB-2030** promoted to **P0**). Prior: 2026-08-05 (**TB-2049** **Done** — Digests Learn more to `/help/digests` + Schedule deep links; **TB-2050**–**TB-2052** remain open). Prior: 2026-08-05 (**TB-1480**, **TB-1501**–**TB-1505** **Done** — Digests Browse buyer-confidence pass: one guided empty story with the includes list behind a disclosure, structured history skeleton, honest **Coverage** column, `.md` export with matching MIME + sanitized delivery vocabulary, `#digest-{id}` deep link select+scroll, stable `?tab=browse`; traffic **DI** 46 → 68, **DIB** 0 → 66). Prior: 2026-08-05 (**TB-2048** **Done** — Learn more job-match in `UI_DESIGN_SYSTEM.md` + UI ARCHITECTURE pointer; **TB-2049**–**TB-2052** remain open). Prior: 2026-08-05 (**TB-2048**–**TB-2052** opened — P0 page-scoped contextual help quality / Learn more job-match; Digests golden; secondary-hub remap; actionable Category-1 links; Vitest; traffic **OCH**; complements **TB-1666**–**TB-1670**). Prior: 2026-08-03 (**TB-2025** **Done** — home authoritative empty SSR skips mount refetch; Vitest already green). Prior: 2026-08-03 (**TB-2024** **Done** — alert-rules hub `dynamic()` tabs + parallel conditions fetches; Vitest). Prior: 2026-08-03 (**TB-2023** **Done** — alerts inbox-summary endpoint + fan-out cut; Vitest). Prior: 2026-08-03 (**TB-2022** **Done** — run-detail first paint always buyer-summary; Vitest). Prior: 2026-08-03 (**TB-2021** **Done** — `/reviews/[runId]` findings/export/below-fold `dynamic()`; Vitest guards; baseline remeasure pending). Prior: 2026-08-03 (**TB-2032** **Done** — marketing LCP `next/image` **waived**; Vitest guard + evidence note). Prior: 2026-08-03 (**TB-2031** **Done** — field Web Vitals triage gate). Prior: 2026-08-02 (**TB-1953** **Done** — Snapshot inbound query policy documented; App Router shim stays off next.config; Vitest). Prior: 2026-08-02 (**TB-1952** **Done** — Snapshot redirect destinations documented as review workspace per run class; Vitest). Prior: 2026-08-02 (**TB-1951** **Done** — Snapshot traffic workbook SRN notes document redirect-only leave-behind shim; Vitest). Prior: 2026-08-02 (**TB-1965** **Done** — Executive summary Vitest regression bundle for TB-1961–TB-1964; Vitest). Prior: 2026-08-02 (**TB-1963** **Done** — Executive summary command palette + troubleshooting deep-links use canonical SPE path; Vitest). Prior: 2026-08-02 (**TB-1962** **Done** — Executive summary metadata/tab/nav title aligns with H1 Executive value report; Vitest). Prior: 2026-08-02 (**TB-1961** **Done** — Executive summary traffic workbook retagged Sponsor report; Vitest). Prior: 2026-08-01 (**TB-1886**–**TB-1890** **Done** — retired `/settings/alerts` SEL pre-release). Prior: 2026-08-01 (**TB-1972** **Done** — ROI summary zero CTA uses buyer Start architecture review label; Vitest). Prior: 2026-08-01 (**TB-1901**–**TB-1905** **Done** — retired `/settings/exec-digest` SEX pre-release). Prior: 2026-07-31 (added **TB-2021**–**TB-2032** — UI performance wave 3; also surface open peers **TB-934**/**TB-935**). Prior: 2026-07-31 (added **TB-2016**–**TB-2020** **Done** — marketing/operator dual Container App no-Front-Door split + host-gate middleware). Prior: 2026-07-28 (P0 priority resync — restored 2026-07-27 demotion pass in this file from `TECH_BACKLOG.md` canonical table + policy: keep correctness/reliability/security/cost/release-gate/eng-leak/broken-route P0s; demote adoption/testability/maintainability/redirect-hygiene to P1/P2; drop Done rows from shippable section). Prior: 2026-07-27 (added **TB-1976**–**TB-1993** — V1.1 closed-loop architecture reasoning system; `generation_quality_analysis.md` Second Revision; GTM **M-300**–**M-304**). Prior: 2026-07-27 (added **TB-1971**–**TB-1975** — P0/P1 `/sponsor-report/roi-summary` SPR ~45/100). Prior: 2026-07-27 (added **TB-1966**–**TB-1970** — P0/P1 `/sponsor-report/pilot-outcomes` SPP ~46/100). Prior: 2026-07-27 (added **TB-1961**–**TB-1965** — P0/P1 `/sponsor-report/executive-summary` SPE ~50/100). Prior: 2026-07-27 (added **TB-1956**–**TB-1960** — P0/P1 `/insights/architecture-scorecard` SPA ~48/100). Prior: 2026-07-27 (added **TB-1951**–**TB-1955** — P0/P1 `/snapshot/[runId]` SNU ~30/100). Prior: 2026-07-27 (added **TB-1946**–**TB-1950** — P0 `/signed-records/.../artifacts/...` MAM ~10/100). Prior: 2026-07-27 (added **TB-1941**–**TB-1945** — P0/P1 `/signed-records` SI ~50/100). Prior: 2026-07-27 (added **TB-1936**–**TB-1940** — P0/P1 `/administration/settings/users?tab=users` SSU ~46/100). Prior: 2026-07-27 (added **TB-1931**–**TB-1935** — P0/P1 `/administration/settings/users?tab=keys` SEU ~45/100). Prior: 2026-07-27 (added **TB-1926**–**TB-1930** — P0/P1 `/administration/settings/model-governance` SEM ~48/100). Prior: 2026-07-27 (added **TB-1921**–**TB-1925** — P0/P1 `/administration/settings/identity-providers/saml` SSA ~52/100). Prior: 2026-07-27 (added **TB-1916**–**TB-1920** — P0/P1 `/administration/settings/identity-providers/role-mapping` SEO ~43/100). Prior: 2026-07-27 (added **TB-1911**–**TB-1915** — P0/P1 `/administration/settings/identity-providers/oidc` SOI ~44/100). Prior: 2026-07-27 (added **TB-1906**–**TB-1910** — P0/P1 `/administration/settings/identity-providers/diagnostics` SEI ~47/100). Prior: 2026-07-27 (added **TB-1901**–**TB-1905** — P0/P1 `/settings/exec-digest` SEX ~12/100). Prior: 2026-07-27 (added **TB-1896**–**TB-1900** — P0/P1 `/administration/settings/developer` SED ~42/100). Prior: 2026-07-27 (added **TB-1891**–**TB-1895** — P0/P1 `/administration/settings/auth-domains` SAU ~48/100). Prior: 2026-07-27 (added **TB-1886**–**TB-1890** — P0/P1 `/settings/alerts` SEL ~12/100). Prior: 2026-07-27 (P0 recheck demotion pass)
...
| Page-scoped Learn more job-match (design system) | **TB-2048** (Done 2026-08-05); remaps/Vitest **TB-2049**–**TB-2052** remain open |
| Digests Learn more golden + Schedule deep links | **TB-2049** (Done 2026-08-05); secondary remap **TB-2050**; action allowlist **TB-2051**; Vitest **TB-2052** remain open |
...
| Cluster | IDs | Summary |
| --- | --- | --- |
| Performance wave 5 (next-10 after TB-2053–2062) | **TB-2117**–**TB-2124** (open **P0**); promoted **TB-915**/**TB-947**/**TB-932** (**P0**) | Run-detail + shell First Load JS; slim operator `ResultJson`; Redis L2 enablement; Real-mode Critic/bulkhead; outbox poll floors; force-dynamic/TanStack remainder; cold-start paid levers; scale mix + TPM + evidence-gated blob offload. Does not reopen Done **TB-2053**–**TB-2062**. Owner ask 2026-08-08 |
...
| Core pilot first-review help (`/help/core-pilot`) | **TB-1331**–**TB-1335** (open P1 **V1**) | Incremental after Done **TB-1040**–**TB-1043**: step-2 evidence CTA honesty; sample Claims label; stepper pending chrome; post-stepper density; related-guides IA vs first-hour/onboarding; owner re-review ~70/100 2026-07-26; traffic **COR** |
...
| Governance API contracts help (`/help/governance-api-contracts`) | **TB-1384**–**TB-1388** (**Done**) | Specialty API contracts guide + title honesty; Admin gate; de-index; buyer deep-link retarget; leakage strip; traffic **HG** |
| Pilot ROI model help (`/help/pilot-roi-model`) | **TB-1389**/**TB-1391**–**TB-1393** (open P1 **V1**) | Specialty companion + CTAs; **TB-1390** Done 2026-07-29 contributor leak purge |
...
| Legacy Admin AI usage (`/admin/ai-usage-cost`) | **TB-1404**–**TB-1408** (open P1/P2 **V1**) | Delete dead page behind permanent redirect; readiness/nav hygiene; traffic workbook redirect-only; CI drift; docs canonicalize; owner review ~48/100 2026-07-26; traffic **ADA**; after Done **TB-753**; **IA-014**; pairs **TB-748**; product UX **TB-1216**–**TB-1220** |
...
| Legacy alert routing (`/alert-routing`) | **TB-1444**–**TB-1445** (open P1/P2 **V1**; **TB-1441**–**TB-1443** Done) | CI drift; canonicalize docs/help/comments; owner review ~49/100 2026-07-27; traffic **AL2**; **IA-014**; pairs **TB-1404**/**TB-1435**; workbook redirect-only **TB-1443** Done |
...
| Page-scoped contextual help *quality* (Learn more job-match) | **TB-2050**–**TB-2052** (open **P0** **V1**); **TB-2048**/**TB-2049** **Done** | Secondary-hub sweep; actionable Category-1 popover links; Vitest; Digests golden Learn more + Schedule deep links **Done**; design-system Learn more job-match **Done**; owner Digests review 2026-08-05; traffic **OCH**/**DI**/**HDG**; complements mount cluster **TB-1666**–**TB-1670** (do not reopen); IDs skip PA **TB-2042**–**TB-2047** |
...
| Alert rules Conditions (`/governance/alert-rules?tab=rules`) | **TB-1584**–**TB-1588** (open P1 **V1**) | Demote h2; dual-lead; Create primary; projectId honesty; Select/loading; ~50/100; traffic **GLR**; pairs **TB-1479** |
...
| Legacy digest subscriptions (`/digest-subscriptions`) | **TB-1492**–**TB-1496** (open P1/P2 **V1**) | Single redirect shim; traffic redirect-only; CI no product reintro; canonicalize nav/seo/breadcrumb; permanent inventory + SEO hygiene; owner review ~50/100 2026-07-27; traffic **IXX**; pairs **TB-1441**–**TB-1445** |
...
| ~~TB-1384~~ | ~~`/help/governance-api-contracts` — reclassify as internal-runbook + Admin gate~~ **Done** 2026-07-29 | Trustworthiness P0 **V1** — TB-1250 + Vitest |
...
| TB-2050 | Secondary hubs — remap Learn more off generic getting-started/how-it-works | Adoption friction P0 **V1** — after **TB-2048**/**TB-2049** Done; planning / decision-register / advisory / impact-preview / … |
| TB-2051 | Category-1 popover — actionable deep-link CTAs for next/configure fields | Adoption friction P0 **V1** — with **TB-2048**; Digests Schedule is golden |
| TB-2052 | Vitest — Learn more job-match + Digests golden + ban generic secondary-hub targets | Testability P0 **V1** — after **TB-2049**–**TB-2051**; pairs **TB-1670** (do not reopen) |
...
| Policy-pack delta demo (`/help/policy-pack-delta-demo`) | **TB-1726**–**TB-1730** (open P1 **V1**) | Specialty + Open CTA; API/script leakage; title; vs governance help IA; 5-min arc; ~38/100; traffic **POL**; internal-runbook |
...
| Legacy `/onboarding/start` | **TB-1801**–**TB-1805** (open P1/P2 **V1**) | Traffic redirect-only; noindex; canonicalize; SEO drop; anti-reintro Vitest; ~12/100; traffic **ONS**; peer ON **TB-1796**–**TB-1800** |
...
| Page-scoped contextual help *quality* (Learn more job-match) | **TB-2050**–**TB-2052** (open **P0** **V1**); **TB-2048**/**TB-2049** **Done** | Secondary-hub remap + actionable Category-1 links + Vitest; Digests golden + design-system Learn more job-match **Done**; traffic **OCH**/**DI**/**HDG**; complements **TB-1666**–**TB-1670**; IDs skip PA **TB-2042**–**TB-2047** |
