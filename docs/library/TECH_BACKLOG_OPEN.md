...
| Non-policy-pack assessment pillars (deterministic + agent + integrity) | **TB-2201**–**TB-2231** (open **P0**/**P1**/**P2** **V1**–**V1.1**); **Done:** shipped topology wave (workload scope, structure, merge gate, cross-run diff, anti-patterns) | **31 rows** across six pillars beyond policy packs: (1) requirements traceability **TB-2201**–**TB-2205**; (2) security baseline **TB-2206**–**TB-2210** (**TB-2210 Done** 2026-08-14); (3) cost constraints **TB-2211**–**TB-2215** (**TB-2215 Done** 2026-08-16); (4) inventory reality **TB-2216**–**TB-2220**; (5) agent critique **TB-2221**–**TB-2225**; (6) output integrity **TB-2226**–**TB-2231**. Reuses topology patterns (`TopologyExpectedCategoryResolver`, structure analyzers, merge gate, cross-run diff). **Recommended ship order:** **TB-2216**/**TB-2211** → scope engines → validate-before-overlay → structural gaps → **TB-2226**. Peers: Done **TB-1196**/**TB-1197**; open **TB-1369**/**TB-1370**; **TB-874**–**TB-876**. Owner ask 2026-08-13 |
