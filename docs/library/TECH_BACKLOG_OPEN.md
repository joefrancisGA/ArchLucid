...
| Operator/marketing clickable-link affordance | **TB-1671**–**TB-1675** (open P1/P2 **V1**) | Design-system `OPERATOR_LINK` contract + ban bare/hover-only body anchors; compare/provenance bare links; home/Reviews/marketing/core-pilot resting affordance; finding StatusTag-as-link + secondary inventory; Vitest bare-`<a>`/`<Link>` guard; owner unstyled-link pass 2026-07-27; traffic **OLA**; pairs a11y `UI-Accessibility-Baseline.mdc` / CTA **TB-1539**; IDs skip OPH **TB-1666**–**TB-1670** / line-tabs **TB-1661**–**TB-1665** |
...
| Data handling (`/help/data-handling`) | **TB-1651**–**TB-1655** (open P1 **V1**) | Specialty + Trust CTA; vs HDA dual; isolation honesty; leaves/stays chrome; Related; ~52/100; traffic **HED** |
