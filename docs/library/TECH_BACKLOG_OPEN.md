...
| UI dependency & supply-chain | **TB-859** – **TB-865** (7 tickets, open) | From [`docs/architecture/ui_dependency_assessment.md`](../architecture/ui_dependency_assessment.md): Tier 1 removals (**TB-859** `ajv`/`ajv-formats`; **TB-858** App Insights React plugin **Done**); Knip cross-validation (**TB-860**); `engines.node >=22` (**TB-861**); **TB-570**-style import-policy tests for `reactflow` (**TB-862**) and `mermaid` (**TB-863**); weekly `npm audit` scheduled CI (**TB-864**); `optimizePackageImports` allowlist drift guard (**TB-865**). Related: **TB-697** bundle re-audit **Done**. |


## Open items (auto-generated from summary table)

_Regenerated 2026-07-07. 35 open rows (+ **TB-754–TB-759** appended 2026-07-12, + **TB-858–TB-865** appended 2026-07-12; **TB-868** closed 2026-07-17; removed stale Front Door rows that wrongly reused Done help IDs **TB-760–TB-762**; full regen still **TB-673**)._
