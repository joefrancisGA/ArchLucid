...
| TB-1965 | Executive summary — Vitest traffic + vocabulary + canonical hrefs | Testability P2 **V1** — SPE ~50 |
...
| Executive summary (`/sponsor-report/executive-summary`) | **TB-1965** (open **V1**) | Vitest bundle; ~50/100; traffic **SPE**; siblings SPP/SPR; **TB-1961**–**TB-1964** Done |
