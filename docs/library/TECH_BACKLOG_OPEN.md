...
| Cluster | IDs | Summary |
| --- | --- | --- |
| Stickiness (episodic-usage residual) | **TB-2194**–**TB-2195** (open **P1** **V1**); **TB-2196**–**TB-2200** (open **P2** **V1.1**); **Done:** **TB-2191**–**TB-2193** (2026-08-12) | **V1 open:** verified-resolved finding lifecycle from existing fingerprint correlation; assigned-to-me findings queue. **V1 shipped:** stickiness cockpit wired onto operator home (**TB-2191**); post-commit recurrence proposal with an explicit decline that creates nothing (**TB-2192**); leader-elected waiver-expiry scanner with 30/14/7/0-day email reminders (**TB-2193**, email only — Teams/webhook residual). **V1.1:** tokenized read-only sponsor deep links from digest email (needs INV-001 review); two-way Teams actions + wider Slack surface; GitHub App + Check Runs; tenant-authored approved-architecture registry; workspace-scoped Ask. **Already shipped — do not refile:** recurrence + completion notify + schedule health (**TB-222**, **TB-261**–**TB-263**), digests/exec summary, alert rules + routing, ITSM/cloud/SSO/SCIM, ROI + drift trends (**TB-244**–**TB-249**), compare (**TB-224**), decision register + waivers (**TB-058**–**TB-061**, **TB-226**), tenant health scoring (**TB-228**), activation spine (**TB-345**–**TB-353**, **TB-2130**–**TB-2139**). **Excluded:** cross-tenant peer benchmarking (not credible at current tenant count; needs privacy review). Peers not duplicated: open **TB-879**, **TB-1394**–**TB-1398**, **TB-394**–**TB-396**, GTM **M-41**. Owner ask 2026-08-12 |
