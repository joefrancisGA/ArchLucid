...
| TB-1963 | Executive summary — command palette / deep-links use canonical SPE path | Trustworthiness P1 **V1** — SPE ~50 |
...
| Executive summary (`/sponsor-report/executive-summary`) | **TB-1963**, **TB-1965** (open **V1**) | Canonical deep-links; Vitest bundle; ~50/100; traffic **SPE**; siblings SPP/SPR; **TB-1961**/**TB-1962**/**TB-1964** Done |
