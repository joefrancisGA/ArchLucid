...
| Cluster | IDs | Summary |
| --- | --- | --- |
| Marketing / operator dual Container App (no Front Door) | **TB-2016**–**TB-2018**/**TB-2020** **Done**; **TB-2019** open | Same-image marketing CA + custom-domain runbook + `site-urls` CTAs + CD/CORS; remaining host-gate middleware; owner override 2026-07-31; supersedes “don’t split” bottom line in `MARKETING_PRODUCT_SEPARATION_ASSESSMENT.md` |
...
| Pilot outcomes (`/sponsor-report/pilot-outcomes`) | **TB-1966**–**TB-1970** (open **V1**) | Traffic section; empty most-recent deep-link; help with **TB-1668**; chrome with **TB-1437**; Vitest; ~46/100; traffic **SPP**; sibling SPR |
