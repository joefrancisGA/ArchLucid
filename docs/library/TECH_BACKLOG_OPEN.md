...
| Configuration reference help (`/help/configuration-reference`) | **TB-1326**, **TB-1328**–**TB-1330** (open; **TB-1327** Done) | Operator specialty guide + catalog split; SSO/identity/API-keys CTAs; Admin gate/tier honesty; in-app-only links; owner review ~39/100 2026-07-26; traffic **CON**; pairs **TB-1246**/**TB-1250**/**TB-1253**/**TB-734** |
