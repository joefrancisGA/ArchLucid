...
| Redundant page-description chrome (strip × header) | **TB-1437**–**TB-1440** (open P1/P2 **V1**; **TB-1434**–**TB-1436** Done) | LayerContextStrip orientation duplicates OperatorPageHeader lead: `/value-report*`, `/product-learning`, `/dashboard`, Vitest guard; owner pass 2026-07-27; pairs Done **TB-1125**/**TB-1129**/**TB-1434**–**TB-1436** / open **TB-1224** |
...
| Legacy alert routing (`/alert-routing`) | **TB-1441**–**TB-1445** (open P1/P2 **V1**) | Single redirect shim; permanent next.config; traffic workbook redirect-only; CI drift; canonicalize docs/help/comments; owner review ~49/100 2026-07-27; traffic **AL2**; **IA-014**; pairs **TB-1404**/**TB-1435** |
