> **Scope:** Buyer — ArchLucid V1 — readiness summary - full detail, tables, and links in the sections below.
...
|------|----------------------|
| **GTM / packaging realism** | **`docs/go-to-market/QUOTE_TO_PROOF_PACKET.md#productized-service-offers`** (`SERVICE_LED_OFFERS.md` alias) and **`GTM_BACKLOG.md`** define named review SKUs and founder-led sequencing; ship **buyable offers** and pain-first copy alongside technical readiness. |
