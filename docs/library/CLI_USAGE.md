...
For HTTP automation against the documented buyer integration path (create → execute → commit → export → compare → ROI), see [Governance API contracts](/help/governance-api-contracts), [Developer troubleshooting](/help/developer-troubleshooting), and the sanitized starter fixtures in [`scripts/ci/data/v1_integration_starter_contracts.v1.json`](../../scripts/ci/data/v1_integration_starter_contracts.v1.json).
