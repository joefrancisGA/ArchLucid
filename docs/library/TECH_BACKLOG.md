...
**Updated:** 2026-06-15 (after product-drift / onboarding narrative realignment assessment — **TB-337–344**, evidence-first onboarding). Prior: 2026-06-14 observability assessment — **ADR 0053**, **TB-329–336**. **~38 unique** engineering tasks (BE/SEC register pairs counted once). Excludes **TB-135**, **TB-136** (V1.1 assurance backlog), **TB-138** (owner Azure OpenAI secrets), **TB-140** / G-REAL (owner/credentialed), and **TB-340** (owner PQ-DRIFT-01). Sorted **descending**.
