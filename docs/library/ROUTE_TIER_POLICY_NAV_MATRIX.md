...
| --- | --- |
| Registry rows | **235** controller route families (`route-tier-policy-nav-registry-count`) |
...
<!-- route-tier-policy-nav-registry-count:235 -->
...
| `Architecture/ArchitecturesController.cs` | `/v1/architectures` | standard | AuthenticatedUserOnly |  | GET list/get = ReadAuthority; PATCH = ExecuteAuthority |
...
| `Authority/EvidenceDocumentTextExtractionController.cs` | `/v1/architecture/evidence` | none | ReadAuthority |  |  |
...
| `User/UserAttentionSummaryController.cs` | `/v1/user/attention-summary` | standard | AuthenticatedUserOnly |  |  |
