...
| --- | --- |
| Registry rows | **245** controller route families (`route-tier-policy-nav-registry-count`) |
...
<!-- route-tier-policy-nav-registry-count:245 -->
...
| `Findings/InsightDensityVerificationConfirmedRatesController.cs` | `/v1/tenants/current/insight-density` | standard | ExecuteAuthority |  |  |
