...
| [`docs/library/`](./) | **Mixed** — default to [`NAVIGATOR.md`](../archive/NAVIGATOR.md) rows | Hundreds of refs: [`../engineering/../engineering/BUILD.md`](../engineering/BUILD.md), [`CONFIGURATION_REFERENCE.md`](CONFIGURATION_REFERENCE.md), assessments, connectors. |
...
3. **[`../engineering/../engineering/BUILD.md`](../engineering/BUILD.md)**, **[`TEST_STRUCTURE.md`](TEST_STRUCTURE.md)** — local correctness loop.
