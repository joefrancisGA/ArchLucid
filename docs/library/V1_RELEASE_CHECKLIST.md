...
- [ ] **RC release gate workflow** green for the candidate tag/branch: `.github/workflows/rc-release-gate.yml` (blocking high-risk guards + real-model canary artifact). Policy: [`RC_RELEASE_GATE.md`](../runbooks/RC_RELEASE_GATE.md).
