...
- [ ] **RC live UI↔SQL parity evidence:** `.\scripts\release-smoke-rc.ps1 -ResultOut artifacts/release-smoke/result.json` (mandatory for release-candidate signoff; default smoke alone does not prove browser parity).
