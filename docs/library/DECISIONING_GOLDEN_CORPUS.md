...
Each case is a directory under `tests/golden-corpus/decisioning/` named `case-NN` (two-digit index). **40** directories exist today: **`case-01` … `case-30`** are produced by `GoldenCorpusGraphFactory` / the materializer; **`case-31`**, **`case-32`**, **`case-33`**, **`case-34`**, **`case-35`**, **`case-36`**, **`case-37`**, **`case-38`**, **`case-39`**, **`case-40`**, **`case-41`**, **`case-42`**, and **`case-43`** are **hand-authored** scenarios (see each folder’s `README.md`).
...
| **`case-43`** (hand-authored) | **DX-22** — six declaration public-network gaps on storage-shaped topology nodes. Feeds **`ChecklistClusterSynthesisGoldenCorpusTests`** (post-gate synthesis sibling). See `tests/golden-corpus/decisioning/case-43/README.md`. |
