...
> **Deprecated as primary entry (2026-04-27):** **[`START_HERE.md`](../START_HERE.md)** has the contributor path. This page remains a one-pager shortcut.
...
| I want to… | Go here |
| --- | --- |
| **Docker-first boot (no .NET first)** | [docs/engineering/FIRST_30_MINUTES.md](FIRST_30_MINUTES.md) |
| **Build, test, migrations** | [docs/engineering/BUILD.md](BUILD.md) |
...
| **Deployment (internal operators)** | [docs/engineering/DEPLOYMENT.md](DEPLOYMENT.md) |
...
[docs/engineering/INSTALL_ORDER.md](INSTALL_ORDER.md) — pinned SDK/SQL/Node. [docs/runbooks/TROUBLESHOOTING.md](../runbooks/TROUBLESHOOTING.md) — ports and local failures. `dotnet run --project ArchLucid.Cli -- doctor` · `dotnet run --project ArchLucid.Cli -- support-bundle --zip` (review before sharing).
