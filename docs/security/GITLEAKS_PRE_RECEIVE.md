...
Developers should also run `gitleaks detect --no-git -v` locally before pushing (see [SECURITY.md](../library/contributor-reference/SECURITY.md)). CI continues to run secret scanning on pull requests.
