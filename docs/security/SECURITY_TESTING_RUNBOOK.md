...
- **[SYSTEM_THREAT_MODEL.md](../../security/SYSTEM_THREAT_MODEL.md)** — STRIDE summary at the product boundary.
- **[RLS_RISK_ACCEPTANCE.md](../../security/RLS_RISK_ACCEPTANCE.md)** — RLS residual risk acceptance template (historical).
