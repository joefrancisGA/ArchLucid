...
**Purpose.** Measure the time-to-first-finding for newly provisioned tenants so the marketing claim "first finding inside 30 minutes" can be substantiated with first-party evidence rather than anecdote. See [`docs/archive/../assessments/LATEST_GPT55.md`](../archive/../assessments/LATEST_GPT55.md) §3 Improvement 12 for the assessment finding that motivated the work.
