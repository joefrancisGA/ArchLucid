...
3. **Cadence:** publish within **10 business days** of customer approval (align with [`SECURITY.md`](../../library/contributor-reference/SECURITY.md) acknowledgment SLA where applicable).
...
5. **PGP:** when [`SECURITY.md`](../../library/contributor-reference/SECURITY.md) publishes a disclosure encryption key, link it from the published summary header.

## Files

| File | Status |
| --- | --- |
| [`2026-Q2-SOW.md`](2026-Q2-SOW.md) | **Template** — reserved for **V2** third-party vendor (no vendor awarded for V1; owner 2026-05-01) |
| [`2026-Q2-REDACTED-SUMMARY.md`](2026-Q2-REDACTED-SUMMARY.md) | Placeholder — populate after **V2** assessor redacted delivery (**not** a V1 readiness gate) |
...
- [`../library/contributor-reference/SECURITY.md`](../../library/contributor-reference/SECURITY.md)
