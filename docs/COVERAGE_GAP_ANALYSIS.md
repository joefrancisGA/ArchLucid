...
| Rank | Class | File | Line coverage % | Uncovered lines | Prior attempt? |
|------|-------|------|-----------------|-----------------|----------------|
| 1 | `ArchLucid.Host.Core.Configuration.DataConsistencyProbeOptions` | `ArchLucid.Host.Core\Configuration\DataConsistencyProbeOptions.cs` | 0.00 | 3 | No |
| 2 | `ArchLucid.Host.Core.Configuration.Secrets.EnvironmentVariableSecretProvider` | `ArchLucid.Host.Core\Configuration\Secrets\EnvironmentVariableSecretProvider.cs` | 0.00 | 6 | No |
| 3 | `ArchLucid.Host.Core.Configuration.Secrets.KeyVaultSecretProvider` | `ArchLucid.Host.Core\Configuration\Secrets\KeyVaultSecretProvider.cs` | 0.00 | 21 | No |
...
| 2 | `ArchLucid.Host.Core.Configuration.Secrets.EnvironmentVariableSecretProvider` | `ArchLucid.Host.Core\Configuration\Secrets\EnvironmentVariableSecretProvider.cs` | 0.00 | 6 | No |
| 3 | `ArchLucid.Host.Core.Configuration.Secrets.KeyVaultSecretProvider` | `ArchLucid.Host.Core\Configuration\Secrets\KeyVaultSecretProvider.cs` | 0.00 | 21 | No |
| 4 | `ArchLucid.Host.Core.Integration.IntegrationEventServiceBusMessageDispatch` | `ArchLucid.Host.Core\Integration\IntegrationEventServiceBusMessageDispatch.cs` | 0.00 | 50 | No |
| 5 | `ArchLucid.Host.Core.Integration.ProcessMessageEventArgsSettlement` | `ArchLucid.Host.Core\Integration\IntegrationEventPeekLockSettlements.cs` | 0.00 | 3 | No |
| 6 | `ArchLucid.Host.Core.Integration.ServiceBusReceiverSettlement` | `ArchLucid.Host.Core\Integration\IntegrationEventPeekLockSettlements.cs` | 0.00 | 3 | No |
| 7 | `ArchLucid.Host.Core.Integration.TrialLifecycleEmailIntegrationEventHandler` | `ArchLucid.Host.Core\Integration\TrialLifecycleEmailIntegrationEventHandler.cs` | 0.00 | 26 | No |
| 8 | `ArchLucid.Host.Core.Jobs.AzureBlobBackgroundJobResultBlobAccessor` | `ArchLucid.Host.Core\Jobs\AzureBlobBackgroundJobResultBlobAccessor.cs` | 0.00 | 34 | No |
| 9 | `ArchLucid.Host.Core.Jobs.AzureStorageQueueBackgroundJobNotifySender` | `ArchLucid.Host.Core\Jobs\AzureStorageQueueBackgroundJobNotifySender.cs` | 0.00 | 6 | No |
| 10 | `ArchLucid.Host.Core.Jobs.BackgroundJobPersistenceMapper` | `ArchLucid.Host.Core\Jobs\BackgroundJobPersistenceMapper.cs` | 0.00 | 15 | No |
| 11 | `ArchLucid.Host.Core.Jobs.BackgroundJobQueueAddress` | `ArchLucid.Host.Core\Jobs\BackgroundJobQueueAddress.cs` | 0.00 | 11 | No |
| 12 | `ArchLucid.Host.Core.Jobs.BackgroundJobQueueProcessorHostedService` | `ArchLucid.Host.Core\Jobs\BackgroundJobQueueProcessorHostedService.cs` | 0.00 | 102 | No |
| 13 | `ArchLucid.Host.Core.Jobs.DurableBackgroundJobQueue` | `ArchLucid.Host.Core\Jobs\DurableBackgroundJobQueue.cs` | 0.00 | 46 | No |
| 14 | `ArchLucid.Host.Core.Startup.WorkerHostPipelineExtensions` | `ArchLucid.Host.Core\Startup\WorkerHostPipelineExtensions.cs` | 0.00 | 68 | No |
| 15 | `ArchLucid.Host.Core.Services.Delivery.CloudEventsWrappingWebhookPoster` | `ArchLucid.Host.Core\Services\Delivery\CloudEventsWrappingWebhookPoster.cs` | 8.33 | 33 | No |
| 16 | `ArchLucid.Host.Core.DataConsistency.DataConsistencyOrphanProbeExecutor` | `ArchLucid.Host.Core\DataConsistency\DataConsistencyOrphanProbeExecutor.cs` | 9.92 | 118 | No |
| 17 | `ArchLucid.Host.Core.Hosted.AuthorityPipelineWorkProcessor` | `ArchLucid.Host.Core\Hosted\AuthorityPipelineWorkProcessor.cs` | 15.22 | 78 | No |
| 18 | `ArchLucid.Host.Core.Health.RunGoldenManifestConsistencyHealthCheck` | `ArchLucid.Host.Core\Health\RunGoldenManifestConsistencyHealthCheck.cs` | 30.43 | 16 | No |
| 19 | `ArchLucid.Host.Core.Hosted.DataConsistencyOrphanProbeHostedService` | `ArchLucid.Host.Core\Hosted\DataConsistencyOrphanProbeHostedService.cs` | 31.25 | 22 | No |
| 20 | `ArchLucid.Host.Core.Startup.Validation.Rules.E2EHarnessRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\E2eHarnessRules.cs` | 33.33 | 6 | No |
| 21 | `ArchLucid.Host.Core.Jobs.ServiceBusIntegrationEventsArchLucidJob` | `ArchLucid.Host.Core\Jobs\ServiceBusIntegrationEventsArchLucidJob.cs` | 36.00 | 48 | No |
| 22 | `ArchLucid.Host.Core.Services.AuditRetryDrainHostedService` | `ArchLucid.Host.Core\Services\AuditRetryDrainHostedService.cs` | 48.39 | 16 | No |
| 23 | `ArchLucid.Host.Core.Configuration.E2EHarnessOptions` | `ArchLucid.Host.Core\Configuration\E2eHarnessOptions.cs` | 50.00 | 1 | No |
| 24 | `ArchLucid.Host.Core.Health.BlobStorageHealthCheck` | `ArchLucid.Host.Core\Health\BlobStorageHealthCheck.cs` | 50.00 | 8 | No |
| 25 | `ArchLucid.Host.Core.Health.ProcessTempDirectoryHealthCheck` | `ArchLucid.Host.Core\Health\ProcessTempDirectoryHealthCheck.cs` | 50.00 | 8 | No |
| 26 | `ArchLucid.Host.Core.Services.Ask.ContextBuilder` | `ArchLucid.Host.Core\Services\Ask\ContextBuilder.cs` | 50.00 | 41 | No |
| 27 | `ArchLucid.Host.Core.Notifications.Email.TrialLifecycleEmailPublishingAuditDecorator` | `ArchLucid.Host.Core\Notifications\Email\TrialLifecycleEmailPublishingAuditDecorator.cs` | 56.98 | 37 | No |
| 28 | `ArchLucid.Host.Core.Health.ComplianceRulePackHealthCheck` | `ArchLucid.Host.Core\Health\ComplianceRulePackHealthCheck.cs` | 57.14 | 3 | No |
| 29 | `ArchLucid.Host.Core.Startup.ArchLucidPersistenceStartup` | `ArchLucid.Host.Core\Startup\ArchLucidPersistenceStartup.cs` | 57.14 | 18 | No |
| 30 | `ArchLucid.Host.Core.Configuration.ArchLucidLegacyConfigurationWarnings` | `ArchLucid.Host.Core\Configuration\ArchLucidLegacyConfigurationWarnings.cs` | 57.89 | 8 | No |
| 31 | `ArchLucid.Host.Core.Integration.LoggingIntegrationEventHandler` | `ArchLucid.Host.Core\Integration\LoggingIntegrationEventHandler.cs` | 61.11 | 7 | No |
| 32 | `ArchLucid.Host.Core.Integration.NullIntegrationEventPublisher` | `ArchLucid.Host.Core\Integration\NullIntegrationEventPublisher.cs` | 66.67 | 2 | No |
| 33 | `ArchLucid.Host.Core.Startup.LlmPromptRedactionProductionWarningPostConfigure` | `ArchLucid.Host.Core\Startup\LlmPromptRedactionProductionWarningPostConfigure.cs` | 68.42 | 6 | No |
| 34 | `ArchLucid.Host.Core.Startup.Validation.Rules.HostLeaderElectionRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\HostLeaderElectionRules.cs` | 68.42 | 6 | No |
| 35 | `ArchLucid.Host.Core.Health.SchemaFilesHealthCheck` | `ArchLucid.Host.Core\Health\SchemaFilesHealthCheck.cs` | 69.70 | 10 | No |
| 36 | `ArchLucid.Host.Core.Jobs.JobRunTelemetry` | `ArchLucid.Host.Core\Jobs\JobRunTelemetry.cs` | 70.59 | 15 | No |
| 37 | `ArchLucid.Host.Core.Services.Ask.AskService` | `ArchLucid.Host.Core\Services\Ask\AskService.cs` | 73.18 | 59 | No |
| 38 | `ArchLucid.Host.Core.Startup.Validation.Rules.BackgroundJobsRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\BackgroundJobsRules.cs` | 75.00 | 6 | No |
| 39 | `ArchLucid.Host.Core.Startup.ObservabilityExtensions` | `ArchLucid.Host.Core\Startup\ObservabilityExtensions.cs` | 75.25 | 25 | No |
| 40 | `ArchLucid.Host.Core.Services.ArchitectureApplicationService` | `ArchLucid.Host.Core\Services\ArchitectureApplicationService.cs` | 76.13 | 37 | No |
...
| 43 | `ArchLucid.Host.Core.Startup.Validation.Rules.LlmTokenQuotaRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\LlmTokenQuotaRules.cs` | 80.00 | 4 | No |
| 44 | `ArchLucid.Host.Core.Hosted.TrialLifecycleSchedulerHostedService` | `ArchLucid.Host.Core\Hosted\TrialLifecycleSchedulerHostedService.cs` | 80.56 | 7 | No |
| 45 | `ArchLucid.Host.Core.ProblemDetails.ProblemErrorCodes` | `ArchLucid.Host.Core\ProblemDetails\ProblemErrorCodes.cs` | 81.25 | 9 | No |
| 46 | `ArchLucid.Host.Core.Hosted.IntegrationEventOutboxHostedService` | `ArchLucid.Host.Core\Hosted\IntegrationEventOutboxHostedService.cs` | 81.48 | 5 | No |
| 47 | `ArchLucid.Host.Core.Jobs.InMemoryBackgroundJobQueue` | `ArchLucid.Host.Core\Jobs\InMemoryBackgroundJobQueue.cs` | 82.03 | 23 | No |
| 48 | `ArchLucid.Host.Core.Jobs.AuditEventChangeFeedArchLucidJob` | `ArchLucid.Host.Core\Jobs\AuditEventChangeFeedArchLucidJob.cs` | 82.61 | 4 | No |
| 49 | `ArchLucid.Host.Core.Hosted.TenantHealthScoringHostedService` | `ArchLucid.Host.Core\Hosted\TenantHealthScoringHostedService.cs` | 82.86 | 6 | No |
| 50 | `ArchLucid.Host.Core.Startup.Diagnostics.StartupConfigurationFactsReader` | `ArchLucid.Host.Core\Startup\Diagnostics\StartupConfigurationFacts.cs` | 82.93 | 7 | No |
| 51 | `ArchLucid.Host.Core.Health.SqlConnectionHealthCheck` | `ArchLucid.Host.Core\Health\SqlConnectionHealthCheck.cs` | 83.33 | 3 | No |
| 52 | `ArchLucid.Host.Core.Hosted.OutboxOperationalMetricsHostedService` | `ArchLucid.Host.Core\Hosted\OutboxOperationalMetricsHostedService.cs` | 83.33 | 7 | No |
| 53 | `ArchLucid.Host.Core.Startup.Validation.Rules.ContentSafetyRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\ContentSafetyRules.cs` | 83.33 | 3 | No |
| 54 | `ArchLucid.Host.Core.Diagnostics.FakeAgentResultFactory` | `ArchLucid.Host.Core\Diagnostics\FakeAgentResultFactory.cs` | 83.38 | 57 | No |
| 55 | `ArchLucid.Host.Core.Jobs.DataArchivalArchLucidJob` | `ArchLucid.Host.Core\Jobs\DataArchivalArchLucidJob.cs` | 83.87 | 5 | No |
| 56 | `ArchLucid.Host.Core.ProblemDetails.ProblemSupportHints` | `ArchLucid.Host.Core\ProblemDetails\ProblemSupportHints.cs` | 86.05 | 6 | No |
| 57 | `ArchLucid.Host.Core.Middleware.PrometheusScrapeAuthMiddleware` | `ArchLucid.Host.Core\Middleware\PrometheusScrapeAuthMiddleware.cs` | 86.79 | 7 | No |
| 58 | `ArchLucid.Host.Core.Jobs.ArchLucidJobsOffload` | `ArchLucid.Host.Core\Jobs\ArchLucidJobsOffload.cs` | 87.50 | 1 | No |
| 59 | `ArchLucid.Host.Core.Hosted.HostLeaderElectionCoordinator` | `ArchLucid.Host.Core\Hosted\HostLeaderElectionCoordinator.cs` | 87.65 | 10 | No |
| 60 | `ArchLucid.Host.Core.Jobs.TrialLifecycleArchLucidJob` | `ArchLucid.Host.Core\Jobs\TrialLifecycleArchLucidJob.cs` | 88.00 | 3 | No |
| 61 | `ArchLucid.Host.Core.Jobs.OrphanProbeArchLucidJob` | `ArchLucid.Host.Core\Jobs\OrphanProbeArchLucidJob.cs` | 88.24 | 2 | No |
| 62 | `ArchLucid.Host.Core.Jobs.AdvisoryScanArchLucidJob` | `ArchLucid.Host.Core\Jobs\AdvisoryScanArchLucidJob.cs` | 90.00 | 2 | No |
| 63 | `ArchLucid.Host.Core.Jobs.TrialEmailScanArchLucidJob` | `ArchLucid.Host.Core\Jobs\TrialEmailScanArchLucidJob.cs` | 90.00 | 2 | No |
| 64 | `ArchLucid.Host.Core.Startup.Validation.Rules.ContainerJobsOffloadRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\ContainerJobsOffloadRules.cs` | 90.48 | 2 | No |
| 65 | `ArchLucid.Host.Core.Startup.Validation.Rules.LlmCompletionCacheRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\LlmCompletionCacheRules.cs` | 90.62 | 3 | No |
| 66 | `ArchLucid.Host.Core.Hosted.DataArchivalHostedService` | `ArchLucid.Host.Core\Hosted\DataArchivalHostedService.cs` | 91.89 | 3 | No |
| 67 | `ArchLucid.Host.Core.Hosted.AuthorityPipelineWorkHostedService` | `ArchLucid.Host.Core\Hosted\AuthorityPipelineWorkHostedService.cs` | 92.59 | 2 | No |
| 68 | `ArchLucid.Host.Core.Hosted.RetrievalIndexingOutboxHostedService` | `ArchLucid.Host.Core\Hosted\RetrievalIndexingOutboxHostedService.cs` | 92.59 | 2 | No |
| 69 | `ArchLucid.Host.Core.Authority.FeatureManagementAuthorityPipelineModeResolver` | `ArchLucid.Host.Core\Authority\FeatureManagementAuthorityPipelineModeResolver.cs` | 92.86 | 1 | No |
| 70 | `ArchLucid.Host.Core.Startup.Validation.Rules.SchemaValidationRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\SchemaValidationRules.cs` | 92.86 | 2 | No |
| 71 | `ArchLucid.Host.Core.Startup.Validation.Rules.AgentExecutionRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\AgentExecutionRules.cs` | 93.10 | 2 | No |
| 72 | `ArchLucid.Host.Core.Startup.Validation.Rules.ApiDeprecationRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\ApiDeprecationRules.cs` | 93.75 | 1 | No |
| 73 | `ArchLucid.Host.Core.Startup.Validation.Rules.CosmosPolyglotRules` | `ArchLucid.Host.Core\Startup\Validation\Rules\CosmosPolyglotRules.cs` | 94.12 | 1 | No |
| 74 | `ArchLucid.Host.Core.Services.CircuitBreakerAuditBridge` | `ArchLucid.Host.Core\Services\CircuitBreakerAuditBridge.cs` | 94.19 | 5 | No |
| 75 | `ArchLucid.Host.Core.Hosted.DataArchivalHostIteration` | `ArchLucid.Host.Core\Hosted\DataArchivalHostIteration.cs` | 94.29 | 2 | No |
| 76 | `ArchLucid.Host.Core.Startup.RlsBypassPolicyBootstrap` | `ArchLucid.Host.Core\Startup\RlsBypassPolicyBootstrap.cs` | 94.44 | 1 | No |

### ArchLucid.Application (73.29% line coverage)
...
| 19 | `ArchLucid.Application.Analysis.EndToEndReplayComparisonExportService` | `ArchLucid.Application\Analysis\EndToEndReplayComparisonExportService.cs` | 45.32 | 222 | No |
| 20 | `ArchLucid.Application.Analysis.ConsultingDocxTemplateRecommendationService` | `ArchLucid.Application\Analysis\ConsultingDocxTemplateRecommendationService.cs` | 49.09 | 28 | No |
| 21 | `ArchLucid.Application.Analysis.EndToEndComparisonExportProfile` | `ArchLucid.Application\Analysis\EndToEndComparisonExportProfile.cs` | 50.00 | 3 | No |
| 22 | `ArchLucid.Application.Audit.RunPipelineTimelineItemDto` | `ArchLucid.Application\Audit\RunPipelineTimelineItemDto.cs` | 50.00 | 3 | No |
| 23 | `ArchLucid.Application.ConflictException` | `ArchLucid.Application\ConflictException.cs` | 50.00 | 2 | No |
...
| 26 | `ArchLucid.Application.Analysis.ArchitectureAnalysisService` | `ArchLucid.Application\Analysis\ArchitectureAnalysisService.cs` | 56.70 | 42 | No |
...
| 30 | `ArchLucid.Application.Analysis.DocxArchitectureAnalysisExportService` | `ArchLucid.Application\Analysis\DocxArchitectureAnalysisExportService.cs` | 65.55 | 41 | No |
| 31 | `ArchLucid.Application.Runs.Orchestration.ArchitectureRunCommitOrchestrator` | `ArchLucid.Application\Runs\Orchestration\ArchitectureRunCommitOrchestrator.cs` | 65.87 | 158 | No |
...
| 41 | `ArchLucid.Application.Runs.Orchestration.ArchitectureRunExecuteOrchestrator` | `ArchLucid.Application\Runs\Orchestration\ArchitectureRunExecuteOrchestrator.cs` | 72.73 | 78 | No |
| 42 | `ArchLucid.Application.Runs.Orchestration.ArchitectureRunCreateOrchestrator` | `ArchLucid.Application\Runs\Orchestration\ArchitectureRunCreateOrchestrator.cs` | 74.27 | 79 | No |
...
| 58 | `ArchLucid.Application.Governance.GovernanceApprovalReviewConflictException` | `ArchLucid.Application\Governance\GovernanceApprovalReviewConflictException.cs` | 85.71 | 2 | No |
...
| 66 | `ArchLucid.Application.Evolution.SimulationEvaluationService` | `ArchLucid.Application\Evolution\SimulationEvaluationService.cs` | 87.50 | 22 | No |
...
| 69 | `ArchLucid.Application.Diagrams.ManifestDiagramService` | `ArchLucid.Application\Diagrams\ManifestDiagramService.cs` | 88.57 | 12 | No |
| 70 | `ArchLucid.Application.Governance.Preview.GovernanceManifestComparer` | `ArchLucid.Application\Governance\Preview\GovernanceManifestComparer.cs` | 88.89 | 6 | No |
| 71 | `ArchLucid.Application.Runs.Mapping.RunRecordToArchitectureRunMapper` | `ArchLucid.Application\Runs\Mapping\RunRecordToArchitectureRunMapper.cs` | 88.89 | 3 | No |
| 72 | `ArchLucid.Application.Tenancy.TrialSeatAccountant` | `ArchLucid.Application\Tenancy\TrialSeatAccountant.cs` | 88.89 | 1 | No |
| 73 | `ArchLucid.Application.Governance.GovernanceWorkflowService` | `ArchLucid.Application\Governance\GovernanceWorkflowService.cs` | 88.94 | 51 | No |
| 74 | `ArchLucid.Application.Diffs.ManifestDiffService` | `ArchLucid.Application\Diffs\ManifestDiffService.cs` | 89.11 | 11 | No |
...
### ArchLucid.AgentRuntime (77.82% line coverage)
...
| 21 | `ArchLucid.AgentRuntime.AgentExecutionTraceRecorder` | `ArchLucid.AgentRuntime\AgentExecutionTraceRecorder.cs` | 83.68 | 62 | No |
...
| 27 | `ArchLucid.AgentRuntime.MemoryLlmCompletionResponseStore` | `ArchLucid.AgentRuntime\MemoryLlmCompletionResponseStore.cs` | 90.48 | 2 | No |
| 28 | `ArchLucid.AgentRuntime.LlmCostEstimator` | `ArchLucid.AgentRuntime\LlmCostEstimator.cs` | 90.91 | 1 | No |
| 29 | `ArchLucid.AgentRuntime.Explanation.RunExplanationSummaryService` | `ArchLucid.AgentRuntime\Explanation\RunExplanationSummaryService.cs` | 91.34 | 11 | No |
| 30 | `ArchLucid.AgentRuntime.RealAgentExecutor` | `ArchLucid.AgentRuntime\RealAgentExecutor.cs` | 92.24 | 9 | No |
| 31 | `ArchLucid.AgentRuntime.CircuitBreakingAgentCompletionClient` | `ArchLucid.AgentRuntime\CircuitBreakingAgentCompletionClient.cs` | 93.33 | 2 | No |
| 32 | `ArchLucid.AgentRuntime.Prompts.CachedAgentSystemPromptCatalog` | `ArchLucid.AgentRuntime\Prompts\CachedAgentSystemPromptCatalog.cs` | 94.59 | 2 | No |

### ArchLucid.Host.Composition (79.42% line coverage)
...
| 2 | `ArchLucid.Host.Composition.Configuration.ArchLucidStorageServiceCollectionExtensions` | `ArchLucid.Host.Composition\Configuration\ArchLucidStorageServiceCollectionExtensions.cs` | 56.77 | 67 | No |
...
### ArchLucid.Core (84.48% line coverage)
...
| 19 | `ArchLucid.Core.Audit.DurableAuditLogRetry` | `ArchLucid.Core\Audit\DurableAuditLogRetry.cs` | 57.14 | 12 | No |
...
| 31 | `ArchLucid.Core.Resilience.CircuitBreakerGate` | `ArchLucid.Core\Resilience\CircuitBreakerGate.cs` | 87.97 | 19 | No |
| 32 | `ArchLucid.Core.Diagnostics.ArchLucidInstrumentation` | `ArchLucid.Core\Diagnostics\ArchLucidInstrumentation.cs` | 90.38 | 38 | No |
...
### ArchLucid.Cli (88.64% line coverage)
...
| 2 | `ArchLucid.Cli.Support.SupportBundleCollector` | `ArchLucid.Cli\Support\SupportBundleCollector.cs` | 83.51 | 31 | No |
| 3 | `ArchLucid.Cli.ArchLucidProjectScaffolder` | `ArchLucid.Cli\ArchLucidProjectScaffolder.cs` | 88.46 | 27 | No |
...
| 2 | `ArchLucid.Cli.Support.SupportBundleCollector` | `ArchLucid.Cli\Support\SupportBundleCollector.cs` | 83.51 | 31 | No |
| 3 | `ArchLucid.Cli.ArchLucidProjectScaffolder` | `ArchLucid.Cli\ArchLucidProjectScaffolder.cs` | 88.46 | 27 | No |
| 4 | `ArchLucid.Cli.Commands.CliCommandShared` | `ArchLucid.Cli\Commands\CliCommandShared.cs` | 90.54 | 7 | No |
| 5 | `ArchLucid.Cli.Support.SupportBundleRedactor` | `ArchLucid.Cli\Support\SupportBundleRedactor.cs` | 92.50 | 3 | No |

### ArchLucid.Contracts (90.38% line coverage)
...
| 5 | `ArchLucid.Contracts.ProductLearning.ProductLearningArtifactOutcomeTrendsResponse` | `ArchLucid.Contracts\ProductLearning\ProductLearningArtifactOutcomeTrendsResponse.cs` | 0.00 | 2 | No |
| 6 | `ArchLucid.Contracts.ProductLearning.ProductLearningDashboardSummaryResponse` | `ArchLucid.Contracts\ProductLearning\ProductLearningDashboardSummaryResponse.cs` | 0.00 | 11 | No |
| 7 | `ArchLucid.Contracts.ProductLearning.ProductLearningImprovementOpportunitiesResponse` | `ArchLucid.Contracts\ProductLearning\ProductLearningImprovementOpportunitiesResponse.cs` | 0.00 | 2 | No |
| 8 | `ArchLucid.Contracts.ProductLearning.ProductLearningReportExportResponse` | `ArchLucid.Contracts\ProductLearning\ProductLearningReportExportResponse.cs` | 0.00 | 3 | No |
| 9 | `ArchLucid.Contracts.ProductLearning.ProductLearningTriageQueueResponse` | `ArchLucid.Contracts\ProductLearning\ProductLearningTriageQueueResponse.cs` | 0.00 | 2 | No |
| 10 | `ArchLucid.Contracts.Common.AgentTypeKeys` | `ArchLucid.Contracts\Common\AgentTypeKeys.cs` | 39.13 | 14 | No |
| 11 | `ArchLucid.Contracts.Evolution.SimulationReadProfile` | `ArchLucid.Contracts\Evolution\SimulationReadProfile.cs` | 62.86 | 13 | No |
| 12 | `ArchLucid.Contracts.DecisionTraces.DecisionTrace` | `ArchLucid.Contracts\DecisionTraces\DecisionTrace.cs` | 66.67 | 2 | No |
| 13 | `ArchLucid.Contracts.Agents.AgentOutputEvaluationScore` | `ArchLucid.Contracts\Agents\AgentOutputEvaluationScore.cs` | 71.43 | 2 | No |
| 14 | `ArchLucid.Contracts.ProductLearning.Planning.ImprovementThemeEvidence` | `ArchLucid.Contracts\ProductLearning\Planning\ImprovementThemeEvidence.cs` | 71.43 | 2 | No |
| 15 | `ArchLucid.Contracts.ProductLearning.ProductLearningPilotSignalRecord` | `ArchLucid.Contracts\ProductLearning\ProductLearningPilotSignalRecord.cs` | 76.47 | 4 | No |
| 16 | `ArchLucid.Contracts.Governance.PreCommitGovernanceGateOptions` | `ArchLucid.Contracts\Governance\PreCommitGovernanceGateOptions.cs` | 80.00 | 1 | No |
| 17 | `ArchLucid.Contracts.DecisionTraces.DecisionTraceJsonConverter` | `ArchLucid.Contracts\DecisionTraces\DecisionTraceJsonConverter.cs` | 81.25 | 6 | No |
| 18 | `ArchLucid.Contracts.Requests.RequestConstraintClassifier` | `ArchLucid.Contracts\Requests\RequestConstraintClassifier.cs` | 86.67 | 2 | No |
...
| 7 | `ArchLucid.Decisioning.Models.FindingsSnapshot` | `ArchLucid.Decisioning\Models\FindingsSnapshot.cs` | 78.57 | 3 | No |
...
- **Merged line coverage:** 72.43%
- **Merged branch coverage:** 58.49%
