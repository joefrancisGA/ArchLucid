# ADR 0004: Dual manifest and decision-trace repository contracts
...
- **Operational:** In-memory hosts must register **both** Decisioning and Data in-memory implementations where features touch both paths (see ADR 0005).

## Related

- `docs/ARCHITECTURE_COMPONENTS.md` (dual manifest / trace section).
- ADR 0005 (storage provider branching).
