...
1. **Choose your path.** **Public sample (no sign-in):** open [archlucid.net/get-started](https://archlucid.net/get-started) and explore an illustrative review — no sign-in required. **Guided workspace:** open [archlucid.net](https://archlucid.net) and sign in with a supported identity or verify your email with a one-time code (work or school account, or email-code sign-in). No credit card is required to start. You will land in a workspace ready for your first **architecture review**.
