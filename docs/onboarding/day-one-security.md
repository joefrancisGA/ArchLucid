...
**Canonical operator action map:** [OPERATOR_ATLAS.md](../OPERATOR_ATLAS.md) — where Enterprise Controls routes live vs Core Pilot defaults.
...
- [ ] **2. AuthZ model** — Map **Admin / Operator / Reader** (Entra app roles) to API policies **ReadAuthority / ExecuteAuthority / AdminAuthority** (root [README.md](../../README.md#api-authentication-archlucidauth), [appsettings.Entra.sample.json](../../ArchLucid.Api/appsettings.Entra.sample.json)).
