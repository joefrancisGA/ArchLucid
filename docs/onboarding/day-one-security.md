...
- [ ] **2. AuthZ model** — Map **Admin / Operator / Reader** (Entra app roles) to API policies **ReadAuthority / ExecuteAuthority / AdminAuthority** (root [README.md](../../README.md#api-authentication-archiforgeauth), [appsettings.Entra.sample.json](../../ArchLucid.Api/appsettings.Entra.sample.json)).
