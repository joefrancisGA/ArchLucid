...
- [ ] **2. Deploy narrative** — Read [DEPLOYMENT.md](../DEPLOYMENT.md) + [DEPLOYMENT_TERRAFORM.md](../DEPLOYMENT_TERRAFORM.md) for how roots compose; **authoritative Azure apply order** is [REFERENCE_SAAS_STACK_ORDER.md](../REFERENCE_SAAS_STACK_ORDER.md) + [`infra/terraform-pilot`](../../infra/terraform-pilot/README.md).
