...
> **Hub:** Canonical repo entry — **[`../START_HERE.md`](../START_HERE.md)** — before role-scoped week-one tasks below.
...
| Role | Day-one ticket |
|------|----------------|
| **Developer** | [day-one-developer.md](day-one-developer.md) |
| **SRE / Platform** | [day-one-sre.md](day-one-sre.md) |
| **Security / GRC** | [day-one-security.md](day-one-security.md) |
...
**Full environment path:** [START_HERE.md](../START_HERE.md) (first row: canonical one-pager) · [day-one-sre.md](day-one-sre.md) (platform week-one) · [day-one-developer.md](day-one-developer.md) (developer week-one).
