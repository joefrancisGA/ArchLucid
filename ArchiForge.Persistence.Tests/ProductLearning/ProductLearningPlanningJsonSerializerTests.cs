...
public sealed class ProductLearningPlanningJsonSerializerTests
{
    ...
    public void Serialize_then_deserialize_round_trips_ordered_by_ordinal()
    {
        ...
        [
            new ProductLearningImprovementPlanActionStep { Ordinal = 2, ActionType = "B", Description = "second" },
            new ProductLearningImprovementPlanActionStep { Ordinal = 1, ActionType = "A", Description = "first" },
        ];
