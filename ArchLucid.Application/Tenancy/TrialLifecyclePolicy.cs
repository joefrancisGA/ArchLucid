...
{
    public static TrialLifecycleAdvancement? TryGetNextAdvancement(
        TenantRecord tenant,
        DateTimeOffset utcNow,
        TrialLifecycleSchedulerOptions options)
    {
    ...
    public static int? ComputeDaysRemainingForStatusDisplay(
        TenantRecord tenant,
        DateTimeOffset utcNow,
        TrialLifecycleSchedulerOptions options)
    {
