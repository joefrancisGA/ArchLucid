    ...
    IPromptRedactor promptRedactor) : IFindingLlmAuditService
{
    ...
    private async Task<AgentExecutionTrace?> ResolveTraceAsync(
        string runId,
        Finding finding,
        CancellationToken cancellationToken)
    {
        ...
        {
            AgentExecutionTrace? direct =
                await _agentExecutionTraceRepository.GetByTraceIdAsync(preferredId.Trim(), cancellationToken);
