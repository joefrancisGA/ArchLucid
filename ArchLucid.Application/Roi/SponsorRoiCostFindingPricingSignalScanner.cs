...
/// <summary>Detects pricing signals in committed run findings for sponsor ROI basis labels.</summary>
public static class SponsorRoiCostFindingPricingSignalScanner
{
