...
internal static class SponsorOrphanCandidateKpiCalculator
{
    internal static SponsorOrphanCandidateSummary BuildFromLatestDetails(IReadOnlyList<ArchitectureRunDetail> latestDetails)
    {
        ...
        if (evidence is null)
            return new SponsorOrphanCandidateSummary { CandidateCount = 0 };
        ...
        return new SponsorOrphanCandidateSummary
        {
