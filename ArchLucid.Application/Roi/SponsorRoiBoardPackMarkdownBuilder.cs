...
/// <summary>Formats a one-page sponsor ROI board pack as Markdown (no LLM calls).</summary>
public static class SponsorRoiBoardPackMarkdownBuilder
{
        ...
        string? traceId)
    {
        ...
        sb.AppendLine("# Sponsor ROI — Board Pack");
        sb.AppendLine();
