...
public static class SponsorRoiSavingsPricingBasisDescriptionBuilder
{
        ...
        RoiCostEvidenceFreshnessSnapshot freshness)
    {
        ...
        {
            case SponsorRoiSavingsPricingBasis.UploadedActualAmortized:
            ...
            case SponsorRoiSavingsPricingBasis.EaAdjusted:
                builder.Append(
                    CultureInfo.InvariantCulture,
                    $"Tenant EA discount multiplier {eaDiscountMultiplier:0.####} applied to Retail-derived cost findings.");
                break;

            case SponsorRoiSavingsPricingBasis.HeuristicFallback:
