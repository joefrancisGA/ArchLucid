...
/// </summary>
internal static class SponsorRoiFindingExclusionLogger
{
        ...
        IEnumerable<ArchitectureFinding> mutedFindings)
    {
        ...
        foreach (ArchitectureFinding finding in mutedFindings)
        {
            logger.LogInformation(
                "Sponsor ROI summary excluded muted finding {FindingId} with estimated savings {EstimatedUsdSavings}.",
        ...
        IEnumerable<ArchitectureFinding> findings)
    {
        ...
        foreach (ArchitectureFinding finding in findings)
        {
            ...
            {
                logger.LogInformation(
                    "Sponsor ROI summary excluded duplicate finding {FindingId} with estimated savings {EstimatedUsdSavings}.",
                    finding.FindingId,
                    finding.EstimatedUsdSavings);
            }
        }
