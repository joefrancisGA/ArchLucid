...
/// <summary>
///     Computes trailing 30-day finding discovery and resolution counts for sponsor ROI summaries.
/// </summary>
internal static class SponsorRoiTrailing30DayMetricsCalculator
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        while (true)
        {
            ...
            foreach (RunSummary summary in items)
            {
                ...
                foreach (ArchitectureFinding finding in SponsorRoiFindingDeduplicator.DeduplicateByStableIdentity(activeFindings))
                {
