...
/// <summary>Builds six-month systemic-issue trends for sponsor ROI (Improvement #12).</summary>
public static class SponsorRoiSystemicIssueTrendBuilder
{
    ...
    /// </summary>
    public static List<SponsorRoiSystemicIssueTrendSeries> Build(
        ...
        TimeProvider timeProvider)
    {
        ...
        List<SponsorRoiSystemicIssueTrendSeries> series = [];
        ...
        foreach (string findingId in topFindingIds)
        {
            ...
            List<SponsorRoiSystemicIssueTrendPoint> points = monthKeys
                .Select(monthKey => new SponsorRoiSystemicIssueTrendPoint
                {
                    MonthKey = monthKey,
            ...
            series.Add(new SponsorRoiSystemicIssueTrendSeries
            {
                FindingId = findingId,
