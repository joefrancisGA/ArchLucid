...
/// <summary>
///     Outcome of <see cref="Runs.Orchestration.IArchitectureRunCreateOrchestrator.CreateRunAsync" /> after successful
///     coordination and persistence.
/// </summary>
public sealed class CreateRunResult
{
    /// <summary>
    ///     Run record written to storage (status typically
    ///     <see cref="ArchLucid.Contracts.Common.ArchitectureRunStatus.TasksGenerated" />).
    /// </summary>
...
/// <summary>
///     Outcome of <see cref="Runs.Orchestration.IArchitectureRunExecuteOrchestrator.ExecuteRunAsync" />: persisted agent
///     outputs for the run.
/// </summary>
/// <remarks>
///     On failure, <see cref="Runs.Orchestration.IArchitectureRunExecuteOrchestrator.ExecuteRunAsync" /> throws before
///     returning.
///     Baseline mutation audit (<c>Baseline.Architecture.RunFailed</c>) then records exception type, or
///     <c>CircuitBreakerOpenException:CircuitBreakerRejected</c> /
///     <c>LlmTokenQuotaExceededException:LlmTokenQuotaExceeded</c>
...
/// <summary>
///     Outcome of <see cref="Runs.Orchestration.IArchitectureRunCommitOrchestrator.CommitRunAsync" />: committed golden
///     manifest and associated decision traces.
/// </summary>
