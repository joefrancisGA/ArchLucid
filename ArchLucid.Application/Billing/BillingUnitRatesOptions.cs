...
public sealed class BillingUnitRatesOptions
{
    ...
    public decimal StandardMonthlyUsdLow { get; set; } = 49;

    public decimal StandardMonthlyUsdHigh { get; set; } = 199;

    public decimal EnterpriseMonthlyUsdLow { get; set; } = 199;

    public decimal EnterpriseMonthlyUsdHigh { get; set; } = 899;

    public string MethodologyNote { get; set; } =
