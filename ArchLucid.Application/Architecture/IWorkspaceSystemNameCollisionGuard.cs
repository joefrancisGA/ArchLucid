...
/// <summary>Prevents duplicate review or architecture names within a workspace.</summary>
public interface IWorkspaceSystemNameCollisionGuard
{
    ...
    ///     entity of <paramref name="occupancyKind" /> in <paramref name="scope" />'s workspace. Failed and
    ///     quality-rejected runs do not occupy review names; committed and in-flight runs do.
    /// </summary>
    ...
    /// <summary>
    ///     Returns <see langword="false" /> when <paramref name="systemName" /> is already used by an occupying entity
    ///     of <paramref name="occupancyKind" /> in <paramref name="scope" />'s workspace. Empty names after trim are
