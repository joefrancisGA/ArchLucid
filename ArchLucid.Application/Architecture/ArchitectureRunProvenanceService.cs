...
public sealed class ArchitectureRunProvenanceService(
    ...
    : IArchitectureRunProvenanceService
{
    /// <inheritdoc />
    public async Task<ArchitectureRunProvenanceGraph?> GetProvenanceAsync(
        string runId,
    ...
    private static async Task<EvidenceBundle?> TryResolveEvidenceBundleAsync(
        ArchitectureRunDetail detail,
        IEvidenceBundleRepository bundles,
        CancellationToken cancellationToken)
    {
        string? bundleRef = detail.Tasks
    ...
    private static ArchitectureRunProvenanceGraph BuildGraph(
        ArchitectureRunDetail detail,
    ...
    private static void AddSnapshotNodes(
        ArchitectureRun run,
        string runNodeId,
        Action<ArchitectureLinkageNode> addNode,
