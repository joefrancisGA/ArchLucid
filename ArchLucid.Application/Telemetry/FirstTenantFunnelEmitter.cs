...
/// </summary>
public sealed class FirstTenantFunnelEmitter(
    IOptionsMonitor<FirstTenantFunnelOptions> optionsMonitor,
    IFirstTenantFunnelEventStore eventStore,
    TimeProvider timeProvider,
    ILogger<FirstTenantFunnelEmitter> logger) : IFirstTenantFunnelEmitter
{
