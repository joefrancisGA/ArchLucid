...
public sealed class RecurringArchitectureReviewTriggerService(
    ArchLucid.Core.Persistence.Ports.IArchitectureReviewRecurrenceScheduleRepository scheduleRepository,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            using (AmbientScopeContext.Push(scope))
            {
                ...
                await executeOrchestrator.ExecuteRunAsync(runIdHex, cancellationToken);
