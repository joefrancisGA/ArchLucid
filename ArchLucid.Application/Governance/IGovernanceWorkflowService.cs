...
public interface IGovernanceWorkflowService
{
    ...
    ///     Human-readable identity of the user or system submitting the request (
    ///     <see cref="Application.Common.IActorContext.GetActor" />).
    /// </param>
    /// <param name="requestedByActorKey">
    ///     Canonical segregation key (<see cref="Application.Common.IActorContext.GetActorId" />
    ///     ); persists as <see cref="GovernanceApprovalRequest.RequestedByActorKey" />.
    /// </param>
