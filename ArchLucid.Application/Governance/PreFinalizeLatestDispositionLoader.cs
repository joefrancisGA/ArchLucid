...
internal static class PreFinalizeLatestDispositionLoader
{
    internal static async Task<IReadOnlyDictionary<string, Disposition>> LoadAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        IReadOnlyList<FindingReviewEventRecord> events =
            await findingReviewTrailRepository
