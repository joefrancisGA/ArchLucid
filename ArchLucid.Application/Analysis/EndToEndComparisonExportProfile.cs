...
public static class EndToEndComparisonExportProfile
{
    ...
    public static bool IsShort(string? profile) =>
        string.Equals(profile, Short, StringComparison.OrdinalIgnoreCase);

    public static bool IsExecutive(string? profile) =>
        string.Equals(profile, Executive, StringComparison.OrdinalIgnoreCase);
    ...
    public static bool IsDetailedOrDefault(string? profile) =>
        ...
        string.Equals(profile, Detailed, StringComparison.OrdinalIgnoreCase);

    public static string Normalize(string? profile) =>
        string.IsNullOrWhiteSpace(profile) ? Default : profile.Trim().ToLowerInvariant();
}
