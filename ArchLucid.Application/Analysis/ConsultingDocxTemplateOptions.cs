...
public sealed class ConsultingDocxTemplateOptions
{
    ...
    public bool IncludeDocumentControl
    {
        get;
        set;
    } = true;
    ...
    public bool IncludeArchitectureOverview
    {
        get;
        set;
    } = true;
    ...
    public bool IncludeEvidenceAndConstraints
    {
        get;
        set;
    } = true;
    ...
    public bool IncludeArchitectureDetails
    {
        get;
        set;
    } = true;
    ...
    public bool IncludeGovernanceAndControls
    {
        get;
        set;
    } = true;
    ...
    public bool IncludeExplainabilitySection
    {
        get;
        set;
    } = true;
    ...
    public bool IncludeConclusions
    {
        get;
        set;
    } = true;
    ...
    public bool IncludeAppendixMermaid
    {
        get;
        set;
    } = true;
    ...
    ///     is included.
    /// </summary>
    public bool IncludeAppendixExecutionTraceIndex
    {
        get;
        set;
    } = true;
    ...
    /// </summary>
    public bool IncludeAppendixDeterminismAndComparison
    {
        get;
        set;
    } = true;
    ...
    ///     <see langword="true" />. May be absolute or relative to <see cref="System.AppContext.BaseDirectory" /> (publish /
    ///     build output).
    /// </summary>
