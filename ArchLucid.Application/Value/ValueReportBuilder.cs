...
public sealed class ValueReportBuilder(IValueReportMetricsReader metricsReader, IOptionsMonitor<ValueReportComputationOptions> optionsMonitor)
{
        ...
        DateTimeOffset toUtcExclusive, CancellationToken cancellationToken)
    {
        ...
        decimal perManifestHours = raw.TenantBaselineManualPrepHoursPerReview ?? o.BaselineArchitectHoursBeforeArchLucidPerCommittedManifest;
        ...
        {
            decimal denom = raw.TenantArchitectureTeamSize is { } ats and > 0 ? ats : o.DefaultTeamSizeForHourlyCostScaling;
            if (denom > 0m)
