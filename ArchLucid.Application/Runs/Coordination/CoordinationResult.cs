...
/// <summary>
///     Result of a coordinate-create call (maps an architecture request to an authority run and starter tasks).
...
{
    /// <summary>
    ///     The architecture run record created by coordination.
