...
public sealed class TrialLifecycleEmailIntegrationEnvelope
{
    ...
    public TrialLifecycleEmailTrigger Trigger { get; init; }
    ...
    /// <summary>Converted tier label (e.g. Professional) when <see cref="Trigger"/> is <see cref="TrialLifecycleEmailTrigger.Converted"/>.</summary>
