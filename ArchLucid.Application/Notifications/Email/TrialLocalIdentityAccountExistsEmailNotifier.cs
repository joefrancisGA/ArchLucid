    ...
    ILogger<TrialLocalIdentityAccountExistsEmailNotifier> logger) : ITrialLocalIdentityAccountExistsNotifier
{
    ...
    private readonly ILogger<TrialLocalIdentityAccountExistsEmailNotifier> _logger =
    ...
    public async Task NotifyAccountAlreadyExistsAsync(string toEmail, CancellationToken cancellationToken)
    {
        ...
        string html =
            $"<p>You already have a {safeProduct} account for this email address.</p>" +
        ...
        string text =
            $"You already have a {productName} account for this email address.\n" +
