...
/// <summary>Razor model for <c>Templates/SponsorDigest.cshtml</c>.</summary>
public sealed class SponsorDigestEmailModel
{
    ...
    public IReadOnlyList<SponsorDigestHighlightedRun> TopRuns
    {
        get;
        init;
    } = [];
