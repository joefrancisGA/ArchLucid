...
/// <inheritdoc cref = "ISponsorDigestUnsubscribeTokenFactory"/>
...
public sealed class SponsorDigestUnsubscribeTokenFactory(IDataProtectionProvider dataProtectionProvider) : ISponsorDigestUnsubscribeTokenFactory
{
    private const string Purpose = "ArchLucid.SponsorDigest.Unsubscribe.v1";
