...
public sealed record WhyArchLucidPackSourceDto
{
    ...
    public WhyArchLucidPackSourceDto(string runId, string projectId, string manifestSectionMarkdown, string authorityChainSectionMarkdown,
        string artifactsSectionMarkdown, string pipelineTimelineSectionMarkdown, string runExplanationSectionMarkdown, string citationsSectionMarkdown,
