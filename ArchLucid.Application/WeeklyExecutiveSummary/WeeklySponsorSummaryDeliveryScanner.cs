...
public sealed class WeeklySponsorSummaryDeliveryScanner(
    ...
    ILogger<WeeklySponsorSummaryDeliveryScanner> logger)
{
    ...
    private readonly ILogger<WeeklySponsorSummaryDeliveryScanner> _logger =
    ...
    {
        WeeklySponsorSummaryOptions options = _optionsMonitor.CurrentValue;
    ...
    private static bool IsScheduledLocalHour(DateTimeOffset utcNow, WeeklySponsorSummaryOptions options)
    {
        TimeZoneInfo tz;
