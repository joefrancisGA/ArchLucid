...
/// <inheritdoc cref="IArchitectureRequestDraftExtractStage" />
public sealed class ArchitectureRequestDraftExtractStage(IAgentCompletionClient completionClient)
    : IArchitectureRequestDraftExtractStage
{
    ...
    public async Task<ArchitectureRequestDraftExtractionResult> ExtractAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new ArchitectureRequestDraftExtractionResult
        {
            NormalizedConstraints = Normalize(response.SuggestedConstraints, response.Constraints),
            NormalizedAssumptions = Normalize(response.SuggestedAssumptions, response.Assumptions),
            ...
            ExistingConstraints = ArchitectureRequestDraftSemanticUniquePass.NormalizeExact(input.CurrentConstraints),
            ExistingAssumptions = ArchitectureRequestDraftSemanticUniquePass.NormalizeExact(input.CurrentAssumptions),
