...
public static class OperationalErrorRecordBuilder
{
    public static OperationalErrorRecord Build(OperationalErrorCaptureRequest request, OperationalErrorOptions options)
    {
        ...
        bool hasSqlException = SqlExceptionDetailsAccessor.TryGet(exception, out int sqlErrorNumber, out byte sqlErrorState);
        ...
        return new OperationalErrorRecord
        {
            ...
            SqlErrorNumber = hasSqlException ? sqlErrorNumber : null,
            SqlErrorState = hasSqlException ? sqlErrorState : null,
