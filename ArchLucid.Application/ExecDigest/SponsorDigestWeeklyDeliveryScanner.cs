...
public sealed class SponsorDigestWeeklyDeliveryScanner(
    ...
    ISponsorDigestComposer execDigestComposer,
    ISponsorDigestEmailDispatcher execDigestEmailDispatcher,
    ...
    ILogger<SponsorDigestWeeklyDeliveryScanner> logger)
{
    ...
    private readonly ISponsorDigestComposer _execDigestComposer = execDigestComposer ?? throw new ArgumentNullException(nameof(execDigestComposer));

    private readonly ISponsorDigestEmailDispatcher _execDigestEmailDispatcher =
