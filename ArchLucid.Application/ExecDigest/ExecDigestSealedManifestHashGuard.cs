...
/// <summary>Wave-25 suggestion 242: exec digest compose fail-closed unless highlighted run sealed hash verifies.</summary>
public static class ExecDigestSealedManifestHashGuard
{
