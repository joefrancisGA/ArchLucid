...
{
    /// <summary>
    ///     <paramref name="weekStartUtcInclusive" /> / <paramref name="weekEndUtcExclusive" /> define the digest window in
    ///     UTC.
    ///     <paramref name="authorityScope" /> must match the tenant’s primary authority project boundary (workspace + project
    ///     ids).
    /// </summary>
