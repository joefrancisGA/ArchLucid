    ...
    public async Task ExecuteRunAsync_does_not_change_StructuralExecutionMode_when_GoldenManifestId_pre_sealed()
    {
        ...
        ArchitectureRunExecuteOrchestrator sut = ArchitectureRunExecuteOrchestratorTestFactory.Create(
            ...
            new ArchitectureRunExecuteOrchestratorCreateArgs
            {
                ...
                PostExecuteHooks = ArchitectureRunExecuteOrchestratorTestFactory.CreatePostExecuteHooks(auditService.Object, scopeProvider.Object, baselineAudit.Object, runRepo.Object),
                ...
                AgentExecutionOptions = Microsoft.Extensions.Options.Options.Create(new AgentExecutionOptions { Mode = "Simulator" }),
                EffectiveAgentExecutionModeAccessor = new FixedEffectiveAgentExecutionModeAccessor("Simulator"),
