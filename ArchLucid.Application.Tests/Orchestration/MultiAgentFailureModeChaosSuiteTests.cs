        ...
        IRunScopedLlmBudgetReservationService? budgetService = null)
    {
        ...
        return ArchitectureRunExecuteOrchestratorTestFactory.Create(
            ...
            new ArchitectureRunExecuteOrchestratorCreateArgs
            {
                ...
                PostExecuteHooks = ArchitectureRunExecuteOrchestratorTestFactory.CreatePostExecuteHooks(audit.Object, scopeProvider.Object, baselineAudit.Object, runRepo),
                ...
                AgentOutputQualityGateOptions = Options.Create(gateOptions ?? new AgentOutputQualityGateOptions()),
                ...
                TopologyProposalSeeder = tail.TopologyProposalSeeder,
                DemoExpensiveActionGate = tail.DemoExpensiveActionGate,
                RunScopedLlmBudgetReservationService = budgetService ?? tail.RunScopedLlmBudgetReservationService,
                OperationCancellationRegistry = tail.OperationCancellationRegistry,
                RunCancellationMarker = tail.RunCancellationMarker,
                RunExecuteOwnershipLeaseService = tail.RunExecuteOwnershipLeaseService,
