...
public sealed class ItsmInboundWebhookProcessPipelineTests {
  ...
  private static ItsmInboundWebhookProcessPipeline CreatePipeline(IItsmFindingCorrelationRepository correlations) {
    ...
    return new ItsmInboundWebhookProcessPipeline(new ItsmInboundWebhookSyncSupport(correlations, replay.Object), monitor.Object, new ItsmInboundDispositionSync(new Mock<IFindingDispositionService>().Object, NullLogger<ItsmInboundDispositionSync>.Instance), NullLogger<ItsmInboundWebhookProcessPipeline>.Instance);
  }
