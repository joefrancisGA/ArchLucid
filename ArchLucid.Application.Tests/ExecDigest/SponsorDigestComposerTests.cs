...
[Trait("Suite", "Core")]
[Trait("Category", "Unit")]
public sealed class SponsorDigestComposerTests
{
    [SkippableFact]
    public async Task ComposeAsync_includes_compliance_table_when_service_returns_points()
    {
        ...
        SponsorDigestComposer composer = new(
            compliance.Object,
            authority.Object,
            runDetails.Object,
            deltas.Object,
            decisionNeeded.Object,
            NullLogger<SponsorDigestComposer>.Instance);
        ...
        SponsorDigestComposition result = await composer.ComposeAsync(tenantId, start, end, scope, "https://app.example", CancellationToken.None);
    ...
    public async Task ComposeAsync_orders_highlights_by_score_and_builds_findings_delta_without_refetch()
    {
        ...
        SponsorDigestComposition result = await composer.ComposeAsync(
            tenantId,
            weekStart,
            weekEnd,
            scope,
