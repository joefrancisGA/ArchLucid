...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateBatchTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_batch_node_has_compute_category_but_synthetic_datastore_id_used()
    {
