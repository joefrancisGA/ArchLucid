...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateServicebusQueueTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_servicebus_queue_node_has_compute_category_but_synthetic_datastore_id_used()
    {
        GraphSnapshot graph = Graph(
            ComputeNode(nodeId: "svc-1", label: "api", sourceId: "azurerm_linux_virtual_machine.main"),
            ComputeNode(nodeId: "sbq-1", label: "orders", sourceId: "azurerm_servicebus_queue.orders"));
