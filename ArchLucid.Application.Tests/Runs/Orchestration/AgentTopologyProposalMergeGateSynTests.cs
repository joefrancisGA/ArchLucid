...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateSynTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_syn_node_has_compute_category_but_synthetic_datastore_id_used()
    {
        GraphSnapshot graph = Graph(
            ComputeNode(nodeId: "svc-1", label: "api", sourceId: "azurerm_linux_virtual_machine.main"),
            ComputeNode(nodeId: "sy-1", label: "syn", sourceId: "azurerm_syn.main"));
