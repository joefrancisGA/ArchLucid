...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateCglTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_cgl_node_has_compute_category_but_synthetic_datastore_id_used()
    {
