...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateUpuTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_upu_node_has_compute_category_but_synthetic_datastore_id_used()
    {
