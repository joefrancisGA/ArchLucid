...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateAutomationDscConfigurationTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_automation_dsc_configuration_node_has_compute_category_but_synthetic_datastore_id_used()
    {
        GraphSnapshot graph = Graph(
            ComputeNode(nodeId: "svc-1", label: "api", sourceId: "azurerm_linux_virtual_machine.main"),
            ComputeNode(nodeId: "dsc-1", label: "baseline", sourceId: "azurerm_automation_dsc_configuration.baseline"));
