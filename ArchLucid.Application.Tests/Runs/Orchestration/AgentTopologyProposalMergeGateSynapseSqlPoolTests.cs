...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateSynapseSqlPoolTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_synapse_sql_pool_node_has_compute_category_but_synthetic_datastore_id_used()
    {
        GraphSnapshot graph = Graph(
            ComputeNode(nodeId: "svc-1", label: "api", sourceId: "azurerm_linux_virtual_machine.main"),
            ComputeNode(nodeId: "sp-1", label: "analytics", sourceId: "azurerm_synapse_sql_pool.analytics"));
