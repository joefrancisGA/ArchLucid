...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGatePolicySetDefinitionTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_policy_set_definition_node_has_compute_category_but_synthetic_datastore_id_used()
    {
        GraphSnapshot graph = Graph(
            ComputeNode(nodeId: "svc-1", label: "api", sourceId: "azurerm_linux_virtual_machine.main"),
            ComputeNode(nodeId: "psd-1", label: "baseline", sourceId: "azurerm_policy_set_definition.baseline"));
