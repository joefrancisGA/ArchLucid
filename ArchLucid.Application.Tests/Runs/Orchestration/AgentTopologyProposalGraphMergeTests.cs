...
public sealed class AgentTopologyProposalGraphMergeTests
{
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_purview_account_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_mssql_server_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "sql-1", label: "orders-db", sourceId: "azurerm_mssql_server.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-orders-db")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_sql_managed_instance_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "mi-1", label: "sqlmi-db", sourceId: "azurerm_sql_managed_instance.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-sqlmi-db")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_search_service_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_synapse_workspace_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "syn-1", label: "synapse", sourceId: "azurerm_synapse_workspace.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-synapse")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_data_factory_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "adf-1", label: "etl", sourceId: "azurerm_data_factory.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-etl")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_cosmosdb_account_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_postgresql_flexible_server_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "pg-1", label: "pg-db", sourceId: "azurerm_postgresql_flexible_server.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-pg-db")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_mysql_flexible_server_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "my-1", label: "my-db", sourceId: "azurerm_mysql_flexible_server.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-my-db")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_mariadb_server_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "mdb-1", label: "maria-db", sourceId: "azurerm_mariadb_server.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-maria-db")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_sql_database_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "db-1", label: "app-db", sourceId: "azurerm_sql_database.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-app-db")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_app_configuration_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "appcfg-1", label: "config", sourceId: "azurerm_app_configuration.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-config")), resultId: "topology-1");

        GraphSnapshot merged = AgentTopologyProposalGraphMerge.WithMergedTopologyProposals(graph, [topology]);

        merged.Edges.Should().ContainSingle(e =>
            e.FromNodeId == "appcfg-1" &&
            e.ToNodeId == "ds-1");
    }
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_netapp_volume_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "netapp-1", label: "files", sourceId: "azurerm_netapp_volume.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-files")), resultId: "topology-1");

        GraphSnapshot merged = AgentTopologyProposalGraphMerge.WithMergedTopologyProposals(graph, [topology]);

        merged.Edges.Should().ContainSingle(e =>
            e.FromNodeId == "netapp-1" &&
            e.ToNodeId == "ds-1");
    }
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_recovery_services_vault_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "rsv-1", label: "backup", sourceId: "azurerm_recovery_services_vault.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-backup")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_private_endpoint_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "pe-1", label: "storage-pe", sourceId: "azurerm_private_endpoint.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-storage-pe")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_managed_disk_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "disk-1", label: "data-disk", sourceId: "azurerm_managed_disk.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-data-disk")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_stream_analytics_job_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_iothub_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "iot-1", label: "devices", sourceId: "azurerm_iothub.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-devices")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_powerbi_embedded_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "pbi-1", label: "bi", sourceId: "azurerm_powerbi_embedded.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-bi")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_eventgrid_topic_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_redis_enterprise_cache_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "redis-1", label: "ent-cache", sourceId: "azurerm_redis_enterprise_cache.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-ent-cache")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_maps_account_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "maps-1", label: "geo", sourceId: "azurerm_maps_account.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-geo")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_data_share_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "share-1", label: "partner", sourceId: "azurerm_data_share.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-partner")), resultId: "topology-1");

        GraphSnapshot merged = AgentTopologyProposalGraphMerge.WithMergedTopologyProposals(graph, [topology]);

        merged.Edges.Should().ContainSingle(e =>
            e.FromNodeId == "share-1" &&
            e.ToNodeId == "ds-1");
    }
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_digital_twins_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "dt-1", label: "factory", sourceId: "azurerm_digital_twins_instance.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-factory")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_media_services_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "ams-1", label: "stream", sourceId: "azurerm_media_services_account.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-stream")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_elastic_san_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "esan-1", label: "vol", sourceId: "azurerm_elastic_san.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-vol")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_healthcare_workspace_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "hc-1", label: "fhir", sourceId: "azurerm_healthcare_workspace.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-fhir")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_backup_vault_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "bv-1", label: "archive", sourceId: "azurerm_backup_vault.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-archive")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_storage_account_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
            DataNode(nodeId: "sa-1", label: "artifacts", sourceId: "azurerm_storage_account.main"),
            DataNode());

        AgentResult topology = TopologyResult(RelationshipProposal(Relationship("svc-artifacts")), resultId: "topology-1");
    ...
    [Fact]
    public void WithMergedTopologyProposals_materializes_edge_when_storage_share_node_has_data_category_but_synthetic_service_id_used()
    {
        GraphSnapshot graph = Graph(
