...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateGeoTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_geo_node_has_compute_category_but_synthetic_datastore_id_used()
    {
        GraphSnapshot graph = Graph(
            ComputeNode(nodeId: "svc-1", label: "api", sourceId: "azurerm_linux_virtual_machine.main"),
            ComputeNode(nodeId: "ge-1", label: "geo", sourceId: "azurerm_geo.main"));
