...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateJejTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_jej_node_has_compute_category_but_synthetic_datastore_id_used()
    {
