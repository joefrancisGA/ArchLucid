...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateDinTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_din_node_has_compute_category_but_synthetic_datastore_id_used()
    {
