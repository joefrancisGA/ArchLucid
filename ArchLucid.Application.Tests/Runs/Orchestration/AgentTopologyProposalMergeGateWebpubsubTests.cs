...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateWebpubsubTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_webpubsub_node_has_compute_category_but_synthetic_datastore_id_used()
    {
