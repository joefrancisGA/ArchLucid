...
[Trait("Category", "Unit")]
public sealed class AgentTopologyProposalMergeGateRestorePointCollectionTests
{
    [Fact]
    public void FilterValidatedProposals_keeps_relationship_when_restore_point_collection_node_has_compute_category_but_synthetic_datastore_id_used()
    {
        GraphSnapshot graph = Graph(
            ComputeNode(nodeId: "svc-1", label: "api", sourceId: "azurerm_linux_virtual_machine.main"),
            ComputeNode(nodeId: "rpc-1", label: "backup", sourceId: "azurerm_restore_point_collection.backup"));
