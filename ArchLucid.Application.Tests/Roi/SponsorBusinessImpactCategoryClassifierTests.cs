...
[Trait("Suite", "Core")]
public sealed class SponsorBusinessImpactCategoryClassifierTests
{
    [Fact]
    public void Build_buckets_security_compliance_and_reliability_themes()
    {
        ...
        SponsorBusinessImpactCategoryCounts counts =
            SponsorBusinessImpactCategoryClassifier.Build(findings);
    ...
    {
        SponsorBusinessImpactCategoryCounts counts =
            SponsorBusinessImpactCategoryClassifier.Build([Finding("Cost optimization")]);
    ...
    {
        SponsorBusinessImpactCategoryCounts counts =
            SponsorBusinessImpactCategoryClassifier.Build([Finding("Governance drift")]);
