...
internal static class SponsorRoiSummaryServiceTestSupport
{
        ...
        Action<Mock<IFindingsSnapshotRepository>>? configureFindingsSnapshots = null)
    {
        ...
        architectureRiskRegister
            .Setup(service => service.GetRegisterAsync(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<Guid?>(), It.IsAny<int>(), It.IsAny<ArchitectureRiskRegisterListOptions?>(), It.IsAny<CancellationToken>()))
