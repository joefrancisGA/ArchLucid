...
[Trait("Category", "Unit")]
public sealed class ExportBundleCareerPostureResolverIsSampleRunPascalCaseTests
{
    [Fact]
    public void ResolveFromDeltasJson_blocks_sample_run_when_is_sample_run_pascal_case_true()
    {
