...
[Trait("Suite", "Core")]
public sealed class GoldenManifestProvenanceRelationalBranchesDirectSqlIntegrationTests(
    SqlServerPersistenceFixture fixture)
{
    ...
    public async Task HydrateAsync_provenance_total_count_zero_falls_back_to_ProvenanceJson()
    {
        ...
        string provenanceJson = JsonEntitySerializer.Serialize(
            ...
            {
                SourceFindingIds = ["f-json"], SourceGraphNodeIds = ["n-json"], AppliedRuleIds = ["r-json"]
            });
