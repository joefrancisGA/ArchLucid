...
/// <remarks>
///     <para>
///         <b>Why order matters:</b> <see cref="Services.ContextIngestionService" /> iterates this sequence
...
///         without changing underlying object merge semantics (enrichment and deduplication run after all connectors).
///     </para>
///     <para>
///         <b>Single source of truth:</b> The API host registers <c>IEnumerable&lt;IContextConnector&gt;</c>
///         only via <see cref="CreateOrderedContextConnectorPipeline" /> so execution order is never inferred from
///         incidental <c>AddSingleton</c> registration order or multi-registration collection rules.
///     </para>
