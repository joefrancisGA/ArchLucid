...
public sealed class GovernanceControllerRunHistoryScopeTests
{
    ...
    [Fact]
    public async Task GetApprovalRequests_returns_bad_request_when_run_id_is_whitespace()
    {
        Mock<IGovernanceApprovalRequestRepository> approvals = new(MockBehavior.Strict);
        ...
        IActionResult result = await sut.GetApprovalRequests("   ", CancellationToken.None);
    ...
    {
        string oversizeApprovalRequestId = new('a', 65);
    ...
    [Fact]
    public async Task BatchReviewApprovalRequests_returns_bad_request_when_approval_request_id_exceeds_max_length()
    {
        Mock<IGovernanceApprovalRequestRepository> approvals = new(MockBehavior.Strict);
        Mock<IGovernanceWorkflowService> workflow = new(MockBehavior.Strict);
        ...
        IActionResult result = await sut.BatchReviewApprovalRequests(
            ...
            {
                ApprovalRequestIds = [new string('a', 65)],
                Decision = "approve",
            },
            CancellationToken.None);
    ...
    [Fact]
    public async Task BatchReviewApprovalRequests_returns_bad_request_when_review_comment_exceeds_max_length()
    {
        Mock<IGovernanceApprovalRequestRepository> approvals = new(MockBehavior.Strict);
        Mock<IGovernanceWorkflowService> workflow = new(MockBehavior.Strict);
        ...
        IActionResult result = await sut.BatchReviewApprovalRequests(
            new GovernanceApprovalBatchReviewRequest
            {
                ...
                Decision = "approve",
                ReviewComment = new string('x', 4001),
            },
            CancellationToken.None);
    ...
    [Fact]
    public async Task BatchReviewApprovalRequests_returns_bad_request_when_decision_is_whitespace()
    {
        Mock<IGovernanceApprovalRequestRepository> approvals = new(MockBehavior.Strict);
        Mock<IGovernanceWorkflowService> workflow = new(MockBehavior.Strict);
    ...
    [Fact]
    public async Task BatchReviewApprovalRequests_returns_bad_request_when_approval_request_id_is_empty_guid()
    {
        Mock<IGovernanceApprovalRequestRepository> approvals = new(MockBehavior.Strict);
        Mock<IGovernanceWorkflowService> workflow = new(MockBehavior.Strict);
        ...
        IActionResult result = await sut.BatchReviewApprovalRequests(
            new GovernanceApprovalBatchReviewRequest
            {
                ApprovalRequestIds = [Guid.Empty.ToString("D")],
                Decision = "approve",
            },
            CancellationToken.None);
    ...
    public async Task Promote_returns_bad_request_when_manifest_version_exceeds_max_length()
    {
        ...
        IActionResult result = await sut.Promote(
            ...
            {
                RunId = runId.ToString("D"),
                ManifestVersion = new string('v', 129),
                SourceEnvironment = "dev",
                TargetEnvironment = "test",
            },
            dryRun: true,
    ...
    public async Task SubmitApprovalRequest_returns_bad_request_when_request_comment_exceeds_max_length()
    {
        ...
        IActionResult result = await sut.SubmitApprovalRequest(
            new CreateGovernanceApprovalRequest
            {
                ...
                SourceEnvironment = "dev",
                TargetEnvironment = "test",
                RequestComment = new string('x', 4001),
            },
            dryRun: true,
            CancellationToken.None);
    ...
    {
        const string approvalRequestId = "apr-review-comment-length";
        Guid runId = Guid.Parse("55555555-5555-5555-5555-555555555555");
        ...
        IActionResult result = await sut.Approve(
            approvalRequestId,
            new ApproveGovernanceRequest { ReviewComment = new string('x', 4001) },
            CancellationToken.None);
    ...
    public async Task Activate_returns_bad_request_when_manifest_version_exceeds_max_length()
    {
        ...
        GovernanceController sut = CreateController(workflowService: workflow.Object);
        sut.ControllerContext = new ControllerContext { HttpContext = new DefaultHttpContext() };
        sut.ControllerContext.HttpContext.Request.Headers["Idempotency-Key"] = "activate-manifest-length";
    ...
    [Fact]
    public async Task Activate_returns_bad_request_when_environment_is_invalid()
    {
        Guid runId = Guid.Parse("11111111-1111-1111-1111-111111111111");
        ...
        GovernanceController sut = CreateController(workflowService: workflow.Object);
        sut.ControllerContext = new ControllerContext { HttpContext = new DefaultHttpContext() };
        sut.ControllerContext.HttpContext.Request.Headers["Idempotency-Key"] = "activate-invalid-env";
    ...
    [Fact]
    public async Task Promote_returns_bad_request_when_source_environment_is_whitespace()
    {
        Guid runId = Guid.Parse("11111111-1111-1111-1111-111111111111");
    ...
    [Fact]
    public async Task Promote_returns_bad_request_when_source_environment_is_invalid()
    {
        Guid runId = Guid.Parse("11111111-1111-1111-1111-111111111111");
    ...
    [Fact]
    public async Task SubmitApprovalRequest_returns_bad_request_when_source_and_target_environments_are_the_same()
    {
        Guid runId = Guid.Parse("11111111-1111-1111-1111-111111111111");
    ...
    [Fact]
    public async Task SubmitApprovalRequest_returns_bad_request_when_promotion_step_is_invalid()
    {
        Guid runId = Guid.Parse("11111111-1111-1111-1111-111111111111");
    ...
    [Fact]
    public async Task Promote_returns_bad_request_when_promotion_step_is_invalid()
    {
        Guid runId = Guid.Parse("11111111-1111-1111-1111-111111111111");
