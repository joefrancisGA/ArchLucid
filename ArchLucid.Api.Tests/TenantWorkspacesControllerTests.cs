...
public sealed class TenantWorkspacesControllerTests
{
    ...
    [Fact]
    public async Task DeleteProjectAsync_soft_deletes_sibling_project_in_same_workspace()
    {
        ScopeContext scope = new()
        {
            TenantId = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
        ...
        Guid defaultProjectId = Guid.Parse("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee");
        ...
        Mock<IArchitectureProjectRepository> projectsMock = new();
        projectsMock
            .Setup(r => r.TrySoftDeleteAsync(scope.TenantId, scope.WorkspaceId, siblingProjectId, It.IsAny<CancellationToken>()))
            .ReturnsAsync(true);
        ...
        projectsMock.Verify(
            r => r.TrySoftDeleteAsync(scope.TenantId, scope.WorkspaceId, siblingProjectId, It.IsAny<CancellationToken>()),
            Times.Once);
    }
