...
public sealed class GovernanceCoverageControllerScopeTests
{
    ...
    [Fact]
    public async Task PreviewCoverage_returns_bad_request_when_body_null()
    {
        GovernanceCoverageController controller = new(
            Mock.Of<ICoverageQueryService>(),
            Mock.Of<ICoveragePreviewService>(MockBehavior.Strict),
            Mock.Of<IPolicyPackRepository>(MockBehavior.Strict),
            Mock.Of<IScopeContextProvider>(MockBehavior.Strict),
    ...
    [Fact]
    public async Task GetScopeCoverage_returns_not_found_when_workspace_is_out_of_scope()
    {
        Mock<ICoverageQueryService> coverage = new(MockBehavior.Strict);
        ...
        GovernanceCoverageController controller = new(
            ...
            Mock.Of<IPolicyPackRepository>(),
            scopeProvider.Object,
            TenantWithForeignWorkspaceOnlyRepository());
        controller.ControllerContext = new ControllerContext { HttpContext = new DefaultHttpContext() };
    ...
    [Fact]
    public async Task PreviewCoverage_returns_not_found_when_workspace_is_out_of_scope()
    {
        Mock<ICoveragePreviewService> preview = new(MockBehavior.Strict);
