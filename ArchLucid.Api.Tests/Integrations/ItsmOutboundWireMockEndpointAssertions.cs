...
internal static class ItsmOutboundWireMockEndpointAssertions
{
    ...
    internal static void AssertVendorJsonEquivalent(string expectedJson, string? actualJson, string reason)
    {
