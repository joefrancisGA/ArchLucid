    ...
    : IClassFixture<JwtLocalSigningWebAppFactory>
{
    ...
    {
        Guid tenantId = await JwtLocalSigningIntegrationTestTenant.SeedStandardTierTenantAsync(factory);
        string token = JwtLocalSigningIntegrationTestTenant.MintBearerJwtForTenant(
            factory,
            tenantId,
            "ReaderUser",
