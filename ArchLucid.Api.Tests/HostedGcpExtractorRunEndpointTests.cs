...
/// <summary>HTTP coverage for <c>POST /v1/admin/gcp-extractor/hosted/run</c>.</summary>
[Trait("Suite", "Core")]
[Trait("Category", "Slow")]
public sealed class HostedGcpExtractorRunEndpointTests(ApiKeyReaderAndAdminArchLucidApiFactory factory)
    : IClassFixture<ApiKeyReaderAndAdminArchLucidApiFactory>
{
    private const string EndpointPath = "/v1/admin/gcp-extractor/hosted/run";
