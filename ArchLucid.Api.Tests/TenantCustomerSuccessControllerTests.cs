...
public sealed class TenantCustomerSuccessControllerTests
{
    ...
    [SkippableFact]
    public async Task PostProductFeedbackAsync_returns_bad_request_when_score_is_out_of_range()
    {
    ...
    [SkippableFact]
    public async Task PostProductFeedbackAsync_returns_bad_request_when_run_id_is_empty_guid()
    {
        Mock<ITenantCustomerSuccessRepository> repo = new(MockBehavior.Strict);
        Mock<IScopeContextProvider> scopeProvider = new();
        scopeProvider.Setup(s => s.GetCurrentScope()).Returns(Scope);
    ...
    [Fact]
    public async Task GetFunnelSnapshotAsync_returns_not_found_when_workspace_is_out_of_scope()
    {
    ...
    [Fact]
    public async Task GetHealthScoreAsync_returns_not_found_when_workspace_is_out_of_scope()
    {
        Guid foreignWorkspaceId = Guid.Parse("dddddddd-dddd-dddd-dddd-dddddddddddd");
    ...
    [Fact]
    public async Task GetNextBestActionsAsync_returns_not_found_when_workspace_is_out_of_scope()
    {
        Guid foreignWorkspaceId = Guid.Parse("dddddddd-dddd-dddd-dddd-dddddddddddd");
    ...
    [Fact]
    public async Task PostProductFeedbackAsync_returns_not_found_when_workspace_is_out_of_scope()
    {
        Guid foreignWorkspaceId = Guid.Parse("dddddddd-dddd-dddd-dddd-dddddddddddd");
        ...
        ProductFeedbackRequest request = new() { Score = 1 };
