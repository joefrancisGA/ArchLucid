...
[Trait("Suite", "Core")]
public sealed class MarketingQuickScanSampleOnlyTests
{
    [SkippableFact]
    public async Task PostQuickScan_when_sample_only_returns_503_without_calling_orchestrator()
    {
        ...
        operational
            ...
            .ReturnsAsync(new QuickScanSafetyOperationalSnapshot
            {
                ...
                PublicMessage = "Sample only mode.",
                StoreHealthy = true,
            });
