...
public sealed class GovernanceStickinessControllerTests
{
    ...
    [Fact]
    public async Task ListRiskExceptions_returns_bad_request_when_project_id_is_empty_guid()
    {
        ...
        IActionResult action = await sut.ListRiskExceptions(
            projectId: Guid.Empty,
            cancellationToken: CancellationToken.None);
    ...
    {
        GovernanceStickinessController sut = BuildSut();
        DateTimeOffset after = new(2026, 2, 1, 0, 0, 0, TimeSpan.Zero);
        DateTimeOffset before = new(2026, 1, 1, 0, 0, 0, TimeSpan.Zero);
    ...
    [Fact]
    public async Task GetDecisionRegister_returns_bad_request_when_min_confidence_is_negative()
    {
        GovernanceStickinessController sut = BuildSut();
    ...
    [Fact]
    public async Task GetDecisionRegister_returns_bad_request_when_max_confidence_exceeds_one_hundred()
    {
        GovernanceStickinessController sut = BuildSut();
    ...
    [Fact]
    public async Task GetDecisionRegister_returns_bad_request_when_buyer_confidence_source_is_whitespace()
    {
        GovernanceStickinessController sut = BuildSut();
    ...
    [Fact]
    public async Task RecordBulkDisposition_returns_bad_request_when_disposition_validation_fails_for_in_scope_finding()
    {
        ...
        badRequest.Value.Should().BeOfType<Microsoft.AspNetCore.Mvc.ProblemDetails>()
            .Which.Detail.Should().Contain("Revisit due date is required");
    }
    ...
    [Fact]
    public async Task RecordDisposition_returns_bad_request_when_run_id_is_empty_guid()
    {
    ...
    [Fact]
    public async Task UpdateRecurrenceSchedule_returns_bad_request_when_cron_expression_is_whitespace()
    {
        Mock<IArchitectureReviewRecurrenceScheduleRepository> recurrenceRepo = new(MockBehavior.Strict);
        GovernanceStickinessController controller = BuildSut(recurrenceRepo: recurrenceRepo);
    ...
    [Fact]
    public async Task CreateRiskException_returns_bad_request_when_run_id_is_empty_guid()
    {
        Mock<IRiskExceptionService> riskExceptions = new(MockBehavior.Strict);
        GovernanceStickinessController controller = BuildSut(riskExceptions: riskExceptions);
    ...
    [Fact]
    public async Task CreateRiskException_returns_bad_request_when_manifest_id_is_empty_guid()
    {
        Mock<IRiskExceptionService> riskExceptions = new(MockBehavior.Strict);
        GovernanceStickinessController controller = BuildSut(riskExceptions: riskExceptions);
    ...
    [Fact]
    public async Task RecordDisposition_returns_bad_request_when_route_finding_id_is_whitespace()
    {
        GovernanceStickinessController controller = BuildSut();
        SetIdempotencyKey(controller);
    ...
    [Fact]
    public async Task RecordDisposition_returns_bad_request_when_body_finding_id_mismatches_route()
    {
        Mock<IFindingDispositionService> dispositions = new(MockBehavior.Strict);
        GovernanceStickinessController controller = BuildSut(dispositionService: dispositions);
        SetIdempotencyKey(controller);
    ...
    [Fact]
    public async Task CreateRecurrenceSchedule_returns_bad_request_when_cron_expression_is_null()
    {
        Mock<IArchitectureReviewRecurrenceScheduleRepository> recurrenceRepo = new(MockBehavior.Strict);
        GovernanceStickinessController controller = BuildSut(recurrenceRepo: recurrenceRepo);
    ...
    public void PreviewRecurrenceScheduleRuns_returns_bad_request_when_cron_expression_exceeds_max_length()
    {
        ...
        IActionResult action = controller.PreviewRecurrenceScheduleRuns(
    ...
    [Fact]
    public async Task ResolveFindingMergeConflict_returns_bad_request_when_action_is_out_of_range()
    {
        GovernanceStickinessController controller = BuildSut();
