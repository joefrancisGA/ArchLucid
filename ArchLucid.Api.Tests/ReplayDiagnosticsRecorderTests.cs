...
public sealed class ReplayDiagnosticsRecorderTests
{
    ...
    public void Record_evicts_entries_older_than_retention_minutes()
    {
        ...
        {
            TimestampUtc = TimeProvider.System.UtcNowDateTime().AddHours(-2), ComparisonRecordId = "old"
        });
        sut.Record(new ReplayDiagnosticsEntry { TimestampUtc = TimeProvider.System.UtcNowDateTime(), ComparisonRecordId = "new" });
