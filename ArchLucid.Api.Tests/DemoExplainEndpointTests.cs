...
/// <list type="bullet">
///   <item><description><b>Demo:Enabled=false</b> (factory default) — <see cref="FeatureGateFilter"/> short-circuits before the action runs.</description></item>
///   <item><description><b>Demo:Enabled=true</b> but no committed demo run — <see cref="DemoReadModelClient"/> returns null and the controller emits <c>NotFoundProblem</c>.</description></item>
/// </list>
/// A third scenario stubs <see cref="IDemoReadModelClient"/> to return a payload and confirms the endpoint serializes it intact.
/// </summary>
...
public sealed class DemoExplainEndpointTests : IClassFixture<ArchLucidApiFactory>
{
    ...
    public DemoExplainEndpointTests(ArchLucidApiFactory factory) => _factory = factory;
    ...
    {
        public Task<DemoExplainResponse?> GetLatestCommittedDemoExplainAsync(CancellationToken cancellationToken = default)
        {
