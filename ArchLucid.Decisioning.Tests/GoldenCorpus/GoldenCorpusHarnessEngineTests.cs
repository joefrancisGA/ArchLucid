...
public sealed class GoldenCorpusHarnessEngineTests
{
    ...
    public void CreateEngines_registers_declaration_engines()
    {
        ...
        engineTypes.Count.Should().Be(28, "harness graph engine registration is a merge-blocking contract (WK-06 + DX-24/25/36/49 golden fixtures + topology-anti-pattern + topology-security-drift + AS-042 diagram-declaration-omission + requirement-gap)");
    }
}
