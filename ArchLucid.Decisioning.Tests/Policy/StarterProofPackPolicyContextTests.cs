...
public sealed class StarterProofPackPolicyContextTests
{
    ...
    [
        ...
        Path.Combine("Templates", "StarterProofPacks", "aws-cost-governance", "policy-context.json"),
        Path.Combine("Templates", "StarterProofPacks", "gcp-cost-governance", "policy-context.json"),
