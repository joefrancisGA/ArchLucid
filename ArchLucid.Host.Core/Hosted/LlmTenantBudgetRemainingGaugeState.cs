...
/// <summary>Latest per-tenant LLM UTC-month budget USD headroom before hard cutoff (read on Prometheus scrape).</summary>
public sealed class LlmTenantBudgetRemainingGaugeState
{
