...
- **Assessments / readiness passes:** **`docs/library/ASSESSMENT_INPUTS.md`**, **`docs/assessments/LATEST.md`**, `.cursor/rules/Assessment-Read-First.mdc`, `.cursor/rules/Assessment-Scope-V1_1.mdc`.
