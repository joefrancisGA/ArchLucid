...
public static class FindingsSnapshotMigrator
{
    ...
    {
        if (f.FindingSchemaVersion >= FindingsSchema.CurrentFindingVersion) return;
    ...
    {
        if (string.Equals(findingType, "RequirementFinding", StringComparison.OrdinalIgnoreCase)) return "Requirement";
        if (string.Equals(findingType, "TopologyGap", StringComparison.OrdinalIgnoreCase)) return "Topology";
        if (string.Equals(findingType, "SecurityControlFinding", StringComparison.OrdinalIgnoreCase)) return "Security";
    ...
    {
        if (string.Equals(findingType, "RequirementFinding", StringComparison.OrdinalIgnoreCase)) return nameof(Payloads.RequirementFindingPayload);
        if (string.Equals(findingType, "TopologyGap", StringComparison.OrdinalIgnoreCase)) return nameof(Payloads.TopologyGapFindingPayload);
        if (string.Equals(findingType, "SecurityControlFinding", StringComparison.OrdinalIgnoreCase)) return nameof(Payloads.SecurityControlFindingPayload);
