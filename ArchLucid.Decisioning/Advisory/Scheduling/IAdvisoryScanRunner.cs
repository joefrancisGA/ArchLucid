...
{
    /// <summary>
    /// Creates an execution row, runs comparison/advisory/digest delivery under ambient scope, and advances <see cref="AdvisoryScanSchedule.LastRunUtc"/> / <see cref="AdvisoryScanSchedule.NextRunUtc"/> (including after failures).
    /// </summary>
    /// <param name="schedule">Schedule metadata including tenant/workspace/project and <see cref="AdvisoryScanSchedule.RunProjectSlug"/>.</param>
