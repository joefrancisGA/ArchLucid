...
{
    /// <summary>
    /// Builds markdown content (top recommendations, summary notes, alert section) and populates <see cref="ArchitectureDigest.MetadataJson"/> with recommendation/alert counts.
    /// </summary>
