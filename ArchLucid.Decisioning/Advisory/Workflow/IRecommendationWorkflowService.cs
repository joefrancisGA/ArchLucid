...
{
    /// <summary>
    /// Upserts every recommendation in the plan for the given scope, preserving review state when a row already left <see cref="RecommendationStatus.Proposed"/>.
    /// </summary>
    /// <param name="plan">Generated plan; each <see cref="ImprovementRecommendation"/> must carry a stable <see cref="ImprovementRecommendation.RecommendationId"/>.</param>
    /// <param name="tenantId">Tenant scope.</param>
    /// <param name="workspaceId">Workspace scope.</param>
    /// <param name="projectId">Project scope.</param>
    /// <param name="ct">Cancellation token.</param>
    /// <remarks>
    /// If an existing row is found and its status is no longer <c>Proposed</c>, status, reviewer fields, and original <see cref="RecommendationRecord.CreatedUtc"/> are retained;
    /// content fields are refreshed from the plan and <see cref="RecommendationRecord.LastUpdatedUtc"/> is set to UTC now.
    /// </remarks>
    ...
    /// <summary>
    /// Updates status and reviewer metadata from <see cref="RecommendationActionRequest"/>; unknown actions leave status unchanged.
    /// </summary>
    ...
    /// <param name="request">Action discriminator in <see cref="RecommendationActionRequest.Action"/>; optional comment/rationale.</param>
    /// <param name="ct">Cancellation token.</param>
