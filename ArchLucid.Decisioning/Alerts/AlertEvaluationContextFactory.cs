...
/// <summary>
///     Builds <see cref="AlertEvaluationContext" /> for orchestration paths that already have an improvement plan and
///     merged governance (e.g. advisory scan).
/// </summary>
/// <remarks>
///     Primary caller: <c>ArchLucid.Persistence.Advisory.AdvisoryScanRunner</c> after loading
///     <see cref="IEffectiveGovernanceLoader" /> once per scan.
/// </remarks>
public static class AlertEvaluationContextFactory
{
    /// <summary>
    ///     Creates a context for advisory digest / alert evaluation with governance pre-attached so alert services skip a
    ///     second loader call.
    /// </summary>
    ...
    /// <param name="effectiveGovernance">
    ///     Merged <see cref="PolicyPackContentDocument" /> from
    ///     <see cref="IEffectiveGovernanceLoader" />.
    /// </param>
    /// <returns>
    ///     A new <see cref="AlertEvaluationContext" /> with
    ///     <see cref="AlertEvaluationContext.EffectiveGovernanceContent" /> set.
    /// </returns>
