...
{
    /// <summary>
    /// When <paramref name="runId"/> is set, builds a single context for that run (optional comparison). Otherwise loads recent runs for the slug and builds one context per run.
    /// </summary>
