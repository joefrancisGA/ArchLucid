...
{
    /// <summary>
    /// Builds contexts via <see cref="IAlertSimulationContextProvider"/>, evaluates the requested rule kind per context, and aggregates counts and outcomes.
    /// </summary>
    ...
    /// <summary>
    /// Runs <see cref="SimulateAsync"/> twice (candidate A vs B) with shared window settings and returns side-by-side results plus summary notes.
    /// </summary>
