...
{
    /// <summary>
    /// Runs one simulation per distinct candidate threshold, scores with noise heuristics, and sets <see cref="ThresholdRecommendationResult.RecommendedCandidate"/> to the best row.
    /// </summary>
