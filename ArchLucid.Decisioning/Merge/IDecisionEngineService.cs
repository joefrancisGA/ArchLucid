...
public interface IDecisionEngineService
{
    ...
    /// and <see cref="DecisionMergeResult.Manifest"/> is populated on success, or <see cref="DecisionMergeResult.Errors"/>
    /// is non-empty on failure (the manifest may be partially populated in that case).
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// Thrown when <paramref name="request"/>, <paramref name="evaluations"/>, or <paramref name="decisionNodes"/> is <see langword="null"/>.
    /// </exception>
