...
/// <remarks>
/// <para>
/// <strong>Why:</strong> Call sites such as <c>AlertService</c>, <c>CompositeAlertService</c>, <c>AdvisoryScanRunner</c>,
/// and <c>PolicyFilteredComplianceRulePackProvider</c> should not duplicate merge logic; they load effective content once per operation.
/// </para>
/// <para>
/// Implementation delegates to <see cref="IEffectiveGovernanceResolver.ResolveAsync"/> and returns
/// <see cref="EffectiveGovernanceResolutionResult.EffectiveContent"/> only. For full traceability use the resolver or
...
public interface IEffectiveGovernanceLoader
{
    ...
    /// <returns>
    /// Merged <see cref="PolicyPackContentDocument"/> after hierarchical resolution; may be empty when no assignments apply.
    /// </returns>
