...
/// <summary>
///     Domain service for <strong>mutating</strong> policy packs: create pack, publish version, assign version to a scope
///     tier.
...
{
    /// <summary>
    ///     Creates a new pack scoped to tenant/workspace/project and seeds an initial <strong>unpublished</strong>
    ///     version <c>1.0.0</c>.
    /// </summary>
    ...
    /// <remarks>
    ///     Caller is typically <c>PolicyPacksAppService.CreatePackAsync</c> after API validation. Also used from integration
    ///     tests.
    /// </remarks>
    ...
    /// <summary>
    ///     Publishes (or re-publishes) a semantic version for a pack: upserts <see cref="PolicyPackVersion" />, marks
    ///     published,
    ///     and updates the parent pack to <see cref="PolicyPackStatus.Active" /> with <see cref="PolicyPack.CurrentVersion" />
    ///     set.
    /// </summary>
    ...
    /// <summary>
    ///     Persists a new <see cref="PolicyPackAssignment" /> linking a pack version to a governance tier (tenant / workspace
    ///     / project).
    /// </summary>
    /// <param name="tenantId">Tenant for the assignment (always required).</param>
    /// <param name="workspaceId">
    ///     Workspace for workspace/project scope; may be stored as <see cref="Guid.Empty" /> for tenant
    ///     scope.
    /// </param>
    ...
    ///     Normalized to <see cref="GovernanceScopeLevel" />; invalid values should be rejected by API
    ///     validation.
    /// </param>
