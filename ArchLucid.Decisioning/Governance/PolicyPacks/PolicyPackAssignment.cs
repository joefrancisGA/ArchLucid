...
/// </summary>
/// <remarks>
///     Rows are queried hierarchically (see <see cref="IPolicyPackAssignmentRepository.ListByScopeAsync" />). Unused scope
...
public class PolicyPackAssignment
{
    ...
    ///     <see cref="IPolicyPackAssignmentRepository.ListByScopeAsync" />.
    /// </summary>
    ...
    /// <summary>
    ///     When true with <see cref="IsEnabled" />, manifest commit is blocked if the run has Critical findings (optional
    ///     gate).
    /// </summary>
