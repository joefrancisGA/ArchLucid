...
/// <remarks>
/// Created via <see cref="IPolicyPackManagementService.CreatePackAsync"/>; status moves to <see cref="PolicyPackStatus.Active"/> on publish.
/// Referenced when resolving assignments to display names in <see cref="ResolvedPolicyPack"/> and governance decisions.
/// </remarks>
