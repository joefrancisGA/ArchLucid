...
/// </summary>
/// <remarks>
/// Built by <see cref="EffectiveGovernanceResolver"/>; surfaced in API JSON for transparency. <see cref="ValueJson"/> meaning depends on
/// <see cref="GovernanceResolutionDecision.ItemType"/> (raw string for dictionary entries, JSON string for compliance keys, GUID format for ids).
/// </remarks>
