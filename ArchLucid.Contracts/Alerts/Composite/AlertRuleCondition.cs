namespace ArchLucid.Contracts.Alerts.Composite;

/// <summary>
///     One predicate in a <see cref="CompositeAlertRule" />: metric id, comparison operator, and threshold.
/// </summary>
/// <remarks>
///     <see cref="MetricType" /> should be a <see cref="AlertMetricType" /> constant; <see cref="Operator" /> uses
///     <see cref="AlertConditionOperator" /> values.
/// </remarks>
