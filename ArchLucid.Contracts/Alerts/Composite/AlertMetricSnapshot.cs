...
/// <summary>
///     Numeric metrics derived from an <see cref="AlertEvaluationContext" /> for composite rule predicates (
///     <see cref="AlertRuleCondition" />).
/// </summary>
/// <remarks>
///     Built by <see cref="AlertMetricSnapshotBuilder" /> immediately before <see cref="ICompositeAlertRuleEvaluator" />
///     and <see cref="IAlertSuppressionPolicy" />.
/// </remarks>
