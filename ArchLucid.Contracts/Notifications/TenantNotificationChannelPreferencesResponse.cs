...
/// <summary>
///     Read model for <c>GET /v1/notifications/customer-channel-preferences</c> (Logic Apps / governance promotion
///     customer fan-out).
/// </summary>
public sealed class TenantNotificationChannelPreferencesResponse
{
    ...
    /// <summary>
    ///     When true, Logic Apps may send governance promotion customer email (addresses still come from Key Vault /
    ///     connector config, not this API).
    /// </summary>
