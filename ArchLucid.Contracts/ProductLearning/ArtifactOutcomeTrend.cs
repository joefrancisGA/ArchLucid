...
public sealed class ArtifactOutcomeTrend
{
    ...
    /// <summary>
    ///     Signals interpreted as positive acceptance/trust (maps to
    ///     <see cref="ProductLearningDispositionValues.Trusted" /> in 58R pipelines).
    /// </summary>
    ...
    public double? AverageUsefulnessScore
    {
        get;
        init;
    }
