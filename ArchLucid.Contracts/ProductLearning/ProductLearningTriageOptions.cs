...
public sealed class ProductLearningTriageOptions
{
    ...
    public int MinSignalsPerAggregate
    {
        get;
        init;
    } = 2;
    ...
    public int MinNegativeOutcomesOnArtifactTrend
    {
        get;
        init;
    } = 2;
    ...
    public int MinAggregateBadScoreForOpportunity
    {
        get;
        init;
    } = 4;
    ...
    public int MinCommentThemeOccurrences
    {
        get;
        init;
    } = 2;
    ...
    public int MinCommentOccurrencesForTriageQueue
    {
        get;
        init;
    } = 4;
    ...
    public int MaxImprovementOpportunities
    {
        get;
        init;
    } = 30;
    ...
    public int MaxTriageQueueItems
    {
        get;
        init;
    } = 25;
    ...
    ///     <c>IProductLearningFeedbackAggregationService.GetSnapshotAsync</c> in 58R (property reserved for a future panel or
    ///     caller).
    /// </summary>
    public int TopRejectedRevisedTake
    {
        get;
        init;
    } = 25;
