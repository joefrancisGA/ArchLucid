...
/// <summary>
///     A product issue or enhancement candidate inferred from feedback patterns (for triage — not an auto-commit backlog
///     item).
/// </summary>
public sealed class ImprovementOpportunity
{
    ...
    public string? SuggestedOwnerRole
    {
        get;
        init;
    }
    ...
    public string? RepeatedThemeSnippet
    {
        get;
        init;
    }
