...
{
    /// <summary>
    /// Returns plans sorted by <see cref="ImprovementPlan.PriorityScore"/> descending, then <see cref="ImprovementPlan.PlanId"/>.
    /// Each plan is cloned with updated <see cref="ImprovementPlan.PriorityScore"/> and <see cref="ImprovementPlan.PrioritizationExplanation"/>.
    /// </summary>
