...
public sealed class ImprovementThemeExtractionOptions
{
    ...
    public int MinSignalsPerAggregateTheme
    {
        get;
        init;
    } = 2;
    ...
    public int MinRejectedOrFollowUpForOutcomePattern
    {
        get;
        init;
    } = 2;
    ...
    public int MinRevisedForRevisionPattern
    {
        get;
        init;
    } = 2;
    ...
    public int MinSignalsPerArtifactTrend
    {
        get;
        init;
    } = 2;
    ...
    public int MinCommentOccurrences
    {
        get;
        init;
    } = 2;
    ...
    public int MaxExampleEvidencePerTheme
    {
        get;
        init;
    } = 5;
