...
/// <summary>
///     Redacted LLM prompt/response audit slice for one finding, aligned with persisted
///     <see cref="Agents.AgentExecutionTrace" /> rows.
/// </summary>
public sealed class FindingLlmAuditResult
{
    ...
    public string SystemPromptRedacted
    {
        get;
        set;
    } = string.Empty;

    public string UserPromptRedacted
    {
        get;
        set;
    } = string.Empty;

    public string RawResponseRedacted
    {
        get;
        set;
    } = string.Empty;
    ...
    public Dictionary<string, int> RedactionCountsByCategory
    {
        get;
        set;
