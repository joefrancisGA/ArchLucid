...
public static class ValueReportReviewCycleSectionFormatter
{
    ...
    public static IReadOnlyList<ValueReportReviewCycleParagraph> GetParagraphs(ValueReportSnapshot snapshot)
    {
        ...
        list.Add(new ValueReportReviewCycleParagraph(deltaLine, Bold: false, Italic: false, FontSizeHalfPoints: 22));
    ...
    private static string FormatHours(decimal? hours) => hours is { } h ? h.ToString("0.##", CultureInfo.InvariantCulture) : "0";
}
