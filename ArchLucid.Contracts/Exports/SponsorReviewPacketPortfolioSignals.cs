...
/// <summary>Cross-run governance and ROI signals included in sponsor review packets (TB-062 / Batch C).</summary>
public sealed class SponsorReviewPacketPortfolioSignals
{
