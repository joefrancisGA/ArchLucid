...
{
    /// <summary>Disposition-aware open + needs-evidence USD headline for executive summary surfaces.</summary>
    ...
    /// <summary>Trailing 30-day UTC finding review and discovery counters on executive summary.</summary>
