...
public static class GovernanceEnvironmentOrder
{
    private static readonly IReadOnlyDictionary<string, int> Order =
        ...
        {
            [GovernanceEnvironment.Dev] = 0,
            [GovernanceEnvironment.Test] = 1,
            [GovernanceEnvironment.Prod] = 2,
        };

    /// <summary>
    /// Returns <see langword="true"/> when <paramref name="target"/> is exactly one step after <paramref name="source"/> in the governance ladder.
    /// </summary>
