...
/// <summary>
///     JSON shape for an advisory <see cref="ArchLucid.Decisioning.Advisory.Models.ImprovementPlan" /> returned from HTTP
///     APIs.
/// </summary>
...
public class ImprovementPlanResponse
{
    ...
    public List<ImprovementRecommendationResponse> Recommendations
    {
        get;
        set;
    } = [];
