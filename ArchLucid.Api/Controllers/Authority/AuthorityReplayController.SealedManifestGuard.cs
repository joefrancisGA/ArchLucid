...
public sealed partial class AuthorityReplayController
{
    ...
    /// <summary>
    ///     Maps authority replay read <see cref="ConflictException" /> raised via sealed-manifest guards to OpenAPI **409**.
    /// </summary>
    private IActionResult MapAuthorityReplaySealedManifestConflict(ConflictException ex) =>
