    ...
    IScopeContextProvider scopeContextProvider) : ControllerBase
{
    ...
    /// <summary>Deprecated alias — tenant must match ambient scope via route binding filter.</summary>
    [HttpGet("tenants/{tenantId:guid}/summary")]
    [Obsolete("Use GET /v1/admin/metering/summary — tenant is resolved from scope only.")]
    [ProducesResponseType(typeof(IReadOnlyList<TenantUsageSummary>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(Microsoft.AspNetCore.Mvc.ProblemDetails), StatusCodes.Status400BadRequest)]
    public Task<IActionResult> GetTenantSummaryLegacyAsync(
        Guid tenantId,
        [FromQuery] DateTimeOffset periodStart,
        [FromQuery] DateTimeOffset periodEnd,
        CancellationToken cancellationToken = default) =>
