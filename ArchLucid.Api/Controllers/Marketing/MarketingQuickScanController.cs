    ...
    IActorContext actorContext) : ControllerBase
{
    ...
    public async Task<IActionResult> GetQuickScanStatusAsync(CancellationToken cancellationToken)
    {
        ...
        return Ok(MapStatus(status, operational));
    }
    ...
    private static QuickScanStatusResponse MapStatus(
        QuickScanStatusResponse guardStatus,
        QuickScanSafetyOperationalSnapshot operational) =>
        new()
        {
            Enabled = guardStatus.Enabled && operational.AnonymousExecutionAllowed,
            CapacityAvailable = guardStatus.CapacityAvailable && operational.AnonymousExecutionAllowed,
            RequireSignIn = guardStatus.RequireSignIn,
            SampleResultAvailable = operational.SampleResultAvailable,
