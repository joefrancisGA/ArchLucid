...
/// <summary>
///     Adds description and a JSON example for POST create run (
///     <see cref="ArchLucid.Contracts.Requests.ArchitectureRequest" />) including context-ingestion fields.
/// </summary>
/// <remarks>
///     Microsoft.OpenApi 2.x does not ship the old <c>OpenApiObject</c> / <c>Microsoft.OpenApi.Any</c> model for
