        ...
        services.AddSwaggerGen(c =>
        {
            ...
            c.TagActionsBy(api =>
            {
                ...
                string tag = cad.ControllerName switch
                {
                    ...
                    "Graph" or "Manifests" or "Provenance" or "ProvenanceQuery" or "ArtifactExport" =>
                        "Authority artifacts",
