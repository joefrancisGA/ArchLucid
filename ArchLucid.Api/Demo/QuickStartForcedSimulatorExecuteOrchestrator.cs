...
public sealed class QuickStartForcedSimulatorExecuteOrchestrator(
    ...
    DeterministicAgentSimulator deterministicAgentSimulator,
    IAgentExecutionTraceRecorder agentExecutionTraceRecorder,
    ...
    ILogger<QuickStartForcedSimulatorExecuteOrchestrator> logger)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            IReadOnlyList<AgentResult> results = await _forcedSimulatorExecutor.ExecuteAsync(
                runId,
                request,
                evidence,
                tasks,
