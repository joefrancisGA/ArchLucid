...
public sealed class LearningSummaryResponse
{
    ...
    /// <summary>
    ///     Sum of <see cref="LearningThemeResponse.EvidenceSignalCount" /> across themes in scope (same cap as themes
    ///     list).
    /// </summary>
    ...
    /// <summary>
    ///     Maximum <see cref="LearningPlanListItemResponse.PriorityScore" /> among plans in scope, or null when there are
    ///     no plans.
    /// </summary>
