...
/// <summary>
///     Extracts structured shadow metrics from persisted
///     <see cref="ArchLucid.Contracts.Evolution.EvolutionSimulationRunRecord.OutcomeJson" />.
/// </summary>
internal static class EvolutionOutcomeShadowReader
{
    ...
    /// </summary>
    internal static void TryReadShadow(string outcomeJson, out EvolutionShadowOutcomeSnapshot? shadow,
        out string shadowKind)
    {
        ...
        try
        {
            ...
            {
                shadow = JsonSerializer.Deserialize<EvolutionShadowOutcomeSnapshot>(sh.GetRawText(),
                    DeserializeOptions);
