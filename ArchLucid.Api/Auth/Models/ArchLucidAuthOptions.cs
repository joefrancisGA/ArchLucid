...
public class ArchLucidAuthOptions
{
    ...
    /// <summary>
    ///     Comma-separated Entra directory tenant ids (<c>tid</c>). When non-empty, tokens must include a matching
    ///     <c>tid</c> claim.
    /// </summary>
    public string AllowedEntraTenantIds
    {
        get;
        set;
    } = string.Empty;
    ...
    /// </summary>
    public string JwtSigningPublicKeyPemPath
    {
        get;
        set;
    } = string.Empty;
    ...
    public string JwtLocalAudience
    {
        get;
        set;
    } = string.Empty;
    ...
    /// </summary>
    public bool RequireJwtBearerInProduction
    {
        get;
        set;
    }
