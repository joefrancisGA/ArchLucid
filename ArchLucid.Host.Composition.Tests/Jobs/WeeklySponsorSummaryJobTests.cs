...
[Trait("Suite", "Core")]
[Trait("Category", "Unit")]
public sealed class WeeklySponsorSummaryJobTests
{
    [Fact]
    public void Name_is_canonical_weekly_executive_summary_slug()
    {
        WeeklySponsorSummaryJob job = new(Mock.Of<IServiceProvider>(), NullLogger<WeeklySponsorSummaryJob>.Instance);
    ...
    public async Task RunOnceAsync_returns_success_when_feature_disabled()
    {
        ...
        WeeklySponsorSummaryJob job = new(provider, NullLogger<WeeklySponsorSummaryJob>.Instance);
