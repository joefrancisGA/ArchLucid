...
/// </summary>
public static class AgentModelTierCompositionModule
{
        ...
        services.AddScoped<IAgentTierCompletionRouter>(sp =>
        {
            ...
            return new TieredAgentCompletionRouter(
                ...
                tier =>
                {
                    ...
                    return AgentCompletionPipelineHelpers.BuildAzureOpenAiScopedCompletionChain(sp, azureInner, primaryGate, effectiveDeployment);
                },
                primaryHolder.Inner,
                aliasResolver);
        });
