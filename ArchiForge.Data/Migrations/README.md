...
- **Ordering:** Resource names must sort lexicographically — use prefixes `001_`, `002_`, … `031_`, … (see `ArchiForge.Api.Tests/DatabaseMigrationScriptTests.cs`).
...
After editing migrations, update **`SQL/ArchiForge.sql`** so greenfield installs stay aligned.
